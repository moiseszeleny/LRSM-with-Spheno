...
Subroutine getZCouplings(Lam,vvSM,g1,g2,TW,g3,Yd,ZDL,ZDR,Ye,ZEL,ZER,Yu,               & 
& ZUL,ZUR,cplAhAhhh,cplhhhhhh,cplhhHpcHp,cplAhAhAhAh,cplAhAhhhhh,cplAhAhHpcHp,           & 
...
GZcplcFvFeHpL(i1,i2) = (0._dp*ZcplcFvFeVWpL(i1,i2) - MFe(i2)*ZcplcFvFeVWpR(i1,i2))/MVWp
GZcplcFvFeHpR(i1,i2) = -(MFe(i2)*ZcplcFvFeVWpL(i1,i2) - 0._dp*ZcplcFvFeVWpR(i1,i2))/MVWp
 End Do
End Do 
Do i1=1,3
 Do i2=1,3
...
GZcplcFeFvcHpL(i1,i2) = (MFe(i1)*ZcplcFeFvcVWpL(i1,i2) - 0._dp*ZcplcFeFvcVWpR(i1,i2))/MVWp
GZcplcFeFvcHpR(i1,i2) = -(0._dp*ZcplcFeFvcVWpL(i1,i2) - MFe(i1)*ZcplcFeFvcVWpR(i1,i2))/MVWp
 End Do
End Do 
...
& g2,g3,Lam,Yu,Yd,Ye,m2SM,vvSM,cplAhAhhh,cplhhhhhh,cplhhHpcHp,cplAhAhAhAh,               & 
& cplAhAhhhhh,cplAhAhHpcHp,cplhhhhhhhh,cplhhhhHpcHp,cplHpHpcHpcHp,cplAhhhVZ,             & 
...
& dg1,dg2,dg3,dYu,dYd,dYe,dm2SM,dLam,dvvSM,dZDL,dZDR,dZUL,dZUR,dZEL,dZER,dSinTW,         & 
...
Real(dp),Intent(out) :: dg1,dg2,dg3,dvvSM,dSinTW,dCosTW,dTanTW
...
Call OneLoopTadpoleshh(vvSM,MAh,MAh2,MFd,MFd2,MFe,MFe2,MFu,MFu2,Mhh,Mhh2,             & 
& MHp,MHp2,MVWp,MVWp2,MVZ,MVZ2,cplAhAhhh,cplcFdFdhhL,cplcFdFdhhR,cplcFeFehhL,            & 
& cplcFeFehhR,cplcFuFuhhL,cplcFuFuhhR,cplcgWpgWphh,cplcgWCgWChh,cplcgZgZhh,              & 
& cplhhhhhh,cplhhHpcHp,cplhhcVWpVWp,cplhhVZVZ,Tad1Loop(1:1))
...
Call ParametersToG62(g1,g2,g3,Lam,Yu,Yd,Ye,m2SM,vvSM,g1D)

TwoLoopRGEsave=TwoLoopRGE 
TwoLoopRGE=.False. 
Call rge62(62,0._dp,g1D,g1D) 
TwoLoopRGE=TwoLoopRGEsave 
Call GToParameters62(g1D,dg1,dg2,dg3,dLam,dYu,dYd,dYe,dm2SM,dvvSM)
...
! -----------------------------------------------------------
Call CalculateCouplingCT(Lam,vvSM,g1,g2,TW,g3,Yd,ZDL,ZDR,Ye,ZEL,ZER,Yu,               & 
& ZUL,ZUR,dLam,dvvSM,dg1,dg2,dSinTW,dCosTW,dTanTW,dg3,dYd,dZDL,dZDR,dYe,dZEL,            & 
...
& MVWpOS,MVWp2OS,ZDLOS,ZDROS,ZULOS,ZUROS,ZELOS,ZEROS,vvSM,g1,g2,g3,Lam,Yu,               & 
& Yd,Ye,m2SM,epsI,deltaM,kont)
...
Real(dp) :: dg1,dg2,dg3,dvvSM,dSinTW,dCosTW,dTanTW
...
End if 
! Couplings 
Call AllCouplingsReallyAll(Lam,vvSM,g1,g2,TW,g3,Yd,ZDL,ZDR,Ye,ZEL,ZER,Yu,             & 
& ZUL,ZUR,cplAhAhhh,cplhhhhhh,cplhhHpcHp,cplAhAhAhAh,cplAhAhhhhh,cplAhAhHpcHp,           & 
& cplhhhhhhhh,cplhhhhHpcHp,cplHpHpcHpcHp,cplAhhhVZ,cplAhHpcVWp,cplAhcHpVWp,              & 
& cplhhHpcVWp,cplhhcHpVWp,cplHpcHpVP,cplHpcHpVZ,cplhhcVWpVWp,cplhhVZVZ,cplHpcVWpVP,      & 
& cplHpcVWpVZ,cplcHpVPVWp,cplcHpVWpVZ,cplAhAhcVWpVWp,cplAhAhVZVZ,cplAhHpcVWpVP,          & 
...
If (externalZfactors) Then 
Call getZCouplings(Lam,vvSM,g1,g2,TW,g3,Yd,ZDL,ZDR,Ye,ZEL,ZER,Yu,ZUL,ZUR,             & 
...
& cplcgWCgZcHp,ZRUVd,ZRUUd,ZRUVu,ZRUUu,ZRUVe,ZRUUe,ZcplAhAhhh,Zcplhhhhhh,ZcplhhHpcHp,    & 
& ZcplAhAhAhAh,ZcplAhAhhhhh,ZcplAhAhHpcHp,Zcplhhhhhhhh,ZcplhhhhHpcHp,ZcplHpHpcHpcHp,     & 
& ZcplAhhhVZ,ZcplAhHpcVWp,ZcplAhcHpVWp,ZcplhhHpcVWp,ZcplhhcHpVWp,ZcplHpcHpVP,            & 
& ZcplHpcHpVZ,ZcplhhcVWpVWp,ZcplhhVZVZ,ZcplHpcVWpVP,ZcplHpcVWpVZ,ZcplcHpVPVWp,           & 
& ZcplcHpVWpVZ,ZcplAhAhcVWpVWp,ZcplAhAhVZVZ,ZcplAhHpcVWpVP,ZcplAhHpcVWpVZ,               & 
...
& ZcplcFvFeHpR,ZcplcFuFuhhL,ZcplcFuFuhhR,ZcplcFdFucHpL,ZcplcFdFucHpR,ZcplcFeFvcHpL,      & 
& ZcplcFeFvcHpR,ZcplcFdFdVGL,ZcplcFdFdVGR,ZcplcFdFdVPL,ZcplcFdFdVPR,ZcplcFuFdVWpL,       & 
& ZcplcFuFdVWpR,ZcplcFdFdVZL,ZcplcFdFdVZR,ZcplcFeFeVPL,ZcplcFeFeVPR,ZcplcFvFeVWpL,       & 
& ZcplcFvFeVWpR,ZcplcFeFeVZL,ZcplcFeFeVZR,ZcplcFuFuVGL,ZcplcFuFuVGR,ZcplcFuFuVPL,        & 
& ZcplcFuFuVPR,ZcplcFuFuVZL,ZcplcFuFuVZR,ZcplcFdFucVWpL,ZcplcFdFucVWpR,ZcplcFvFvVZL,     & 
& ZcplcFvFvVZR,ZcplcFeFvcVWpL,ZcplcFeFvcVWpR,ZcplVGVGVGVG1,ZcplVGVGVGVG2,ZcplVGVGVGVG3,  & 
& ZcplcVWpVPVPVWp1,ZcplcVWpVPVPVWp2,ZcplcVWpVPVPVWp3,ZcplcVWpVPVWpVZ1,ZcplcVWpVPVWpVZ2,  & 
& ZcplcVWpVPVWpVZ3,ZcplcVWpcVWpVWpVWp1,ZcplcVWpcVWpVWpVWp2,ZcplcVWpcVWpVWpVWp3,          & 
& ZcplcVWpVWpVZVZ1,ZcplcVWpVWpVZVZ2,ZcplcVWpVWpVZVZ3,ZcplcgGgGVG,ZcplcgWpgAVWp,          & 
& ZcplcgWCgAcVWp,ZcplcgWpgWpVP,ZcplcgWpgWpVZ,ZcplcgAgWpcVWp,ZcplcgZgWpcVWp,              & 
...
& Yu,Yd,Ye,m2SM,vvSM,cplAhAhhh,cplhhhhhh,cplhhHpcHp,cplAhAhAhAh,cplAhAhhhhh,             & 
...
& Ye,m2SM,vvSM,dg1,dg2,dg3,dYu,dYd,dYe,dm2SM,dLam,dvvSM,dZDL,dZDR,dZUL,dZUR,             & 
& dZEL,dZER,dSinTW,dCosTW,dTanTW,ZfVG,ZfHp,ZfvL,ZfAh,Zfhh,ZfVP,ZfVZ,ZfVWp,               & 
