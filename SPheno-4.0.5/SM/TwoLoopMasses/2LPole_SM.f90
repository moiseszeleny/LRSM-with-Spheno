...
Subroutine CalculatePi2S(p2,vvSM,g1,g2,g3,Lam,Yu,Yd,Ye,m2SM,kont,tad2L,               & 
& Pi2S,Pi2P)
...
Call CouplingsFor2LPole3(Lam,vvSM,g3,Yd,ZDL,ZDR,Ye,ZEL,ZER,Yu,ZUL,ZUR,cplAhAhhh,      & 
...
do i2=1,1
do i3=1,1
 funcvalue= tad1LmatrixAh(i2,i3)*CCtilde(Mhh2,MAh2,MAh2,Qscale)
do gE1=1,1
do gE2=1,1
coup1 = cplAhAhhh
coup2 = cplAhAhhh
...
do i2=1,1
do i3=1,1
 funcvalue= tad1Lmatrixhh(i2,i3)*CCtilde(MAh2,Mhh2,Mhh2,Qscale)
do gE1=1,1
do gE2=1,1
coup1 = cplAhAhhh
coup2 = cplAhAhhh
...
if(abs(prefactor) .gt. epscouplings) then
 ...
 tempcouplingvector(gE1)= 0._dp
   ...
   End Do
if(nonzerocoupling) then 
 funcvalue= 2._dp*0._dp*MFe(i4)*TfSSFbFb(MHp2,MHp2,0._dp,MFe2(i4),Qscale)
 temptad=temptad+tempcouplingvector*funcvalue
end if
end if
...
if(abs(prefactor) .gt. epscouplings) then
 ...
 tempcouplingvector(gE1)= 0._dp
   ...
   End Do
if(nonzerocoupling) then 
 funcvalue= -2._dp*0._dp*TfFFFbS(MFe2(i1),MFe2(i2),0._dp,MHp2,Qscale)
 temptad=temptad+tempcouplingvector*funcvalue
end if
end if
...
if(abs(prefactor) .gt. epscouplings) then
 ...
 tempcouplingvector(gE1)= 0._dp
   ...
   End Do
if(nonzerocoupling) then 
 funcvalue= 2._dp*MFe(i1)*0._dp*MFe(i2)*TfFbFbFbS(MFe2(i1),MFe2(i2),0._dp,MHp2,Qscale)
 temptad=temptad+tempcouplingvector*funcvalue
end if
end if
...
if(abs(prefactor) .gt. epscouplings) then
 ...
 tempcouplingmatrix(gE1,gE2)= 0._dp
  ...
  End do
if(nonzerocoupling) then 
 funcvalue= -1._dp*0._dp*MFe(i4)*WfSSFbFb(p2,MHp2,MHp2,0._dp,MFe2(i4),Qscale)
 tempcont=tempcont+tempcouplingmatrix*funcvalue
end if
end if
...
if(abs(prefactor) .gt. epscouplings) then
 ...
 tempcouplingmatrix(gE1,gE2)= 0._dp
  ...
  End do
if(nonzerocoupling) then 
 funcvalue= 2._dp*MFe(i2)*0._dp*MFe(i4)*MfSFbSFbFb(p2,MHp2,MFe2(i2),MHp2,MFe2(i4),0._dp,Qscale)
 tempcont=tempcont+tempcouplingmatrix*funcvalue
end if
end if
...
if(abs(prefactor) .gt. epscouplings) then
 ...
 tempcouplingmatrix(gE1,gE2)= 0._dp
  ...
  End do
if(nonzerocoupling) then 
 funcvalue= 2._dp*0._dp*MfSFSFFb(p2,MHp2,MFe2(i2),MHp2,MFe2(i4),0._dp,Qscale)
 tempcont=tempcont+tempcouplingmatrix*funcvalue
end if
end if
...
if(abs(prefactor) .gt. epscouplings) then
 ...
 tempcouplingmatrix(gE1,gE2)= 0._dp
  ...
  End do
if(nonzerocoupling) then 
 funcvalue= 2._dp*MFe(i4)*0._dp*VfSSSFbFb(p2,MHp2,MHp2,MHp2,MFe2(i4),0._dp,Qscale)
 tempcont=tempcont+tempcouplingmatrix*funcvalue
end if
end if
...
if(abs(prefactor) .gt. epscouplings) then
 ...
 tempcouplingmatrix(gE1,gE2)= 0._dp
  ...
  End do
if(nonzerocoupling) then 
 funcvalue= 2._dp*MFe(i1)*MFe(i3)*MFe(i2)*0._dp*VfFbFbFbFbS(p2,MFe2(i1),MFe2(i2),MFe2(i3),0._dp,MHp2,Qscale)
 tempcont=tempcont+tempcouplingmatrix*funcvalue
end if
end if
...
if(abs(prefactor) .gt. epscouplings) then
 ...
 tempcouplingmatrix(gE1,gE2)= 0._dp
  ...
  End do
if(nonzerocoupling) then 
 funcvalue= 2._dp*MFe(i1)*0._dp*VfFbFFFbS(p2,MFe2(i1),MFe2(i2),MFe2(i3),0._dp,MHp2,Qscale)
 tempcont=tempcont+tempcouplingmatrix*funcvalue
end if
end if
...
if(abs(prefactor) .gt. epscouplings) then
 ...
 tempcouplingmatrix(gE1,gE2)= 0._dp
  ...
  End do
if(nonzerocoupling) then 
 funcvalue= 4._dp*MFe(i3)*0._dp*VfFFFbFbS(p2,MFe2(i1),MFe2(i2),MFe2(i3),0._dp,MHp2,Qscale)
 tempcont=tempcont+tempcouplingmatrix*funcvalue
end if
end if
...
if(abs(prefactor) .gt. epscouplings) then
 ...
 tempcouplingmatrixah(gE1,gE2)= 0._dp
  ...
  End do
if(nonzerocoupling) then 
 funcvalue= -1._dp/2._dp*YfSSSS(p2,Mhh2,MAh2,MAh2,Mhh2,Qscale)
 tempcontah=tempcontah+tempcouplingmatrixah*funcvalue
end if
! ---- hh,Ah,Ah,Hp ----
nonzerocoupling=.false.
...
if(abs(prefactor) .gt. epscouplings) then
 ...
 tempcouplingmatrixah(gE1,gE2)= 0._dp
  ...
  End do
if(nonzerocoupling) then 
 funcvalue= 1._dp*VfSSSSS(p2,Mhh2,MAh2,MAh2,MAh2,Mhh2,Qscale)
 tempcontah=tempcontah+tempcouplingmatrixah*funcvalue
end if
! ---- Topology MoSSSSS
! ---- Ah,Ah,hh,hh,hh ----
...
if(abs(prefactor) .gt. epscouplings) then
 ...
 tempcouplingmatrixah(gE1,gE2)= 0._dp
  ...
  End do
if(nonzerocoupling) then 
 funcvalue= 1._dp*MfSSSSS(p2,MAh2,MAh2,Mhh2,Mhh2,Mhh2,Qscale)
 tempcontah=tempcontah+tempcouplingmatrixah*funcvalue
end if
! ---- Ah,hh,hh,Ah,Ah ----
nonzerocoupling=.false.
...
if(abs(prefactor) .gt. epscouplings) then
 ...
 tempcouplingmatrixah(gE1,gE2)= 0._dp
  ...
  End do
if(nonzerocoupling) then 
 funcvalue= 1._dp*MfSSSSS(p2,MAh2,Mhh2,Mhh2,MAh2,MAh2,Qscale)
 tempcontah=tempcontah+tempcouplingmatrixah*funcvalue
end if
! ---- Topology WoSSFF
! ---- Ah,Ah,Fd,bar[Fd] ----
