...
Real(dp),Intent(in)::Q,MHp,MVWp,MFd(3),MFu(3),MFe(3)
Integer::i1 
Real(dp)::DeltaAlpha 
If (MZ_input) then 
...
Real(dp),Intent(in)::AlphaEW_In, Q,MHp,MVWp,MFd(3),MFu(3),MFe(3)
Integer::i1 
Real(dp)::DeltaAlpha 
...
Subroutine DeltaVB(sinW2,sinW2_dr,rho,MAh,MFe,Mhh,MHp,ZER,ZEL,Ye,res)

Implicit None 
Real(dp),Intent(in) :: MAh,MFe(3),Mhh,MHp

Complex(dp),Intent(in) :: ZER(3,3),ZEL(3,3),Ye(3,3)

Real(dp) :: MAh2,MFe2(3),Mhh2,MHp2

Complex(dp) :: cplcFeFeAhL(3,3),cplcFeFeAhR(3,3),cplcFeFehhL(3,3),cplcFeFehhR(3,3),cplcFeFvcHpL(3,3),& 
& cplcFeFvcHpR(3,3),cplcFvFeHpL(3,3),cplcFvFeHpR(3,3)
...
chargefactor = 1 
  Do i2=1,3
If ((Mhh2.gt.mf_l2(2)).Or.(MFe2(i2).gt.mf_l2(2))) Then
coup1L = cplcFeFehhL(i2,gt1)
coup1R = cplcFeFehhR(i2,gt1)
coup2R = Conjg(cplcFeFehhL(i2,gt2))
coup2L = Conjg(cplcFeFehhR(i2,gt2))
sumI = sumI + chargefactor*0.5_dp*coup1L*coup2R*B1(0._dp,MFe2(i2),Mhh2)  
End if 
  End Do
