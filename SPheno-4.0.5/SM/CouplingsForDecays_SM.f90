...
& ZURinput,ZDLinput,ZELinput,ZULinput,ZWinput,ZZinput,g1input,g2input,g3input,           & 
& Laminput,Yuinput,Ydinput,Yeinput,m2SMinput,vvSMinput,cplcFuFdVWpL,cplcFuFdVWpR,        & 
...
& MHp2input,MVWpinput,MVWp2input,MVZinput,MVZ2input,TWinput,ZDRinput,ZERinput,           & 
& ZURinput,ZDLinput,ZELinput,ZULinput,ZWinput,ZZinput,g1input,g2input,g3input,           & 
& Laminput,Yuinput,Ydinput,Yeinput,m2SMinput,vvSMinput,cplcFeFehhL,cplcFeFehhR,          & 
& cplcFeFeVZL,cplcFeFeVZR,cplcFeFvcVWpL,cplcFeFvcVWpR,deltaM)
...
& MHp2input,MVWpinput,MVWp2input,MVZinput,MVZ2input,TWinput,ZDRinput,ZERinput,           & 
& ZURinput,ZDLinput,ZELinput,ZULinput,ZWinput,ZZinput,g1input,g2input,g3input,           & 
& Laminput,Yuinput,Ydinput,Yeinput,m2SMinput,vvSMinput,cplcFdFdhhL,cplcFdFdhhR,          & 
...
& MHp2input,MVWpinput,MVWp2input,MVZinput,MVZ2input,TWinput,ZDRinput,ZERinput,           & 
& ZURinput,ZDLinput,ZELinput,ZULinput,ZWinput,ZZinput,g1input,g2input,g3input,           & 
& Laminput,Yuinput,Ydinput,Yeinput,m2SMinput,vvSMinput,cplHiggsPP,cplHiggsGG,            & 
...
& ZURinput,ZDLinput,ZELinput,ZULinput,ZWinput,ZZinput,g1input,g2input,g3input,           & 
& Laminput,Yuinput,Ydinput,Yeinput,m2SMinput,vvSMinput,cplcFdFdhhL,cplcFdFdhhR,          & 
& cplcFdFdVZL,cplcFdFdVZR,cplcFdFucVWpL,cplcFdFucVWpR,cplcFeFehhL,cplcFeFehhR,           & 
& cplcFeFeVZL,cplcFeFeVZR,cplcFeFvcVWpL,cplcFeFvcVWpR,cplcFuFdVWpL,cplcFuFdVWpR,         & 
...
& cplcFuFuVZL,cplcFuFuVZR,cplcFvFeVWpL,cplcFvFeVWpR,cplcFvFvVZL,cplcFvFvVZR,deltaM)
...
& Laminput,Yuinput,Ydinput,Yeinput,m2SMinput,vvSMinput,cplcFdFdhhL,cplcFdFdhhR,          & 
& cplcFdFdVZL,cplcFdFdVZR,cplcFdFucVWpL,cplcFdFucVWpR,cplcFeFehhL,cplcFeFehhR,           & 
& cplcFeFeVZL,cplcFeFeVZR,cplcFuFdVWpL,cplcFuFdVWpR,cplcFuFuhhL,cplcFuFuhhR,             & 
& cplcFuFuVZL,cplcFuFuVZR,cplcFvFeVWpL,cplcFvFeVWpR,cplcFvFvVZL,cplcFvFvVZR,deltaM)
...
End Module CouplingsForDecays_SM
