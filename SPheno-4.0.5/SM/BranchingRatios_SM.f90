...
& ZEL,ZER,vvSM,g1,g2,g3,Lam,Yu,Yd,Ye,m2SM,epsI,deltaM,kont)
...
& Yu,Yd,Ye,m2SM,vvSM,gPFu(:,1:15),gTFu,BRFu(:,1:15))
...
& MHp,MHp2,MVWp,MVWp2,MVZ,MVZ2,TW,ZDR,ZER,ZUR,ZDL,ZEL,ZUL,ZW,ZZ,g1,g2,g3,Lam,            & 
& Yu,Yd,Ye,m2SM,vvSM,gPFe(:,1:12),gTFe,BRFe(:,1:12))
...
& MHp,MHp2,MVWp,MVWp2,MVZ,MVZ2,TW,ZDR,ZER,ZUR,ZDL,ZEL,ZUL,ZW,ZZ,g1,g2,g3,Lam,            & 
& Yu,Yd,Ye,m2SM,vvSM,gPFd(:,1:15),gTFd,BRFd(:,1:15))
...
& Yd,Ye,m2SM,vvSM,gThh,gTVWp,gTVZ,gFuFucFdFd,gFuFdcFeFv,gFuFucFeFe,gFuFucFuFu,           & 
& gFuFucFvFv,epsI,deltaM,.False.,gTFu,gPFu(:,16:150),BRFu(:,16:150))

Else 
Call FuThreeBodyDecay(-1,MAh,MAh2,MFd,MFd2,MFe,MFe2,MFu,MFu2,Mhh,Mhh2,MHp,            & 
& MHp2,MVWp,MVWp2,MVZ,MVZ2,TW,ZDR,ZER,ZUR,ZDL,ZEL,ZUL,ZW,ZZ,g1,g2,g3,Lam,Yu,             & 
& Yd,Ye,m2SM,vvSM,gThh,gTVWp,gTVZ,gFuFucFdFd,gFuFdcFeFv,gFuFucFeFe,gFuFucFuFu,           & 
& gFuFucFvFv,epsI,deltaM,.True.,gTFu,gPFu(:,16:150),BRFu(:,16:150))
...
& MHp2,MVWp,MVWp2,MVZ,MVZ2,TW,ZDR,ZER,ZUR,ZDL,ZEL,ZUL,ZW,ZZ,g1,g2,g3,Lam,Yu,             & 
& Yd,Ye,m2SM,vvSM,gThh,gTVWp,gTVZ,gFeFecFdFd,gFeFecFeFe,gFeFecFuFu,gFeFecFvFv,           & 
& gFeFvcFuFd,epsI,deltaM,.False.,gTFe,gPFe(:,13:147),BRFe(:,13:147))

Else 
Call FeThreeBodyDecay(-1,MAh,MAh2,MFd,MFd2,MFe,MFe2,MFu,MFu2,Mhh,Mhh2,MHp,            & 
& MHp2,MVWp,MVWp2,MVZ,MVZ2,TW,ZDR,ZER,ZUR,ZDL,ZEL,ZUL,ZW,ZZ,g1,g2,g3,Lam,Yu,             & 
& Yd,Ye,m2SM,vvSM,gThh,gTVWp,gTVZ,gFeFecFdFd,gFeFecFeFe,gFeFecFuFu,gFeFecFvFv,           & 
& gFeFvcFuFd,epsI,deltaM,.True.,gTFe,gPFe(:,13:147),BRFe(:,13:147))
...
& MHp2,MVWp,MVWp2,MVZ,MVZ2,TW,ZDR,ZER,ZUR,ZDL,ZEL,ZUL,ZW,ZZ,g1,g2,g3,Lam,Yu,             & 
& Yd,Ye,m2SM,vvSM,gThh,gTVWp,gTVZ,gFdFdcFdFd,gFdFdcFeFe,gFdFdcFuFu,gFdFdcFvFv,           & 
& gFdFucFvFe,epsI,deltaM,.False.,gTFd,gPFd(:,16:150),BRFd(:,16:150))

Else 
Call FdThreeBodyDecay(-1,MAh,MAh2,MFd,MFd2,MFe,MFe2,MFu,MFu2,Mhh,Mhh2,MHp,            & 
& MHp2,MVWp,MVWp2,MVZ,MVZ2,TW,ZDR,ZER,ZUR,ZDL,ZEL,ZUL,ZW,ZZ,g1,g2,g3,Lam,Yu,             & 
& Yd,Ye,m2SM,vvSM,gThh,gTVWp,gTVZ,gFdFdcFdFd,gFdFdcFeFe,gFdFdcFuFu,gFdFdcFvFv,           & 
& gFdFucFvFe,epsI,deltaM,.True.,gTFd,gPFd(:,16:150),BRFd(:,16:150))
