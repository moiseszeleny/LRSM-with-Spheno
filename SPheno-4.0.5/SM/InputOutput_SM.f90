...
If (i_par.Eq.1) Then 
If (i_c.Eq.0) LambdaIN= Cmplx(wert,Aimag(LambdaIN),dp) 
If (i_c.Eq.1) LambdaIN= Cmplx(Real(LambdaIN,dp),wert,dp) 
Else
...
& PDGFd(3),PDGFu(3),PDGFe(3),PDGFv(3)
...
l_open= .False.
End If
Write(io_L,100) "# SUSY Les Houches Accord 2 - SM Spectrum + Decays + Flavour Observables"
...
Write(io_L,101) 1, Real(LambdaIN,dp) ,"# LambdaIN"
WriteNextBlock = .False. 
If (Abs(Aimag(LambdaIN)).gt.0._dp) WriteNextBlock = .True. 
If(WriteNextBlock) Then 
Write(io_L,100) "Block IMMINPAR  # Input parameters"
If (Abs(Aimag(LambdaIN)).gt.0._dp) Then 
Write(io_L,101) 1, Aimag(LambdaIN) ,"# LambdaIN"
End if 
End if 
...
Write(io_L,104) 1,Real(m2SMGUT,dp), "# m2SM" 
...
Write(io_L,100) "Block DMASS  # Overall uncertainty"
 Write(io_L,102) INT(Abs(25)), Sqrt(mass_uncertainty_Q(3)**2+mass_uncertainty_Yt(3)**2),"# Mhh(1) " 
Write(io_L,100) "Block DMASSQ  # Scale uncertainty"
 Write(io_L,102) INT(Abs(25)), mass_uncertainty_Q(3),"# Mhh(1) " 
Write(io_L,100) "Block DMASST  # Top Matching uncertainty"
 Write(io_L,102) INT(Abs(25)), mass_uncertainty_Yt(3),"# Mhh(1) " 
End if
...
icount = icount +1 
  End Do 
If (Maxval(BRFu(1,16:150)).Gt.BRmin) Then 
...
icount = icount +1 
  End Do 
If (Maxval(BRFu(2,16:150)).Gt.BRmin) Then 
Write(io_L,100) "#    BR                NDA      ID1      ID2       ID3" 
End If 
Do gt1=1,3
  Do gt2=1,3
...
icount = icount +1 
  End Do 
If (Maxval(BRFu(3,16:150)).Gt.BRmin) Then 
Write(io_L,100) "#    BR                NDA      ID1      ID2       ID3" 
End If 
Do gt1=1,3
  Do gt2=1,3
...
icount = icount +1 
  End Do 
If (Maxval(BRFe(1,13:147)).Gt.BRmin) Then 
Write(io_L,100) "#    BR                NDA      ID1      ID2       ID3" 
End If 
Do gt1=1,3
  Do gt2=1,3
...
icount = icount +1 
  End Do 
If (Maxval(BRFe(2,13:147)).Gt.BRmin) Then 
Write(io_L,100) "#    BR                NDA      ID1      ID2       ID3" 
End If 
Do gt1=1,3
  Do gt2=1,3
...
icount = icount +1 
  End Do 
If (Maxval(BRFe(3,13:147)).Gt.BRmin) Then 
Write(io_L,100) "#    BR                NDA      ID1      ID2       ID3" 
End If 
Do gt1=1,3
  Do gt2=1,3
...
icount = icount +1 
  End Do 
If (Maxval(BRFd(1,16:150)).Gt.BRmin) Then 
Write(io_L,100) "#    BR                NDA      ID1      ID2       ID3" 
End If 
Do gt1=1,3
  Do gt2=1,3
...
icount = icount +1 
  End Do 
If (Maxval(BRFd(2,16:150)).Gt.BRmin) Then 
Write(io_L,100) "#    BR                NDA      ID1      ID2       ID3" 
End If 
Do gt1=1,3
  Do gt2=1,3
...
icount = icount +1 
  End Do 
If (Maxval(BRFd(3,16:150)).Gt.BRmin) Then 
Write(io_L,100) "#    BR                NDA      ID1      ID2       ID3" 
End If 
Do gt1=1,3
  Do gt2=1,3
...
If ((gThh.gt.MinWidth).or.(OutputForMG)) Then 
...
Write(io_L,201) BRhh(1,icount),2,CurrentPDG2, & 
 & Trim(NameParticlehh)//" -> "//Trim(NameParticleFv(gt1))//" "//Trim(NameParticleFv(gt2))//"^* "//")"
End if 
icount = icount +1 
  End Do 
End Do 
...
CurrentPDG2(2) = PDGVP 
Write(io_L,201) BRhh(1,icount),2,CurrentPDG2, & 
 & Trim(NameParticlehh)//" -> "//Trim(NameParticlehh)//" "//Trim(NameParticleVP)//" "//")"
End if 
icount = icount +1 
If (BRhh(1,icount).Gt.BrMin) Then 
CurrentPDG2(1) = PDGhh 
CurrentPDG2(2) = PDGVZ 
Write(io_L,201) BRhh(1,icount),2,CurrentPDG2, & 
 & Trim(NameParticlehh)//" -> "//Trim(NameParticlehh)//" "//Trim(NameParticleVZ)//" "//")"
End if 
icount = icount +1 
If (BRhh(1,icount).Gt.BrMin) Then 
CurrentPDG2(1) = PDGVG 
...
CurrentPDG2(2) = PDGVP 
Write(io_L,201) BRhh(1,icount),2,CurrentPDG2, & 
 & Trim(NameParticlehh)//" -> "//Trim(NameParticleVZ)//" "//Trim(NameParticleVP)//" "//")"
End if 
icount = icount +1 
End if 
...
Write(io_L,200) INT(Abs(PDGAh)),0._dp, "Ah_1" 
End if 
...
If(gT1Lhh.gt.MinWidth) Then 
Write(io_L,210) INT(PDGhh),gT1Lhh,Trim(NameParticlehh) 
Write(io_L,100) "#    BR                NDA      ID1      ID2" 
icount = 1 
...
Subroutine WriteWHIZARD 
   Open(123,file="WHIZARD.par.SM",status="unknown")
...
Write(90,"(e16.8)",advance="No") BRinvH(1)/gThh 
...
Write(89,"(3e16.8)",advance="No")  Real(ratioPP,dp)**2 
Write(89,"(3e16.8)",advance="No")  Real(ratioGG,dp)**2 
Write(89,"(3e16.8)",advance="No") 0._dp 
...
Write(90,"(I1)",advance="No") 1 
Write(90,"(e16.8)",advance="No") BRinvH(1)/gThh 
Write(90,"(e16.8)",advance="No") BRHll(1,1,2)/gThh 
Write(90,"(e16.8)",advance="No") BRHll(1,1,3)/gThh 
Write(90,"(e16.8)",advance="No") BRHll(1,2,3)/gThh 
...
Subroutine WriteWCXF 
   Open(123,file="WC.SM_1.json",status="unknown")
Write(123,*) "{"
Write(123,*) '  "eft": "WET",'
...
Write(123,*) "}"
    Close(123) 
   Open(123,file="WC.SM_2.json",status="unknown")
Write(123,*) "{"
Write(123,*) '  "eft": "WET",'
Write(123,*) '  "basis": "FlavorKit",'
Write(123,*) '  "scale": "91.",'
...
If (i_c.Eq.0) m2SMIN= Cmplx(wert,Aimag(m2SMIN),dp) 
If (i_c.Eq.1) m2SMIN= Cmplx(Real(m2SMIN,dp),wert,dp) 
InputValueform2SM= .True. 
Else
Write(ErrCan,*) "Error in routine "//NameOfUnit(Iname)
