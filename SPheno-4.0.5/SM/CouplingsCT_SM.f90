...
Contains 
 ...
 Subroutine CalculateCouplingCT(Lam,vvSM,g1,g2,TW,g3,Yd,ZDL,ZDR,Ye,ZEL,ZER,            & 
& Yu,ZUL,ZUR,dLam,dvvSM,dg1,dg2,dSinTW,dCosTW,dTanTW,dg3,dYd,dZDL,dZDR,dYe,              & 
& dZEL,dZER,dYu,dZUL,dZUR,ctcplAhAhhh,ctcplhhhhhh,ctcplhhHpcHp,ctcplAhhhVZ,              & 
...
Implicit None 
Real(dp), Intent(in) :: vvSM,g1,g2,TW,g3,dvvSM,dg1,dg2,dSinTW,dCosTW,dTanTW,dg3
...
ctcplAhAhhh = 0._dp 
Call CT_CouplingAhAhhh(Lam,vvSM,dLam,dvvSM,ctcplAhAhhh)



ctcplhhhhhh = 0._dp 
Call CT_Couplinghhhhhh(Lam,vvSM,dLam,dvvSM,ctcplhhhhhh)



ctcplhhHpcHp = 0._dp 
Call CT_CouplinghhHpcHp(Lam,vvSM,dLam,dvvSM,ctcplhhHpcHp)
...
Call CT_CouplinghhcVWpVWp(g2,vvSM,dg2,dvvSM,ctcplhhcVWpVWp)



ctcplhhVZVZ = 0._dp 
Call CT_CouplinghhVZVZ(g1,g2,vvSM,TW,dg1,dg2,dvvSM,dSinTW,dCosTW,dTanTW,              & 
& ctcplhhVZVZ)
...
Subroutine CT_CouplingAhAhhh(Lam,vvSM,dLam,dvvSM,res)

Implicit None 

Real(dp), Intent(in) :: vvSM,dvvSM
...
Subroutine CT_Couplinghhhhhh(Lam,vvSM,dLam,dvvSM,res)
...
Subroutine CT_CouplinghhHpcHp(Lam,vvSM,dLam,dvvSM,res)
...
res = 0._dp 
res = res-1._dp/2._dp*(dSinTW*g1)
res = res+(dCosTW*g2)/2._dp
res = res+(dg2*Cos(TW))/2._dp
res = res-1._dp/2._dp*(dg1*Sin(TW))
If (Real(res,dp).ne.Real(res,dp)) Then 
 Write(*,*) "NaN appearing in ",NameOfUnit(Iname) 
 Call TerminateProgram 
End If 
...
Subroutine CT_CouplinghhcVWpVWp(g2,vvSM,dg2,dvvSM,res)

Implicit None 

Real(dp), Intent(in) :: g2,vvSM,dg2,dvvSM
...
Subroutine CT_CouplinghhVZVZ(g1,g2,vvSM,TW,dg1,dg2,dvvSM,dSinTW,dCosTW,               & 
& dTanTW,res)
...
res = 0._dp 
res = res+(dvvSM*g1**2)/4._dp
res = res+(dvvSM*g2**2)/4._dp
res = res+(dg1*g1*vvSM)/2._dp
res = res+(dg2*g2*vvSM)/2._dp
res = res-1._dp/2._dp*(dCosTW*g1**2*vvSM*Cos(TW))
res = res+dSinTW*g1*g2*vvSM*Cos(TW)
res = res+(dCosTW*g2**2*vvSM*Cos(TW))/2._dp
res = res-1._dp/4._dp*(dvvSM*g1**2*Cos(TW)**2)
res = res+(dvvSM*g2**2*Cos(TW)**2)/4._dp
res = res-1._dp/2._dp*(dg1*g1*vvSM*Cos(TW)**2)
res = res+(dg2*g2*vvSM*Cos(TW)**2)/2._dp
res = res+(dSinTW*g1**2*vvSM*Sin(TW))/2._dp
res = res+dCosTW*g1*g2*vvSM*Sin(TW)
res = res-1._dp/2._dp*(dSinTW*g2**2*vvSM*Sin(TW))
res = res+dvvSM*g1*g2*Cos(TW)*Sin(TW)
res = res+dg2*g1*vvSM*Cos(TW)*Sin(TW)
res = res+dg1*g2*vvSM*Cos(TW)*Sin(TW)
res = res+(dvvSM*g1**2*Sin(TW)**2)/4._dp
res = res-1._dp/4._dp*(dvvSM*g2**2*Sin(TW)**2)
res = res+(dg1*g1*vvSM*Sin(TW)**2)/2._dp
res = res-1._dp/2._dp*(dg2*g2*vvSM*Sin(TW)**2)
If (Real(res,dp).ne.Real(res,dp)) Then 
 Write(*,*) "NaN appearing in ",NameOfUnit(Iname) 
 Call TerminateProgram 
End If 
...
res = 0._dp 
res = res-1._dp/2._dp*(dSinTW*g1*g2*vvSM)
res = res-1._dp/2._dp*(dvvSM*g1*g2*Sin(TW))
res = res-1._dp/2._dp*(dg2*g1*vvSM*Sin(TW))
res = res-1._dp/2._dp*(dg1*g2*vvSM*Sin(TW))
If (Real(res,dp).ne.Real(res,dp)) Then 
 Write(*,*) "NaN appearing in ",NameOfUnit(Iname) 
 Call TerminateProgram 
End If 
