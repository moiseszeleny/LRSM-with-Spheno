...
& g3,Lam,Yu,Yd,Ye,m2SM,vvSM,gThh,gTVWp,gTVZ,gFdFdcFdFd,gFdFdcFeFe,gFdFdcFuFu,            & 
& gFdFdcFvFv,gFdFucFvFe,epsI,deltaM,CheckRealStates,gT,gPartial,BR)
...
& cplcFuFuVZR,cplcFvFeVWpL,cplcFvFeVWpR,cplcFvFvVZL,cplcFvFvVZR,deltaM)
...
coup2(4) = Conjg(cplcFdFdhhL(gt1,iIN)) 
coup2(3) = Conjg(cplcFdFdhhR(gt1,iIN))  
...
coup2(1) = cplcFdFdVZL(iIN,gt3) 
coup2(2) = cplcFdFdVZR(iIN,gt3) 
coup2(4) = Conjg(cplcFdFdhhL(gt3,iIN)) 
coup2(3) = Conjg(cplcFdFdhhR(gt3,iIN))  
coup2(5) = cplcFdFdVZL(gt2,gt1) 
coup2(6) = cplcFdFdVZR(gt2,gt1) 
coup2(8) = Conjg(cplcFdFdhhL(gt1,gt2)) 
coup2(7) = Conjg(cplcFdFdhhR(gt1,gt2)) 
Call IntegrateGaugeSscalarS(Boson4, mass, coup2, deltaM, epsI,IntegralVSss,NVSss, resC, check) 
If (resC.ne.resC) resC = 0._dp
resC = 2._dp*resC 
resC= 3*resC ! color factor 
...
coup2(1) = cplcFdFdVZL(iIN,gt1) 
coup2(2) = cplcFdFdVZR(iIN,gt1) 
coup2(4) = cplcFdFucVWpL(iIN,gt3) 
coup2(3) = cplcFdFucVWpR(iIN,gt3)  
coup2(5) = cplcFuFuVZL(gt2,gt3) 
coup2(6) = cplcFuFuVZR(gt2,gt3) 
coup2(8) = cplcFuFdVWpL(gt2,gt1) 
coup2(7) = cplcFuFdVWpR(gt2,gt1) 
Call IntegrateGaugeST(Boson4, mass, coup2, deltaM, epsI,IntegralVVst,NVVst, resC, check) 
If (resC.ne.resC) resC = 0._dp
resC = -2._dp*resC 
resC= 1*resC ! color factor 
