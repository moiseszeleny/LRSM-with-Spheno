...
Module Wrapper_OneLoopDecay_Fd_SM
Use Model_Data_SM 
Use Kinematics 
Use OneLoopDecay_Fd_SM 
Use Control 
Use Settings 
...
Subroutine OneLoopDecay_Fd(MFdOS,MFd2OS,MFuOS,MFu2OS,MFeOS,MFe2OS,MHpOS,              & 
...
Call Amplitude_Tree_SM_FdToFdhh(cplcFdFdhhL,cplcFdFdhhR,MFd,Mhh,MFd2,Mhh2,            & 
& AmpTreeFdToFdhh)

  Else 
Call Amplitude_Tree_SM_FdToFdhh(ZcplcFdFdhhL,ZcplcFdFdhhR,MFd,Mhh,MFd2,               & 
...
If (OSkinematics) Then 
  If (.not.ExternalZfactors) Then 
 ! OS and no Z-factors 
Call Gamma_Real_SM_FdToFdhh(MLambda,em,gs,cplcFdFdhhL,cplcFdFdhhR,MFdOS,              & 
& MhhOS,MRPFdToFdhh,MRGFdToFdhh)

  Else 
 ! OS and Z-factors 
Call Gamma_Real_SM_FdToFdhh(MLambda,em,gs,ZcplcFdFdhhL,ZcplcFdFdhhR,MFdOS,            & 
& MhhOS,MRPFdToFdhh,MRGFdToFdhh)
...
Else 
 ! DR and no Z-factors 
  If (.not.ExternalZfactors) Then 
Call Gamma_Real_SM_FdToFdhh(MLambda,em,gs,cplcFdFdhhL,cplcFdFdhhR,MFd,Mhh,            & 
& MRPFdToFdhh,MRGFdToFdhh)

  Else 
 ! DR and Z-factors 
Call Gamma_Real_SM_FdToFdhh(MLambda,em,gs,ZcplcFdFdhhL,ZcplcFdFdhhR,MFd,              & 
...
Call Amplitude_WAVE_SM_FdToFdhh(cplcFdFdhhL,cplcFdFdhhR,ctcplcFdFdhhL,ctcplcFdFdhhR,  & 
& MFd,MFd2,Mhh,Mhh2,ZfDL,ZfDR,Zfhh,AmpWaveFdToFdhh)



!Vertex Corrections 
Call Amplitude_VERTEX_SM_FdToFdhh(MAh,MFd,MFu,Mhh,MHp,MVG,MVP,MVWp,MVZ,               & 
...
& cplhhhhhh,cplhhHpcHp,cplhhHpcVWp,cplhhcHpVWp,cplhhcVWpVWp,cplhhVZVZ,AmpVertexFdToFdhh)

If (ShiftIRdiv) Then 
Call Amplitude_IR_VERTEX_SM_FdToFdhh(MAh,MFd,MFu,Mhh,MHp,MVG,MVP,MVWp,MVZ,            & 
& MAh2,MFd2,MFu2,Mhh2,MHp2,MVG2,MVP2,MVWp2,MVZ2,cplAhAhhh,cplcFdFdAhL,cplcFdFdAhR,       & 
& cplAhhhVZ,cplcFdFdhhL,cplcFdFdhhR,cplcFuFdHpL,cplcFuFdHpR,cplcFdFdVGL,cplcFdFdVGR,     & 
& cplcFdFdVPL,cplcFdFdVPR,cplcFuFdVWpL,cplcFuFdVWpR,cplcFdFdVZL,cplcFdFdVZR,             & 
& cplcFuFuhhL,cplcFuFuhhR,cplcFdFucHpL,cplcFdFucHpR,cplcFdFucVWpL,cplcFdFucVWpR,         & 
& cplhhhhhh,cplhhHpcHp,cplhhHpcVWp,cplhhcHpVWp,cplhhcVWpVWp,cplhhVZVZ,AmpVertexIRdrFdToFdhh)

 If (ExternalZfactors) Then 
  If (OSkinematics) Then 
 ! OS and Z-factors 
Call Amplitude_IR_VERTEX_SM_FdToFdhh(MAhOS,MFdOS,MFuOS,MhhOS,MHpOS,MVG,               & 
...
Call Amplitude_IR_VERTEX_SM_FdToFdhh(MAh,MFd,MFu,Mhh,MHp,MVG,MVP,MVWp,MVZ,            & 
& MAh2,MFd2,MFu2,Mhh2,MHp2,MVG2,MVP2,MVWp2,MVZ2,cplAhAhhh,cplcFdFdAhL,cplcFdFdAhR,       & 
& cplAhhhVZ,ZcplcFdFdhhL,ZcplcFdFdhhR,cplcFuFdHpL,cplcFuFdHpR,cplcFdFdVGL,               & 
...
& cplcFdFdVPL,cplcFdFdVPR,cplcFuFdVWpL,cplcFuFdVWpR,cplcFdFdVZL,cplcFdFdVZR,             & 
& cplcFuFuhhL,cplcFuFuhhR,cplcFdFucHpL,cplcFdFucHpR,cplcFdFucVWpL,cplcFdFucVWpR,         & 
& cplhhhhhh,cplhhHpcHp,cplhhHpcVWp,cplhhcHpVWp,cplhhcVWpVWp,cplhhVZVZ,AmpVertexIRosFdToFdhh)
...
!Tree Level 
  If (.not.ExternalZfactors) Then 
Call Amplitude_Tree_SM_FdToFdVZ(cplcFdFdVZL,cplcFdFdVZR,MFd,MVZ,MFd2,MVZ2,            & 
& AmpTreeFdToFdVZ)

  Else 
Call Amplitude_Tree_SM_FdToFdVZ(ZcplcFdFdVZL,ZcplcFdFdVZR,MFd,MVZ,MFd2,               & 
...
If (OSkinematics) Then 
  If (.not.ExternalZfactors) Then 
 ! OS and no Z-factors 
Call Gamma_Real_SM_FdToFdVZ(MLambda,em,gs,cplcFdFdVZL,cplcFdFdVZR,MFdOS,              & 
& MVZOS,MRPFdToFdVZ,MRGFdToFdVZ)

  Else 
 ! OS and Z-factors 
Call Gamma_Real_SM_FdToFdVZ(MLambda,em,gs,ZcplcFdFdVZL,ZcplcFdFdVZR,MFdOS,            & 
& MVZOS,MRPFdToFdVZ,MRGFdToFdVZ)
...
Else 
 ! DR and no Z-factors 
  If (.not.ExternalZfactors) Then 
Call Gamma_Real_SM_FdToFdVZ(MLambda,em,gs,cplcFdFdVZL,cplcFdFdVZR,MFd,MVZ,            & 
& MRPFdToFdVZ,MRGFdToFdVZ)

  Else 
 ! DR and Z-factors 
Call Gamma_Real_SM_FdToFdVZ(MLambda,em,gs,ZcplcFdFdVZL,ZcplcFdFdVZR,MFd,              & 
...
!Self-energy Corrections 
Call Amplitude_WAVE_SM_FdToFdVZ(cplcFdFdVPL,cplcFdFdVPR,cplcFdFdVZL,cplcFdFdVZR,      & 
& ctcplcFdFdVPL,ctcplcFdFdVPR,ctcplcFdFdVZL,ctcplcFdFdVZR,MFd,MFd2,MVP,MVP2,             & 
& MVZ,MVZ2,ZfDL,ZfDR,ZfVPVZ,ZfVZ,AmpWaveFdToFdVZ)



!Vertex Corrections 
Call Amplitude_VERTEX_SM_FdToFdVZ(MAh,MFd,MFu,Mhh,MHp,MVG,MVP,MVWp,MVZ,               & 
& MAh2,MFd2,MFu2,Mhh2,MHp2,MVG2,MVP2,MVWp2,MVZ2,cplcFdFdAhL,cplcFdFdAhR,cplAhhhVZ,       & 
...
If (ShiftIRdiv) Then 
Call Amplitude_IR_VERTEX_SM_FdToFdVZ(MAh,MFd,MFu,Mhh,MHp,MVG,MVP,MVWp,MVZ,            & 
& MAh2,MFd2,MFu2,Mhh2,MHp2,MVG2,MVP2,MVWp2,MVZ2,cplcFdFdAhL,cplcFdFdAhR,cplAhhhVZ,       & 
& cplcFdFdhhL,cplcFdFdhhR,cplcFuFdHpL,cplcFuFdHpR,cplcFdFdVGL,cplcFdFdVGR,               & 
& cplcFdFdVPL,cplcFdFdVPR,cplcFuFdVWpL,cplcFuFdVWpR,cplcFdFdVZL,cplcFdFdVZR,             & 
& cplcFuFuVZL,cplcFuFuVZR,cplcFdFucHpL,cplcFdFucHpR,cplcFdFucVWpL,cplcFdFucVWpR,         & 
& cplhhVZVZ,cplHpcHpVZ,cplHpcVWpVZ,cplcHpVWpVZ,cplcVWpVWpVZ,AmpVertexIRdrFdToFdVZ)
 ...
 If (ExternalZfactors) Then 
  If (OSkinematics) Then 
 ! OS and Z-factors 
Call Amplitude_IR_VERTEX_SM_FdToFdVZ(MAhOS,MFdOS,MFuOS,MhhOS,MHpOS,MVG,               & 
& MVP,MVWpOS,MVZOS,MAh2OS,MFd2OS,MFu2OS,Mhh2OS,MHp2OS,MVG2,MVP2,MVWp2OS,MVZ2OS,          & 
...
!Tree Level 
  If (.not.ExternalZfactors) Then 
Call Amplitude_Tree_SM_FdToFucVWp(cplcFdFucVWpL,cplcFdFucVWpR,MFd,MFu,MVWp,           & 
& MFd2,MFu2,MVWp2,AmpTreeFdToFucVWp)

  Else 
Call Amplitude_Tree_SM_FdToFucVWp(ZcplcFdFucVWpL,ZcplcFdFucVWpR,MFd,MFu,              & 
...
If (OSkinematics) Then 
  If (.not.ExternalZfactors) Then 
 ! OS and no Z-factors 
Call Gamma_Real_SM_FdToFucVWp(MLambda,em,gs,cplcFdFucVWpL,cplcFdFucVWpR,              & 
& MFdOS,MFuOS,MVWpOS,MRPFdToFucVWp,MRGFdToFucVWp)

  Else 
 ! OS and Z-factors 
Call Gamma_Real_SM_FdToFucVWp(MLambda,em,gs,ZcplcFdFucVWpL,ZcplcFdFucVWpR,            & 
& MFdOS,MFuOS,MVWpOS,MRPFdToFucVWp,MRGFdToFucVWp)
...
!Self-energy Corrections 
Call Amplitude_WAVE_SM_FdToFucVWp(cplcFdFucVWpL,cplcFdFucVWpR,ctcplcFdFucVWpL,        & 
& ctcplcFdFucVWpR,MFd,MFd2,MFu,MFu2,MVWp,MVWp2,ZfDL,ZfDR,ZfUL,ZfUR,ZfVWp,AmpWaveFdToFucVWp)



!Vertex Corrections 
Call Amplitude_VERTEX_SM_FdToFucVWp(MAh,MFd,MFu,Mhh,MHp,MVG,MVP,MVWp,MVZ,             & 
& MAh2,MFd2,MFu2,Mhh2,MHp2,MVG2,MVP2,MVWp2,MVZ2,cplcFdFdAhL,cplcFdFdAhR,cplcFuFuAhL,     & 
& cplcFuFuAhR,cplAhHpcVWp,cplcFdFdhhL,cplcFdFdhhR,cplcFdFdVGL,cplcFdFdVGR,               & 
...
& cplHpcVWpVP,cplHpcVWpVZ,cplcVWpVPVWp,cplcVWpVWpVZ,AmpVertexFdToFucVWp)

If (ShiftIRdiv) Then 
Call Amplitude_IR_VERTEX_SM_FdToFucVWp(MAh,MFd,MFu,Mhh,MHp,MVG,MVP,MVWp,              & 
...
& cplhhcVWpVWp,cplHpcVWpVP,cplHpcVWpVZ,cplcVWpVPVWp,cplcVWpVWpVZ,AmpVertexIRdrFdToFucVWp)
 ...
 If (ExternalZfactors) Then 
  If (OSkinematics) Then 
 ! OS and Z-factors 
Call Amplitude_IR_VERTEX_SM_FdToFucVWp(MAhOS,MFdOS,MFuOS,MhhOS,MHpOS,MVG,             & 
& MVP,MVWpOS,MVZOS,MAh2OS,MFd2OS,MFu2OS,Mhh2OS,MHp2OS,MVG2,MVP2,MVWp2OS,MVZ2OS,          & 
& cplcFdFdAhL,cplcFdFdAhR,cplcFuFuAhL,cplcFuFuAhR,cplAhHpcVWp,cplcFdFdhhL,               & 
...
!Self-energy Corrections 
 If (ExternalZfactors) Then 
Call Amplitude_WAVE_SM_FdToFdVG(ZcplcFdFdVGL,ZcplcFdFdVGR,ctcplcFdFdVGL,              & 
& ctcplcFdFdVGR,MFdOS,MFd2OS,MVG,MVG2,ZfDL,ZfDR,ZfVG,AmpWaveFdToFdVG)

 Else 
Call Amplitude_WAVE_SM_FdToFdVG(cplcFdFdVGL,cplcFdFdVGR,ctcplcFdFdVGL,ctcplcFdFdVGR,  & 
& MFdOS,MFd2OS,MVG,MVG2,ZfDL,ZfDR,ZfVG,AmpWaveFdToFdVG)
...
!Vertex Corrections 
 If (ExternalZfactors) Then 
Call Amplitude_VERTEX_SM_FdToFdVG(MAhOS,MFdOS,MFuOS,MhhOS,MHpOS,MVG,MVP,              & 
& MVWpOS,MVZOS,MAh2OS,MFd2OS,MFu2OS,Mhh2OS,MHp2OS,MVG2,MVP2,MVWp2OS,MVZ2OS,              & 
& ZcplcFdFdAhL,ZcplcFdFdAhR,ZcplcFdFdhhL,ZcplcFdFdhhR,ZcplcFuFdHpL,ZcplcFuFdHpR,         & 
...
Call Amplitude_VERTEX_SM_FdToFdVG(MAhOS,MFdOS,MFuOS,MhhOS,MHpOS,MVG,MVP,              & 
& MVWpOS,MVZOS,MAh2OS,MFd2OS,MFu2OS,Mhh2OS,MHp2OS,MVG2,MVP2,MVWp2OS,MVZ2OS,              & 
& cplcFdFdAhL,cplcFdFdAhR,cplcFdFdhhL,cplcFdFdhhR,cplcFuFdHpL,cplcFuFdHpR,               & 
& cplcFdFdVGL,cplcFdFdVGR,cplcFdFdVPL,cplcFdFdVPR,cplcFuFdVWpL,cplcFuFdVWpR,             & 
...
!Self-energy Corrections 
Call Amplitude_WAVE_SM_FdToFdVG(cplcFdFdVGL,cplcFdFdVGR,ctcplcFdFdVGL,ctcplcFdFdVGR,  & 
& MFd,MFd2,MVG,MVG2,ZfDL,ZfDR,ZfVG,AmpWaveFdToFdVG)



!Vertex Corrections 
Call Amplitude_VERTEX_SM_FdToFdVG(MAh,MFd,MFu,Mhh,MHp,MVG,MVP,MVWp,MVZ,               & 
& MAh2,MFd2,MFu2,Mhh2,MHp2,MVG2,MVP2,MVWp2,MVZ2,cplcFdFdAhL,cplcFdFdAhR,cplcFdFdhhL,     & 
& cplcFdFdhhR,cplcFuFdHpL,cplcFuFdHpR,cplcFdFdVGL,cplcFdFdVGR,cplcFdFdVPL,               & 
& cplcFdFdVPR,cplcFuFdVWpL,cplcFuFdVWpR,cplcFdFdVZL,cplcFdFdVZR,cplcFuFuVGL,             & 
...
!Self-energy Corrections 
 If (ExternalZfactors) Then 
Call Amplitude_WAVE_SM_FdToFdVP(ZcplcFdFdVPL,ZcplcFdFdVPR,ZcplcFdFdVZL,               & 
...
& MFd2OS,MVP,MVP2,ZfDL,ZfDR,ZfVP,ZfVZVP,AmpWaveFdToFdVP)
 ...
 Else 
Call Amplitude_WAVE_SM_FdToFdVP(cplcFdFdVPL,cplcFdFdVPR,cplcFdFdVZL,cplcFdFdVZR,      & 
& ctcplcFdFdVPL,ctcplcFdFdVPR,ctcplcFdFdVZL,ctcplcFdFdVZR,MFdOS,MFd2OS,MVP,              & 
& MVP2,ZfDL,ZfDR,ZfVP,ZfVZVP,AmpWaveFdToFdVP)
...
!Vertex Corrections 
 If (ExternalZfactors) Then 
Call Amplitude_VERTEX_SM_FdToFdVP(MAhOS,MFdOS,MFuOS,MhhOS,MHpOS,MVG,MVP,              & 
& MVWpOS,MVZOS,MAh2OS,MFd2OS,MFu2OS,Mhh2OS,MHp2OS,MVG2,MVP2,MVWp2OS,MVZ2OS,              & 
& ZcplcFdFdAhL,ZcplcFdFdAhR,ZcplcFdFdhhL,ZcplcFdFdhhR,ZcplcFuFdHpL,ZcplcFuFdHpR,         & 
& ZcplcFdFdVGL,ZcplcFdFdVGR,ZcplcFdFdVPL,ZcplcFdFdVPR,ZcplcFuFdVWpL,ZcplcFuFdVWpR,       & 
...
Call Amplitude_WAVE_SM_FdToFdVP(cplcFdFdVPL,cplcFdFdVPR,cplcFdFdVZL,cplcFdFdVZR,      & 
& ctcplcFdFdVPL,ctcplcFdFdVPR,ctcplcFdFdVZL,ctcplcFdFdVZR,MFd,MFd2,MVP,MVP2,             & 
& ZfDL,ZfDR,ZfVP,ZfVZVP,AmpWaveFdToFdVP)



!Vertex Corrections 
Call Amplitude_VERTEX_SM_FdToFdVP(MAh,MFd,MFu,Mhh,MHp,MVG,MVP,MVWp,MVZ,               & 
& MAh2,MFd2,MFu2,Mhh2,MHp2,MVG2,MVP2,MVWp2,MVZ2,cplcFdFdAhL,cplcFdFdAhR,cplcFdFdhhL,     & 
& cplcFdFdhhR,cplcFuFdHpL,cplcFuFdHpR,cplcFdFdVGL,cplcFdFdVGR,cplcFdFdVPL,               & 
& cplcFdFdVPR,cplcFuFdVWpL,cplcFuFdVWpR,cplcFdFdVZL,cplcFdFdVZR,cplcFuFuVPL,             & 
& cplcFuFuVPR,cplcFdFucHpL,cplcFdFucHpR,cplcFdFucVWpL,cplcFdFucVWpR,cplHpcHpVP,          & 
& cplHpcVWpVP,cplcHpVPVWp,cplcVWpVPVWp,AmpVertexFdToFdVP)
...
End Module Wrapper_OneLoopDecay_Fd_SM
