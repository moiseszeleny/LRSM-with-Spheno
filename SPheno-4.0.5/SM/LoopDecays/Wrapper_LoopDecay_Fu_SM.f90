...
Module Wrapper_OneLoopDecay_Fu_SM
Use Model_Data_SM 
Use Kinematics 
Use OneLoopDecay_Fu_SM 
Use Control 
Use Settings 
...
Subroutine OneLoopDecay_Fu(MFdOS,MFd2OS,MFuOS,MFu2OS,MFeOS,MFe2OS,MHpOS,              & 
...
& cplHpcHpVZ,cplHpcVWpVP,cplHpcVWpVZ,cplVGVGVG,ctcplcFuFdHpL(3,3),ctcplcFuFdHpR(3,3),    & 
& ctcplcFuFdVWpL(3,3),ctcplcFuFdVWpR(3,3),ctcplcFuFuAhL(3,3),ctcplcFuFuAhR(3,3),         & 
& ctcplcFuFuhhL(3,3),ctcplcFuFuhhR(3,3),ctcplcFuFuVGL(3,3),ctcplcFuFuVGR(3,3),           & 
& ctcplcFuFuVPL(3,3),ctcplcFuFuVPR(3,3),ctcplcFuFuVZL(3,3),ctcplcFuFuVZR(3,3),           & 
& GcplcFuFdHpL(3,3),GcplcFuFdHpR(3,3),GcplcHpVPVWp,GcplHpcVWpVP,GosZcplcFuFdHpL(3,3),    & 
& GosZcplcFuFdHpR(3,3),GosZcplcHpVPVWp,GosZcplHpcVWpVP,GZcplcFuFdHpL(3,3),               & 
& GZcplcFuFdHpR(3,3),GZcplcHpVPVWp,GZcplHpcVWpVP,ZcplcFdFdVGL(3,3),ZcplcFdFdVGR(3,3),    & 
& ZcplcFdFdVPL(3,3),ZcplcFdFdVPR(3,3),ZcplcFdFucHpL(3,3),ZcplcFdFucHpR(3,3),             & 
& ZcplcFdFucVWpL(3,3),ZcplcFdFucVWpR(3,3),ZcplcFuFdHpL(3,3),ZcplcFuFdHpR(3,3),           & 
& ZcplcFuFdVWpL(3,3),ZcplcFuFdVWpR(3,3),ZcplcFuFuAhL(3,3),ZcplcFuFuAhR(3,3),             & 
& ZcplcFuFuhhL(3,3),ZcplcFuFuhhR(3,3),ZcplcFuFuVGL(3,3),ZcplcFuFuVGR(3,3),               & 
...
Call Amplitude_Tree_SM_FuToFdVWp(cplcFuFdVWpL,cplcFuFdVWpR,MFd,MFu,MVWp,              & 
& MFd2,MFu2,MVWp2,AmpTreeFuToFdVWp)

  Else 
Call Amplitude_Tree_SM_FuToFdVWp(ZcplcFuFdVWpL,ZcplcFuFdVWpR,MFd,MFu,MVWp,            & 
& MFd2,MFu2,MVWp2,AmpTreeFuToFdVWp)
...
If (OSkinematics) Then 
  If (.not.ExternalZfactors) Then 
 ! OS and no Z-factors 
Call Gamma_Real_SM_FuToFdVWp(MLambda,em,gs,cplcFuFdVWpL,cplcFuFdVWpR,MFdOS,           & 
& MFuOS,MVWpOS,MRPFuToFdVWp,MRGFuToFdVWp)

  Else 
 ! OS and Z-factors 
Call Gamma_Real_SM_FuToFdVWp(MLambda,em,gs,ZcplcFuFdVWpL,ZcplcFuFdVWpR,               & 
...
Else 
 ! DR and no Z-factors 
  If (.not.ExternalZfactors) Then 
Call Gamma_Real_SM_FuToFdVWp(MLambda,em,gs,cplcFuFdVWpL,cplcFuFdVWpR,MFd,             & 
& MFu,MVWp,MRPFuToFdVWp,MRGFuToFdVWp)
...
Call Amplitude_WAVE_SM_FuToFdVWp(cplcFuFdVWpL,cplcFuFdVWpR,ctcplcFuFdVWpL,            & 
& ctcplcFuFdVWpR,MFd,MFd2,MFu,MFu2,MVWp,MVWp2,ZfDL,ZfDR,ZfUL,ZfUR,ZfVWp,AmpWaveFuToFdVWp)



!Vertex Corrections 
Call Amplitude_VERTEX_SM_FuToFdVWp(MAh,MFd,MFu,Mhh,MHp,MVG,MVP,MVWp,MVZ,              & 
& MAh2,MFd2,MFu2,Mhh2,MHp2,MVG2,MVP2,MVWp2,MVZ2,cplcFdFdAhL,cplcFdFdAhR,cplcFuFuAhL,     & 
& cplcFuFuAhR,cplAhcHpVWp,cplcFdFdhhL,cplcFdFdhhR,cplcFuFdHpL,cplcFuFdHpR,               & 
...
& cplcFuFuVPL,cplcFuFuVPR,cplcFuFuVZL,cplcFuFuVZR,cplhhcHpVWp,cplhhcVWpVWp,              & 
& cplcHpVPVWp,cplcVWpVPVWp,cplcHpVWpVZ,cplcVWpVWpVZ,AmpVertexFuToFdVWp)

If (ShiftIRdiv) Then 
Call Amplitude_IR_VERTEX_SM_FuToFdVWp(MAh,MFd,MFu,Mhh,MHp,MVG,MVP,MVWp,               & 
...
& cplhhcVWpVWp,cplcHpVPVWp,cplcVWpVPVWp,cplcHpVWpVZ,cplcVWpVWpVZ,AmpVertexIRdrFuToFdVWp)
 ...
 If (ExternalZfactors) Then 
  If (OSkinematics) Then 
 ! OS and Z-factors 
Call Amplitude_IR_VERTEX_SM_FuToFdVWp(MAhOS,MFdOS,MFuOS,MhhOS,MHpOS,MVG,              & 
& MVP,MVWpOS,MVZOS,MAh2OS,MFd2OS,MFu2OS,Mhh2OS,MHp2OS,MVG2,MVP2,MVWp2OS,MVZ2OS,          & 
& cplcFdFdAhL,cplcFdFdAhR,cplcFuFuAhL,cplcFuFuAhR,cplAhcHpVWp,cplcFdFdhhL,               & 
...
!Tree Level 
  If (.not.ExternalZfactors) Then 
Call Amplitude_Tree_SM_FuToFuhh(cplcFuFuhhL,cplcFuFuhhR,MFu,Mhh,MFu2,Mhh2,            & 
& AmpTreeFuToFuhh)

  Else 
Call Amplitude_Tree_SM_FuToFuhh(ZcplcFuFuhhL,ZcplcFuFuhhR,MFu,Mhh,MFu2,               & 
...
If (OSkinematics) Then 
  If (.not.ExternalZfactors) Then 
 ! OS and no Z-factors 
Call Gamma_Real_SM_FuToFuhh(MLambda,em,gs,cplcFuFuhhL,cplcFuFuhhR,MFuOS,              & 
& MhhOS,MRPFuToFuhh,MRGFuToFuhh)

  Else 
 ! OS and Z-factors 
Call Gamma_Real_SM_FuToFuhh(MLambda,em,gs,ZcplcFuFuhhL,ZcplcFuFuhhR,MFuOS,            & 
& MhhOS,MRPFuToFuhh,MRGFuToFuhh)
...
Else 
 ! DR and no Z-factors 
  If (.not.ExternalZfactors) Then 
Call Gamma_Real_SM_FuToFuhh(MLambda,em,gs,cplcFuFuhhL,cplcFuFuhhR,MFu,Mhh,            & 
& MRPFuToFuhh,MRGFuToFuhh)

  Else 
 ! DR and Z-factors 
Call Gamma_Real_SM_FuToFuhh(MLambda,em,gs,ZcplcFuFuhhL,ZcplcFuFuhhR,MFu,              & 
...
!Self-energy Corrections 
Call Amplitude_WAVE_SM_FuToFuhh(cplcFuFuhhL,cplcFuFuhhR,ctcplcFuFuhhL,ctcplcFuFuhhR,  & 
& MFu,MFu2,Mhh,Mhh2,Zfhh,ZfUL,ZfUR,AmpWaveFuToFuhh)



!Vertex Corrections 
Call Amplitude_VERTEX_SM_FuToFuhh(MAh,MFd,MFu,Mhh,MHp,MVG,MVP,MVWp,MVZ,               & 
...
& cplhhhhhh,cplhhHpcHp,cplhhHpcVWp,cplhhcHpVWp,cplhhcVWpVWp,cplhhVZVZ,AmpVertexFuToFuhh)

If (ShiftIRdiv) Then 
Call Amplitude_IR_VERTEX_SM_FuToFuhh(MAh,MFd,MFu,Mhh,MHp,MVG,MVP,MVWp,MVZ,            & 
& MAh2,MFd2,MFu2,Mhh2,MHp2,MVG2,MVP2,MVWp2,MVZ2,cplAhAhhh,cplcFuFuAhL,cplcFuFuAhR,       & 
& cplAhhhVZ,cplcFdFdhhL,cplcFdFdhhR,cplcFuFdHpL,cplcFuFdHpR,cplcFuFdVWpL,cplcFuFdVWpR,   & 
& cplcFuFuhhL,cplcFuFuhhR,cplcFuFuVGL,cplcFuFuVGR,cplcFuFuVPL,cplcFuFuVPR,               & 
& cplcFuFuVZL,cplcFuFuVZR,cplcFdFucHpL,cplcFdFucHpR,cplcFdFucVWpL,cplcFdFucVWpR,         & 
& cplhhhhhh,cplhhHpcHp,cplhhHpcVWp,cplhhcHpVWp,cplhhcVWpVWp,cplhhVZVZ,AmpVertexIRdrFuToFuhh)

 If (ExternalZfactors) Then 
  If (OSkinematics) Then 
 ! OS and Z-factors 
Call Amplitude_IR_VERTEX_SM_FuToFuhh(MAhOS,MFdOS,MFuOS,MhhOS,MHpOS,MVG,               & 
& MVP,MVWpOS,MVZOS,MAh2OS,MFd2OS,MFu2OS,Mhh2OS,MHp2OS,MVG2,MVP2,MVWp2OS,MVZ2OS,          & 
...
& cplcFuFuVZL,cplcFuFuVZR,cplcFdFucHpL,cplcFdFucHpR,cplcFdFucVWpL,cplcFdFucVWpR,         & 
& cplhhhhhh,cplhhHpcHp,cplhhHpcVWp,cplhhcHpVWp,cplhhcVWpVWp,cplhhVZVZ,AmpVertexIRosFuToFuhh)
...
!Tree Level 
  If (.not.ExternalZfactors) Then 
Call Amplitude_Tree_SM_FuToFuVZ(cplcFuFuVZL,cplcFuFuVZR,MFu,MVZ,MFu2,MVZ2,            & 
& AmpTreeFuToFuVZ)

  Else 
Call Amplitude_Tree_SM_FuToFuVZ(ZcplcFuFuVZL,ZcplcFuFuVZR,MFu,MVZ,MFu2,               & 
...
If (OSkinematics) Then 
  If (.not.ExternalZfactors) Then 
 ! OS and no Z-factors 
Call Gamma_Real_SM_FuToFuVZ(MLambda,em,gs,cplcFuFuVZL,cplcFuFuVZR,MFuOS,              & 
& MVZOS,MRPFuToFuVZ,MRGFuToFuVZ)

  Else 
 ! OS and Z-factors 
Call Gamma_Real_SM_FuToFuVZ(MLambda,em,gs,ZcplcFuFuVZL,ZcplcFuFuVZR,MFuOS,            & 
& MVZOS,MRPFuToFuVZ,MRGFuToFuVZ)
...
Else 
 ! DR and no Z-factors 
  If (.not.ExternalZfactors) Then 
Call Gamma_Real_SM_FuToFuVZ(MLambda,em,gs,cplcFuFuVZL,cplcFuFuVZR,MFu,MVZ,            & 
& MRPFuToFuVZ,MRGFuToFuVZ)

  Else 
 ! DR and Z-factors 
Call Gamma_Real_SM_FuToFuVZ(MLambda,em,gs,ZcplcFuFuVZL,ZcplcFuFuVZR,MFu,              & 
...
!Self-energy Corrections 
Call Amplitude_WAVE_SM_FuToFuVZ(cplcFuFuVPL,cplcFuFuVPR,cplcFuFuVZL,cplcFuFuVZR,      & 
& ctcplcFuFuVPL,ctcplcFuFuVPR,ctcplcFuFuVZL,ctcplcFuFuVZR,MFu,MFu2,MVP,MVP2,             & 
& MVZ,MVZ2,ZfUL,ZfUR,ZfVPVZ,ZfVZ,AmpWaveFuToFuVZ)



!Vertex Corrections 
Call Amplitude_VERTEX_SM_FuToFuVZ(MAh,MFd,MFu,Mhh,MHp,MVG,MVP,MVWp,MVZ,               & 
& MAh2,MFd2,MFu2,Mhh2,MHp2,MVG2,MVP2,MVWp2,MVZ2,cplcFuFuAhL,cplcFuFuAhR,cplAhhhVZ,       & 
& cplcFuFdHpL,cplcFuFdHpR,cplcFuFdVWpL,cplcFuFdVWpR,cplcFdFdVZL,cplcFdFdVZR,             & 
& cplcFuFuhhL,cplcFuFuhhR,cplcFuFuVGL,cplcFuFuVGR,cplcFuFuVPL,cplcFuFuVPR,               & 
& cplcFuFuVZL,cplcFuFuVZR,cplcFdFucHpL,cplcFdFucHpR,cplcFdFucVWpL,cplcFdFucVWpR,         & 
& cplhhVZVZ,cplHpcHpVZ,cplHpcVWpVZ,cplcHpVWpVZ,cplcVWpVWpVZ,AmpVertexFuToFuVZ)

If (ShiftIRdiv) Then 
Call Amplitude_IR_VERTEX_SM_FuToFuVZ(MAh,MFd,MFu,Mhh,MHp,MVG,MVP,MVWp,MVZ,            & 
& MAh2,MFd2,MFu2,Mhh2,MHp2,MVG2,MVP2,MVWp2,MVZ2,cplcFuFuAhL,cplcFuFuAhR,cplAhhhVZ,       & 
& cplcFuFdHpL,cplcFuFdHpR,cplcFuFdVWpL,cplcFuFdVWpR,cplcFdFdVZL,cplcFdFdVZR,             & 
& cplcFuFuhhL,cplcFuFuhhR,cplcFuFuVGL,cplcFuFuVGR,cplcFuFuVPL,cplcFuFuVPR,               & 
& cplcFuFuVZL,cplcFuFuVZR,cplcFdFucHpL,cplcFdFucHpR,cplcFdFucVWpL,cplcFdFucVWpR,         & 
& cplhhVZVZ,cplHpcHpVZ,cplHpcVWpVZ,cplcHpVWpVZ,cplcVWpVWpVZ,AmpVertexIRdrFuToFuVZ)

 If (ExternalZfactors) Then 
  If (OSkinematics) Then 
 ! OS and Z-factors 
Call Amplitude_IR_VERTEX_SM_FuToFuVZ(MAhOS,MFdOS,MFuOS,MhhOS,MHpOS,MVG,               & 
& MVP,MVWpOS,MVZOS,MAh2OS,MFd2OS,MFu2OS,Mhh2OS,MHp2OS,MVG2,MVP2,MVWp2OS,MVZ2OS,          & 
& cplcFuFuAhL,cplcFuFuAhR,cplAhhhVZ,cplcFuFdHpL,cplcFuFdHpR,cplcFuFdVWpL,cplcFuFdVWpR,   & 
& cplcFdFdVZL,cplcFdFdVZR,cplcFuFuhhL,cplcFuFuhhR,cplcFuFuVGL,cplcFuFuVGR,               & 
& cplcFuFuVPL,cplcFuFuVPR,ZcplcFuFuVZL,ZcplcFuFuVZR,cplcFdFucHpL,cplcFdFucHpR,           & 
& cplcFdFucVWpL,cplcFdFucVWpR,cplhhVZVZ,cplHpcHpVZ,cplHpcVWpVZ,cplcHpVWpVZ,              & 
...
& cplhhVZVZ,cplHpcHpVZ,cplHpcVWpVZ,cplcHpVWpVZ,cplcVWpVWpVZ,AmpVertexIRosFuToFuVZ)
...
!Self-energy Corrections 
 If (ExternalZfactors) Then 
Call Amplitude_WAVE_SM_FuToFuVG(ZcplcFuFuVGL,ZcplcFuFuVGR,ctcplcFuFuVGL,              & 
& ctcplcFuFuVGR,MFuOS,MFu2OS,MVG,MVG2,ZfUL,ZfUR,ZfVG,AmpWaveFuToFuVG)

 Else 
Call Amplitude_WAVE_SM_FuToFuVG(cplcFuFuVGL,cplcFuFuVGR,ctcplcFuFuVGL,ctcplcFuFuVGR,  & 
& MFuOS,MFu2OS,MVG,MVG2,ZfUL,ZfUR,ZfVG,AmpWaveFuToFuVG)
...
!Vertex Corrections 
 If (ExternalZfactors) Then 
Call Amplitude_VERTEX_SM_FuToFuVG(MAhOS,MFdOS,MFuOS,MhhOS,MHpOS,MVG,MVP,              & 
& MVWpOS,MVZOS,MAh2OS,MFd2OS,MFu2OS,Mhh2OS,MHp2OS,MVG2,MVP2,MVWp2OS,MVZ2OS,              & 
& ZcplcFuFuAhL,ZcplcFuFuAhR,ZcplcFuFdHpL,ZcplcFuFdHpR,ZcplcFdFdVGL,ZcplcFdFdVGR,         & 
& ZcplcFuFdVWpL,ZcplcFuFdVWpR,ZcplcFuFuhhL,ZcplcFuFuhhR,ZcplcFuFuVGL,ZcplcFuFuVGR,       & 
...
Call Amplitude_VERTEX_SM_FuToFuVG(MAhOS,MFdOS,MFuOS,MhhOS,MHpOS,MVG,MVP,              & 
& MVWpOS,MVZOS,MAh2OS,MFd2OS,MFu2OS,Mhh2OS,MHp2OS,MVG2,MVP2,MVWp2OS,MVZ2OS,              & 
& cplcFuFuAhL,cplcFuFuAhR,cplcFuFdHpL,cplcFuFdHpR,cplcFdFdVGL,cplcFdFdVGR,               & 
...
!Self-energy Corrections 
Call Amplitude_WAVE_SM_FuToFuVG(cplcFuFuVGL,cplcFuFuVGR,ctcplcFuFuVGL,ctcplcFuFuVGR,  & 
& MFu,MFu2,MVG,MVG2,ZfUL,ZfUR,ZfVG,AmpWaveFuToFuVG)



!Vertex Corrections 
Call Amplitude_VERTEX_SM_FuToFuVG(MAh,MFd,MFu,Mhh,MHp,MVG,MVP,MVWp,MVZ,               & 
& MAh2,MFd2,MFu2,Mhh2,MHp2,MVG2,MVP2,MVWp2,MVZ2,cplcFuFuAhL,cplcFuFuAhR,cplcFuFdHpL,     & 
& cplcFuFdHpR,cplcFdFdVGL,cplcFdFdVGR,cplcFuFdVWpL,cplcFuFdVWpR,cplcFuFuhhL,             & 
& cplcFuFuhhR,cplcFuFuVGL,cplcFuFuVGR,cplcFuFuVPL,cplcFuFuVPR,cplcFuFuVZL,               & 
& cplcFuFuVZR,cplcFdFucHpL,cplcFdFucHpR,cplcFdFucVWpL,cplcFdFucVWpR,cplVGVGVG,           & 
& AmpVertexFuToFuVG)
...
!Self-energy Corrections 
 If (ExternalZfactors) Then 
Call Amplitude_WAVE_SM_FuToFuVP(ZcplcFuFuVPL,ZcplcFuFuVPR,ZcplcFuFuVZL,               & 
...
& MFu2OS,MVP,MVP2,ZfUL,ZfUR,ZfVP,ZfVZVP,AmpWaveFuToFuVP)
 ...
 Else 
Call Amplitude_WAVE_SM_FuToFuVP(cplcFuFuVPL,cplcFuFuVPR,cplcFuFuVZL,cplcFuFuVZR,      & 
& ctcplcFuFuVPL,ctcplcFuFuVPR,ctcplcFuFuVZL,ctcplcFuFuVZR,MFuOS,MFu2OS,MVP,              & 
& MVP2,ZfUL,ZfUR,ZfVP,ZfVZVP,AmpWaveFuToFuVP)
...
!Vertex Corrections 
 If (ExternalZfactors) Then 
Call Amplitude_VERTEX_SM_FuToFuVP(MAhOS,MFdOS,MFuOS,MhhOS,MHpOS,MVG,MVP,              & 
& MVWpOS,MVZOS,MAh2OS,MFd2OS,MFu2OS,Mhh2OS,MHp2OS,MVG2,MVP2,MVWp2OS,MVZ2OS,              & 
& ZcplcFuFuAhL,ZcplcFuFuAhR,ZcplcFuFdHpL,ZcplcFuFdHpR,ZcplcFdFdVPL,ZcplcFdFdVPR,         & 
& ZcplcFuFdVWpL,ZcplcFuFdVWpR,ZcplcFuFuhhL,ZcplcFuFuhhR,ZcplcFuFuVGL,ZcplcFuFuVGR,       & 
& ZcplcFuFuVPL,ZcplcFuFuVPR,ZcplcFuFuVZL,ZcplcFuFuVZR,ZcplcFdFucHpL,ZcplcFdFucHpR,       & 
...
Call Amplitude_VERTEX_SM_FuToFuVP(MAhOS,MFdOS,MFuOS,MhhOS,MHpOS,MVG,MVP,              & 
& MVWpOS,MVZOS,MAh2OS,MFd2OS,MFu2OS,Mhh2OS,MHp2OS,MVG2,MVP2,MVWp2OS,MVZ2OS,              & 
& cplcFuFuAhL,cplcFuFuAhR,cplcFuFdHpL,cplcFuFdHpR,cplcFdFdVPL,cplcFdFdVPR,               & 
& cplcFuFdVWpL,cplcFuFdVWpR,cplcFuFuhhL,cplcFuFuhhR,cplcFuFuVGL,cplcFuFuVGR,             & 
& cplcFuFuVPL,cplcFuFuVPR,cplcFuFuVZL,cplcFuFuVZR,cplcFdFucHpL,cplcFdFucHpR,             & 
...
Call Amplitude_WAVE_SM_FuToFuVP(cplcFuFuVPL,cplcFuFuVPR,cplcFuFuVZL,cplcFuFuVZR,      & 
& ctcplcFuFuVPL,ctcplcFuFuVPR,ctcplcFuFuVZL,ctcplcFuFuVZR,MFu,MFu2,MVP,MVP2,             & 
& ZfUL,ZfUR,ZfVP,ZfVZVP,AmpWaveFuToFuVP)



!Vertex Corrections 
Call Amplitude_VERTEX_SM_FuToFuVP(MAh,MFd,MFu,Mhh,MHp,MVG,MVP,MVWp,MVZ,               & 
& MAh2,MFd2,MFu2,Mhh2,MHp2,MVG2,MVP2,MVWp2,MVZ2,cplcFuFuAhL,cplcFuFuAhR,cplcFuFdHpL,     & 
& cplcFuFdHpR,cplcFdFdVPL,cplcFdFdVPR,cplcFuFdVWpL,cplcFuFdVWpR,cplcFuFuhhL,             & 
& cplcFuFuhhR,cplcFuFuVGL,cplcFuFuVGR,cplcFuFuVPL,cplcFuFuVPR,cplcFuFuVZL,               & 
& cplcFuFuVZR,cplcFdFucHpL,cplcFdFucHpR,cplcFdFucVWpL,cplcFdFucVWpR,cplHpcHpVP,          & 
& cplHpcVWpVP,cplcHpVPVWp,cplcVWpVPVWp,AmpVertexFuToFuVP)
...
End Module Wrapper_OneLoopDecay_Fu_SM
