...
Use StandardModel 
Use RunSM_SM
Use FlavorKit_LFV_SM
Use FlavorKit_QFV_SM
Use FlavorKit_Observables_SM
...
& Yuinput,Ydinput,Yeinput,m2SMinput,vvSMinput,Tpar,Spar,Upar,ae,amu,atau,EDMe,           & 
...
Real(dp),Intent(inout) :: g1input,g2input,g3input,vvSMinput

Complex(dp),Intent(inout) :: Laminput,Yuinput(3,3),Ydinput(3,3),Yeinput(3,3),m2SMinput
...
& OA2lSLSM(3,3),OA2lSRSM(3,3),OA1LSM(3,3),OA1RSM(3,3),OH2lSLSM(3,3,1),OH2lSRSM(3,3,1),   & 
...
& PVO4lTRRcross(3,3,3,3),OA2lSL(3,3),OA2lSR(3,3),OA1L(3,3),OA1R(3,3),OH2lSL(3,3,1),      & 
& OH2lSR(3,3,1),DP2lSL(3,3),DP2lSR(3,3),OZ2lSL(3,3),OZ2lSR(3,3),OZ2lVL(3,3),             & 
& OZ2lVR(3,3)
...
& OA2qVRSM(3,3),OG2qSLSM(3,3),OG2qSRSM(3,3),OH2qSLSM(3,3,1),OH2qSRSM(3,3,1)
...
& OA2qSR(3,3),OA2qVL(3,3),OA2qVR(3,3),OG2qSL(3,3),OG2qSR(3,3),OH2qSL(3,3,1),             & 
& OH2qSR(3,3,1)
...
& OA2lSLcheck(3,3),OA2lSRcheck(3,3),OA1Lcheck(3,3),OA1Rcheck(3,3),OH2lSLcheck(3,3,1),    & 
& OH2lSRcheck(3,3,1),DP2lSLcheck(3,3),DP2lSRcheck(3,3),OZ2lSLcheck(3,3),OZ2lSRcheck(3,3),& 
...
& OA2qVLcheck(3,3),OA2qVRcheck(3,3),OG2qSLcheck(3,3),OG2qSRcheck(3,3),OH2qSLcheck(3,3,1),& 
& OH2qSRcheck(3,3,1)
...
& Ydinput,Yeinput,m2SMinput,vvSMinput,g1,g2,g3,Lam,Yu,Yd,Ye,m2SM,vvSM,CKM_160,           & 
& sinW2_160,Alpha_160,AlphaS_160,.false.)
...
MHp=MVWp
MHp2=MVWp2
Call AllCouplings(Lam,vvSM,g1,g2,TW,g3,Yd,ZDL,ZDR,Ye,ZEL,ZER,Yu,ZUL,ZUR,              & 
& cplAhAhhh,cplhhhhhh,cplhhHpcHp,cplAhhhVZ,cplAhHpcVWp,cplAhcHpVWp,cplhhHpcVWp,          & 
...
& cplcFvFeHpR,cplcFvFeVWpL,cplcFvFeVWpR,cplcFvFvVZL,cplcFvFvVZR,cplcHpVWpVZ,             & 
...
& Yeinput,m2SMinput,vvSMinput,g1,g2,g3,Lam,Yu,Yd,Ye,m2SM,vvSM,CKM_MZ,sinW2_MZ,           & 
...
Call CalculateTreeS4L(gt1,gt2,gt3,gt4,.True.,MAh,MAh2,MFe,MFe2,Mhh,Mhh2,              & 
& MHp,MHp2,MVWp,MVWp2,MVZ,MVZ2,cplAhAhhh,cplAhhhVZ,cplcFeFeAhL,cplcFeFeAhR,              & 
& cplcFeFehhL,cplcFeFehhR,cplcFeFeVPL,cplcFeFeVPR,cplcFeFeVZL,cplcFeFeVZR,               & 
& cplcFeFvcHpL,cplcFeFvcHpR,cplcFeFvcVWpL,cplcFeFvcVWpR,cplcFvFeHpL,cplcFvFeHpR,         & 
& cplcFvFeVWpL,cplcFvFeVWpR,cplhhhhhh,cplhhVZVZ,TSO4lSLLSM(gt1,gt2,gt3,gt4)              & 
...
Call CalculateTreeV4L(gt1,gt2,gt3,gt4,.True.,MAh,MAh2,MFe,MFe2,Mhh,Mhh2,              & 
& MHp,MHp2,MVWp,MVWp2,MVZ,MVZ2,cplAhAhhh,cplAhhhVZ,cplcFeFeAhL,cplcFeFeAhR,              & 
& cplcFeFehhL,cplcFeFehhR,cplcFeFeVPL,cplcFeFeVPR,cplcFeFeVZL,cplcFeFeVZR,               & 
& cplcFeFvcHpL,cplcFeFvcHpR,cplcFeFvcVWpL,cplcFeFvcVWpR,cplcFvFeHpL,cplcFvFeHpR,         & 
& cplcFvFeVWpL,cplcFvFeVWpR,cplhhhhhh,cplhhVZVZ,TVO4lSLLSM(gt1,gt2,gt3,gt4)              & 
...
Call CalculateTreeS4Lcross(gt1,gt2,gt3,gt4,.True.,MAh,MAh2,MFe,MFe2,Mhh,              & 
& Mhh2,MHp,MHp2,MVWp,MVWp2,MVZ,MVZ2,cplAhAhhh,cplAhhhVZ,cplcFeFeAhL,cplcFeFeAhR,         & 
& cplcFeFehhL,cplcFeFehhR,cplcFeFeVPL,cplcFeFeVPR,cplcFeFeVZL,cplcFeFeVZR,               & 
& cplcFeFvcHpL,cplcFeFvcHpR,cplcFeFvcVWpL,cplcFeFvcVWpR,cplcFvFeHpL,cplcFvFeHpR,         & 
& cplcFvFeVWpL,cplcFvFeVWpR,cplhhhhhh,cplhhVZVZ,TSO4lSLLcrossSM(gt1,gt2,gt3,gt4)         & 
...
Call CalculateTreeV4Lcross(gt1,gt2,gt3,gt4,.True.,MAh,MAh2,MFe,MFe2,Mhh,              & 
& Mhh2,MHp,MHp2,MVWp,MVWp2,MVZ,MVZ2,cplAhAhhh,cplAhhhVZ,cplcFeFeAhL,cplcFeFeAhR,         & 
& cplcFeFehhL,cplcFeFehhR,cplcFeFeVPL,cplcFeFeVPR,cplcFeFeVZL,cplcFeFeVZR,               & 
& cplcFeFvcHpL,cplcFeFvcHpR,cplcFeFvcVWpL,cplcFeFvcVWpR,cplcFvFeHpL,cplcFvFeHpR,         & 
& cplcFvFeVWpL,cplcFvFeVWpR,cplhhhhhh,cplhhVZVZ,TVO4lSLLcrossSM(gt1,gt2,gt3,gt4)         & 
...
Call CalculateBox4L(gt1,gt2,gt3,gt4,.True.,MAh,MAh2,MFe,MFe2,Mhh,Mhh2,MHp,            & 
...
& cplcFvFeVWpR,cplhhhhhh,cplhhVZVZ,BO4lSLLSM(gt1,gt2,gt3,gt4),BO4lSRRSM(gt1,gt2,gt3,gt4) & 
...
Call CalculatePengS4L(gt1,gt2,gt3,gt4,.True.,MAh,MAh2,MFe,MFe2,Mhh,Mhh2,              & 
& MHp,MHp2,MVWp,MVWp2,MVZ,MVZ2,cplAhAhhh,cplAhhhVZ,cplcFeFeAhL,cplcFeFeAhR,              & 
& cplcFeFehhL,cplcFeFehhR,cplcFeFeVPL,cplcFeFeVPR,cplcFeFeVZL,cplcFeFeVZR,               & 
& cplcFeFvcHpL,cplcFeFvcHpR,cplcFeFvcVWpL,cplcFeFvcVWpR,cplcFvFeHpL,cplcFvFeHpR,         & 
& cplcFvFeVWpL,cplcFvFeVWpR,cplhhhhhh,cplhhVZVZ,PSO4lSLLSM(gt1,gt2,gt3,gt4)              & 
...
Call CalculatePengV4L(gt1,gt2,gt3,gt4,.True.,MAh,MAh2,MFe,MFe2,Mhh,Mhh2,              & 
& MHp,MHp2,MVWp,MVWp2,MVZ,MVZ2,cplAhAhhh,cplAhhhVZ,cplcFeFeAhL,cplcFeFeAhR,              & 
& cplcFeFehhL,cplcFeFehhR,cplcFeFeVPL,cplcFeFeVPR,cplcFeFeVZL,cplcFeFeVZR,               & 
& cplcFeFvcHpL,cplcFeFvcHpR,cplcFeFvcVWpL,cplcFeFvcVWpR,cplcFvFeHpL,cplcFvFeHpR,         & 
& cplcFvFeVWpL,cplcFvFeVWpR,cplhhhhhh,cplhhVZVZ,PVO4lSLLSM(gt1,gt2,gt3,gt4)              & 
...
Call CalculateBox4Lcross(gt1,gt2,gt3,gt4,.True.,MAh,MAh2,MFe,MFe2,Mhh,Mhh2,           & 
& MHp,MHp2,MVWp,MVWp2,MVZ,MVZ2,cplAhAhhh,cplAhhhVZ,cplcFeFeAhL,cplcFeFeAhR,              & 
& cplcFeFehhL,cplcFeFehhR,cplcFeFeVPL,cplcFeFeVPR,cplcFeFeVZL,cplcFeFeVZR,               & 
& cplcFeFvcHpL,cplcFeFvcHpR,cplcFeFvcVWpL,cplcFeFvcVWpR,cplcFvFeHpL,cplcFvFeHpR,         & 
& cplcFvFeVWpL,cplcFvFeVWpR,cplhhhhhh,cplhhVZVZ,BO4lSLLcrossSM(gt1,gt2,gt3,gt4)          & 
...
Call CalculatePengS4Lcross(gt1,gt2,gt3,gt4,.True.,MAh,MAh2,MFe,MFe2,Mhh,              & 
& Mhh2,MHp,MHp2,MVWp,MVWp2,MVZ,MVZ2,cplAhAhhh,cplAhhhVZ,cplcFeFeAhL,cplcFeFeAhR,         & 
& cplcFeFehhL,cplcFeFehhR,cplcFeFeVPL,cplcFeFeVPR,cplcFeFeVZL,cplcFeFeVZR,               & 
& cplcFeFvcHpL,cplcFeFvcHpR,cplcFeFvcVWpL,cplcFeFvcVWpR,cplcFvFeHpL,cplcFvFeHpR,         & 
& cplcFvFeVWpL,cplcFvFeVWpR,cplhhhhhh,cplhhVZVZ,PSO4lSLLcrossSM(gt1,gt2,gt3,gt4)         & 
...
Call CalculatePengV4Lcross(gt1,gt2,gt3,gt4,.True.,MAh,MAh2,MFe,MFe2,Mhh,              & 
& Mhh2,MHp,MHp2,MVWp,MVWp2,MVZ,MVZ2,cplAhAhhh,cplAhhhVZ,cplcFeFeAhL,cplcFeFeAhR,         & 
& cplcFeFehhL,cplcFeFehhR,cplcFeFeVPL,cplcFeFeVPR,cplcFeFeVZL,cplcFeFeVZR,               & 
& cplcFeFvcHpL,cplcFeFvcHpR,cplcFeFvcVWpL,cplcFeFvcVWpR,cplcFvFeHpL,cplcFvFeHpR,         & 
& cplcFvFeVWpL,cplcFvFeVWpR,cplhhhhhh,cplhhVZVZ,PVO4lSLLcrossSM(gt1,gt2,gt3,gt4)         & 
...
Call CalculateGamma2l(gt1,gt2,gt3,.True.,MAh,MAh2,MFe,MFe2,Mhh,Mhh2,MHp,              & 
& MHp2,MVWp,MVWp2,MVZ,MVZ2,cplcFeFeAhL,cplcFeFeAhR,cplcFeFehhL,cplcFeFehhR,              & 
& cplcFeFeVPL,cplcFeFeVPR,cplcFeFeVZL,cplcFeFeVZR,cplcFeFvcHpL,cplcFeFvcHpR,             & 
& cplcFeFvcVWpL,cplcFeFvcVWpR,cplcFvFeHpL,cplcFvFeHpR,cplcFvFeVWpL,cplcFvFeVWpR,         & 
& cplcHpVPVWp,cplcVWpVPVWp,cplHpcHpVP,cplHpcVWpVP,OA2lSLSM(gt1,gt2),OA2lSRSM(gt1,gt2)    & 
& ,OA1LSM(gt1,gt2),OA1RSM(gt1,gt2))
...
& cplcFeFehhR,cplcFeFeVZL,cplcFeFeVZR,cplcFeFvcHpL,cplcFeFvcHpR,cplcFeFvcVWpL,           & 
& cplcFeFvcVWpR,cplcFvFeHpL,cplcFvFeHpR,cplcFvFeVWpL,cplcFvFeVWpR,cplhhcHpVWp,           & 
& cplhhcVWpVWp,cplhhhhhh,cplhhHpcHp,cplhhHpcVWp,cplhhVZVZ,OH2lSL(gt1,gt2,gt3)            & 
& ,OH2lSR(gt1,gt2,gt3))

Call CalculateH2l(gt1,gt2,gt3,.True.,MAh,MAh2,MFe,MFe2,Mhh,Mhh2,MHp,MHp2,             & 
& MVWp,MVWp2,MVZ,MVZ2,cplAhAhhh,cplAhhhVZ,cplcFeFeAhL,cplcFeFeAhR,cplcFeFehhL,           & 
& cplcFeFehhR,cplcFeFeVZL,cplcFeFeVZR,cplcFeFvcHpL,cplcFeFvcHpR,cplcFeFvcVWpL,           & 
& cplcFeFvcVWpR,cplcFvFeHpL,cplcFvFeHpR,cplcFvFeVWpL,cplcFvFeVWpR,cplhhcHpVWp,           & 
& cplhhcVWpVWp,cplhhhhhh,cplhhHpcHp,cplhhHpcVWp,cplhhVZVZ,OH2lSLSM(gt1,gt2,gt3)          & 
...
gt2 = IndexArray2(i1,2) 
  gt3= 1 
Call CalculateLeptonEDMgminus2(gt1,gt2,gt3,.False.,MAh,MAh2,MFe,MFe2,Mhh,             & 
& Mhh2,MHp,MHp2,MVWp,MVWp2,MVZ,MVZ2,cplcFeFeAhL,cplcFeFeAhR,cplcFeFehhL,cplcFeFehhR,     & 
& cplcFeFeVPL,cplcFeFeVPR,cplcFeFeVZL,cplcFeFeVZR,cplcFeFvcHpL,cplcFeFvcHpR,             & 
& cplcFeFvcVWpL,cplcFeFvcVWpR,cplcFvFeHpL,cplcFvFeHpR,cplcFvFeVWpL,cplcFvFeVWpR,         & 
& cplcHpVPVWp,cplcVWpVPVWp,cplHpcHpVP,cplHpcVWpVP,DP2lSL(gt1,gt2),DP2lSR(gt1,gt2))

Call CalculateLeptonEDMgminus2(gt1,gt2,gt3,.True.,MAh,MAh2,MFe,MFe2,Mhh,              & 
& Mhh2,MHp,MHp2,MVWp,MVWp2,MVZ,MVZ2,cplcFeFeAhL,cplcFeFeAhR,cplcFeFehhL,cplcFeFehhR,     & 
& cplcFeFeVPL,cplcFeFeVPR,cplcFeFeVZL,cplcFeFeVZR,cplcFeFvcHpL,cplcFeFvcHpR,             & 
& cplcFeFvcVWpL,cplcFeFvcVWpR,cplcFvFeHpL,cplcFvFeHpR,cplcFvFeVWpL,cplcFvFeVWpR,         & 
& cplcHpVPVWp,cplcVWpVPVWp,cplHpcHpVP,cplHpcVWpVP,DP2lSLSM(gt1,gt2),DP2lSRSM(gt1,gt2))
...
& cplcHpVWpVZ,cplcVWpVWpVZ,cplhhVZVZ,cplHpcHpVZ,cplHpcVWpVZ,OZ2lSL(gt1,gt2)              & 
& ,OZ2lSR(gt1,gt2),OZ2lVL(gt1,gt2),OZ2lVR(gt1,gt2))

Call CalculateZ2l(gt1,gt2,gt3,.True.,MAh,MAh2,MFe,MFe2,Mhh,Mhh2,MHp,MHp2,             & 
& MVWp,MVWp2,MVZ,MVZ2,cplAhhhVZ,cplcFeFeAhL,cplcFeFeAhR,cplcFeFehhL,cplcFeFehhR,         & 
& cplcFeFeVZL,cplcFeFeVZR,cplcFeFvcHpL,cplcFeFvcHpR,cplcFeFvcVWpL,cplcFeFvcVWpR,         & 
& cplcFvFeHpL,cplcFvFeHpR,cplcFvFeVWpL,cplcFvFeVWpR,cplcFvFvVZL,cplcFvFvVZR,             & 
& cplcHpVWpVZ,cplcVWpVWpVZ,cplhhVZVZ,cplHpcHpVZ,cplHpcVWpVZ,OZ2lSLSM(gt1,gt2)            & 
& ,OZ2lSRSM(gt1,gt2),OZ2lVLSM(gt1,gt2),OZ2lVRSM(gt1,gt2))
