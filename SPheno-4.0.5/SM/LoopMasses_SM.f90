...
& vvSM,Lam,cplcUFdFdAhL,cplcUFdFdAhR,cplcUFdFdhhL,cplcUFdFdhhR,cplcUFdFdVGL,             & 
...
If (NewGBC) Then 
Call CalculatePi2S(125._dp**2,vvSM,g1,g2,g3,Lam,Yu,Yd,Ye,m2SM,kont,ti_ep2L,           & 
& Pi2S_EffPot,PiP2S_EffPot)

Else 
Call CalculatePi2S(0._dp,vvSM,g1,g2,g3,Lam,Yu,Yd,Ye,m2SM,kont,ti_ep2L,Pi2S_EffPot,    & 
& PiP2S_EffPot)
...
End if 
Call SolveTadpoleEquations(g1,g2,g3,Lam,Yu,Yd,Ye,m2SM,vvSM,Tad1Loop)
...
Call OneLoopFe(Ye,vvSM,MFe,MFe2,MAh,MAh2,Mhh,Mhh2,MVZ,MVZ2,MHp,MHp2,MVWp,             & 
...
Call OneLoopHp(g2,m2SM1L,Lam,vvSM,MVWp,MVWp2,MAh,MAh2,MFd,MFd2,MFu,MFu2,              & 
...
& cplhhhhHpcHp,cplHpHpcHpcHp,cplHpcHpVPVP,cplHpcHpcVWpVWp,cplHpcHpVZVZ,0.1_dp*delta_mass,& 
& MHp_1L,MHp2_1L,kont)

Call OneLoopAh(g1,g2,m2SM2L,Lam,vvSM,TW,Mhh,Mhh2,MAh,MAh2,MFd,MFd2,MFe,               & 
& MFe2,MFu,MFu2,MVZ,MVZ2,MVWp,MVWp2,MHp,MHp2,cplAhAhhh,cplcFdFdAhL,cplcFdFdAhR,          & 
...
Call OneLoophh(m2SM2L,Lam,vvSM,MAh,MAh2,MVZ,MVZ2,MFd,MFd2,MFe,MFe2,MFu,               & 
& MFu2,Mhh,Mhh2,MHp,MHp2,MVWp,MVWp2,cplAhAhhh,cplAhhhVZ,cplcFdFdhhL,cplcFdFdhhR,         & 
...
Subroutine OneLoopTadpoleshh(vvSM,MAh,MAh2,MFd,MFd2,MFe,MFe2,MFu,MFu2,Mhh,            & 
...
B0m2 = 0._dp*Real(SA_B0(p2,0._dp,MHp2),dp) 
...
B0m2 = 0._dp*Real(SA_DerB0(p2,0._dp,MHp2),dp) 
coupL1 = cplcUFeFvcHpL(gO1,i2)
coupR1 = cplcUFeFvcHpR(gO1,i2)
coupL2 =  Conjg(cplcUFeFvcHpL(gO2,i2))
coupR2 =  Conjg(cplcUFeFvcHpR(gO2,i2))
...
Subroutine OneLoopHp(g2,m2SM,Lam,vvSM,MVWp,MVWp2,MAh,MAh2,MFd,MFd2,MFu,               & 
& MFu2,MFe,MFe2,MHp,MHp2,Mhh,Mhh2,MVZ,MVZ2,cplAhcHpVWp,cplcFdFucHpL,cplcFdFucHpR,        & 
& cplcFeFvcHpL,cplcFeFvcHpR,cplcgZgWpcHp,cplcgWpgZHp,cplcgWCgZcHp,cplcgZgWCHp,           & 
& cplhhHpcHp,cplhhcHpVWp,cplHpcHpVP,cplHpcHpVZ,cplcHpVPVWp,cplcHpVWpVZ,cplAhAhHpcHp,     & 
...
mi2 = 0._dp 
mi2 = mi2+m2SM
mi2 = mi2+(vvSM**2*Lam)/2._dp
mi2 = mi2+(g2**2*vvSM**2*RXiWp)/4._dp
...
B0m2 = -2._dp*MFe(i1)*0._dp*SA_B0(p2,MFe2(i1),0._dp) 
...
B0m2 = -2._dp*MFe(i1)*0._dp*SA_DerB0(p2,MFe2(i1),0._dp) 
coupL1 = cplcFeFvcHpL(i1,i2)
coupR1 = cplcFeFvcHpR(i1,i2)
coupL2 =  Conjg(cplcFeFvcHpL(i1,i2))
coupR2 =  Conjg(cplcFeFvcHpR(i1,i2))
...
Subroutine OneLoopAh(g1,g2,m2SM,Lam,vvSM,TW,Mhh,Mhh2,MAh,MAh2,MFd,MFd2,               & 
& MFe,MFe2,MFu,MFu2,MVZ,MVZ2,MVWp,MVWp2,MHp,MHp2,cplAhAhhh,cplcFdFdAhL,cplcFdFdAhR,      & 
& cplcFeFeAhL,cplcFeFeAhR,cplcFuFuAhL,cplcFuFuAhR,cplcgWpgWpAh,cplcgWCgWCAh,             & 
& cplAhhhVZ,cplAhHpcVWp,cplAhAhAhAh,cplAhAhhhhh,cplAhAhHpcHp,cplAhAhcVWpVWp,             & 
...
mi2 = mi2+m2SM
mi2 = mi2+(vvSM**2*Lam)/2._dp
mi2 = mi2+(g2**2*vvSM**2*Cos(TW)**2*RXiZ)/4._dp
mi2 = mi2+(g1*g2*vvSM**2*Cos(TW)*RXiZ*Sin(TW))/2._dp
mi2 = mi2+(g1**2*vvSM**2*RXiZ*Sin(TW)**2)/4._dp
...
Subroutine OneLoophh(m2SM,Lam,vvSM,MAh,MAh2,MVZ,MVZ2,MFd,MFd2,MFe,MFe2,               & 
& MFu,MFu2,Mhh,Mhh2,MHp,MHp2,MVWp,MVWp2,cplAhAhhh,cplAhhhVZ,cplcFdFdhhL,cplcFdFdhhR,     & 
& cplcFeFehhL,cplcFeFehhR,cplcFuFuhhL,cplcFuFuhhR,cplcgWpgWphh,cplcgWCgWChh,             & 
& cplcgZgZhh,cplhhhhhh,cplhhHpcHp,cplhhHpcVWp,cplhhcVWpVWp,cplhhVZVZ,cplAhAhhhhh,        & 
...
B0m2 = 0._dp*Real(SA_B0(MFe2(gO1),0._dp,MHp2),dp) 
Else 
B1m2 = -Real(SA_B1(p2,0._dp,MHp2),dp) 
B0m2 = 0._dp*Real(SA_B0(p2,0._dp,MHp2),dp) 
End If 
