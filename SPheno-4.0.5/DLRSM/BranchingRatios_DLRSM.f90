...
& ZER,UP,ZUR,ZDL,ZEL,ZUL,ZH,ZM,ZW,ZZ,$Failed,$Failed,0,0,0,0,$Failed,0,0,0,              & 
& 0,$Failed,$Failed,0,0,$Failed,$Failed,gBL,g2,g3,LAM2,LAM1,ALP1,RHO1,RHO2,              & 
& ALP2,ALP3,LAM5,LAM6,LAM3,LAM4,Y,YQ1,YQ2,Yt,YL,YR,Mux,MU12,MU22,k1,vR,gPFu(:,1:36)      & 
& ,gTFu,BRFu(:,1:36))
...
& ZER,UP,ZUR,ZDL,ZEL,ZUL,ZH,ZM,ZW,ZZ,$Failed,$Failed,0,0,0,0,$Failed,0,0,0,              & 
& 0,$Failed,$Failed,0,0,$Failed,$Failed,gBL,g2,g3,LAM2,LAM1,ALP1,RHO1,RHO2,              & 
& ALP2,ALP3,LAM5,LAM6,LAM3,LAM4,Y,YQ1,YQ2,Yt,YL,YR,Mux,MU12,MU22,k1,vR,gPFe(:,1:60)      & 
& ,gTFe,BRFe(:,1:60))
...
& ZER,UP,ZUR,ZDL,ZEL,ZUL,ZH,ZM,ZW,ZZ,$Failed,$Failed,0,0,0,0,$Failed,0,0,0,              & 
& 0,$Failed,$Failed,0,0,$Failed,$Failed,gBL,g2,g3,LAM2,LAM1,ALP1,RHO1,RHO2,              & 
& ALP2,ALP3,LAM5,LAM6,LAM3,LAM4,Y,YQ1,YQ2,Yt,YL,YR,Mux,MU12,MU22,k1,vR,gPFd(:,1:36)      & 
& ,gTFd,BRFd(:,1:36))
...
& ZER,UP,ZUR,ZDL,ZEL,ZUL,ZH,ZM,ZW,ZZ,$Failed,$Failed,0,0,0,0,$Failed,0,0,0,              & 
& 0,$Failed,$Failed,0,0,$Failed,$Failed,gBL,g2,g3,LAM2,LAM1,ALP1,RHO1,RHO2,              & 
& ALP2,ALP3,LAM5,LAM6,LAM3,LAM4,Y,YQ1,YQ2,Yt,YL,YR,Mux,MU12,MU22,k1,vR,gPhh,             & 
& gThh,BRhh)
...
& ZER,UP,ZUR,ZDL,ZEL,ZUL,ZH,ZM,ZW,ZZ,$Failed,$Failed,0,0,0,0,$Failed,0,0,0,              & 
& 0,$Failed,$Failed,0,0,$Failed,$Failed,gBL,g2,g3,LAM2,LAM1,ALP1,RHO1,RHO2,              & 
& ALP2,ALP3,LAM5,LAM6,LAM3,LAM4,Y,YQ1,YQ2,Yt,YL,YR,Mux,MU12,MU22,k1,vR,gPFv(:,1:84)      & 
& ,gTFv,BRFv(:,1:84))
...
& ZER,UP,ZUR,ZDL,ZEL,ZUL,ZH,ZM,ZW,ZZ,$Failed,$Failed,0,0,0,0,$Failed,0,0,0,              & 
& 0,$Failed,$Failed,0,0,$Failed,$Failed,gBL,g2,g3,LAM2,LAM1,ALP1,RHO1,RHO2,              & 
& ALP2,ALP3,LAM5,LAM6,LAM3,LAM4,Y,YQ1,YQ2,Yt,YL,YR,Mux,MU12,MU22,k1,vR,gPVZ,             & 
& gTVZ,BRVZ)
...
& ZER,UP,ZUR,ZDL,ZEL,ZUL,ZH,ZM,ZW,ZZ,$Failed,$Failed,0,0,0,0,$Failed,0,0,0,              & 
& 0,$Failed,$Failed,0,0,$Failed,$Failed,gBL,g2,g3,LAM2,LAM1,ALP1,RHO1,RHO2,              & 
& ALP2,ALP3,LAM5,LAM6,LAM3,LAM4,Y,YQ1,YQ2,Yt,YL,YR,Mux,MU12,MU22,k1,vR,gPAh,             & 
& gTAh,BRAh)
...
Call FuThreeBodyDecay(-1,MAh,MAh2,MFd,MFd2,MFe,MFe2,MFu,MFu2,MFv,MFv2,MHpm,           & 
& MHpm2,MVWLm,MVWLm2,MVWRm,MVWRm2,MVZ,MVZ2,MVZR,MVZR2,PhiW,TW,UC,ZDR,ZER,UP,             & 
& ZUR,ZDL,ZEL,ZUL,ZH,ZM,ZW,ZZ,$Failed,$Failed,0,0,0,0,$Failed,0,0,0,0,$Failed,           & 
& $Failed,0,0,$Failed,$Failed,gBL,g2,g3,LAM2,LAM1,ALP1,RHO1,RHO2,ALP2,ALP3,              & 
& LAM5,LAM6,LAM3,LAM4,Y,YQ1,YQ2,Yt,YL,YR,Mux,MU12,MU22,k1,vR,gTAh,gThh,gTHpm,            & 
& gTVWLm,gTVWRm,gTVZ,gTVZR,gFuFucFdFd,gFuFucFeFe,gFuFucFuFu,gFuFuFvFv,gFuFdcFeFv,        & 
& epsI,deltaM,.False.,gTFu,gPFu(:,37:441),BRFu(:,37:441))
...
& LAM5,LAM6,LAM3,LAM4,Y,YQ1,YQ2,Yt,YL,YR,Mux,MU12,MU22,k1,vR,gTAh,gThh,gTHpm,            & 
& gTVWLm,gTVWRm,gTVZ,gTVZR,gFuFucFdFd,gFuFucFeFe,gFuFucFuFu,gFuFuFvFv,gFuFdcFeFv,        & 
& epsI,deltaM,.True.,gTFu,gPFu(:,37:441),BRFu(:,37:441))
...
Call FeThreeBodyDecay(-1,MAh,MAh2,MFd,MFd2,MFe,MFe2,MFu,MFu2,MFv,MFv2,MHpm,           & 
& MHpm2,MVWLm,MVWLm2,MVWRm,MVWRm2,MVZ,MVZ2,MVZR,MVZR2,PhiW,TW,UC,ZDR,ZER,UP,             & 
& ZUR,ZDL,ZEL,ZUL,ZH,ZM,ZW,ZZ,$Failed,$Failed,0,0,0,0,$Failed,0,0,0,0,$Failed,           & 
& $Failed,0,0,$Failed,$Failed,gBL,g2,g3,LAM2,LAM1,ALP1,RHO1,RHO2,ALP2,ALP3,              & 
& LAM5,LAM6,LAM3,LAM4,Y,YQ1,YQ2,Yt,YL,YR,Mux,MU12,MU22,k1,vR,gTAh,gThh,gTHpm,            & 
& gTVWLm,gTVWRm,gTVZ,gTVZR,gFeFecFdFd,gFeFecFeFe,gFeFecFuFu,gFeFeFvFv,gFeFvcFuFd,        & 
& epsI,deltaM,.False.,gTFe,gPFe(:,61:465),BRFe(:,61:465))
...
& LAM5,LAM6,LAM3,LAM4,Y,YQ1,YQ2,Yt,YL,YR,Mux,MU12,MU22,k1,vR,gTAh,gThh,gTHpm,            & 
& gTVWLm,gTVWRm,gTVZ,gTVZR,gFeFecFdFd,gFeFecFeFe,gFeFecFuFu,gFeFeFvFv,gFeFvcFuFd,        & 
& epsI,deltaM,.True.,gTFe,gPFe(:,61:465),BRFe(:,61:465))
...
Call FdThreeBodyDecay(-1,MAh,MAh2,MFd,MFd2,MFe,MFe2,MFu,MFu2,MFv,MFv2,MHpm,           & 
& MHpm2,MVWLm,MVWLm2,MVWRm,MVWRm2,MVZ,MVZ2,MVZR,MVZR2,PhiW,TW,UC,ZDR,ZER,UP,             & 
& ZUR,ZDL,ZEL,ZUL,ZH,ZM,ZW,ZZ,$Failed,$Failed,0,0,0,0,$Failed,0,0,0,0,$Failed,           & 
& $Failed,0,0,$Failed,$Failed,gBL,g2,g3,LAM2,LAM1,ALP1,RHO1,RHO2,ALP2,ALP3,              & 
& LAM5,LAM6,LAM3,LAM4,Y,YQ1,YQ2,Yt,YL,YR,Mux,MU12,MU22,k1,vR,gTAh,gThh,gTHpm,            & 
& gTVWLm,gTVWRm,gTVZ,gTVZR,gFdFdcFdFd,gFdFdcFeFe,gFdFdcFuFu,gFdFdFvFv,gFdFuFvFe,         & 
& epsI,deltaM,.False.,gTFd,gPFd(:,37:441),BRFd(:,37:441))
...
& LAM5,LAM6,LAM3,LAM4,Y,YQ1,YQ2,Yt,YL,YR,Mux,MU12,MU22,k1,vR,gTAh,gThh,gTHpm,            & 
& gTVWLm,gTVWRm,gTVZ,gTVZR,gFdFdcFdFd,gFdFdcFeFe,gFdFdcFuFu,gFdFdFvFv,gFdFuFvFe,         & 
& epsI,deltaM,.True.,gTFd,gPFd(:,37:441),BRFd(:,37:441))
...
Call FvThreeBodyDecay(-1,MAh,MAh2,MFd,MFd2,MFe,MFe2,MFu,MFu2,MFv,MFv2,MHpm,           & 
& MHpm2,MVWLm,MVWLm2,MVWRm,MVWRm2,MVZ,MVZ2,MVZR,MVZR2,PhiW,TW,UC,ZDR,ZER,UP,             & 
& ZUR,ZDL,ZEL,ZUL,ZH,ZM,ZW,ZZ,$Failed,$Failed,0,0,0,0,$Failed,0,0,0,0,$Failed,           & 
& $Failed,0,0,$Failed,$Failed,gBL,g2,g3,LAM2,LAM1,ALP1,RHO1,RHO2,ALP2,ALP3,              & 
& LAM5,LAM6,LAM3,LAM4,Y,YQ1,YQ2,Yt,YL,YR,Mux,MU12,MU22,k1,vR,gTAh,gThh,gTHpm,            & 
& gTVWLm,gTVWRm,gTVZ,gTVZR,gFvFvcFdFd,gFvFvcFeFe,gFvFvcFuFu,gFvFvFvFv,gFvFecFdFu,        & 
& epsI,deltaM,.False.,gTFv,gPFv(:,85:1083),BRFv(:,85:1083))
...
& LAM5,LAM6,LAM3,LAM4,Y,YQ1,YQ2,Yt,YL,YR,Mux,MU12,MU22,k1,vR,gTAh,gThh,gTHpm,            & 
& gTVWLm,gTVWRm,gTVZ,gTVZR,gFvFvcFdFd,gFvFvcFeFe,gFvFvcFuFu,gFvFvFvFv,gFvFecFdFu,        & 
& epsI,deltaM,.True.,gTFv,gPFv(:,85:1083),BRFv(:,85:1083))
