...
Subroutine CalculatePi2S(p2,k1,vR,gBL,g2,g3,LAM2,LAM1,ALP1,RHO1,RHO2,ALP2,            & 
& ALP3,LAM5,LAM6,LAM3,LAM4,Y,YQ1,YQ2,Yt,YL,YR,Mux,MU12,MU22,kont,tad2L,Pi2S,Pi2P)
...
Complex(dp) :: cplAhAhAhAh(4,4,4,4),cplAhAhAhHpm(4,4,4,4),cplAhAhAhcHpm(4,4,4,4),cplAhAhhhhh(4,4,4,4),& 
...
& LAM4,k1,vR,ZH,UP,UC,g3,YQ1,YQ2,ZDL,ZDR,Y,Yt,ZEL,ZER,ZUL,ZUR,YR,ZM,cplAhAhhh,           & 
& cplAhAhHpm,cplAhAhcHpm,cplAhhhHpm,cplAhhhcHpm,cplAhHpmcHpm,cplhhhhhh,cplhhhhHpm,       & 
& cplhhhhcHpm,cplhhHpmcHpm,cplHpmHpmcHpm,cplHpmcHpmcHpm,cplVGVGVG,cplcFdFdAhL,           & 
& cplcFdFdAhR,cplcFeFeAhL,cplcFeFeAhR,cplcFuFuAhL,cplcFuFuAhR,cplFvFvAhL,cplFvFvAhR,     & 
& cplcFdFdhhL,cplcFdFdhhR,cplcFuFdHpmL,cplcFuFdHpmR,cplFvFeHpmL,cplFvFeHpmR,             & 
& cplcFeFehhL,cplcFeFehhR,cplcFuFuhhL,cplcFuFuhhR,cplcFdFucHpmL,cplcFdFucHpmR,           & 
& cplFvFvhhL,cplFvFvhhR,cplcFeFvcHpmL,cplcFeFvcHpmR,cplcFdFdVGL,cplcFdFdVGR,             & 
& cplcFuFuVGL,cplcFuFuVGR)

Call CouplingsFor2LPole4(LAM2,LAM1,ALP1,RHO1,RHO2,ALP2,ALP3,LAM5,LAM6,LAM3,           & 
& UP,UC,LAM4,ZH,cplAhAhAhAh,cplAhAhAhHpm,cplAhAhAhcHpm,cplAhAhhhhh,cplAhAhhhHpm,         & 
...
& cplhhHpmcHpmcHpm,cplHpmHpmcHpmcHpm)
...
tad1LmatrixAh(3,3)=tad1LmatrixAh(3,3)+1/k1*tad1LG(3)
tad1LmatrixAh(4,4)=tad1LmatrixAh(4,4)+1/vR*tad1LG(4)
...
do i2=1,4
do i3=1,4
 funcvalue= tad1LmatrixAh(i2,i3)*CCtilde(MHpm2(i1),MAh2(i2),MAh2(i3),Qscale)
do gE1=1,4
do gE2=1,4
coup1 = cplAhAhcHpm(gE1,i2,i1)
coup2 = cplAhAhcHpm(gE2,i3,i1)
delta2LmassesAh(gE1,gE2)=delta2LmassesAh(gE1,gE2)+real(coup1*coup2*2._dp*funcvalue,dp)
end do
 end do
end do 
...
tad1LmatrixHpm(1,1)=tad1LmatrixHpm(1,1)+1/k1*tad1LG(3)
tad1LmatrixHpm(2,2)=tad1LmatrixHpm(2,2)+1/vR*tad1LG(4)
tad1LmatrixHpm(3,3)=tad1LmatrixHpm(3,3)+1/k1*tad1LG(3)
tad1LmatrixHpm(4,4)=tad1LmatrixHpm(4,4)+1/vR*tad1LG(4)
...
do i2=1,4
do i3=1,4
 funcvalue= tad1LmatrixHpm(i2,i3)*CCtilde(MHpm2(i1),MAh2(i2),MAh2(i3),Qscale)
do gE1=1,4
do gE2=1,4
coup1 = cplAhAhcHpm(gE1,i2,i1)
coup2 = cplAhAhcHpm(gE2,i3,i1)
...
nonzerocoupling=.false.
  Do gE1=1,4
coup1 = cplAhAhhhHpm(i1,i2,gE1,i3)
coup2 = cplAhAhcHpm(i1,i2,i3)
prefactor=Real(coup1*coup2,dp)
if(abs(prefactor) .gt. epscouplings) then
 tempcouplingvector(gE1)=prefactor
 nonzerocoupling=.true.
 ...
 tempcouplingvector(gE1)= 0._dp
   ...
   End Do
if(nonzerocoupling) then 
 funcvalue= 1._dp*TfSSS(MAh2(i1),MAh2(i2),MHpm2(i3),Qscale)
 temptad=temptad+tempcouplingvector*funcvalue
end if
end do
end do
...
nonzerocoupling=.false.
  Do gE1=1,4
coup1 = cplAhhhhhHpm(i1,gE1,i2,i3)
coup2 = cplAhhhcHpm(i1,i2,i3)
prefactor=Real(coup1*coup2,dp)
if(abs(prefactor) .gt. epscouplings) then
 tempcouplingvector(gE1)=prefactor
 nonzerocoupling=.true.
...
nonzerocoupling=.false.
  Do gE1=1,4
coup1 = cplhhhhhhHpm(gE1,i1,i2,i3)
coup2 = cplhhhhcHpm(i1,i2,i3)
prefactor=Real(coup1*coup2,dp)
if(abs(prefactor) .gt. epscouplings) then
 tempcouplingvector(gE1)=prefactor
 nonzerocoupling=.true.
...
nonzerocoupling=.false.
  Do gE1=1,4
coup1 = cplhhHpmHpmcHpm(gE1,i1,i2,i3)
coup2 = cplHpmcHpmcHpm(i3,i1,i2)
prefactor=Real(coup1*coup2,dp)
if(abs(prefactor) .gt. epscouplings) then
 tempcouplingvector(gE1)=prefactor
 nonzerocoupling=.true.
 ...
 tempcouplingvector(gE1)= 0._dp
   ...
   End Do
if(nonzerocoupling) then 
 funcvalue= 1._dp/3._dp*TfSSS(MHpm2(i1),MHpm2(i2),MHpm2(i3),Qscale)
 temptad=temptad+tempcouplingvector*funcvalue
end if
end do
end do
...
nonzerocoupling=.false.
  Do gE1=1,4
coup1 = cplAhhhHpm(i1,gE1,i2)
coup2 = cplAhAhAhcHpm(i1,i3,i3,i2)
prefactor=Real(coup1*coup2,dp)
if(abs(prefactor) .gt. epscouplings) then
 tempcouplingvector(gE1)=prefactor
 nonzerocoupling=.true.
 ...
 tempcouplingvector(gE1)= 0._dp
   ...
   End Do
if(nonzerocoupling) then 
 funcvalue= 1._dp*TfSS(MAh2(i1),MHpm2(i2),MAh2(i3),Qscale)
 temptad=temptad+tempcouplingvector*funcvalue
end if
end do
end do
...
nonzerocoupling=.false.
  Do gE1=1,4
coup1 = cplAhhhHpm(i1,gE1,i2)
coup2 = cplAhhhhhcHpm(i1,i3,i3,i2)
prefactor=Real(coup1*coup2,dp)
if(abs(prefactor) .gt. epscouplings) then
 tempcouplingvector(gE1)=prefactor
 nonzerocoupling=.true.
...
nonzerocoupling=.false.
  Do gE1=1,4
coup1 = cplAhhhHpm(i1,gE1,i2)
coup2 = cplAhHpmcHpmcHpm(i1,i3,i2,i3)
prefactor=Real(coup1*coup2,dp)
if(abs(prefactor) .gt. epscouplings) then
 tempcouplingvector(gE1)=prefactor
 nonzerocoupling=.true.
 ...
 tempcouplingvector(gE1)= 0._dp
   ...
   End Do
if(nonzerocoupling) then 
 funcvalue= 2._dp*TfSS(MAh2(i1),MHpm2(i2),MHpm2(i3),Qscale)
 temptad=temptad+tempcouplingvector*funcvalue
end if
end do
end do
...
nonzerocoupling=.false.
  Do gE1=1,4
coup1 = cplhhhhHpm(gE1,i1,i2)
coup2 = cplAhAhhhcHpm(i3,i3,i1,i2)
prefactor=Real(coup1*coup2,dp)
if(abs(prefactor) .gt. epscouplings) then
 tempcouplingvector(gE1)=prefactor
 nonzerocoupling=.true.
...
nonzerocoupling=.false.
  Do gE1=1,4
coup1 = cplhhhhHpm(gE1,i1,i2)
coup2 = cplhhhhhhcHpm(i1,i3,i3,i2)
prefactor=Real(coup1*coup2,dp)
if(abs(prefactor) .gt. epscouplings) then
 tempcouplingvector(gE1)=prefactor
 nonzerocoupling=.true.
...
nonzerocoupling=.false.
  Do gE1=1,4
coup1 = cplhhhhHpm(gE1,i1,i2)
coup2 = cplhhHpmcHpmcHpm(i1,i3,i2,i3)
prefactor=Real(coup1*coup2,dp)
if(abs(prefactor) .gt. epscouplings) then
 tempcouplingvector(gE1)=prefactor
 nonzerocoupling=.true.
...
nonzerocoupling=.false.
  Do gE1=1,4
coup1 = cplAhAhhh(i1,i2,gE1)
coup2 = cplAhAhHpm(i1,i3,i4)
coup3 = cplAhAhcHpm(i2,i3,i4)
prefactor=Real(coup1*coup2*coup3,dp)
if(abs(prefactor) .gt. epscouplings) then
 tempcouplingvector(gE1)=prefactor
 nonzerocoupling=.true.
 ...
 tempcouplingvector(gE1)= 0._dp
   ...
   End Do
if(nonzerocoupling) then 
 funcvalue= -1._dp*TfSSSS(MAh2(i1),MAh2(i2),MAh2(i3),MHpm2(i4),Qscale)
 temptad=temptad+tempcouplingvector*funcvalue
end if
end do
end do
...
nonzerocoupling=.false.
  Do gE1=1,4
coup1 = cplAhAhhh(i1,i2,gE1)
coup2 = cplAhhhHpm(i1,i3,i4)
coup3 = cplAhhhcHpm(i2,i3,i4)
prefactor=Real(coup1*coup2*coup3,dp)
if(abs(prefactor) .gt. epscouplings) then
 tempcouplingvector(gE1)=prefactor
 nonzerocoupling=.true.
...
nonzerocoupling=.false.
  Do gE1=1,4
coup1 = cplAhhhHpm(i1,gE1,i2)
coup2 = cplAhAhcHpm(i1,i3,i4)
coup3 = cplAhHpmcHpm(i3,i4,i2)
prefactor=Real(coup1*coup2*coup3,dp)
if(abs(prefactor) .gt. epscouplings) then
 tempcouplingvector(gE1)=prefactor
 nonzerocoupling=.true.
 ...
 tempcouplingvector(gE1)= 0._dp
   ...
   End Do
if(nonzerocoupling) then 
 funcvalue= -2._dp*TfSSSS(MAh2(i1),MHpm2(i2),MAh2(i3),MHpm2(i4),Qscale)
 temptad=temptad+tempcouplingvector*funcvalue
end if
end do
end do
...
nonzerocoupling=.false.
  Do gE1=1,4
coup1 = cplAhhhHpm(i1,gE1,i2)
coup2 = cplAhhhcHpm(i1,i3,i4)
coup3 = cplhhHpmcHpm(i3,i4,i2)
prefactor=Real(coup1*coup2*coup3,dp)
if(abs(prefactor) .gt. epscouplings) then
 tempcouplingvector(gE1)=prefactor
 nonzerocoupling=.true.
...
if(abs(prefactor) .gt. epscouplings) then
 ...
 tempcouplingvector(gE1)= 0._dp
   ...
   End Do
if(nonzerocoupling) then 
 funcvalue= -1._dp*TfSSSS(MAh2(i1),MHpm2(i2),MHpm2(i3),MHpm2(i4),Qscale)
 temptad=temptad+tempcouplingvector*funcvalue
end if
end do
end do
...
nonzerocoupling=.false.
  Do gE1=1,4
coup1 = cplhhhhhh(gE1,i1,i2)
coup2 = cplAhhhHpm(i3,i1,i4)
coup3 = cplAhhhcHpm(i3,i2,i4)
prefactor=Real(coup1*coup2*coup3,dp)
if(abs(prefactor) .gt. epscouplings) then
 tempcouplingvector(gE1)=prefactor
 nonzerocoupling=.true.
...
nonzerocoupling=.false.
  Do gE1=1,4
coup1 = cplhhhhhh(gE1,i1,i2)
coup2 = cplhhhhHpm(i1,i3,i4)
coup3 = cplhhhhcHpm(i2,i3,i4)
prefactor=Real(coup1*coup2*coup3,dp)
if(abs(prefactor) .gt. epscouplings) then
 tempcouplingvector(gE1)=prefactor
 nonzerocoupling=.true.
...
if(abs(prefactor) .gt. epscouplings) then
 ...
 tempcouplingvector(gE1)= 0._dp
   ...
   End Do
if(nonzerocoupling) then 
 funcvalue= -2._dp*TfSSSS(MHpm2(i1),MAh2(i2),MAh2(i3),MHpm2(i4),Qscale)
 temptad=temptad+tempcouplingvector*funcvalue
end if
end do
end do
...
nonzerocoupling=.false.
  Do gE1=1,4
coup1 = cplhhHpmcHpm(gE1,i1,i2)
coup2 = cplAhAhcHpm(i3,i4,i1)
coup3 = cplAhAhHpm(i3,i4,i2)
prefactor=Real(coup1*coup2*coup3,dp)
if(abs(prefactor) .gt. epscouplings) then
 tempcouplingvector(gE1)=prefactor
 nonzerocoupling=.true.
 ...
 tempcouplingvector(gE1)= 0._dp
   ...
   End Do
if(nonzerocoupling) then 
 funcvalue= -1._dp/2._dp*TfSSSS(MHpm2(i1),MHpm2(i2),MAh2(i3),MAh2(i4),Qscale)
 temptad=temptad+tempcouplingvector*funcvalue
end if
end do
end do
...
nonzerocoupling=.false.
  Do gE1=1,4
coup1 = cplhhHpmcHpm(gE1,i1,i2)
coup2 = cplAhhhcHpm(i3,i4,i1)
coup3 = cplAhhhHpm(i3,i4,i2)
prefactor=Real(coup1*coup2*coup3,dp)
if(abs(prefactor) .gt. epscouplings) then
 tempcouplingvector(gE1)=prefactor
 nonzerocoupling=.true.
...
nonzerocoupling=.false.
  Do gE1=1,4
coup1 = cplhhHpmcHpm(gE1,i1,i2)
coup2 = cplhhhhcHpm(i3,i4,i1)
coup3 = cplhhhhHpm(i3,i4,i2)
prefactor=Real(coup1*coup2*coup3,dp)
if(abs(prefactor) .gt. epscouplings) then
 tempcouplingvector(gE1)=prefactor
 nonzerocoupling=.true.
...
nonzerocoupling=.false.
  Do gE1=1,4
coup1 = cplhhHpmcHpm(gE1,i1,i2)
coup2 = cplHpmHpmcHpm(i3,i4,i1)
coup3 = cplHpmcHpmcHpm(i2,i3,i4)
prefactor=Real(coup1*coup2*coup3,dp)
if(abs(prefactor) .gt. epscouplings) then
 tempcouplingvector(gE1)=prefactor
 nonzerocoupling=.true.
 ...
 tempcouplingvector(gE1)= 0._dp
   ...
   End Do
if(nonzerocoupling) then 
 funcvalue= -1._dp/2._dp*TfSSSS(MHpm2(i1),MHpm2(i2),MHpm2(i3),MHpm2(i4),Qscale)
 temptad=temptad+tempcouplingvector*funcvalue
end if
end do
end do
...
nonzerocoupling=.false.
  Do gE1=1,4
coup1 = cplhhHpmcHpm(gE1,i1,i2)
coup2 = cplHpmcHpmcHpm(i3,i1,i4)
coup3 = cplHpmHpmcHpm(i2,i4,i3)
prefactor=Real(coup1*coup2*coup3,dp)
if(abs(prefactor) .gt. epscouplings) then
 tempcouplingvector(gE1)=prefactor
 nonzerocoupling=.true.
...
nonzerocoupling=.false.
  Do gE1=1,4
coup1 = cplhhHpmcHpm(gE1,i1,i2)
coup2L = cplcFdFucHpmL(i4,i3,i1)
coup2R = cplcFdFucHpmR(i4,i3,i1)
coup3L = cplcFuFdHpmL(i3,i4,i2)
coup3R = cplcFuFdHpmR(i3,i4,i2)
prefactor=Real(coup1*coup2L*coup3R+coup1*coup2R*coup3L,dp)
if(abs(prefactor) .gt. epscouplings) then
 tempcouplingvector(gE1)=prefactor
 nonzerocoupling=.true.
 ...
 tempcouplingvector(gE1)= 0._dp
   ...
   End Do
if(nonzerocoupling) then 
 funcvalue= -3._dp*TfSSFF(MHpm2(i1),MHpm2(i2),MFu2(i3),MFd2(i4),Qscale)
 temptad=temptad+tempcouplingvector*funcvalue
end if
...
if(abs(prefactor) .gt. epscouplings) then
 ...
 tempcouplingvector(gE1)= 0._dp
   ...
   End Do
if(nonzerocoupling) then 
 funcvalue= 6._dp*MFu(i3)*MFd(i4)*TfSSFbFb(MHpm2(i1),MHpm2(i2),MFu2(i3),MFd2(i4),Qscale)
 temptad=temptad+tempcouplingvector*funcvalue
end if
end if
...
nonzerocoupling=.false.
  Do gE1=1,4
coup1 = cplhhHpmcHpm(gE1,i1,i2)
coup2L = cplcFeFvcHpmL(i4,i3,i1)
coup2R = cplcFeFvcHpmR(i4,i3,i1)
coup3L = cplFvFeHpmL(i3,i4,i2)
coup3R = cplFvFeHpmR(i3,i4,i2)
prefactor=Real(coup1*coup2L*coup3R+coup1*coup2R*coup3L,dp)
if(abs(prefactor) .gt. epscouplings) then
 tempcouplingvector(gE1)=prefactor
 nonzerocoupling=.true.
 ...
 tempcouplingvector(gE1)= 0._dp
   ...
   End Do
if(nonzerocoupling) then 
 funcvalue= -1._dp*TfSSFF(MHpm2(i1),MHpm2(i2),MFv2(i3),MFe2(i4),Qscale)
 temptad=temptad+tempcouplingvector*funcvalue
end if
...
if(abs(prefactor) .gt. epscouplings) then
 ...
 tempcouplingvector(gE1)= 0._dp
   ...
   End Do
if(nonzerocoupling) then 
 funcvalue= 2._dp*MFv(i3)*MFe(i4)*TfSSFbFb(MHpm2(i1),MHpm2(i2),MFv2(i3),MFe2(i4),Qscale)
 temptad=temptad+tempcouplingvector*funcvalue
end if
end if
...
coup1L = cplcFdFdhhL(i2,i1,gE1)
coup1R = cplcFdFdhhR(i2,i1,gE1)
coup2L = cplcFdFucHpmL(i1,i3,i4)
coup2R = cplcFdFucHpmR(i1,i3,i4)
coup3L = cplcFuFdHpmL(i3,i2,i4)
coup3R = cplcFuFdHpmR(i3,i2,i4)
prefactor=Real(coup1L*coup2R*coup3R+coup1R*coup2L*coup3L,dp)
if(abs(prefactor) .gt. epscouplings) then
 tempcouplingvector(gE1)=prefactor
 nonzerocoupling=.true.
...
coup1L = cplcFeFehhL(i2,i1,gE1)
coup1R = cplcFeFehhR(i2,i1,gE1)
coup2L = cplcFeFvcHpmL(i1,i3,i4)
coup2R = cplcFeFvcHpmR(i1,i3,i4)
coup3L = cplFvFeHpmL(i3,i2,i4)
coup3R = cplFvFeHpmR(i3,i2,i4)
prefactor=Real(coup1L*coup2R*coup3R+coup1R*coup2L*coup3L,dp)
if(abs(prefactor) .gt. epscouplings) then
 tempcouplingvector(gE1)=prefactor
 nonzerocoupling=.true.
...
coup1L = cplcFuFuhhL(i2,i1,gE1)
coup1R = cplcFuFuhhR(i2,i1,gE1)
coup2L = cplcFuFdHpmL(i1,i3,i4)
coup2R = cplcFuFdHpmR(i1,i3,i4)
coup3L = cplcFdFucHpmL(i3,i2,i4)
coup3R = cplcFdFucHpmR(i3,i2,i4)
prefactor=Real(coup1L*coup2R*coup3R+coup1R*coup2L*coup3L,dp)
if(abs(prefactor) .gt. epscouplings) then
 tempcouplingvector(gE1)=prefactor
 nonzerocoupling=.true.
...
coup1L = cplFvFvhhL(i1,i2,gE1)
coup1R = cplFvFvhhR(i1,i2,gE1)
coup2L = cplFvFeHpmL(i1,i3,i4)
coup2R = cplFvFeHpmR(i1,i3,i4)
coup3L = cplcFeFvcHpmL(i3,i2,i4)
coup3R = cplcFeFvcHpmR(i3,i2,i4)
prefactor=Real(coup1L*coup2R*coup3R+coup1R*coup2L*coup3L,dp)
if(abs(prefactor) .gt. epscouplings) then
 tempcouplingvector(gE1)=prefactor
 nonzerocoupling=.true.
...
if(abs(prefactor) .gt. epscouplings) then
 ...
 tempcouplingmatrix(gE1,gE2)= 0._dp
  ...
  End do
if(nonzerocoupling) then 
 funcvalue= -1._dp*WfSSSS(p2,MAh2(i1),MAh2(i2),MAh2(i3),MHpm2(i4),Qscale)
 tempcont=tempcont+tempcouplingmatrix*funcvalue
end if
end do
end do
...
nonzerocoupling=.false.
  Do gE1=1,4
   Do gE2=1,4
coup1 = cplAhhhhhHpm(i1,gE1,gE2,i2)
coup2 = cplAhAhhh(i1,i3,i4)
coup3 = cplAhhhcHpm(i3,i4,i2)
prefactor=Real(coup1*coup2*coup3,dp)
if(abs(prefactor) .gt. epscouplings) then
...
if(abs(prefactor) .gt. epscouplings) then
 ...
 tempcouplingmatrix(gE1,gE2)= 0._dp
  ...
  End do
if(nonzerocoupling) then 
 funcvalue= -2._dp*WfSSSS(p2,MAh2(i1),MHpm2(i2),MAh2(i3),MHpm2(i4),Qscale)
 tempcont=tempcont+tempcouplingmatrix*funcvalue
end if
end do
end do
...
if(abs(prefactor) .gt. epscouplings) then
 ...
 tempcouplingmatrix(gE1,gE2)= 0._dp
  ...
  End do
if(nonzerocoupling) then 
 funcvalue= -1._dp*WfSSSS(p2,MAh2(i1),MHpm2(i2),MHpm2(i3),MHpm2(i4),Qscale)
 tempcont=tempcont+tempcouplingmatrix*funcvalue
end if
end do
end do
...
nonzerocoupling=.false.
  Do gE1=1,4
   Do gE2=1,4
coup1 = cplhhhhhhHpm(gE1,gE2,i1,i2)
coup2 = cplAhAhhh(i3,i4,i1)
coup3 = cplAhAhcHpm(i3,i4,i2)
prefactor=Real(coup1*coup2*coup3,dp)
if(abs(prefactor) .gt. epscouplings) then
...
nonzerocoupling=.false.
  Do gE1=1,4
   Do gE2=1,4
coup1 = cplAhhhhhHpm(i2,gE1,gE2,i1)
coup2 = cplAhHpmcHpm(i3,i4,i1)
coup3 = cplAhAhcHpm(i2,i3,i4)
prefactor=Real(coup1*coup2*coup3,dp)
if(abs(prefactor) .gt. epscouplings) then
 ...
 tempcouplingmatrix(gE1,gE2)= 0._dp
  ...
  End do
if(nonzerocoupling) then 
 funcvalue= -2._dp*WfSSSS(p2,MHpm2(i1),MAh2(i2),MAh2(i3),MHpm2(i4),Qscale)
 tempcont=tempcont+tempcouplingmatrix*funcvalue
end if
end do
end do
...
nonzerocoupling=.false.
  Do gE1=1,4
   Do gE2=1,4
coup1 = cplhhhhhhHpm(gE1,gE2,i2,i1)
coup2 = cplAhHpmcHpm(i3,i4,i1)
coup3 = cplAhhhcHpm(i3,i2,i4)
prefactor=Real(coup1*coup2*coup3,dp)
if(abs(prefactor) .gt. epscouplings) then
...
if(abs(prefactor) .gt. epscouplings) then
 ...
 tempcouplingmatrix(gE1,gE2)= 0._dp
  ...
  End do
if(nonzerocoupling) then 
 funcvalue= -1._dp/2._dp*WfSSSS(p2,MHpm2(i1),MHpm2(i2),MAh2(i3),MAh2(i4),Qscale)
 tempcont=tempcont+tempcouplingmatrix*funcvalue
end if
end do
end do
...
if(abs(prefactor) .gt. epscouplings) then
 ...
 tempcouplingmatrix(gE1,gE2)= 0._dp
  ...
  End do
if(nonzerocoupling) then 
 funcvalue= -1._dp/2._dp*WfSSSS(p2,MHpm2(i1),MHpm2(i2),MHpm2(i3),MHpm2(i4),Qscale)
 tempcont=tempcont+tempcouplingmatrix*funcvalue
end if
end do
end do
...
if(abs(prefactor) .gt. epscouplings) then
 ...
 tempcouplingmatrix(gE1,gE2)= 0._dp
  ...
  End do
if(nonzerocoupling) then 
 funcvalue= 1._dp*XfSSS(p2,MAh2(i1),MHpm2(i2),MAh2(i3),Qscale)
 tempcont=tempcont+tempcouplingmatrix*funcvalue
end if
end do
end do
...
if(abs(prefactor) .gt. epscouplings) then
 ...
 tempcouplingmatrix(gE1,gE2)= 0._dp
  ...
  End do
if(nonzerocoupling) then 
 funcvalue= 2._dp*XfSSS(p2,MAh2(i1),MHpm2(i2),MHpm2(i3),Qscale)
 tempcont=tempcont+tempcouplingmatrix*funcvalue
end if
end do
end do
...
nonzerocoupling=.false.
  Do gE1=1,4
   Do gE2=1,4
coup1 = cplAhAhhh(i1,i2,gE1)
coup2 = cplAhhhHpm(i1,gE2,i3)
coup3 = cplAhAhAhcHpm(i2,i4,i4,i3)
prefactor=Real(coup1*coup2*coup3,dp)
if(abs(prefactor) .gt. epscouplings) then
 tempcouplingmatrix(gE1,gE2)=prefactor
 nonzerocoupling=.true.
 ...
 tempcouplingmatrix(gE1,gE2)= 0._dp
  ...
  End do
if(nonzerocoupling) then 
 funcvalue= -2._dp*YfSSSS(p2,MAh2(i1),MAh2(i2),MHpm2(i3),MAh2(i4),Qscale)
 tempcont=tempcont+tempcouplingmatrix*funcvalue
end if
end do
end do
...
coup1 = cplAhAhhh(i1,i2,gE1)
coup2 = cplAhhhHpm(i1,gE2,i3)
coup3 = cplAhhhhhcHpm(i2,i4,i4,i3)
prefactor=Real(coup1*coup2*coup3,dp)
if(abs(prefactor) .gt. epscouplings) then
 tempcouplingmatrix(gE1,gE2)=prefactor
 nonzerocoupling=.true.
...
coup1 = cplAhAhhh(i1,i2,gE1)
coup2 = cplAhhhHpm(i1,gE2,i3)
coup3 = cplAhHpmcHpmcHpm(i2,i4,i3,i4)
prefactor=Real(coup1*coup2*coup3,dp)
if(abs(prefactor) .gt. epscouplings) then
 tempcouplingmatrix(gE1,gE2)=prefactor
 nonzerocoupling=.true.
 ...
 tempcouplingmatrix(gE1,gE2)= 0._dp
  ...
  End do
if(nonzerocoupling) then 
 funcvalue= -4._dp*YfSSSS(p2,MAh2(i1),MAh2(i2),MHpm2(i3),MHpm2(i4),Qscale)
 tempcont=tempcont+tempcouplingmatrix*funcvalue
end if
end do
end do
...
nonzerocoupling=.false.
  Do gE1=1,4
   Do gE2=1,4
coup1 = cplAhhhHpm(i1,gE1,i2)
coup2 = cplAhhhcHpm(i1,gE2,i3)
coup3 = cplAhAhHpmcHpm(i4,i4,i3,i2)
prefactor=Real(coup1*coup2*coup3,dp)
if(abs(prefactor) .gt. epscouplings) then
 tempcouplingmatrix(gE1,gE2)=prefactor
 nonzerocoupling=.true.
 ...
 tempcouplingmatrix(gE1,gE2)= 0._dp
  ...
  End do
if(nonzerocoupling) then 
 funcvalue= -1._dp*YfSSSS(p2,MAh2(i1),MHpm2(i2),MHpm2(i3),MAh2(i4),Qscale)
 tempcont=tempcont+tempcouplingmatrix*funcvalue
end if
end do
end do
...
coup1 = cplAhhhHpm(i1,gE1,i2)
coup2 = cplAhhhcHpm(i1,gE2,i3)
coup3 = cplhhhhHpmcHpm(i4,i4,i3,i2)
prefactor=Real(coup1*coup2*coup3,dp)
if(abs(prefactor) .gt. epscouplings) then
 tempcouplingmatrix(gE1,gE2)=prefactor
 nonzerocoupling=.true.
...
coup1 = cplAhhhHpm(i1,gE1,i2)
coup2 = cplAhhhcHpm(i1,gE2,i3)
coup3 = cplHpmHpmcHpmcHpm(i3,i4,i2,i4)
prefactor=Real(coup1*coup2*coup3,dp)
if(abs(prefactor) .gt. epscouplings) then
 tempcouplingmatrix(gE1,gE2)=prefactor
 nonzerocoupling=.true.
 ...
 tempcouplingmatrix(gE1,gE2)= 0._dp
  ...
  End do
if(nonzerocoupling) then 
 funcvalue= -2._dp*YfSSSS(p2,MAh2(i1),MHpm2(i2),MHpm2(i3),MHpm2(i4),Qscale)
 tempcont=tempcont+tempcouplingmatrix*funcvalue
end if
end do
end do
...
nonzerocoupling=.false.
  Do gE1=1,4
   Do gE2=1,4
coup1 = cplhhhhhh(gE1,i1,i2)
coup2 = cplhhhhHpm(gE2,i1,i3)
coup3 = cplAhAhhhcHpm(i4,i4,i2,i3)
prefactor=Real(coup1*coup2*coup3,dp)
if(abs(prefactor) .gt. epscouplings) then
 tempcouplingmatrix(gE1,gE2)=prefactor
 nonzerocoupling=.true.
...
coup1 = cplhhhhhh(gE1,i1,i2)
coup2 = cplhhhhHpm(gE2,i1,i3)
coup3 = cplhhhhhhcHpm(i2,i4,i4,i3)
prefactor=Real(coup1*coup2*coup3,dp)
if(abs(prefactor) .gt. epscouplings) then
 tempcouplingmatrix(gE1,gE2)=prefactor
 nonzerocoupling=.true.
...
coup1 = cplhhhhhh(gE1,i1,i2)
coup2 = cplhhhhHpm(gE2,i1,i3)
coup3 = cplhhHpmcHpmcHpm(i2,i4,i3,i4)
prefactor=Real(coup1*coup2*coup3,dp)
if(abs(prefactor) .gt. epscouplings) then
 tempcouplingmatrix(gE1,gE2)=prefactor
 nonzerocoupling=.true.
...
if(abs(prefactor) .gt. epscouplings) then
 ...
 tempcouplingmatrix(gE1,gE2)= 0._dp
  ...
  End do
if(nonzerocoupling) then 
 funcvalue= -1._dp*YfSSSS(p2,MHpm2(i1),MAh2(i2),MAh2(i3),MAh2(i4),Qscale)
 tempcont=tempcont+tempcouplingmatrix*funcvalue
end if
end do
end do
...
if(abs(prefactor) .gt. epscouplings) then
 ...
 tempcouplingmatrix(gE1,gE2)= 0._dp
  ...
  End do
if(nonzerocoupling) then 
 funcvalue= -2._dp*YfSSSS(p2,MHpm2(i1),MAh2(i2),MAh2(i3),MHpm2(i4),Qscale)
 tempcont=tempcont+tempcouplingmatrix*funcvalue
end if
end do
end do
...
nonzerocoupling=.false.
  Do gE1=1,4
   Do gE2=1,4
coup1 = cplAhhhHpm(i2,gE1,i1)
coup2 = cplhhhhcHpm(gE2,i3,i1)
coup3 = cplAhhhHpmcHpm(i2,i3,i4,i4)
prefactor=Real(coup1*coup2*coup3,dp)
if(abs(prefactor) .gt. epscouplings) then
 tempcouplingmatrix(gE1,gE2)=prefactor
 nonzerocoupling=.true.
...
if(abs(prefactor) .gt. epscouplings) then
 ...
 tempcouplingmatrix(gE1,gE2)= 0._dp
  ...
  End do
if(nonzerocoupling) then 
 funcvalue= -2._dp*YfSSSS(p2,MHpm2(i1),MAh2(i2),MHpm2(i3),MAh2(i4),Qscale)
 tempcont=tempcont+tempcouplingmatrix*funcvalue
end if
end do
end do
...
if(abs(prefactor) .gt. epscouplings) then
 ...
 tempcouplingmatrix(gE1,gE2)= 0._dp
  ...
  End do
if(nonzerocoupling) then 
 funcvalue= -4._dp*YfSSSS(p2,MHpm2(i1),MAh2(i2),MHpm2(i3),MHpm2(i4),Qscale)
 tempcont=tempcont+tempcouplingmatrix*funcvalue
end if
end do
end do
...
coup1 = cplhhHpmcHpm(gE1,i1,i2)
coup2 = cplAhhhcHpm(i3,gE2,i1)
coup3 = cplAhAhAhHpm(i3,i4,i4,i2)
prefactor=Real(coup1*coup2*coup3,dp)
if(abs(prefactor) .gt. epscouplings) then
 tempcouplingmatrix(gE1,gE2)=prefactor
 nonzerocoupling=.true.
 ...
 tempcouplingmatrix(gE1,gE2)= 0._dp
  ...
  End do
if(nonzerocoupling) then 
 funcvalue= -2._dp*YfSSSS(p2,MHpm2(i1),MHpm2(i2),MAh2(i3),MAh2(i4),Qscale)
 tempcont=tempcont+tempcouplingmatrix*funcvalue
end if
end do
end do
...
coup1 = cplhhHpmcHpm(gE1,i1,i2)
coup2 = cplAhhhcHpm(i3,gE2,i1)
coup3 = cplAhhhhhHpm(i3,i4,i4,i2)
prefactor=Real(coup1*coup2*coup3,dp)
if(abs(prefactor) .gt. epscouplings) then
 tempcouplingmatrix(gE1,gE2)=prefactor
 nonzerocoupling=.true.
...
coup1 = cplhhHpmcHpm(gE1,i1,i2)
coup2 = cplAhhhcHpm(i3,gE2,i1)
coup3 = cplAhHpmHpmcHpm(i3,i2,i4,i4)
prefactor=Real(coup1*coup2*coup3,dp)
if(abs(prefactor) .gt. epscouplings) then
 tempcouplingmatrix(gE1,gE2)=prefactor
 nonzerocoupling=.true.
 ...
 tempcouplingmatrix(gE1,gE2)= 0._dp
  ...
  End do
if(nonzerocoupling) then 
 funcvalue= -4._dp*YfSSSS(p2,MHpm2(i1),MHpm2(i2),MAh2(i3),MHpm2(i4),Qscale)
 tempcont=tempcont+tempcouplingmatrix*funcvalue
end if
end do
end do
...
coup1 = cplhhHpmcHpm(gE1,i1,i2)
coup2 = cplhhhhcHpm(gE2,i3,i1)
coup3 = cplAhAhhhHpm(i4,i4,i3,i2)
prefactor=Real(coup1*coup2*coup3,dp)
if(abs(prefactor) .gt. epscouplings) then
 tempcouplingmatrix(gE1,gE2)=prefactor
 nonzerocoupling=.true.
...
coup1 = cplhhHpmcHpm(gE1,i1,i2)
coup2 = cplhhhhcHpm(gE2,i3,i1)
coup3 = cplhhhhhhHpm(i3,i4,i4,i2)
prefactor=Real(coup1*coup2*coup3,dp)
if(abs(prefactor) .gt. epscouplings) then
 tempcouplingmatrix(gE1,gE2)=prefactor
 nonzerocoupling=.true.
...
coup1 = cplhhHpmcHpm(gE1,i1,i2)
coup2 = cplhhhhcHpm(gE2,i3,i1)
coup3 = cplhhHpmHpmcHpm(i3,i2,i4,i4)
prefactor=Real(coup1*coup2*coup3,dp)
if(abs(prefactor) .gt. epscouplings) then
 tempcouplingmatrix(gE1,gE2)=prefactor
 nonzerocoupling=.true.
...
nonzerocoupling=.false.
  Do gE1=1,4
   Do gE2=1,4
coup1 = cplAhAhhh(i1,i2,gE1)
coup2 = cplAhhhHpm(i3,gE2,i4)
coup3 = cplAhAhAhcHpm(i1,i2,i3,i4)
prefactor=Real(coup1*coup2*coup3,dp)
if(abs(prefactor) .gt. epscouplings) then
 tempcouplingmatrix(gE1,gE2)=prefactor
 nonzerocoupling=.true.
 ...
 tempcouplingmatrix(gE1,gE2)= 0._dp
  ...
  End do
if(nonzerocoupling) then 
 funcvalue= -2._dp*ZfSSSS(p2,MAh2(i1),MAh2(i2),MAh2(i3),MHpm2(i4),Qscale)
 tempcont=tempcont+tempcouplingmatrix*funcvalue
end if
end do
end do
...
nonzerocoupling=.false.
  Do gE1=1,4
   Do gE2=1,4
coup1 = cplAhAhhh(i1,i2,gE1)
coup2 = cplhhhhHpm(gE2,i3,i4)
coup3 = cplAhAhhhcHpm(i1,i2,i3,i4)
prefactor=Real(coup1*coup2*coup3,dp)
if(abs(prefactor) .gt. epscouplings) then
 tempcouplingmatrix(gE1,gE2)=prefactor
 nonzerocoupling=.true.
...
nonzerocoupling=.false.
  Do gE1=1,4
   Do gE2=1,4
coup1 = cplAhhhHpm(i1,gE1,i2)
coup2 = cplAhhhcHpm(i3,gE2,i4)
coup3 = cplAhAhHpmcHpm(i1,i3,i4,i2)
prefactor=Real(coup1*coup2*coup3,dp)
if(abs(prefactor) .gt. epscouplings) then
 tempcouplingmatrix(gE1,gE2)=prefactor
 nonzerocoupling=.true.
 ...
 tempcouplingmatrix(gE1,gE2)= 0._dp
  ...
  End do
if(nonzerocoupling) then 
 funcvalue= -4._dp*ZfSSSS(p2,MAh2(i1),MHpm2(i2),MAh2(i3),MHpm2(i4),Qscale)
 tempcont=tempcont+tempcouplingmatrix*funcvalue
end if
end do
end do
...
coup1 = cplAhhhHpm(i1,gE1,i2)
coup2 = cplhhhhhh(gE2,i3,i4)
coup3 = cplAhhhhhcHpm(i1,i3,i4,i2)
prefactor=Real(coup1*coup2*coup3,dp)
if(abs(prefactor) .gt. epscouplings) then
 tempcouplingmatrix(gE1,gE2)=prefactor
 nonzerocoupling=.true.
...
nonzerocoupling=.false.
  Do gE1=1,4
   Do gE2=1,4
coup1 = cplAhhhHpm(i1,gE1,i2)
coup2 = cplhhhhcHpm(gE2,i3,i4)
coup3 = cplAhhhHpmcHpm(i1,i3,i4,i2)
prefactor=Real(coup1*coup2*coup3,dp)
if(abs(prefactor) .gt. epscouplings) then
 tempcouplingmatrix(gE1,gE2)=prefactor
 nonzerocoupling=.true.
...
coup1 = cplAhhhHpm(i1,gE1,i2)
coup2 = cplhhHpmcHpm(gE2,i3,i4)
coup3 = cplAhHpmcHpmcHpm(i1,i4,i2,i3)
prefactor=Real(coup1*coup2*coup3,dp)
if(abs(prefactor) .gt. epscouplings) then
 tempcouplingmatrix(gE1,gE2)=prefactor
 nonzerocoupling=.true.
 ...
 tempcouplingmatrix(gE1,gE2)= 0._dp
  ...
  End do
if(nonzerocoupling) then 
 funcvalue= -4._dp*ZfSSSS(p2,MAh2(i1),MHpm2(i2),MHpm2(i3),MHpm2(i4),Qscale)
 tempcont=tempcont+tempcouplingmatrix*funcvalue
end if
end do
end do
...
coup1 = cplhhhhhh(gE1,i1,i2)
coup2 = cplhhhhHpm(gE2,i3,i4)
coup3 = cplhhhhhhcHpm(i1,i2,i3,i4)
prefactor=Real(coup1*coup2*coup3,dp)
if(abs(prefactor) .gt. epscouplings) then
 tempcouplingmatrix(gE1,gE2)=prefactor
 nonzerocoupling=.true.
...
nonzerocoupling=.false.
  Do gE1=1,4
   Do gE2=1,4
coup1 = cplhhhhhh(gE1,i1,i2)
coup2 = cplAhhhHpm(i4,gE2,i3)
coup3 = cplAhhhhhcHpm(i4,i1,i2,i3)
prefactor=Real(coup1*coup2*coup3,dp)
if(abs(prefactor) .gt. epscouplings) then
 tempcouplingmatrix(gE1,gE2)=prefactor
 nonzerocoupling=.true.
...
coup1 = cplhhhhHpm(gE1,i1,i2)
coup2 = cplhhhhcHpm(gE2,i3,i4)
coup3 = cplhhhhHpmcHpm(i1,i3,i4,i2)
prefactor=Real(coup1*coup2*coup3,dp)
if(abs(prefactor) .gt. epscouplings) then
 tempcouplingmatrix(gE1,gE2)=prefactor
 nonzerocoupling=.true.
...
coup1 = cplhhhhHpm(gE1,i1,i2)
coup2 = cplhhHpmcHpm(gE2,i3,i4)
coup3 = cplhhHpmcHpmcHpm(i1,i4,i2,i3)
prefactor=Real(coup1*coup2*coup3,dp)
if(abs(prefactor) .gt. epscouplings) then
 tempcouplingmatrix(gE1,gE2)=prefactor
 nonzerocoupling=.true.
...
nonzerocoupling=.false.
  Do gE1=1,4
   Do gE2=1,4
coup1 = cplhhhhHpm(gE1,i1,i2)
coup2 = cplAhhhcHpm(i4,gE2,i3)
coup3 = cplAhhhHpmcHpm(i4,i1,i3,i2)
prefactor=Real(coup1*coup2*coup3,dp)
if(abs(prefactor) .gt. epscouplings) then
 tempcouplingmatrix(gE1,gE2)=prefactor
 nonzerocoupling=.true.
...
nonzerocoupling=.false.
  Do gE1=1,4
   Do gE2=1,4
coup1 = cplAhAhhhHpm(i1,i2,gE1,i3)
coup2 = cplAhAhhhcHpm(i1,i2,gE2,i3)
prefactor=Real(coup1*coup2,dp)
if(abs(prefactor) .gt. epscouplings) then
 tempcouplingmatrix(gE1,gE2)=prefactor
 nonzerocoupling=.true.
 ...
 tempcouplingmatrix(gE1,gE2)= 0._dp
  ...
  End do
if(nonzerocoupling) then 
 funcvalue= 1._dp*SfSSS(p2,MAh2(i1),MAh2(i2),MHpm2(i3),Qscale)
 tempcont=tempcont+tempcouplingmatrix*funcvalue
end if
end do
end do
...
nonzerocoupling=.false.
  Do gE1=1,4
   Do gE2=1,4
coup1 = cplAhhhhhHpm(i1,gE1,i2,i3)
coup2 = cplAhhhhhcHpm(i1,gE2,i2,i3)
prefactor=Real(coup1*coup2,dp)
if(abs(prefactor) .gt. epscouplings) then
 tempcouplingmatrix(gE1,gE2)=prefactor
 nonzerocoupling=.true.
...
nonzerocoupling=.false.
  Do gE1=1,4
   Do gE2=1,4
coup1 = cplhhhhhhHpm(gE1,i1,i2,i3)
coup2 = cplhhhhhhcHpm(gE2,i1,i2,i3)
prefactor=Real(coup1*coup2,dp)
if(abs(prefactor) .gt. epscouplings) then
 tempcouplingmatrix(gE1,gE2)=prefactor
 nonzerocoupling=.true.
...
nonzerocoupling=.false.
  Do gE1=1,4
   Do gE2=1,4
coup1 = cplhhHpmHpmcHpm(gE1,i1,i2,i3)
coup2 = cplhhHpmcHpmcHpm(gE2,i3,i1,i2)
prefactor=Real(coup1*coup2,dp)
if(abs(prefactor) .gt. epscouplings) then
 tempcouplingmatrix(gE1,gE2)=prefactor
 nonzerocoupling=.true.
 ...
 tempcouplingmatrix(gE1,gE2)= 0._dp
  ...
  End do
if(nonzerocoupling) then 
 funcvalue= 1._dp/3._dp*SfSSS(p2,MHpm2(i1),MHpm2(i2),MHpm2(i3),Qscale)
 tempcont=tempcont+tempcouplingmatrix*funcvalue
end if
end do
end do
...
nonzerocoupling=.false.
  Do gE1=1,4
   Do gE2=1,4
coup1 = cplAhAhhh(i1,i2,gE1)
coup2 = cplAhAhhhHpm(i1,i3,gE2,i4)
coup3 = cplAhAhcHpm(i2,i3,i4)
prefactor=Real(coup1*coup2*coup3,dp)
if(abs(prefactor) .gt. epscouplings) then
 tempcouplingmatrix(gE1,gE2)=prefactor
 ...
 tempcouplingmatrix(gE1,gE2)= 0._dp
  ...
  End do
if(nonzerocoupling) then 
 funcvalue= -4._dp*UfSSSS(p2,MAh2(i1),MAh2(i2),MAh2(i3),MHpm2(i4),Qscale)
 tempcont=tempcont+tempcouplingmatrix*funcvalue
end if
end do
end do
...
nonzerocoupling=.false.
  Do gE1=1,4
   Do gE2=1,4
coup1 = cplAhAhhh(i1,i2,gE1)
coup2 = cplAhhhhhHpm(i1,gE2,i3,i4)
coup3 = cplAhhhcHpm(i2,i3,i4)
prefactor=Real(coup1*coup2*coup3,dp)
if(abs(prefactor) .gt. epscouplings) then
 tempcouplingmatrix(gE1,gE2)=prefactor
...
nonzerocoupling=.false.
  Do gE1=1,4
   Do gE2=1,4
coup1 = cplAhhhHpm(i1,gE1,i2)
coup2 = cplAhAhhhcHpm(i1,i3,gE2,i4)
coup3 = cplAhHpmcHpm(i3,i4,i2)
prefactor=Real(coup1*coup2*coup3,dp)
if(abs(prefactor) .gt. epscouplings) then
 tempcouplingmatrix(gE1,gE2)=prefactor
 ...
 tempcouplingmatrix(gE1,gE2)= 0._dp
  ...
  End do
if(nonzerocoupling) then 
 funcvalue= -4._dp*UfSSSS(p2,MAh2(i1),MHpm2(i2),MAh2(i3),MHpm2(i4),Qscale)
 tempcont=tempcont+tempcouplingmatrix*funcvalue
end if
end do
end do
...
nonzerocoupling=.false.
  Do gE1=1,4
   Do gE2=1,4
coup1 = cplAhhhHpm(i1,gE1,i2)
coup2 = cplAhhhhhcHpm(i1,gE2,i3,i4)
coup3 = cplhhHpmcHpm(i3,i4,i2)
prefactor=Real(coup1*coup2*coup3,dp)
if(abs(prefactor) .gt. epscouplings) then
 tempcouplingmatrix(gE1,gE2)=prefactor
...
if(abs(prefactor) .gt. epscouplings) then
 ...
 tempcouplingmatrix(gE1,gE2)= 0._dp
  ...
  End do
if(nonzerocoupling) then 
 funcvalue= -2._dp*UfSSSS(p2,MAh2(i1),MHpm2(i2),MHpm2(i3),MHpm2(i4),Qscale)
 tempcont=tempcont+tempcouplingmatrix*funcvalue
end if
end do
end do
...
nonzerocoupling=.false.
  Do gE1=1,4
   Do gE2=1,4
coup1 = cplhhhhhh(gE1,i1,i2)
coup2 = cplAhhhhhHpm(i3,gE2,i1,i4)
coup3 = cplAhhhcHpm(i3,i2,i4)
prefactor=Real(coup1*coup2*coup3,dp)
if(abs(prefactor) .gt. epscouplings) then
 tempcouplingmatrix(gE1,gE2)=prefactor
...
nonzerocoupling=.false.
  Do gE1=1,4
   Do gE2=1,4
coup1 = cplhhhhhh(gE1,i1,i2)
coup2 = cplhhhhhhHpm(gE2,i1,i3,i4)
coup3 = cplhhhhcHpm(i2,i3,i4)
prefactor=Real(coup1*coup2*coup3,dp)
if(abs(prefactor) .gt. epscouplings) then
 tempcouplingmatrix(gE1,gE2)=prefactor
...
nonzerocoupling=.false.
  Do gE1=1,4
   Do gE2=1,4
coup1 = cplhhhhHpm(gE1,i1,i2)
coup2 = cplAhhhhhcHpm(i3,gE2,i1,i4)
coup3 = cplAhHpmcHpm(i3,i4,i2)
prefactor=Real(coup1*coup2*coup3,dp)
if(abs(prefactor) .gt. epscouplings) then
 tempcouplingmatrix(gE1,gE2)=prefactor
...
nonzerocoupling=.false.
  Do gE1=1,4
   Do gE2=1,4
coup1 = cplhhhhHpm(gE1,i1,i2)
coup2 = cplhhhhhhcHpm(gE2,i1,i3,i4)
coup3 = cplhhHpmcHpm(i3,i4,i2)
prefactor=Real(coup1*coup2*coup3,dp)
if(abs(prefactor) .gt. epscouplings) then
 tempcouplingmatrix(gE1,gE2)=prefactor
...
nonzerocoupling=.false.
  Do gE1=1,4
   Do gE2=1,4
coup1 = cplAhhhHpm(i2,gE1,i1)
coup2 = cplAhhhhhcHpm(i3,gE2,i4,i1)
coup3 = cplAhAhhh(i2,i3,i4)
prefactor=Real(coup1*coup2*coup3,dp)
if(abs(prefactor) .gt. epscouplings) then
 tempcouplingmatrix(gE1,gE2)=prefactor
...
if(abs(prefactor) .gt. epscouplings) then
 ...
 tempcouplingmatrix(gE1,gE2)= 0._dp
  ...
  End do
if(nonzerocoupling) then 
 funcvalue= -4._dp*UfSSSS(p2,MHpm2(i1),MAh2(i2),MAh2(i3),MHpm2(i4),Qscale)
 tempcont=tempcont+tempcouplingmatrix*funcvalue
end if
end do
end do
...
nonzerocoupling=.false.
  Do gE1=1,4
   Do gE2=1,4
coup1 = cplAhhhHpm(i2,gE1,i1)
coup2 = cplhhHpmcHpmcHpm(gE2,i3,i1,i4)
coup3 = cplAhHpmcHpm(i2,i4,i3)
prefactor=Real(coup1*coup2*coup3,dp)
if(abs(prefactor) .gt. epscouplings) then
 tempcouplingmatrix(gE1,gE2)=prefactor
 ...
 tempcouplingmatrix(gE1,gE2)= 0._dp
  ...
  End do
if(nonzerocoupling) then 
 funcvalue= -2._dp*UfSSSS(p2,MHpm2(i1),MAh2(i2),MHpm2(i3),MHpm2(i4),Qscale)
 tempcont=tempcont+tempcouplingmatrix*funcvalue
end if
end do
end do
...
nonzerocoupling=.false.
  Do gE1=1,4
   Do gE2=1,4
coup1 = cplhhhhHpm(gE1,i2,i1)
coup2 = cplAhAhhhcHpm(i3,i4,gE2,i1)
coup3 = cplAhAhhh(i3,i4,i2)
prefactor=Real(coup1*coup2*coup3,dp)
if(abs(prefactor) .gt. epscouplings) then
 tempcouplingmatrix(gE1,gE2)=prefactor
...
nonzerocoupling=.false.
  Do gE1=1,4
   Do gE2=1,4
coup1 = cplhhhhHpm(gE1,i2,i1)
coup2 = cplhhhhhhcHpm(gE2,i3,i4,i1)
coup3 = cplhhhhhh(i2,i3,i4)
prefactor=Real(coup1*coup2*coup3,dp)
if(abs(prefactor) .gt. epscouplings) then
 tempcouplingmatrix(gE1,gE2)=prefactor
...
if(abs(prefactor) .gt. epscouplings) then
 ...
 tempcouplingmatrix(gE1,gE2)= 0._dp
  ...
  End do
if(nonzerocoupling) then 
 funcvalue= -2._dp*UfSSSS(p2,MHpm2(i1),MHpm2(i2),MAh2(i3),MAh2(i4),Qscale)
 tempcont=tempcont+tempcouplingmatrix*funcvalue
end if
end do
end do
...
nonzerocoupling=.false.
  Do gE1=1,4
   Do gE2=1,4
coup1 = cplhhHpmcHpm(gE1,i1,i2)
coup2 = cplhhHpmHpmcHpm(gE2,i3,i4,i1)
coup3 = cplHpmcHpmcHpm(i2,i3,i4)
prefactor=Real(coup1*coup2*coup3,dp)
if(abs(prefactor) .gt. epscouplings) then
 tempcouplingmatrix(gE1,gE2)=prefactor
 ...
 tempcouplingmatrix(gE1,gE2)= 0._dp
  ...
  End do
if(nonzerocoupling) then 
 funcvalue= -2._dp*UfSSSS(p2,MHpm2(i1),MHpm2(i2),MHpm2(i3),MHpm2(i4),Qscale)
 tempcont=tempcont+tempcouplingmatrix*funcvalue
end if
end do
end do
...
coup1 = cplAhAhhh(i1,i2,gE1)
coup2 = cplAhAhhh(i1,i3,gE2)
coup3 = cplAhAhHpm(i2,i4,i5)
coup4 = cplAhAhcHpm(i3,i4,i5)
prefactor=Real(coup1*coup2*coup3*coup4,dp)
if(abs(prefactor) .gt. epscouplings) then
 tempcouplingmatrix(gE1,gE2)=prefactor
 nonzerocoupling=.true.
 ...
 tempcouplingmatrix(gE1,gE2)= 0._dp
  ...
  End do
if(nonzerocoupling) then 
 funcvalue= 2._dp*VfSSSSS(p2,MAh2(i1),MAh2(i2),MAh2(i3),MAh2(i4),MHpm2(i5),Qscale)
 tempcont=tempcont+tempcouplingmatrix*funcvalue
end if
end do
end do
...
coup1 = cplAhAhhh(i1,i2,gE1)
coup2 = cplAhAhhh(i1,i3,gE2)
coup3 = cplAhhhHpm(i2,i4,i5)
coup4 = cplAhhhcHpm(i3,i4,i5)
prefactor=Real(coup1*coup2*coup3*coup4,dp)
if(abs(prefactor) .gt. epscouplings) then
 tempcouplingmatrix(gE1,gE2)=prefactor
 nonzerocoupling=.true.
...
if(abs(prefactor) .gt. epscouplings) then
 ...
 tempcouplingmatrix(gE1,gE2)= 0._dp
  ...
  End do
if(nonzerocoupling) then 
 funcvalue= 4._dp*VfSSSSS(p2,MAh2(i1),MAh2(i2),MHpm2(i3),MAh2(i4),MHpm2(i5),Qscale)
 tempcont=tempcont+tempcouplingmatrix*funcvalue
end if
end do
end do
...
if(abs(prefactor) .gt. epscouplings) then
 ...
 tempcouplingmatrix(gE1,gE2)= 0._dp
  ...
  End do
if(nonzerocoupling) then 
 funcvalue= 2._dp*VfSSSSS(p2,MAh2(i1),MAh2(i2),MHpm2(i3),MHpm2(i4),MHpm2(i5),Qscale)
 tempcont=tempcont+tempcouplingmatrix*funcvalue
end if
end do
end do
...
if(abs(prefactor) .gt. epscouplings) then
 ...
 tempcouplingmatrix(gE1,gE2)= 0._dp
  ...
  End do
if(nonzerocoupling) then 
 funcvalue= 4._dp*VfSSSSS(p2,MAh2(i1),MHpm2(i2),MAh2(i3),MAh2(i4),MHpm2(i5),Qscale)
 tempcont=tempcont+tempcouplingmatrix*funcvalue
end if
end do
end do
...
coup1 = cplAhhhHpm(i1,gE1,i2)
coup2 = cplAhhhHpm(i1,gE2,i3)
coup3 = cplAhAhcHpm(i4,i5,i2)
coup4 = cplAhAhcHpm(i4,i5,i3)
prefactor=Real(coup1*coup2*coup3*coup4,dp)
if(abs(prefactor) .gt. epscouplings) then
 tempcouplingmatrix(gE1,gE2)=prefactor
 nonzerocoupling=.true.
 ...
 tempcouplingmatrix(gE1,gE2)= 0._dp
  ...
  End do
if(nonzerocoupling) then 
 funcvalue= 1._dp*VfSSSSS(p2,MAh2(i1),MHpm2(i2),MHpm2(i3),MAh2(i4),MAh2(i5),Qscale)
 tempcont=tempcont+tempcouplingmatrix*funcvalue
end if
end do
end do
...
coup1 = cplAhhhHpm(i1,gE1,i2)
coup2 = cplAhhhHpm(i1,gE2,i3)
coup3 = cplhhhhcHpm(i4,i5,i2)
coup4 = cplhhhhcHpm(i4,i5,i3)
prefactor=Real(coup1*coup2*coup3*coup4,dp)
if(abs(prefactor) .gt. epscouplings) then
 tempcouplingmatrix(gE1,gE2)=prefactor
 nonzerocoupling=.true.
...
if(abs(prefactor) .gt. epscouplings) then
 ...
 tempcouplingmatrix(gE1,gE2)= 0._dp
  ...
  End do
if(nonzerocoupling) then 
 funcvalue= 1._dp*VfSSSSS(p2,MAh2(i1),MHpm2(i2),MHpm2(i3),MHpm2(i4),MHpm2(i5),Qscale)
 tempcont=tempcont+tempcouplingmatrix*funcvalue
end if
end do
end do
...
if(abs(prefactor) .gt. epscouplings) then
 ...
 tempcouplingmatrix(gE1,gE2)= 0._dp
  ...
  End do
if(nonzerocoupling) then 
 funcvalue= 2._dp*VfSSSSS(p2,MAh2(i1),MHpm2(i2),MHpm2(i3),MAh2(i4),MHpm2(i5),Qscale)
 tempcont=tempcont+tempcouplingmatrix*funcvalue
end if
end do
end do
...
coup1 = cplAhhhHpm(i1,gE1,i2)
coup2 = cplAhhhcHpm(i1,gE2,i3)
coup3 = cplHpmHpmcHpm(i4,i5,i2)
coup4 = cplHpmcHpmcHpm(i3,i4,i5)
prefactor=Real(coup1*coup2*coup3*coup4,dp)
if(abs(prefactor) .gt. epscouplings) then
 tempcouplingmatrix(gE1,gE2)=prefactor
 nonzerocoupling=.true.
...
coup1 = cplhhhhhh(gE1,i1,i2)
coup2 = cplhhhhhh(gE2,i1,i3)
coup3 = cplAhhhHpm(i4,i2,i5)
coup4 = cplAhhhcHpm(i4,i3,i5)
prefactor=Real(coup1*coup2*coup3*coup4,dp)
if(abs(prefactor) .gt. epscouplings) then
 tempcouplingmatrix(gE1,gE2)=prefactor
 nonzerocoupling=.true.
...
coup1 = cplhhhhhh(gE1,i1,i2)
coup2 = cplhhhhhh(gE2,i1,i3)
coup3 = cplhhhhHpm(i2,i4,i5)
coup4 = cplhhhhcHpm(i3,i4,i5)
prefactor=Real(coup1*coup2*coup3*coup4,dp)
if(abs(prefactor) .gt. epscouplings) then
 tempcouplingmatrix(gE1,gE2)=prefactor
 nonzerocoupling=.true.
...
if(abs(prefactor) .gt. epscouplings) then
 ...
 tempcouplingmatrix(gE1,gE2)= 0._dp
  ...
  End do
if(nonzerocoupling) then 
 funcvalue= 2._dp*VfSSSSS(p2,MHpm2(i1),MAh2(i2),MAh2(i3),MAh2(i4),MHpm2(i5),Qscale)
 tempcont=tempcont+tempcouplingmatrix*funcvalue
end if
end do
end do
...
if(abs(prefactor) .gt. epscouplings) then
 ...
 tempcouplingmatrix(gE1,gE2)= 0._dp
  ...
  End do
if(nonzerocoupling) then 
 funcvalue= 1._dp*VfSSSSS(p2,MHpm2(i1),MAh2(i2),MAh2(i3),MHpm2(i4),MHpm2(i5),Qscale)
 tempcont=tempcont+tempcouplingmatrix*funcvalue
end if
end do
end do
...
if(abs(prefactor) .gt. epscouplings) then
 ...
 tempcouplingmatrix(gE1,gE2)= 0._dp
  ...
  End do
if(nonzerocoupling) then 
 funcvalue= 4._dp*VfSSSSS(p2,MHpm2(i1),MAh2(i2),MHpm2(i3),MAh2(i4),MHpm2(i5),Qscale)
 tempcont=tempcont+tempcouplingmatrix*funcvalue
end if
end do
end do
...
if(abs(prefactor) .gt. epscouplings) then
 ...
 tempcouplingmatrix(gE1,gE2)= 0._dp
  ...
  End do
if(nonzerocoupling) then 
 funcvalue= 2._dp*VfSSSSS(p2,MHpm2(i1),MAh2(i2),MHpm2(i3),MHpm2(i4),MHpm2(i5),Qscale)
 tempcont=tempcont+tempcouplingmatrix*funcvalue
end if
end do
end do
...
if(abs(prefactor) .gt. epscouplings) then
 ...
 tempcouplingmatrix(gE1,gE2)= 0._dp
  ...
  End do
if(nonzerocoupling) then 
 funcvalue= 4._dp*VfSSSSS(p2,MHpm2(i1),MHpm2(i2),MAh2(i3),MAh2(i4),MHpm2(i5),Qscale)
 tempcont=tempcont+tempcouplingmatrix*funcvalue
end if
end do
end do
...
if(abs(prefactor) .gt. epscouplings) then
 ...
 tempcouplingmatrix(gE1,gE2)= 0._dp
  ...
  End do
if(nonzerocoupling) then 
 funcvalue= 2._dp*VfSSSSS(p2,MHpm2(i1),MHpm2(i2),MAh2(i3),MHpm2(i4),MHpm2(i5),Qscale)
 tempcont=tempcont+tempcouplingmatrix*funcvalue
end if
end do
end do
...
if(abs(prefactor) .gt. epscouplings) then
 ...
 tempcouplingmatrix(gE1,gE2)= 0._dp
  ...
  End do
if(nonzerocoupling) then 
 funcvalue= 1._dp*VfSSSSS(p2,MHpm2(i1),MHpm2(i2),MHpm2(i3),MAh2(i4),MAh2(i5),Qscale)
 tempcont=tempcont+tempcouplingmatrix*funcvalue
end if
end do
end do
...
if(abs(prefactor) .gt. epscouplings) then
 ...
 tempcouplingmatrix(gE1,gE2)= 0._dp
  ...
  End do
if(nonzerocoupling) then 
 funcvalue= 1._dp*VfSSSSS(p2,MHpm2(i1),MHpm2(i2),MHpm2(i3),MHpm2(i4),MHpm2(i5),Qscale)
 tempcont=tempcont+tempcouplingmatrix*funcvalue
end if
end do
end do
...
! ---- Hpm,conj[Hpm],Hpm,conj[Hpm],conj[Hpm] ----
Do i1=1,4
Do i2=1,4
Do i3=1,4
Do i4=1,4
...
coup1 = cplhhHpmcHpm(gE1,i1,i2)
coup2 = cplhhHpmcHpm(gE2,i3,i1)
coup3 = cplHpmcHpmcHpm(i2,i4,i5)
coup4 = cplHpmHpmcHpm(i4,i5,i3)
prefactor=Real(coup1*coup2*coup3*coup4,dp)
if(abs(prefactor) .gt. epscouplings) then
 tempcouplingmatrix(gE1,gE2)=prefactor
 nonzerocoupling=.true.
...
if(abs(prefactor) .gt. epscouplings) then
 ...
 tempcouplingmatrix(gE1,gE2)= 0._dp
  ...
  End do
if(nonzerocoupling) then 
 funcvalue= 1._dp*MfSSSSS(p2,MAh2(i1),MAh2(i2),MAh2(i3),MAh2(i4),MHpm2(i5),Qscale)
 tempcont=tempcont+tempcouplingmatrix*funcvalue
end if
end do
end do
...
nonzerocoupling=.false.
  Do gE1=1,4
   Do gE2=1,4
coup1 = cplAhAhhh(i1,i3,gE1)
coup2 = cplAhhhHpm(i2,gE2,i4)
coup3 = cplAhAhhh(i1,i2,i5)
coup4 = cplAhhhcHpm(i3,i5,i4)
prefactor=Real(coup1*coup2*coup3*coup4,dp)
if(abs(prefactor) .gt. epscouplings) then
 tempcouplingmatrix(gE1,gE2)=prefactor
 nonzerocoupling=.true.
...
if(abs(prefactor) .gt. epscouplings) then
 ...
 tempcouplingmatrix(gE1,gE2)= 0._dp
  ...
  End do
if(nonzerocoupling) then 
 funcvalue= 4._dp*MfSSSSS(p2,MAh2(i1),MAh2(i2),MAh2(i3),MHpm2(i4),MHpm2(i5),Qscale)
 tempcont=tempcont+tempcouplingmatrix*funcvalue
end if
end do
end do
...
nonzerocoupling=.false.
  Do gE1=1,4
   Do gE2=1,4
coup1 = cplAhAhhh(i1,i3,gE1)
coup2 = cplhhhhHpm(gE2,i2,i4)
coup3 = cplAhAhhh(i1,i5,i2)
coup4 = cplAhAhcHpm(i3,i5,i4)
prefactor=Real(coup1*coup2*coup3*coup4,dp)
if(abs(prefactor) .gt. epscouplings) then
 tempcouplingmatrix(gE1,gE2)=prefactor
 nonzerocoupling=.true.
...
coup3 = cplAhAhcHpm(i1,i5,i2)
coup4 = cplAhAhHpm(i3,i5,i4)
prefactor=Real(coup1*coup2*coup3*coup4,dp)
if(abs(prefactor) .gt. epscouplings) then
 tempcouplingmatrix(gE1,gE2)=prefactor
 nonzerocoupling=.true.
 ...
 tempcouplingmatrix(gE1,gE2)= 0._dp
  ...
  End do
if(nonzerocoupling) then 
 funcvalue= 2._dp*MfSSSSS(p2,MAh2(i1),MHpm2(i2),MAh2(i3),MHpm2(i4),MAh2(i5),Qscale)
 tempcont=tempcont+tempcouplingmatrix*funcvalue
end if
end do
end do
...
coup1 = cplAhAhhh(i1,i3,gE1)
coup2 = cplhhHpmcHpm(gE2,i2,i4)
coup3 = cplAhhhcHpm(i1,i5,i2)
coup4 = cplAhhhHpm(i3,i5,i4)
prefactor=Real(coup1*coup2*coup3*coup4,dp)
if(abs(prefactor) .gt. epscouplings) then
 tempcouplingmatrix(gE1,gE2)=prefactor
 nonzerocoupling=.true.
...
if(abs(prefactor) .gt. epscouplings) then
 ...
 tempcouplingmatrix(gE1,gE2)= 0._dp
  ...
  End do
if(nonzerocoupling) then 
 funcvalue= 2._dp*MfSSSSS(p2,MAh2(i1),MAh2(i2),MHpm2(i3),MHpm2(i4),MHpm2(i5),Qscale)
 tempcont=tempcont+tempcouplingmatrix*funcvalue
end if
end do
end do
...
nonzerocoupling=.false.
  Do gE1=1,4
   Do gE2=1,4
coup1 = cplAhhhHpm(i1,gE1,i3)
coup2 = cplAhhhcHpm(i2,gE2,i4)
coup3 = cplAhAhhh(i1,i2,i5)
coup4 = cplhhHpmcHpm(i5,i4,i3)
prefactor=Real(coup1*coup2*coup3*coup4,dp)
if(abs(prefactor) .gt. epscouplings) then
 tempcouplingmatrix(gE1,gE2)=prefactor
 nonzerocoupling=.true.
...
nonzerocoupling=.false.
  Do gE1=1,4
   Do gE2=1,4
coup1 = cplAhhhHpm(i1,gE1,i3)
coup2 = cplhhhhcHpm(gE2,i2,i4)
coup3 = cplAhAhhh(i1,i5,i2)
coup4 = cplAhHpmcHpm(i5,i4,i3)
prefactor=Real(coup1*coup2*coup3*coup4,dp)
if(abs(prefactor) .gt. epscouplings) then
 tempcouplingmatrix(gE1,gE2)=prefactor
 nonzerocoupling=.true.
...
if(abs(prefactor) .gt. epscouplings) then
 ...
 tempcouplingmatrix(gE1,gE2)= 0._dp
  ...
  End do
if(nonzerocoupling) then 
 funcvalue= 2._dp*MfSSSSS(p2,MAh2(i1),MHpm2(i2),MHpm2(i3),MAh2(i4),MAh2(i5),Qscale)
 tempcont=tempcont+tempcouplingmatrix*funcvalue
end if
end do
end do
...
if(abs(prefactor) .gt. epscouplings) then
 ...
 tempcouplingmatrix(gE1,gE2)= 0._dp
  ...
  End do
if(nonzerocoupling) then 
 funcvalue= 4._dp*MfSSSSS(p2,MAh2(i1),MHpm2(i2),MHpm2(i3),MHpm2(i4),MAh2(i5),Qscale)
 tempcont=tempcont+tempcouplingmatrix*funcvalue
end if
end do
end do
...
if(abs(prefactor) .gt. epscouplings) then
 ...
 tempcouplingmatrix(gE1,gE2)= 0._dp
  ...
  End do
if(nonzerocoupling) then 
 funcvalue= 4._dp*MfSSSSS(p2,MAh2(i1),MHpm2(i2),MHpm2(i3),MHpm2(i4),MHpm2(i5),Qscale)
 tempcont=tempcont+tempcouplingmatrix*funcvalue
end if
end do
end do
...
nonzerocoupling=.false.
  Do gE1=1,4
   Do gE2=1,4
coup1 = cplAhhhHpm(i1,gE1,i3)
coup2 = cplAhhhcHpm(i4,gE2,i2)
coup3 = cplAhAhHpm(i1,i5,i2)
coup4 = cplAhAhcHpm(i4,i5,i3)
prefactor=Real(coup1*coup2*coup3*coup4,dp)
if(abs(prefactor) .gt. epscouplings) then
 tempcouplingmatrix(gE1,gE2)=prefactor
...
if(abs(prefactor) .gt. epscouplings) then
 ...
 tempcouplingmatrix(gE1,gE2)= 0._dp
  ...
  End do
if(nonzerocoupling) then 
 funcvalue= 2._dp*MfSSSSS(p2,MAh2(i1),MHpm2(i2),MHpm2(i3),MAh2(i4),MHpm2(i5),Qscale)
 tempcont=tempcont+tempcouplingmatrix*funcvalue
end if
end do
end do
...
coup1 = cplhhhhhh(gE1,i1,i3)
coup2 = cplhhHpmcHpm(gE2,i2,i4)
coup3 = cplAhhhcHpm(i5,i1,i2)
coup4 = cplAhhhHpm(i5,i3,i4)
prefactor=Real(coup1*coup2*coup3*coup4,dp)
if(abs(prefactor) .gt. epscouplings) then
 tempcouplingmatrix(gE1,gE2)=prefactor
 nonzerocoupling=.true.
...
coup1 = cplhhhhhh(gE1,i1,i3)
coup2 = cplhhHpmcHpm(gE2,i2,i4)
coup3 = cplhhhhcHpm(i1,i5,i2)
coup4 = cplhhhhHpm(i3,i5,i4)
prefactor=Real(coup1*coup2*coup3*coup4,dp)
if(abs(prefactor) .gt. epscouplings) then
 tempcouplingmatrix(gE1,gE2)=prefactor
 nonzerocoupling=.true.
...
coup2 = cplhhHpmcHpm(gE2,i2,i4)
coup3 = cplHpmcHpmcHpm(i5,i1,i2)
coup4 = cplHpmHpmcHpm(i3,i4,i5)
prefactor=Real(coup1*coup2*coup3*coup4,dp)
if(abs(prefactor) .gt. epscouplings) then
 tempcouplingmatrix(gE1,gE2)=prefactor
 nonzerocoupling=.true.
 ...
 tempcouplingmatrix(gE1,gE2)= 0._dp
  ...
  End do
if(nonzerocoupling) then 
 funcvalue= 1._dp*MfSSSSS(p2,MHpm2(i1),MHpm2(i2),MHpm2(i3),MHpm2(i4),MHpm2(i5),Qscale)
 tempcont=tempcont+tempcouplingmatrix*funcvalue
end if
end do
end do
...
if(abs(prefactor) .gt. epscouplings) then
 ...
 tempcouplingmatrix(gE1,gE2)= 0._dp
  ...
  End do
if(nonzerocoupling) then 
 funcvalue= -3._dp*MFu(i3)*MFd(i4)*WfSSFbFb(p2,MHpm2(i1),MHpm2(i2),MFu2(i3),MFd2(i4),Qscale)
 tempcont=tempcont+tempcouplingmatrix*funcvalue
end if
end if
...
if(abs(prefactor) .gt. epscouplings) then
 ...
 tempcouplingmatrix(gE1,gE2)= 0._dp
  ...
  End do
if(nonzerocoupling) then 
 funcvalue= -3._dp*WfSSFF(p2,MHpm2(i1),MHpm2(i2),MFu2(i3),MFd2(i4),Qscale)
 tempcont=tempcont+tempcouplingmatrix*funcvalue
end if
end do
end do
...
if(abs(prefactor) .gt. epscouplings) then
 ...
 tempcouplingmatrix(gE1,gE2)= 0._dp
  ...
  End do
if(nonzerocoupling) then 
 funcvalue= -1._dp*MFv(i3)*MFe(i4)*WfSSFbFb(p2,MHpm2(i1),MHpm2(i2),MFv2(i3),MFe2(i4),Qscale)
 tempcont=tempcont+tempcouplingmatrix*funcvalue
end if
end if
...
if(abs(prefactor) .gt. epscouplings) then
 ...
 tempcouplingmatrix(gE1,gE2)= 0._dp
  ...
  End do
if(nonzerocoupling) then 
 funcvalue= -1._dp*WfSSFF(p2,MHpm2(i1),MHpm2(i2),MFv2(i3),MFe2(i4),Qscale)
 tempcont=tempcont+tempcouplingmatrix*funcvalue
end if
end do
end do
...
coup3L = cplcFdFucHpmL(i1,i2,i5)
coup3R = cplcFdFucHpmR(i1,i2,i5)
coup4L = cplcFuFdHpmL(i4,i3,i5)
coup4R = cplcFuFdHpmR(i4,i3,i5)
prefactor=Real(coup1L*coup2L*coup3L*coup4L+coup1R*coup2R*coup3R*coup4R,dp)
if(abs(prefactor) .gt. epscouplings) then
 tempcouplingmatrix(gE1,gE2)=prefactor
 nonzerocoupling=.true.
...
coup3L = cplcFeFvcHpmL(i1,i2,i5)
coup3R = cplcFeFvcHpmR(i1,i2,i5)
coup4L = cplFvFeHpmL(i4,i3,i5)
coup4R = cplFvFeHpmR(i4,i3,i5)
prefactor=Real(coup1L*coup2L*coup3L*coup4L+coup1R*coup2R*coup3R*coup4R,dp)
if(abs(prefactor) .gt. epscouplings) then
 tempcouplingmatrix(gE1,gE2)=prefactor
 nonzerocoupling=.true.
...
coup2L = cplcFdFdhhL(i2,i4,gE2)
coup2R = cplcFdFdhhR(i2,i4,gE2)
coup3L = cplcFuFdHpmL(i1,i2,i5)
coup3R = cplcFuFdHpmR(i1,i2,i5)
coup4L = cplcFdFucHpmL(i4,i3,i5)
coup4R = cplcFdFucHpmR(i4,i3,i5)
prefactor=Real(coup1L*coup2L*coup3L*coup4L+coup1R*coup2R*coup3R*coup4R,dp)
if(abs(prefactor) .gt. epscouplings) then
 tempcouplingmatrix(gE1,gE2)=prefactor
 nonzerocoupling=.true.
...
coup3L = cplcFeFvcHpmL(i2,i1,i5)
coup3R = cplcFeFvcHpmR(i2,i1,i5)
coup4L = cplFvFeHpmL(i3,i4,i5)
coup4R = cplFvFeHpmR(i3,i4,i5)
prefactor=Real(coup1L*coup2L*coup3L*coup4L+coup1R*coup2R*coup3R*coup4R,dp)
if(abs(prefactor) .gt. epscouplings) then
 tempcouplingmatrix(gE1,gE2)=prefactor
 nonzerocoupling=.true.
...
coup2L = cplcFdFdhhL(i4,i2,gE2)
coup2R = cplcFdFdhhR(i4,i2,gE2)
coup3L = cplcFdFucHpmL(i2,i5,i1)
coup3R = cplcFdFucHpmR(i2,i5,i1)
coup4L = cplcFuFdHpmL(i5,i4,i3)
coup4R = cplcFuFdHpmR(i5,i4,i3)
prefactor=Real(coup1*coup2L*coup3L*coup4L+coup1*coup2R*coup3R*coup4R,dp)
if(abs(prefactor) .gt. epscouplings) then
 tempcouplingmatrix(gE1,gE2)=prefactor
 nonzerocoupling=.true.
 ...
 tempcouplingmatrix(gE1,gE2)= 0._dp
  ...
  End do
if(nonzerocoupling) then 
 funcvalue= 6._dp*MFd(i2)*MFu(i5)*MFd(i4)*MfSFbSFbFb(p2,MHpm2(i1),MFd2(i2),MHpm2(i3),MFd2(i4),MFu2(i5),Qscale)
 tempcont=tempcont+tempcouplingmatrix*funcvalue
end if
end if
...
coup2L = cplcFeFehhL(i4,i2,gE2)
coup2R = cplcFeFehhR(i4,i2,gE2)
coup3L = cplcFeFvcHpmL(i2,i5,i1)
coup3R = cplcFeFvcHpmR(i2,i5,i1)
coup4L = cplFvFeHpmL(i5,i4,i3)
coup4R = cplFvFeHpmR(i5,i4,i3)
prefactor=Real(coup1*coup2L*coup3L*coup4L+coup1*coup2R*coup3R*coup4R,dp)
if(abs(prefactor) .gt. epscouplings) then
 tempcouplingmatrix(gE1,gE2)=prefactor
 nonzerocoupling=.true.
 ...
 tempcouplingmatrix(gE1,gE2)= 0._dp
  ...
  End do
if(nonzerocoupling) then 
 funcvalue= 2._dp*MFe(i2)*MFv(i5)*MFe(i4)*MfSFbSFbFb(p2,MHpm2(i1),MFe2(i2),MHpm2(i3),MFe2(i4),MFv2(i5),Qscale)
 tempcont=tempcont+tempcouplingmatrix*funcvalue
end if
end if
...
coup2L = cplFvFvhhL(i2,i4,gE2)
coup2R = cplFvFvhhR(i2,i4,gE2)
coup3L = cplcFeFvcHpmL(i5,i2,i1)
coup3R = cplcFeFvcHpmR(i5,i2,i1)
coup4L = cplFvFeHpmL(i4,i5,i3)
coup4R = cplFvFeHpmR(i4,i5,i3)
prefactor=Real(coup1*coup2L*coup3L*coup4L+coup1*coup2R*coup3R*coup4R,dp)
if(abs(prefactor) .gt. epscouplings) then
 tempcouplingmatrix(gE1,gE2)=prefactor
 nonzerocoupling=.true.
 ...
 tempcouplingmatrix(gE1,gE2)= 0._dp
  ...
  End do
if(nonzerocoupling) then 
 funcvalue= 2._dp*MFv(i2)*MFv(i4)*MFe(i5)*MfSFbSFbFb(p2,MHpm2(i1),MFv2(i2),MHpm2(i3),MFv2(i4),MFe2(i5),Qscale)
 tempcont=tempcont+tempcouplingmatrix*funcvalue
end if
end if
...
coup2L = cplcFuFuhhL(i2,i4,gE2)
coup2R = cplcFuFuhhR(i2,i4,gE2)
coup3L = cplcFdFucHpmL(i5,i2,i1)
coup3R = cplcFdFucHpmR(i5,i2,i1)
coup4L = cplcFuFdHpmL(i4,i5,i3)
coup4R = cplcFuFdHpmR(i4,i5,i3)
prefactor=Real(coup1*coup2L*coup3L*coup4L+coup1*coup2R*coup3R*coup4R,dp)
if(abs(prefactor) .gt. epscouplings) then
 tempcouplingmatrix(gE1,gE2)=prefactor
 nonzerocoupling=.true.
 ...
 tempcouplingmatrix(gE1,gE2)= 0._dp
  ...
  End do
if(nonzerocoupling) then 
 funcvalue= 6._dp*MFu(i4)*MFd(i5)*MFu(i2)*MfSFbSFbFb(p2,MHpm2(i1),MFu2(i2),MHpm2(i3),MFu2(i4),MFd2(i5),Qscale)
 tempcont=tempcont+tempcouplingmatrix*funcvalue
end if
end if
...
coup1 = cplAhhhHpm(i1,gE1,i2)
coup2 = cplAhhhcHpm(i1,gE2,i3)
coup3L = cplcFdFucHpmL(i5,i4,i2)
coup3R = cplcFdFucHpmR(i5,i4,i2)
coup4L = cplcFuFdHpmL(i4,i5,i3)
coup4R = cplcFuFdHpmR(i4,i5,i3)
prefactor=Real(coup1*coup2*coup3L*coup4L+coup1*coup2*coup3R*coup4R,dp)
if(abs(prefactor) .gt. epscouplings) then
 ...
 tempcouplingmatrix(gE1,gE2)= 0._dp
  ...
  End do
if(nonzerocoupling) then 
 funcvalue= 6._dp*MFu(i4)*MFd(i5)*VfSSSFbFb(p2,MAh2(i1),MHpm2(i2),MHpm2(i3),MFu2(i4),MFd2(i5),Qscale)
 tempcont=tempcont+tempcouplingmatrix*funcvalue
end if
end if
...
if(abs(prefactor) .gt. epscouplings) then
 ...
 tempcouplingmatrix(gE1,gE2)= 0._dp
  ...
  End do
if(nonzerocoupling) then 
 funcvalue= 6._dp*VfSSSFF(p2,MAh2(i1),MHpm2(i2),MHpm2(i3),MFu2(i4),MFd2(i5),Qscale)
 tempcont=tempcont+tempcouplingmatrix*funcvalue
end if
end do
end do
...
coup1 = cplAhhhHpm(i1,gE1,i2)
coup2 = cplAhhhcHpm(i1,gE2,i3)
coup3L = cplcFeFvcHpmL(i5,i4,i2)
coup3R = cplcFeFvcHpmR(i5,i4,i2)
coup4L = cplFvFeHpmL(i4,i5,i3)
coup4R = cplFvFeHpmR(i4,i5,i3)
prefactor=Real(coup1*coup2*coup3L*coup4L+coup1*coup2*coup3R*coup4R,dp)
if(abs(prefactor) .gt. epscouplings) then
 ...
 tempcouplingmatrix(gE1,gE2)= 0._dp
  ...
  End do
if(nonzerocoupling) then 
 funcvalue= 2._dp*MFv(i4)*MFe(i5)*VfSSSFbFb(p2,MAh2(i1),MHpm2(i2),MHpm2(i3),MFv2(i4),MFe2(i5),Qscale)
 tempcont=tempcont+tempcouplingmatrix*funcvalue
end if
end if
...
if(abs(prefactor) .gt. epscouplings) then
 ...
 tempcouplingmatrix(gE1,gE2)= 0._dp
  ...
  End do
if(nonzerocoupling) then 
 funcvalue= 2._dp*VfSSSFF(p2,MAh2(i1),MHpm2(i2),MHpm2(i3),MFv2(i4),MFe2(i5),Qscale)
 tempcont=tempcont+tempcouplingmatrix*funcvalue
end if
end do
end do
...
if(abs(prefactor) .gt. epscouplings) then
 ...
 tempcouplingmatrix(gE1,gE2)= 0._dp
  ...
  End do
if(nonzerocoupling) then 
 funcvalue= 3._dp*MFd(i4)*MFd(i5)*VfSSSFbFb(p2,MHpm2(i1),MAh2(i2),MAh2(i3),MFd2(i4),MFd2(i5),Qscale)
 tempcont=tempcont+tempcouplingmatrix*funcvalue
end if
end if
...
if(abs(prefactor) .gt. epscouplings) then
 ...
 tempcouplingmatrix(gE1,gE2)= 0._dp
  ...
  End do
if(nonzerocoupling) then 
 funcvalue= 3._dp*VfSSSFF(p2,MHpm2(i1),MAh2(i2),MAh2(i3),MFd2(i4),MFd2(i5),Qscale)
 tempcont=tempcont+tempcouplingmatrix*funcvalue
end if
end do
end do
...
if(abs(prefactor) .gt. epscouplings) then
 ...
 tempcouplingmatrix(gE1,gE2)= 0._dp
  ...
  End do
if(nonzerocoupling) then 
 funcvalue= MFe(i4)*MFe(i5)*VfSSSFbFb(p2,MHpm2(i1),MAh2(i2),MAh2(i3),MFe2(i4),MFe2(i5),Qscale)
 tempcont=tempcont+tempcouplingmatrix*funcvalue
end if
end if
...
if(abs(prefactor) .gt. epscouplings) then
 ...
 tempcouplingmatrix(gE1,gE2)= 0._dp
  ...
  End do
if(nonzerocoupling) then 
 funcvalue= 1._dp*VfSSSFF(p2,MHpm2(i1),MAh2(i2),MAh2(i3),MFe2(i4),MFe2(i5),Qscale)
 tempcont=tempcont+tempcouplingmatrix*funcvalue
end if
end do
end do
...
if(abs(prefactor) .gt. epscouplings) then
 ...
 tempcouplingmatrix(gE1,gE2)= 0._dp
  ...
  End do
if(nonzerocoupling) then 
 funcvalue= 3._dp*MFu(i4)*MFu(i5)*VfSSSFbFb(p2,MHpm2(i1),MAh2(i2),MAh2(i3),MFu2(i4),MFu2(i5),Qscale)
 tempcont=tempcont+tempcouplingmatrix*funcvalue
end if
end if
...
if(abs(prefactor) .gt. epscouplings) then
 ...
 tempcouplingmatrix(gE1,gE2)= 0._dp
  ...
  End do
if(nonzerocoupling) then 
 funcvalue= 3._dp*VfSSSFF(p2,MHpm2(i1),MAh2(i2),MAh2(i3),MFu2(i4),MFu2(i5),Qscale)
 tempcont=tempcont+tempcouplingmatrix*funcvalue
end if
end do
end do
...
if(abs(prefactor) .gt. epscouplings) then
 ...
 tempcouplingmatrix(gE1,gE2)= 0._dp
  ...
  End do
if(nonzerocoupling) then 
 funcvalue= 1._dp/2._dp*MFv(i4)*MFv(i5)*VfSSSFbFb(p2,MHpm2(i1),MAh2(i2),MAh2(i3),MFv2(i4),MFv2(i5),Qscale)
 tempcont=tempcont+tempcouplingmatrix*funcvalue
end if
end if
...
if(abs(prefactor) .gt. epscouplings) then
 ...
 tempcouplingmatrix(gE1,gE2)= 0._dp
  ...
  End do
if(nonzerocoupling) then 
 funcvalue= 1._dp/2._dp*VfSSSFF(p2,MHpm2(i1),MAh2(i2),MAh2(i3),MFv2(i4),MFv2(i5),Qscale)
 tempcont=tempcont+tempcouplingmatrix*funcvalue
end if
end do
end do
...
coup1 = cplhhHpmcHpm(gE1,i1,i2)
coup2 = cplhhHpmcHpm(gE2,i3,i1)
coup3L = cplcFuFdHpmL(i5,i4,i2)
coup3R = cplcFuFdHpmR(i5,i4,i2)
coup4L = cplcFdFucHpmL(i4,i5,i3)
coup4R = cplcFdFucHpmR(i4,i5,i3)
prefactor=Real(coup1*coup2*coup3L*coup4L+coup1*coup2*coup3R*coup4R,dp)
if(abs(prefactor) .gt. epscouplings) then
 tempcouplingmatrix(gE1,gE2)=prefactor
 nonzerocoupling=.true.
 ...
 tempcouplingmatrix(gE1,gE2)= 0._dp
  ...
  End do
if(nonzerocoupling) then 
 funcvalue= 6._dp*MFd(i4)*MFu(i5)*VfSSSFbFb(p2,MHpm2(i1),MHpm2(i2),MHpm2(i3),MFd2(i4),MFu2(i5),Qscale)
 tempcont=tempcont+tempcouplingmatrix*funcvalue
end if
end if
...
if(abs(prefactor) .gt. epscouplings) then
 ...
 tempcouplingmatrix(gE1,gE2)= 0._dp
  ...
  End do
if(nonzerocoupling) then 
 funcvalue= 6._dp*VfSSSFF(p2,MHpm2(i1),MHpm2(i2),MHpm2(i3),MFd2(i4),MFu2(i5),Qscale)
 tempcont=tempcont+tempcouplingmatrix*funcvalue
end if
end do
end do
...
coup1 = cplhhHpmcHpm(gE1,i1,i2)
coup2 = cplhhHpmcHpm(gE2,i3,i1)
coup3L = cplFvFeHpmL(i5,i4,i2)
coup3R = cplFvFeHpmR(i5,i4,i2)
coup4L = cplcFeFvcHpmL(i4,i5,i3)
coup4R = cplcFeFvcHpmR(i4,i5,i3)
prefactor=Real(coup1*coup2*coup3L*coup4L+coup1*coup2*coup3R*coup4R,dp)
if(abs(prefactor) .gt. epscouplings) then
 tempcouplingmatrix(gE1,gE2)=prefactor
 nonzerocoupling=.true.
 ...
 tempcouplingmatrix(gE1,gE2)= 0._dp
  ...
  End do
if(nonzerocoupling) then 
 funcvalue= 2._dp*MFe(i4)*MFv(i5)*VfSSSFbFb(p2,MHpm2(i1),MHpm2(i2),MHpm2(i3),MFe2(i4),MFv2(i5),Qscale)
 tempcont=tempcont+tempcouplingmatrix*funcvalue
end if
end if
...
if(abs(prefactor) .gt. epscouplings) then
 ...
 tempcouplingmatrix(gE1,gE2)= 0._dp
  ...
  End do
if(nonzerocoupling) then 
 funcvalue= 2._dp*VfSSSFF(p2,MHpm2(i1),MHpm2(i2),MHpm2(i3),MFe2(i4),MFv2(i5),Qscale)
 tempcont=tempcont+tempcouplingmatrix*funcvalue
end if
end do
end do
...
coup2L = cplcFdFdhhL(i1,i3,gE2)
coup2R = cplcFdFdhhR(i1,i3,gE2)
coup3L = cplcFuFdHpmL(i4,i2,i5)
coup3R = cplcFuFdHpmR(i4,i2,i5)
coup4L = cplcFdFucHpmL(i3,i4,i5)
coup4R = cplcFdFucHpmR(i3,i4,i5)
prefactor=Real(coup1L*coup2L*coup3L*coup4L+coup1R*coup2R*coup3R*coup4R,dp)
if(abs(prefactor) .gt. epscouplings) then
 tempcouplingmatrix(gE1,gE2)=prefactor
 nonzerocoupling=.true.
...
coup2L = cplcFeFehhL(i1,i3,gE2)
coup2R = cplcFeFehhR(i1,i3,gE2)
coup3L = cplFvFeHpmL(i4,i2,i5)
coup3R = cplFvFeHpmR(i4,i2,i5)
coup4L = cplcFeFvcHpmL(i3,i4,i5)
coup4R = cplcFeFvcHpmR(i3,i4,i5)
prefactor=Real(coup1L*coup2L*coup3L*coup4L+coup1R*coup2R*coup3R*coup4R,dp)
if(abs(prefactor) .gt. epscouplings) then
 tempcouplingmatrix(gE1,gE2)=prefactor
 nonzerocoupling=.true.
...
coup2L = cplcFuFuhhL(i1,i3,gE2)
coup2R = cplcFuFuhhR(i1,i3,gE2)
coup3L = cplcFdFucHpmL(i4,i2,i5)
coup3R = cplcFdFucHpmR(i4,i2,i5)
coup4L = cplcFuFdHpmL(i3,i4,i5)
coup4R = cplcFuFdHpmR(i3,i4,i5)
prefactor=Real(coup1L*coup2L*coup3L*coup4L+coup1R*coup2R*coup3R*coup4R,dp)
if(abs(prefactor) .gt. epscouplings) then
 tempcouplingmatrix(gE1,gE2)=prefactor
 nonzerocoupling=.true.
...
coup2L = cplFvFvhhL(i1,i3,gE2)
coup2R = cplFvFvhhR(i1,i3,gE2)
coup3L = cplFvFeHpmL(i2,i4,i5)
coup3R = cplFvFeHpmR(i2,i4,i5)
coup4L = cplcFeFvcHpmL(i4,i3,i5)
coup4R = cplcFeFvcHpmR(i4,i3,i5)
prefactor=Real(coup1L*coup2L*coup3L*coup4L+coup1R*coup2R*coup3R*coup4R,dp)
if(abs(prefactor) .gt. epscouplings) then
 tempcouplingmatrix(gE1,gE2)=prefactor
 nonzerocoupling=.true.
...
nonzerocoupling=.false.
  Do gE1=1,4
   Do gE2=1,4
coup1 = cplAhAhAhHpm(gE1,gE2,i1,i2)
coup2 = cplAhAhhh(i1,i3,i4)
coup3 = cplAhhhcHpm(i3,i4,i2)
prefactor=Real(coup1*coup2*coup3,dp)
if(abs(prefactor) .gt. epscouplings) then
...
nonzerocoupling=.false.
  Do gE1=1,4
   Do gE2=1,4
coup1 = cplAhAhhhHpm(gE1,gE2,i1,i2)
coup2 = cplAhAhhh(i3,i4,i1)
coup3 = cplAhAhcHpm(i3,i4,i2)
prefactor=Real(coup1*coup2*coup3,dp)
if(abs(prefactor) .gt. epscouplings) then
...
nonzerocoupling=.false.
  Do gE1=1,4
   Do gE2=1,4
coup1 = cplAhAhAhHpm(gE1,gE2,i2,i1)
coup2 = cplAhHpmcHpm(i3,i4,i1)
coup3 = cplAhAhcHpm(i2,i3,i4)
prefactor=Real(coup1*coup2*coup3,dp)
if(abs(prefactor) .gt. epscouplings) then
...
nonzerocoupling=.false.
  Do gE1=1,4
   Do gE2=1,4
coup1 = cplAhAhhhHpm(gE1,gE2,i2,i1)
coup2 = cplAhHpmcHpm(i3,i4,i1)
coup3 = cplAhhhcHpm(i3,i2,i4)
prefactor=Real(coup1*coup2*coup3,dp)
if(abs(prefactor) .gt. epscouplings) then
...
nonzerocoupling=.false.
  Do gE1=1,4
   Do gE2=1,4
coup1 = cplAhAhHpm(gE1,i1,i2)
coup2 = cplAhAhcHpm(gE2,i1,i3)
coup3 = cplAhAhHpmcHpm(i4,i4,i3,i2)
prefactor=Real(coup1*coup2*coup3,dp)
if(abs(prefactor) .gt. epscouplings) then
 tempcouplingmatrixah(gE1,gE2)=prefactor
...
nonzerocoupling=.false.
  Do gE1=1,4
   Do gE2=1,4
coup1 = cplAhhhHpm(gE1,i1,i2)
coup2 = cplAhhhcHpm(gE2,i1,i3)
coup3 = cplAhAhHpmcHpm(i4,i4,i3,i2)
prefactor=Real(coup1*coup2*coup3,dp)
if(abs(prefactor) .gt. epscouplings) then
 tempcouplingmatrixah(gE1,gE2)=prefactor
...
nonzerocoupling=.false.
  Do gE1=1,4
   Do gE2=1,4
coup1 = cplAhAhhh(gE1,i1,i2)
coup2 = cplAhAhHpm(gE2,i3,i4)
coup3 = cplAhAhhhcHpm(i1,i3,i2,i4)
prefactor=Real(coup1*coup2*coup3,dp)
if(abs(prefactor) .gt. epscouplings) then
 tempcouplingmatrixah(gE1,gE2)=prefactor
 nonzerocoupling=.true.
...
nonzerocoupling=.false.
  Do gE1=1,4
   Do gE2=1,4
coup1 = cplAhAhhh(gE1,i1,i2)
coup2 = cplAhhhHpm(gE2,i3,i4)
coup3 = cplAhhhhhcHpm(i1,i2,i3,i4)
prefactor=Real(coup1*coup2*coup3,dp)
if(abs(prefactor) .gt. epscouplings) then
 tempcouplingmatrixah(gE1,gE2)=prefactor
 nonzerocoupling=.true.
...
coup3 = cplAhAhhhcHpm(i1,i4,i3,i2)
prefactor=Real(coup1*coup2*coup3,dp)
if(abs(prefactor) .gt. epscouplings) then
 tempcouplingmatrixah(gE1,gE2)=prefactor
 nonzerocoupling=.true.
...
nonzerocoupling=.false.
  Do gE1=1,4
   Do gE2=1,4
coup1 = cplAhAhAhHpm(gE1,i1,i2,i3)
coup2 = cplAhAhAhcHpm(gE2,i1,i2,i3)
prefactor=Real(coup1*coup2,dp)
if(abs(prefactor) .gt. epscouplings) then
 tempcouplingmatrixah(gE1,gE2)=prefactor
 nonzerocoupling=.true.
...
nonzerocoupling=.false.
  Do gE1=1,4
   Do gE2=1,4
coup1 = cplAhAhhhHpm(gE1,i1,i2,i3)
coup2 = cplAhAhhhcHpm(gE2,i1,i2,i3)
prefactor=Real(coup1*coup2,dp)
if(abs(prefactor) .gt. epscouplings) then
 tempcouplingmatrixah(gE1,gE2)=prefactor
 nonzerocoupling=.true.
...
nonzerocoupling=.false.
  Do gE1=1,4
   Do gE2=1,4
coup1 = cplAhhhhhHpm(gE1,i1,i2,i3)
coup2 = cplAhhhhhcHpm(gE2,i1,i2,i3)
prefactor=Real(coup1*coup2,dp)
if(abs(prefactor) .gt. epscouplings) then
 tempcouplingmatrixah(gE1,gE2)=prefactor
 nonzerocoupling=.true.
...
nonzerocoupling=.false.
  Do gE1=1,4
   Do gE2=1,4
coup1 = cplAhHpmHpmcHpm(gE1,i1,i2,i3)
coup2 = cplAhHpmcHpmcHpm(gE2,i3,i1,i2)
prefactor=Real(coup1*coup2,dp)
if(abs(prefactor) .gt. epscouplings) then
 tempcouplingmatrixah(gE1,gE2)=prefactor
 nonzerocoupling=.true.
...
nonzerocoupling=.false.
  Do gE1=1,4
   Do gE2=1,4
coup1 = cplAhAhhh(gE1,i1,i2)
coup2 = cplAhAhAhHpm(gE2,i1,i3,i4)
coup3 = cplAhhhcHpm(i3,i2,i4)
prefactor=Real(coup1*coup2*coup3,dp)
if(abs(prefactor) .gt. epscouplings) then
 tempcouplingmatrixah(gE1,gE2)=prefactor
...
nonzerocoupling=.false.
  Do gE1=1,4
   Do gE2=1,4
coup1 = cplAhAhhh(gE1,i1,i2)
coup2 = cplAhAhhhHpm(gE2,i1,i3,i4)
coup3 = cplhhhhcHpm(i2,i3,i4)
prefactor=Real(coup1*coup2*coup3,dp)
if(abs(prefactor) .gt. epscouplings) then
 tempcouplingmatrixah(gE1,gE2)=prefactor
...
if(abs(prefactor) .gt. epscouplings) then
 ...
 tempcouplingmatrixah(gE1,gE2)= 0._dp
  ...
  End do
if(nonzerocoupling) then 
 funcvalue= -2._dp*UfSSSS(p2,MAh2(i1),MHpm2(i2),MAh2(i3),MAh2(i4),Qscale)
 tempcontah=tempcontah+tempcouplingmatrixah*funcvalue
end if
end do
end do
...
nonzerocoupling=.false.
  Do gE1=1,4
   Do gE2=1,4
coup1 = cplAhAhHpm(gE1,i1,i2)
coup2 = cplAhAhAhcHpm(gE2,i1,i3,i4)
coup3 = cplAhHpmcHpm(i3,i4,i2)
prefactor=Real(coup1*coup2*coup3,dp)
if(abs(prefactor) .gt. epscouplings) then
 tempcouplingmatrixah(gE1,gE2)=prefactor
...
nonzerocoupling=.false.
  Do gE1=1,4
   Do gE2=1,4
coup1 = cplAhAhHpm(gE1,i1,i2)
coup2 = cplAhAhhhcHpm(gE2,i1,i3,i4)
coup3 = cplhhHpmcHpm(i3,i4,i2)
prefactor=Real(coup1*coup2*coup3,dp)
if(abs(prefactor) .gt. epscouplings) then
 tempcouplingmatrixah(gE1,gE2)=prefactor
...
nonzerocoupling=.false.
  Do gE1=1,4
   Do gE2=1,4
coup1 = cplAhAhhh(gE1,i2,i1)
coup2 = cplAhAhhhHpm(gE2,i3,i1,i4)
coup3 = cplAhAhcHpm(i2,i3,i4)
prefactor=Real(coup1*coup2*coup3,dp)
if(abs(prefactor) .gt. epscouplings) then
 tempcouplingmatrixah(gE1,gE2)=prefactor
...
nonzerocoupling=.false.
  Do gE1=1,4
   Do gE2=1,4
coup1 = cplAhAhhh(gE1,i2,i1)
coup2 = cplAhhhhhHpm(gE2,i1,i3,i4)
coup3 = cplAhhhcHpm(i2,i3,i4)
prefactor=Real(coup1*coup2*coup3,dp)
if(abs(prefactor) .gt. epscouplings) then
 tempcouplingmatrixah(gE1,gE2)=prefactor
...
nonzerocoupling=.false.
  Do gE1=1,4
   Do gE2=1,4
coup1 = cplAhhhHpm(gE1,i1,i2)
coup2 = cplAhAhhhcHpm(gE2,i3,i1,i4)
coup3 = cplAhHpmcHpm(i3,i4,i2)
prefactor=Real(coup1*coup2*coup3,dp)
if(abs(prefactor) .gt. epscouplings) then
 tempcouplingmatrixah(gE1,gE2)=prefactor
...
nonzerocoupling=.false.
  Do gE1=1,4
   Do gE2=1,4
coup1 = cplAhhhHpm(gE1,i1,i2)
coup2 = cplAhhhhhcHpm(gE2,i1,i3,i4)
coup3 = cplhhHpmcHpm(i3,i4,i2)
prefactor=Real(coup1*coup2*coup3,dp)
if(abs(prefactor) .gt. epscouplings) then
 tempcouplingmatrixah(gE1,gE2)=prefactor
...
nonzerocoupling=.false.
  Do gE1=1,4
   Do gE2=1,4
coup1 = cplAhAhHpm(gE1,i2,i1)
coup2 = cplAhAhhhcHpm(gE2,i3,i4,i1)
coup3 = cplAhAhhh(i2,i3,i4)
prefactor=Real(coup1*coup2*coup3,dp)
if(abs(prefactor) .gt. epscouplings) then
 tempcouplingmatrixah(gE1,gE2)=prefactor
...
nonzerocoupling=.false.
  Do gE1=1,4
   Do gE2=1,4
coup1 = cplAhAhHpm(gE1,i2,i1)
coup2 = cplAhHpmcHpmcHpm(gE2,i3,i1,i4)
coup3 = cplAhHpmcHpm(i2,i4,i3)
prefactor=Real(coup1*coup2*coup3,dp)
if(abs(prefactor) .gt. epscouplings) then
 tempcouplingmatrixah(gE1,gE2)=prefactor
...
nonzerocoupling=.false.
  Do gE1=1,4
   Do gE2=1,4
coup1 = cplAhhhHpm(gE1,i2,i1)
coup2 = cplAhAhAhcHpm(gE2,i3,i4,i1)
coup3 = cplAhAhhh(i3,i4,i2)
prefactor=Real(coup1*coup2*coup3,dp)
if(abs(prefactor) .gt. epscouplings) then
 tempcouplingmatrixah(gE1,gE2)=prefactor
...
nonzerocoupling=.false.
  Do gE1=1,4
   Do gE2=1,4
coup1 = cplAhhhHpm(gE1,i2,i1)
coup2 = cplAhhhhhcHpm(gE2,i3,i4,i1)
coup3 = cplhhhhhh(i2,i3,i4)
prefactor=Real(coup1*coup2*coup3,dp)
if(abs(prefactor) .gt. epscouplings) then
 tempcouplingmatrixah(gE1,gE2)=prefactor
...
nonzerocoupling=.false.
  Do gE1=1,4
   Do gE2=1,4
coup1 = cplAhHpmcHpm(gE1,i1,i2)
coup2 = cplAhHpmHpmcHpm(gE2,i3,i4,i1)
coup3 = cplHpmcHpmcHpm(i2,i3,i4)
prefactor=Real(coup1*coup2*coup3,dp)
if(abs(prefactor) .gt. epscouplings) then
 tempcouplingmatrixah(gE1,gE2)=prefactor
...
nonzerocoupling=.false.
  Do gE1=1,4
   Do gE2=1,4
coup1 = cplAhAhhh(gE1,i1,i3)
coup2 = cplAhhhHpm(gE2,i2,i4)
coup3 = cplAhAhhh(i1,i5,i2)
coup4 = cplAhhhcHpm(i5,i3,i4)
prefactor=Real(coup1*coup2*coup3*coup4,dp)
if(abs(prefactor) .gt. epscouplings) then
 tempcouplingmatrixah(gE1,gE2)=prefactor
 nonzerocoupling=.true.
