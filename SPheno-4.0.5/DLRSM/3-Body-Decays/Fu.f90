...
& gTAh,gThh,gTHpm,gTVWLm,gTVWRm,gTVZ,gTVZR,gFuFucFdFd,gFuFucFeFe,gFuFucFuFu,             & 
& gFuFuFvFv,gFuFdcFeFv,epsI,deltaM,CheckRealStates,gT,gPartial,BR)
...
Real(dp),Intent(inout) :: gFuFucFdFd(3,3,3,3),gFuFucFeFe(3,3,3,3),gFuFucFuFu(3,3,3,3),gFuFuFvFv(3,3,9,9),       & 
& gFuFdcFeFv(3,3,3,9)

Real(dp),Intent(in) :: gTAh(4),gThh(4),gTHpm(4),gTVWLm,gTVWRm,gTVZ,gTVZR

Real(dp) :: gFuFucFdFdi(3,3,3),gFuFucFeFei(3,3,3),gFuFucFuFui(3,3,3),gFuFuFvFvi(3,9,9),           & 
& gFuFdcFeFvi(3,3,9)
...
gFuFucFdFdi = 0._dp 
Call FuToFucFdFd(i_run,MFu,MFd,MVZ,MVZR,MVWLm,MVWRm,MHpm,MAh,k1**2*(LAM2 - 4._dp*(LAM3)& 
...
& cplcFuFuVZRR,IntegralSs,IntegralSSss,IntegralSSst,IntegralVs,IntegralVSss,             & 
& IntegralVSst,IntegralVVss,IntegralVVst,NSs,NSSss,NSSst,NVs,NVSss,NVSst,NVVss,          & 
& NVVst,gTVZtemp,gTVZRtemp,gTVWLmtemp,gTVWRmtemp,gTHpmtemp,gTAhtemp,gThhtemp,            & 
& deltaM,epsI,check,gFuFucFdFdi)

gFuFucFdFd(i_run,:,:,:) = gFuFucFdFdi 
gT(i_run) = gT(i_run) + Sum(gFuFucFdFdi) 
 
gFuFucFeFei = 0._dp 
Call FuToFucFeFe(i_run,MFu,MFe,MVZ,MVZR,MAh,k1**2*(LAM2 - 4._dp*(LAM3) - LAM5 - LAM6) & 
...
& gTVZtemp,gTVZRtemp,gTAhtemp,gThhtemp,deltaM,epsI,check,gFuFucFeFei)

gFuFucFeFe(i_run,:,:,:) = gFuFucFeFei 
gT(i_run) = gT(i_run) + Sum(gFuFucFeFei) 
 
gFuFucFuFui = 0._dp 
Call FuToFucFuFu(i_run,MFu,MVZ,MVZR,MAh,k1**2*(LAM2 - 4._dp*(LAM3) - LAM5 - LAM6)     & 
&  + ((-1._dp*(ALP2) + ALP3)*vR**2)/2._dp,0,0,0,0,((2._dp*(RHO1) - RHO2)*vR**2)          & 
& /2._dp,0,0,0,0,-2*k1**2*(LAM1 + LAM2),-((ALP1 + ALP3)*k1*vR),0,0,-((ALP1 + ALP3)       & 
& *k1*vR),-2*RHO1*vR**2,cplcFuFuAhL,cplcFuFuAhR,cplcFuFuhhL,cplcFuFuhhR,cplcFuFuVZL,     & 
& cplcFuFuVZR,cplcFuFuVZRL,cplcFuFuVZRR,IntegralSs,IntegralSSss,IntegralSSst,            & 
...
& epsI,check,gFuFucFuFui)

gFuFucFuFu(i_run,:,:,:) = gFuFucFuFui 
gT(i_run) = gT(i_run) + Sum(gFuFucFuFui) 
 
gFuFuFvFvi = 0._dp 
Call FuToFuFvFv(i_run,MFu,MFv,MVZ,MVZR,MAh,k1**2*(LAM2 - 4._dp*(LAM3) - LAM5 - LAM6)  & 
&  + ((-1._dp*(ALP2) + ALP3)*vR**2)/2._dp,0,0,0,0,((2._dp*(RHO1) - RHO2)*vR**2)          & 
& /2._dp,0,0,0,0,-2*k1**2*(LAM1 + LAM2),-((ALP1 + ALP3)*k1*vR),0,0,-((ALP1 + ALP3)       & 
& *k1*vR),-2*RHO1*vR**2,cplcFuFuAhL,cplcFuFuAhR,cplcFuFuhhL,cplcFuFuhhR,cplcFuFuVZL,     & 
& cplcFuFuVZR,cplcFuFuVZRL,cplcFuFuVZRR,cplFvFvAhL,cplFvFvAhR,cplFvFvhhL,cplFvFvhhR,     & 
& cplFvFvVZL,cplFvFvVZR,cplFvFvVZRL,cplFvFvVZRR,IntegralSs,IntegralSSss,IntegralVs,      & 
& IntegralVSss,IntegralVVss,NSs,NSSss,NVs,NVSss,NVVss,gTVZtemp,gTVZRtemp,gTAhtemp,       & 
& gThhtemp,deltaM,epsI,check,gFuFuFvFvi)

gFuFuFvFv(i_run,:,:,:) = gFuFuFvFvi 
gT(i_run) = gT(i_run) + Sum(gFuFuFvFvi) 
 
gFuFdcFeFvi = 0._dp 
Call FuToFdcFeFv(i_run,MFd,MFe,MFv,MVWLm,MVWRm,MHpm,MFu,cplcFeFvcHpmL,cplcFeFvcHpmR,  & 
& cplcFeFvVWLmL,cplcFeFvVWLmR,cplcFeFvVWRmL,cplcFeFvVWRmR,cplcFuFdcVWLmL,cplcFuFdcVWLmR, & 
& cplcFuFdcVWRmL,cplcFuFdcVWRmR,cplcFuFdHpmL,cplcFuFdHpmR,IntegralSs,IntegralSSss,       & 
& IntegralVs,IntegralVSss,IntegralVVss,NSs,NSSss,NVs,NVSss,NVVss,gTVWLmtemp,             & 
& gTVWRmtemp,gTHpmtemp,deltaM,epsI,check,gFuFdcFeFvi)
...
Subroutine FuToFucFdFd(iIN,MFu,MFd,MVZ,MVZR,MVWLm,MVWRm,MHpm,MAh,k1**2*(LAM2 - 4._dp*(LAM3)& 
&  - LAM5 - LAM6) + ((-1._dp*(ALP2) + ALP3)*vR**2)/2._dp,0,0,0,0,((2._dp*(RHO1)          & 
&  - RHO2)*vR**2)/2._dp,0,0,0,0,-2*k1**2*(LAM1 + LAM2),-((ALP1 + ALP3)*k1*vR)            & 
& ,0,0,-((ALP1 + ALP3)*k1*vR),-2*RHO1*vR**2,cplcFdFdAhL,cplcFdFdAhR,cplcFdFdhhL,         & 
& cplcFdFdhhR,cplcFdFdVZL,cplcFdFdVZR,cplcFdFdVZRL,cplcFdFdVZRR,cplcFdFucHpmL,           & 
...
& cplcFuFuVZRR,IntegralSs,IntegralSSss,IntegralSSst,IntegralVs,IntegralVSss,             & 
& IntegralVSst,IntegralVVss,IntegralVVst,NSs,NSSss,NSSst,NVs,NVSss,NVSst,NVVss,          & 
& NVVst,gTVZ,gTVZR,gTVWLm,gTVWRm,gTHpm,gTAh,gThh,deltaM,epsI,check,g,WriteContributions)

Implicit None 
 
Real(dp),Intent(in) :: MFu(3),MFd(3),MVZ,MVZR,MVWLm,MVWRm,MHpm(4),MAh(4),0(4),0(4),0(4),0(4),0(4),           & 
& 0(4),0(4),0(4),0(4),0(4)
...
& cplcFdFdVZRL(3,3),cplcFdFdVZRR(3,3),cplcFdFucHpmL(3,3,4),cplcFdFucHpmR(3,3,4),         & 
...
coup(2) = Conjg(cplcFuFdHpmL(iIN,gt3,i1)) 
coup(1) = Conjg(cplcFuFdHpmR(iIN,gt3,i1)) 
coup(4) = Conjg(cplcFdFucHpmL(gt2,gt1,i1)) 
coup(3) = Conjg(cplcFdFucHpmR(gt2,gt1,i1))
...
If (resD.ne.resD) Then 
Write(*,*) "NaN appearing in the following diagrams: " 
Write(*,*) "Fu->Fu cFd Fd Propagator: Hpm" 
Write(*,*)  "M_in: ",m_in 
Write(*,*)  "mass: ",mass 
Write(*,*)  "coup: ",coup 
gSum(gt1,gt2,gt3,Isum)= 0._dp
...
coup2(3) = Conjg(cplcFuFuVZRL(gt1,iIN)) 
coup2(4) = Conjg(cplcFuFuVZRR(gt1,iIN))  
...
coup2(1) = cplcFuFuVZL(iIN,gt1) 
coup2(2) = cplcFuFuVZR(iIN,gt1) 
coup2(4) = cplcFuFdcVWLmL(iIN,gt3) 
coup2(3) = cplcFuFdcVWLmR(iIN,gt3)  
coup2(5) = cplcFdFdVZL(gt2,gt3) 
coup2(6) = cplcFdFdVZR(gt2,gt3) 
coup2(8) = cplcFdFuVWLmL(gt2,gt1) 
coup2(7) = cplcFdFuVWLmR(gt2,gt1) 
...
coup2(1) = cplcFuFuVZL(iIN,gt1) 
coup2(2) = cplcFuFuVZR(iIN,gt1) 
coup2(4) = cplcFuFdcVWRmL(iIN,gt3) 
coup2(3) = cplcFuFdcVWRmR(iIN,gt3)  
coup2(5) = cplcFdFdVZL(gt2,gt3) 
coup2(6) = cplcFdFdVZR(gt2,gt3) 
coup2(8) = cplcFdFuVWRmL(gt2,gt1) 
coup2(7) = cplcFdFuVWRmR(gt2,gt1) 
Call IntegrateGaugeST(Boson4, mass, coup2, deltaM, epsI,IntegralVVst,NVVst, resC, check) 
If (resC.ne.resC) resC = 0._dp
resC = -2._dp*resC 
resC= 1*resC ! color factor 
...
coup2(1) = cplcFuFuVZL(iIN,gt1) 
coup2(2) = cplcFuFuVZR(iIN,gt1) 
coup2(4) = cplcFuFdHpmL(iIN,gt3,i2) 
coup2(3) = cplcFuFdHpmR(iIN,gt3,i2)  
coup2(5) = cplcFdFdVZL(gt2,gt3) 
coup2(6) = cplcFdFdVZR(gt2,gt3) 
coup2(8) = cplcFdFucHpmL(gt2,gt1,i2) 
coup2(7) = cplcFdFucHpmR(gt2,gt1,i2) 
coupT = coup2(7) 
coup2(7) = coup2(8) 
coup2(8) = coupT 
...
If (resS.ne.resS) Then 
Write(*,*) "NaN appearing in the following diagrams: " 
Write(*,*) "Fu->Fu cFd Fd Propagator: VZ,Hpm" 
Write(*,*)  "M_in: ",m_in 
Write(*,*)  "mass: ",mass 
Write(*,*)  "coup: ",coup 
gSum(gt1,gt2,gt3,Isum)= 0._dp  
...
If (resS.ne.resS) Then 
Write(*,*) "NaN appearing in the following diagrams: " 
Write(*,*) "Fu->Fu cFd Fd Propagator: VZR,Hpm" 
Write(*,*)  "M_in: ",m_in 
Write(*,*)  "mass: ",mass 
Write(*,*)  "coup: ",coup 
gSum(gt1,gt2,gt3,Isum)= 0._dp  
...
If (resS.ne.resS) Then 
Write(*,*) "NaN appearing in the following diagrams: " 
Write(*,*) "Fu->Fu cFd Fd Propagator: conj[VWLm],Hpm" 
Write(*,*)  "M_in: ",m_in 
Write(*,*)  "mass: ",mass 
Write(*,*)  "coup: ",coup 
gSum(gt1,gt2,gt3,Isum)= 0._dp  
...
If (resS.ne.resS) Then 
Write(*,*) "NaN appearing in the following diagrams: " 
Write(*,*) "Fu->Fu cFd Fd Propagator: conj[VWRm],Hpm" 
Write(*,*)  "M_in: ",m_in 
Write(*,*)  "mass: ",mass 
Write(*,*)  "coup: ",coup 
gSum(gt1,gt2,gt3,Isum)= 0._dp  
...
coup2(1) = cplcFuFdHpmL(iIN,gt3,i1) 
coup2(2) = cplcFuFdHpmR(iIN,gt3,i1) 
coup2(4) = cplcFuFdHpmL(iIN,gt3,i2) 
coup2(3) = cplcFuFdHpmR(iIN,gt3,i2)  
coup2(5) = cplcFdFucHpmL(gt2,gt1,i1) 
coup2(6) = cplcFdFucHpmR(gt2,gt1,i1) 
coup2(8) = cplcFdFucHpmL(gt2,gt1,i2) 
coup2(7) = cplcFdFucHpmR(gt2,gt1,i2) 
...
If (resS.ne.resS) Then 
Write(*,*) "NaN appearing in the following diagrams: " 
Write(*,*) "Fu->Fu cFd Fd Propagator: Hpm,Hpm" 
Write(*,*)  "M_in: ",m_in 
Write(*,*)  "mass: ",mass 
Write(*,*)  "coup: ",coup 
gSum(gt1,gt2,gt3,Isum)= 0._dp  
...
If (resS.ne.resS) Then 
Write(*,*) "NaN appearing in the following diagrams: " 
Write(*,*) "Fu->Fu cFd Fd Propagator: Hpm,Ah" 
Write(*,*)  "M_in: ",m_in 
Write(*,*)  "mass: ",mass 
Write(*,*)  "coup: ",coup 
gSum(gt1,gt2,gt3,Isum)= 0._dp  
...
If (resS.ne.resS) Then 
Write(*,*) "NaN appearing in the following diagrams: " 
Write(*,*) "Fu->Fu cFd Fd Propagator: Hpm,hh" 
Write(*,*)  "M_in: ",m_in 
Write(*,*)  "mass: ",mass 
Write(*,*)  "coup: ",coup 
gSum(gt1,gt2,gt3,Isum)= 0._dp  
...
Subroutine FuToFucFeFe(iIN,MFu,MFe,MVZ,MVZR,MAh,k1**2*(LAM2 - 4._dp*(LAM3)            & 
&  - LAM5 - LAM6) + ((-1._dp*(ALP2) + ALP3)*vR**2)/2._dp,0,0,0,0,((2._dp*(RHO1)          & 
&  - RHO2)*vR**2)/2._dp,0,0,0,0,-2*k1**2*(LAM1 + LAM2),-((ALP1 + ALP3)*k1*vR)            & 
...
Real(dp),Intent(in) :: MFu(3),MFe(3),MVZ,MVZR,MAh(4),0(4),0(4),0(4),0(4),0(4),0(4),0(4),0(4),0(4),0(4)
...
Subroutine FuToFucFuFu(iIN,MFu,MVZ,MVZR,MAh,k1**2*(LAM2 - 4._dp*(LAM3) - LAM5 - LAM6) & 
&  + ((-1._dp*(ALP2) + ALP3)*vR**2)/2._dp,0,0,0,0,((2._dp*(RHO1) - RHO2)*vR**2)          & 
& /2._dp,0,0,0,0,-2*k1**2*(LAM1 + LAM2),-((ALP1 + ALP3)*k1*vR),0,0,-((ALP1 + ALP3)       & 
& *k1*vR),-2*RHO1*vR**2,cplcFuFuAhL,cplcFuFuAhR,cplcFuFuhhL,cplcFuFuhhR,cplcFuFuVZL,     & 
& cplcFuFuVZR,cplcFuFuVZRL,cplcFuFuVZRR,IntegralSs,IntegralSSss,IntegralSSst,            & 
...
Real(dp),Intent(in) :: MFu(3),MVZ,MVZR,MAh(4),0(4),0(4),0(4),0(4),0(4),0(4),0(4),0(4),0(4),0(4)

Complex(dp),Intent(in) :: k1**2*(LAM2 - 4._dp*(LAM3) - LAM5 - LAM6) + ((-1._dp*(ALP2) + ALP3)*vR**2)            & 
& /2._dp,((2._dp*(RHO1) - RHO2)*vR**2)/2._dp,-2*k1**2*(LAM1 + LAM2),-((ALP1 + ALP3)      & 
& *k1*vR),-((ALP1 + ALP3)*k1*vR),-2*RHO1*vR**2,cplcFuFuAhL(3,3,4),cplcFuFuAhR(3,3,4),    & 
& cplcFuFuhhL(3,3,4),cplcFuFuhhR(3,3,4),cplcFuFuVZL(3,3),cplcFuFuVZR(3,3),               & 
& cplcFuFuVZRL(3,3),cplcFuFuVZRR(3,3)
...
coup2(1) = cplcFuFuVZL(iIN,gt3) 
coup2(2) = cplcFuFuVZR(iIN,gt3) 
coup2(3) = Conjg(cplcFuFuVZRL(gt3,iIN)) 
coup2(4) = Conjg(cplcFuFuVZRR(gt3,iIN))  
coup2(5) = cplcFuFuVZL(gt2,gt1) 
coup2(6) = cplcFuFuVZR(gt2,gt1) 
coup2(7) = Conjg(cplcFuFuVZRL(gt1,gt2)) 
coup2(8) = Conjg(cplcFuFuVZRR(gt1,gt2)) 
Call IntegrateGaugeSS(Boson4, mass, coup2, deltaM, epsI,IntegralVVss,NVVss, resR, check) 
If (resR.ne.resR) resR = 0._dp
resC = 2._dp*resR 
If (gt1.Eq.gt3) Then 
...
Subroutine FuToFuFvFv(iIN,MFu,MFv,MVZ,MVZR,MAh,k1**2*(LAM2 - 4._dp*(LAM3)             & 
&  - LAM5 - LAM6) + ((-1._dp*(ALP2) + ALP3)*vR**2)/2._dp,0,0,0,0,((2._dp*(RHO1)          & 
&  - RHO2)*vR**2)/2._dp,0,0,0,0,-2*k1**2*(LAM1 + LAM2),-((ALP1 + ALP3)*k1*vR)            & 
& ,0,0,-((ALP1 + ALP3)*k1*vR),-2*RHO1*vR**2,cplcFuFuAhL,cplcFuFuAhR,cplcFuFuhhL,         & 
...
& NVSss,NVVss,gTVZ,gTVZR,gTAh,gThh,deltaM,epsI,check,g,WriteContributions)

Implicit None 
 
Real(dp),Intent(in) :: MFu(3),MFv(9),MVZ,MVZR,MAh(4),0(4),0(4),0(4),0(4),0(4),0(4),0(4),0(4),0(4),0(4)

Complex(dp),Intent(in) :: k1**2*(LAM2 - 4._dp*(LAM3) - LAM5 - LAM6) + ((-1._dp*(ALP2) + ALP3)*vR**2)            & 
& /2._dp,((2._dp*(RHO1) - RHO2)*vR**2)/2._dp,-2*k1**2*(LAM1 + LAM2),-((ALP1 + ALP3)      & 
& *k1*vR),-((ALP1 + ALP3)*k1*vR),-2*RHO1*vR**2,cplcFuFuAhL(3,3,4),cplcFuFuAhR(3,3,4),    & 
& cplcFuFuhhL(3,3,4),cplcFuFuhhR(3,3,4),cplcFuFuVZL(3,3),cplcFuFuVZR(3,3),               & 
& cplcFuFuVZRL(3,3),cplcFuFuVZRR(3,3),cplFvFvAhL(9,9,4),cplFvFvAhR(9,9,4),               & 
...
Subroutine FuToFdcFeFv(iIN,MFd,MFe,MFv,MVWLm,MVWRm,MHpm,MFu,cplcFeFvcHpmL,            & 
& cplcFeFvcHpmR,cplcFeFvVWLmL,cplcFeFvVWLmR,cplcFeFvVWRmL,cplcFeFvVWRmR,cplcFuFdcVWLmL,  & 
& cplcFuFdcVWLmR,cplcFuFdcVWRmL,cplcFuFdcVWRmR,cplcFuFdHpmL,cplcFuFdHpmR,IntegralSs,     & 
& IntegralSSss,IntegralVs,IntegralVSss,IntegralVVss,NSs,NSSss,NVs,NVSss,NVVss,           & 
& gTVWLm,gTVWRm,gTHpm,deltaM,epsI,check,g,WriteContributions)

Implicit None 
 
Real(dp),Intent(in) :: MFd(3),MFe(3),MFv(9),MVWLm,MVWRm,MHpm(4),MFu(3)

Complex(dp),Intent(in) :: cplcFeFvcHpmL(3,9,4),cplcFeFvcHpmR(3,9,4),cplcFeFvVWLmL(3,9),cplcFeFvVWLmR(3,9),      & 
& cplcFeFvVWRmL(3,9),cplcFeFvVWRmR(3,9),cplcFuFdcVWLmL(3,3),cplcFuFdcVWLmR(3,3),         & 
& cplcFuFdcVWRmL(3,3),cplcFuFdcVWRmR(3,3),cplcFuFdHpmL(3,3,4),cplcFuFdHpmR(3,3,4)
...
coup(4) = Conjg(cplcFeFvVWLmL(gt2,gt3)) 
coup(3) = Conjg(cplcFeFvVWLmR(gt2,gt3))
Call IntegrateGaugeSS(Boson2,mass,coup,deltaM,epsI,IntegralVs,NVs,resR, check) 
resR= 1*resR ! color factor 
resS = resS + resR 
...
If (resD.ne.resD) Then 
Write(*,*) "NaN appearing in the following diagrams: " 
Write(*,*) "Fu->Fd cFe Fv Propagator: conj[VWLm]" 
Write(*,*)  "M_in: ",m_in 
Write(*,*)  "mass: ",mass 
Write(*,*)  "coup: ",coup 
gSum(gt1,gt2,gt3,Isum)= 0._dp
...
coup(4) = Conjg(cplcFeFvVWRmL(gt2,gt3)) 
coup(3) = Conjg(cplcFeFvVWRmR(gt2,gt3))
Call IntegrateGaugeSS(Boson2,mass,coup,deltaM,epsI,IntegralVs,NVs,resR, check) 
resR= 1*resR ! color factor 
resS = resS + resR 
...
If (resD.ne.resD) Then 
Write(*,*) "NaN appearing in the following diagrams: " 
Write(*,*) "Fu->Fd cFe Fv Propagator: conj[VWRm]" 
Write(*,*)  "M_in: ",m_in 
Write(*,*)  "mass: ",mass 
Write(*,*)  "coup: ",coup 
gSum(gt1,gt2,gt3,Isum)= 0._dp
...
coup(2) = Conjg(cplcFuFdHpmL(iIN,gt1,i1)) 
coup(1) = Conjg(cplcFuFdHpmR(iIN,gt1,i1)) 
...
If (resD.ne.resD) Then 
Write(*,*) "NaN appearing in the following diagrams: " 
Write(*,*) "Fu->Fd cFe Fv Propagator: Hpm" 
Write(*,*)  "M_in: ",m_in 
Write(*,*)  "mass: ",mass 
Write(*,*)  "coup: ",coup 
gSum(gt1,gt2,gt3,Isum)= 0._dp
...
coup2(4) = cplcFuFdcVWRmL(iIN,gt1) 
coup2(3) = cplcFuFdcVWRmR(iIN,gt1)  
coup2(5) = cplcFeFvVWLmL(gt2,gt3) 
coup2(6) = cplcFeFvVWLmR(gt2,gt3) 
coup2(8) = cplcFeFvVWRmL(gt2,gt3) 
coup2(7) = cplcFeFvVWRmR(gt2,gt3) 
Call IntegrateGaugeSS(Boson4, mass, coup2, deltaM, epsI,IntegralVVss,NVVss, resR, check) 
If (resR.ne.resR) resR = 0._dp
resC = 2._dp*resR 
resS = resS + resC 
If (resS.ne.resS) Then 
Write(*,*) "NaN appearing in the following diagrams: " 
Write(*,*) "Fu->Fd cFe Fv Propagator: conj[VWLm],conj[VWRm]" 
Write(*,*)  "M_in: ",m_in 
Write(*,*)  "mass: ",mass 
Write(*,*)  "coup: ",coup 
gSum(gt1,gt2,gt3,Isum)= 0._dp  
...
coup2(1) = cplcFuFdcVWLmL(iIN,gt1) 
coup2(2) = cplcFuFdcVWLmR(iIN,gt1) 
coup2(4) = cplcFuFdHpmL(iIN,gt1,i2) 
coup2(3) = cplcFuFdHpmR(iIN,gt1,i2)  
coup2(5) = cplcFeFvVWLmL(gt2,gt3) 
coup2(6) = cplcFeFvVWLmR(gt2,gt3) 
coup2(8) = cplcFeFvcHpmL(gt2,gt3,i2) 
coup2(7) = cplcFeFvcHpmR(gt2,gt3,i2) 
Call IntegrateGaugeSscalarS(Boson4, mass, coup2, deltaM, epsI,IntegralVSss,NVSss, resC, check) 
If (resC.ne.resC) resC = 0._dp
resC = 2._dp*resC 
resC= 1*resC ! color factor 
...
If (resS.ne.resS) Then 
Write(*,*) "NaN appearing in the following diagrams: " 
Write(*,*) "Fu->Fd cFe Fv Propagator: conj[VWLm],Hpm" 
Write(*,*)  "M_in: ",m_in 
Write(*,*)  "mass: ",mass 
Write(*,*)  "coup: ",coup 
gSum(gt1,gt2,gt3,Isum)= 0._dp  
...
coup2(4) = cplcFuFdHpmL(iIN,gt1,i2) 
coup2(3) = cplcFuFdHpmR(iIN,gt1,i2)  
coup2(5) = cplcFeFvVWRmL(gt2,gt3) 
coup2(6) = cplcFeFvVWRmR(gt2,gt3) 
coup2(8) = cplcFeFvcHpmL(gt2,gt3,i2) 
coup2(7) = cplcFeFvcHpmR(gt2,gt3,i2) 
Call IntegrateGaugeSscalarS(Boson4, mass, coup2, deltaM, epsI,IntegralVSss,NVSss, resC, check) 
If (resC.ne.resC) resC = 0._dp
...
If (resS.ne.resS) Then 
Write(*,*) "NaN appearing in the following diagrams: " 
Write(*,*) "Fu->Fd cFe Fv Propagator: conj[VWRm],Hpm" 
Write(*,*)  "M_in: ",m_in 
Write(*,*)  "mass: ",mass 
Write(*,*)  "coup: ",coup 
gSum(gt1,gt2,gt3,Isum)= 0._dp  
...
coup2(1) = cplcFuFdHpmL(iIN,gt1,i1) 
coup2(2) = cplcFuFdHpmR(iIN,gt1,i1) 
coup2(4) = cplcFuFdHpmL(iIN,gt1,i2) 
coup2(3) = cplcFuFdHpmR(iIN,gt1,i2)  
...
If (resS.ne.resS) Then 
Write(*,*) "NaN appearing in the following diagrams: " 
Write(*,*) "Fu->Fd cFe Fv Propagator: Hpm,Hpm" 
Write(*,*)  "M_in: ",m_in 
Write(*,*)  "mass: ",mass 
Write(*,*)  "coup: ",coup 
gSum(gt1,gt2,gt3,Isum)= 0._dp  
