...
gFdFdcFdFdi = 0._dp 
Call FdToFdcFdFd(i_run,MFd,MVZ,MVZR,MAh,k1**2*(LAM2 - 4._dp*(LAM3) - LAM5 - LAM6)     & 
...
& cplcFdFdVZR,cplcFdFdVZRL,cplcFdFdVZRR,IntegralSs,IntegralSSss,IntegralSSst,            & 
...
& epsI,check,gFdFdcFdFdi)

gFdFdcFdFd(i_run,:,:,:) = gFdFdcFdFdi 
gT(i_run) = gT(i_run) + Sum(gFdFdcFdFdi) 
 
gFdFdcFeFei = 0._dp 
Call FdToFdcFeFe(i_run,MFd,MFe,MVZ,MVZR,MAh,k1**2*(LAM2 - 4._dp*(LAM3) - LAM5 - LAM6) & 
&  + ((-1._dp*(ALP2) + ALP3)*vR**2)/2._dp,0,0,0,0,((2._dp*(RHO1) - RHO2)*vR**2)          & 
& /2._dp,0,0,0,0,-2*k1**2*(LAM1 + LAM2),-((ALP1 + ALP3)*k1*vR),0,0,-((ALP1 + ALP3)       & 
& *k1*vR),-2*RHO1*vR**2,cplcFdFdAhL,cplcFdFdAhR,cplcFdFdhhL,cplcFdFdhhR,cplcFdFdVZL,     & 
...
& gTVZtemp,gTVZRtemp,gTAhtemp,gThhtemp,deltaM,epsI,check,gFdFdcFeFei)

gFdFdcFeFe(i_run,:,:,:) = gFdFdcFeFei 
gT(i_run) = gT(i_run) + Sum(gFdFdcFeFei) 
 
gFdFdcFuFui = 0._dp 
Call FdToFdcFuFu(i_run,MFd,MFu,MVZ,MVZR,MVWLm,MVWRm,MHpm,MAh,k1**2*(LAM2 - 4._dp*(LAM3)& 
...
& deltaM,epsI,check,gFdFdcFuFui)

gFdFdcFuFu(i_run,:,:,:) = gFdFdcFuFui 
gT(i_run) = gT(i_run) + Sum(gFdFdcFuFui) 
 
gFdFdFvFvi = 0._dp 
Call FdToFdFvFv(i_run,MFd,MFv,MVZ,MVZR,MAh,k1**2*(LAM2 - 4._dp*(LAM3) - LAM5 - LAM6)  & 
&  + ((-1._dp*(ALP2) + ALP3)*vR**2)/2._dp,0,0,0,0,((2._dp*(RHO1) - RHO2)*vR**2)          & 
& /2._dp,0,0,0,0,-2*k1**2*(LAM1 + LAM2),-((ALP1 + ALP3)*k1*vR),0,0,-((ALP1 + ALP3)       & 
& *k1*vR),-2*RHO1*vR**2,cplcFdFdAhL,cplcFdFdAhR,cplcFdFdhhL,cplcFdFdhhR,cplcFdFdVZL,     & 
& cplcFdFdVZR,cplcFdFdVZRL,cplcFdFdVZRR,cplFvFvAhL,cplFvFvAhR,cplFvFvhhL,cplFvFvhhR,     & 
...
& gThhtemp,deltaM,epsI,check,gFdFdFvFvi)

gFdFdFvFv(i_run,:,:,:) = gFdFdFvFvi 
gT(i_run) = gT(i_run) + Sum(gFdFdFvFvi) 
 
gFdFuFvFei = 0._dp 
Call FdToFuFvFe(i_run,MFu,MFv,MFe,MVWLm,MVWRm,MHpm,MFd,cplcFdFucHpmL,cplcFdFucHpmR,   & 
...
Subroutine FdToFdcFdFd(iIN,MFd,MVZ,MVZR,MAh,k1**2*(LAM2 - 4._dp*(LAM3) - LAM5 - LAM6) & 
&  + ((-1._dp*(ALP2) + ALP3)*vR**2)/2._dp,0,0,0,0,((2._dp*(RHO1) - RHO2)*vR**2)          & 
& /2._dp,0,0,0,0,-2*k1**2*(LAM1 + LAM2),-((ALP1 + ALP3)*k1*vR),0,0,-((ALP1 + ALP3)       & 
& *k1*vR),-2*RHO1*vR**2,cplcFdFdAhL,cplcFdFdAhR,cplcFdFdhhL,cplcFdFdhhR,cplcFdFdVZL,     & 
& cplcFdFdVZR,cplcFdFdVZRL,cplcFdFdVZRR,IntegralSs,IntegralSSss,IntegralSSst,            & 
...
Real(dp),Intent(in) :: MFd(3),MVZ,MVZR,MAh(4),0(4),0(4),0(4),0(4),0(4),0(4),0(4),0(4),0(4),0(4)
...
Subroutine FdToFdcFeFe(iIN,MFd,MFe,MVZ,MVZR,MAh,k1**2*(LAM2 - 4._dp*(LAM3)            & 
&  - LAM5 - LAM6) + ((-1._dp*(ALP2) + ALP3)*vR**2)/2._dp,0,0,0,0,((2._dp*(RHO1)          & 
&  - RHO2)*vR**2)/2._dp,0,0,0,0,-2*k1**2*(LAM1 + LAM2),-((ALP1 + ALP3)*k1*vR)            & 
& ,0,0,-((ALP1 + ALP3)*k1*vR),-2*RHO1*vR**2,cplcFdFdAhL,cplcFdFdAhR,cplcFdFdhhL,         & 
...
Real(dp),Intent(in) :: MFd(3),MFe(3),MVZ,MVZR,MAh(4),0(4),0(4),0(4),0(4),0(4),0(4),0(4),0(4),0(4),0(4)
...
Subroutine FdToFdcFuFu(iIN,MFd,MFu,MVZ,MVZR,MVWLm,MVWRm,MHpm,MAh,k1**2*(LAM2 - 4._dp*(LAM3)& 
&  - LAM5 - LAM6) + ((-1._dp*(ALP2) + ALP3)*vR**2)/2._dp,0,0,0,0,((2._dp*(RHO1)          & 
&  - RHO2)*vR**2)/2._dp,0,0,0,0,-2*k1**2*(LAM1 + LAM2),-((ALP1 + ALP3)*k1*vR)            & 
& ,0,0,-((ALP1 + ALP3)*k1*vR),-2*RHO1*vR**2,cplcFdFdAhL,cplcFdFdAhR,cplcFdFdhhL,         & 
& cplcFdFdhhR,cplcFdFdVZL,cplcFdFdVZR,cplcFdFdVZRL,cplcFdFdVZRR,cplcFdFucHpmL,           & 
...
Real(dp),Intent(in) :: MFd(3),MFu(3),MVZ,MVZR,MVWLm,MVWRm,MHpm(4),MAh(4),0(4),0(4),0(4),0(4),0(4),           & 
& 0(4),0(4),0(4),0(4),0(4)
...
coup(2) = Conjg(cplcFdFucHpmL(iIN,gt3,i1)) 
coup(1) = Conjg(cplcFdFucHpmR(iIN,gt3,i1)) 
coup(4) = Conjg(cplcFuFdHpmL(gt2,gt1,i1)) 
coup(3) = Conjg(cplcFuFdHpmR(gt2,gt1,i1))
Call IntegrateScalarSS(Boson2,mass,coup,deltaM,epsI,IntegralSs,NSs,resR, check) 
resR= 3*resR ! color factor 
resS = resS + resR 
...
If (resD.ne.resD) Then 
Write(*,*) "NaN appearing in the following diagrams: " 
Write(*,*) "Fd->Fd cFu Fu Propagator: conj[Hpm]" 
Write(*,*)  "M_in: ",m_in 
Write(*,*)  "mass: ",mass 
Write(*,*)  "coup: ",coup 
gSum(gt1,gt2,gt3,Isum)= 0._dp
...
coup2(1) = cplcFdFdVZL(iIN,gt1) 
coup2(2) = cplcFdFdVZR(iIN,gt1) 
coup2(4) = cplcFdFucHpmL(iIN,gt3,i2) 
coup2(3) = cplcFdFucHpmR(iIN,gt3,i2)  
coup2(5) = cplcFuFuVZL(gt2,gt3) 
coup2(6) = cplcFuFuVZR(gt2,gt3) 
coup2(8) = cplcFuFdHpmL(gt2,gt1,i2) 
coup2(7) = cplcFuFdHpmR(gt2,gt1,i2) 
coupT = coup2(7) 
coup2(7) = coup2(8) 
coup2(8) = coupT 
Call IntegrateGaugeSscalarT(Boson4, mass, coup2, deltaM, epsI,IntegralVSst,NVSst, resC, check) 
...
If (resS.ne.resS) Then 
Write(*,*) "NaN appearing in the following diagrams: " 
Write(*,*) "Fd->Fd cFu Fu Propagator: VZ,conj[Hpm]" 
Write(*,*)  "M_in: ",m_in 
Write(*,*)  "mass: ",mass 
Write(*,*)  "coup: ",coup 
gSum(gt1,gt2,gt3,Isum)= 0._dp  
...
If (resS.ne.resS) Then 
Write(*,*) "NaN appearing in the following diagrams: " 
Write(*,*) "Fd->Fd cFu Fu Propagator: VZR,conj[Hpm]" 
Write(*,*)  "M_in: ",m_in 
Write(*,*)  "mass: ",mass 
Write(*,*)  "coup: ",coup 
gSum(gt1,gt2,gt3,Isum)= 0._dp  
...
If (resS.ne.resS) Then 
Write(*,*) "NaN appearing in the following diagrams: " 
Write(*,*) "Fd->Fd cFu Fu Propagator: VWLm,conj[Hpm]" 
Write(*,*)  "M_in: ",m_in 
Write(*,*)  "mass: ",mass 
Write(*,*)  "coup: ",coup 
gSum(gt1,gt2,gt3,Isum)= 0._dp  
...
If (resS.ne.resS) Then 
Write(*,*) "NaN appearing in the following diagrams: " 
Write(*,*) "Fd->Fd cFu Fu Propagator: VWRm,conj[Hpm]" 
Write(*,*)  "M_in: ",m_in 
Write(*,*)  "mass: ",mass 
Write(*,*)  "coup: ",coup 
gSum(gt1,gt2,gt3,Isum)= 0._dp  
...
coup2(1) = cplcFdFucHpmL(iIN,gt3,i1) 
coup2(2) = cplcFdFucHpmR(iIN,gt3,i1) 
coup2(4) = cplcFdFucHpmL(iIN,gt3,i2) 
coup2(3) = cplcFdFucHpmR(iIN,gt3,i2)  
coup2(5) = cplcFuFdHpmL(gt2,gt1,i1) 
coup2(6) = cplcFuFdHpmR(gt2,gt1,i1) 
coup2(8) = cplcFuFdHpmL(gt2,gt1,i2) 
coup2(7) = cplcFuFdHpmR(gt2,gt1,i2) 
Call IntegrateScalarS1S2(Boson4, mass, coup2, deltaM, epsI,IntegralSSss,NSSss, resC, check) 
If (resC.ne.resC) resC = 0._dp
...
If (resS.ne.resS) Then 
Write(*,*) "NaN appearing in the following diagrams: " 
Write(*,*) "Fd->Fd cFu Fu Propagator: conj[Hpm],conj[Hpm]" 
Write(*,*)  "M_in: ",m_in 
Write(*,*)  "mass: ",mass 
Write(*,*)  "coup: ",coup 
gSum(gt1,gt2,gt3,Isum)= 0._dp  
...
If (resS.ne.resS) Then 
Write(*,*) "NaN appearing in the following diagrams: " 
Write(*,*) "Fd->Fd cFu Fu Propagator: conj[Hpm],Ah" 
Write(*,*)  "M_in: ",m_in 
Write(*,*)  "mass: ",mass 
Write(*,*)  "coup: ",coup 
gSum(gt1,gt2,gt3,Isum)= 0._dp  
...
If (resS.ne.resS) Then 
Write(*,*) "NaN appearing in the following diagrams: " 
Write(*,*) "Fd->Fd cFu Fu Propagator: conj[Hpm],hh" 
Write(*,*)  "M_in: ",m_in 
Write(*,*)  "mass: ",mass 
Write(*,*)  "coup: ",coup 
gSum(gt1,gt2,gt3,Isum)= 0._dp  
...
Subroutine FdToFdFvFv(iIN,MFd,MFv,MVZ,MVZR,MAh,k1**2*(LAM2 - 4._dp*(LAM3)             & 
&  - LAM5 - LAM6) + ((-1._dp*(ALP2) + ALP3)*vR**2)/2._dp,0,0,0,0,((2._dp*(RHO1)          & 
&  - RHO2)*vR**2)/2._dp,0,0,0,0,-2*k1**2*(LAM1 + LAM2),-((ALP1 + ALP3)*k1*vR)            & 
& ,0,0,-((ALP1 + ALP3)*k1*vR),-2*RHO1*vR**2,cplcFdFdAhL,cplcFdFdAhR,cplcFdFdhhL,         & 
& cplcFdFdhhR,cplcFdFdVZL,cplcFdFdVZR,cplcFdFdVZRL,cplcFdFdVZRR,cplFvFvAhL,              & 
...
Real(dp),Intent(in) :: MFd(3),MFv(9),MVZ,MVZR,MAh(4),0(4),0(4),0(4),0(4),0(4),0(4),0(4),0(4),0(4),0(4)

Complex(dp),Intent(in) :: k1**2*(LAM2 - 4._dp*(LAM3) - LAM5 - LAM6) + ((-1._dp*(ALP2) + ALP3)*vR**2)            & 
& /2._dp,((2._dp*(RHO1) - RHO2)*vR**2)/2._dp,-2*k1**2*(LAM1 + LAM2),-((ALP1 + ALP3)      & 
& *k1*vR),-((ALP1 + ALP3)*k1*vR),-2*RHO1*vR**2,cplcFdFdAhL(3,3,4),cplcFdFdAhR(3,3,4),    & 
& cplcFdFdhhL(3,3,4),cplcFdFdhhR(3,3,4),cplcFdFdVZL(3,3),cplcFdFdVZR(3,3),               & 
& cplcFdFdVZRL(3,3),cplcFdFdVZRR(3,3),cplFvFvAhL(9,9,4),cplFvFvAhR(9,9,4),               & 
...
Subroutine FdToFuFvFe(iIN,MFu,MFv,MFe,MVWLm,MVWRm,MHpm,MFd,cplcFdFucHpmL,             & 
...
coup(2) = Conjg(cplcFdFucHpmL(iIN,gt1,i1)) 
coup(1) = Conjg(cplcFdFucHpmR(iIN,gt1,i1)) 
...
If (resD.ne.resD) Then 
Write(*,*) "NaN appearing in the following diagrams: " 
Write(*,*) "Fd->Fu Fv Fe Propagator: conj[Hpm]" 
Write(*,*)  "M_in: ",m_in 
Write(*,*)  "mass: ",mass 
Write(*,*)  "coup: ",coup 
gSum(gt1,gt2,gt3,Isum)= 0._dp
...
coup2(1) = cplcFdFuVWLmL(iIN,gt1) 
coup2(2) = cplcFdFuVWLmR(iIN,gt1) 
coup2(4) = cplcFdFucHpmL(iIN,gt1,i2) 
coup2(3) = cplcFdFucHpmR(iIN,gt1,i2)  
coup2(5) = cplFvFecVWLmL(gt2,gt3) 
coup2(6) = cplFvFecVWLmR(gt2,gt3) 
coup2(8) = cplFvFeHpmL(gt2,gt3,i2) 
coup2(7) = cplFvFeHpmR(gt2,gt3,i2) 
Call IntegrateGaugeSscalarS(Boson4, mass, coup2, deltaM, epsI,IntegralVSss,NVSss, resC, check) 
If (resC.ne.resC) resC = 0._dp
resC = 2._dp*resC 
resC= 1*resC ! color factor 
...
If (resS.ne.resS) Then 
Write(*,*) "NaN appearing in the following diagrams: " 
Write(*,*) "Fd->Fu Fv Fe Propagator: VWLm,conj[Hpm]" 
Write(*,*)  "M_in: ",m_in 
Write(*,*)  "mass: ",mass 
Write(*,*)  "coup: ",coup 
gSum(gt1,gt2,gt3,Isum)= 0._dp  
...
If (resS.ne.resS) Then 
Write(*,*) "NaN appearing in the following diagrams: " 
Write(*,*) "Fd->Fu Fv Fe Propagator: VWRm,conj[Hpm]" 
Write(*,*)  "M_in: ",m_in 
Write(*,*)  "mass: ",mass 
Write(*,*)  "coup: ",coup 
gSum(gt1,gt2,gt3,Isum)= 0._dp  
...
coup2(1) = cplcFdFucHpmL(iIN,gt1,i1) 
coup2(2) = cplcFdFucHpmR(iIN,gt1,i1) 
coup2(4) = cplcFdFucHpmL(iIN,gt1,i2) 
coup2(3) = cplcFdFucHpmR(iIN,gt1,i2)  
...
If (resS.ne.resS) Then 
Write(*,*) "NaN appearing in the following diagrams: " 
Write(*,*) "Fd->Fu Fv Fe Propagator: conj[Hpm],conj[Hpm]" 
Write(*,*)  "M_in: ",m_in 
Write(*,*)  "mass: ",mass 
Write(*,*)  "coup: ",coup 
gSum(gt1,gt2,gt3,Isum)= 0._dp  
