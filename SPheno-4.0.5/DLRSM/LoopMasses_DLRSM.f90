...
! ------------------------------------------------------------------------------  
! File created at 20:07 on 28.5.2025   
! ----------------------------------------------------------------------  
...
& cplAhcHpmcVWLm(4,4),cplAhcHpmcVWRm(4,4),cplAhcUHpmcHpm(4,4,4),cplAhcUHpmcVWLm(4,4),    & 
& cplAhcUHpmcVWRm(4,4),cplAhcVWLmVWRm(4),cplAhcVWRmVWLm(4),cplAhhhcUHpm(4,4,4),          & 
& cplAhhhVP(4,4),cplAhhhVZ(4,4),cplAhhhVZR(4,4),cplAhHpmcUHpm(4,4,4),cplAhHpmVWLm(4,4),  & 
& cplAhUhhcHpm(4,4,4),cplAhUhhhh(4,4,4),cplAhUhhVP(4,4),cplAhUhhVZ(4,4),cplAhUhhVZR(4,4),& 
& cplcFdFdUAhL(3,3,4),cplcFdFdUAhR(3,3,4),cplcFdFdUhhL(3,3,4),cplcFdFdUhhR(3,3,4),       & 
& cplcFdFdVGL(3,3),cplcFdFdVGR(3,3),cplcFdFdVPL(3,3),cplcFdFdVPR(3,3),cplcFdFdVZL(3,3),  & 
& cplcFdFdVZR(3,3),cplcFdFdVZRL(3,3),cplcFdFdVZRR(3,3),cplcFdFucUHpmL(3,3,4),            & 
& cplcFdFucUHpmR(3,3,4),cplcFdFuVWLmL(3,3),cplcFdFuVWLmR(3,3),cplcFeFeUAhL(3,3,4),       & 
...
& cplcFeFvcUHpmL(3,9,4),cplcFeFvcUHpmR(3,9,4),cplcFeFvVWLmL(3,9),cplcFeFvVWLmR(3,9),     & 
& cplcFeUFvcHpmL(3,9,4),cplcFeUFvcHpmR(3,9,4),cplcFeUFvVWLmL(3,9),cplcFeUFvVWLmR(3,9),   & 
& cplcFeUFvVWRmL(3,9),cplcFeUFvVWRmR(3,9),cplcFuFdcVWLmL(3,3),cplcFuFdcVWLmR(3,3),       & 
...
& cplcgWLmgWLmUhh(4),cplcgWLmgWLmVP,cplcgWLmgWLmVZ,cplcgWLmgWLmVZR,cplcgWLmgWRmUAh(4),   & 
& cplcgWLmgWRmUhh(4),cplcgWLmgWRmVP,cplcgWLmgWRmVZ,cplcgWLmgWRmVZR,cplcgWLmgZcUHpm(4),   & 
& cplcgWLmgZpcUHpm(4),cplcgWLmgZpVWLm,cplcgWLmgZVWLm,cplcgWLpgPcVWLm,cplcgWLpgPcVWRm,    & 
...
& cplcgWLpgZcVWLm,cplcgWLpgZcVWRm,cplcgWLpgZpcVWLm,cplcgWLpgZpcVWRm,cplcgWLpgZpUHpm(4),  & 
& cplcgWLpgZUHpm(4),cplcgWRmgPVWLm,cplcgWRmgWLmUAh(4),cplcgWRmgWLmUhh(4),cplcgWRmgWLmVP, & 
& cplcgWRmgWLmVZ,cplcgWRmgWLmVZR,cplcgWRmgWRmUAh(4),cplcgWRmgWRmUhh(4),cplcgWRmgWRmVP,   & 
& cplcgWRmgWRmVZ,cplcgWRmgWRmVZR,cplcgWRmgZcUHpm(4),cplcgWRmgZpcUHpm(4),cplcgWRmgZpVWLm, & 
& cplcgWRmgZVWLm,cplcgWRpgPcVWLm,cplcgWRpgPcVWRm,cplcgWRpgWLpUAh(4),cplcgWRpgWLpUhh(4),  & 
& cplcgWRpgWLpVP,cplcgWRpgWLpVZ,cplcgWRpgWLpVZR,cplcgWRpgWRpUAh(4),cplcgWRpgWRpUhh(4),   & 
& cplcgWRpgWRpVP,cplcgWRpgWRpVZ,cplcgWRpgWRpVZR,cplcgWRpgZcVWLm,cplcgWRpgZcVWRm,         & 
& cplcgWRpgZpcVWLm,cplcgWRpgZpcVWRm,cplcgWRpgZpUHpm(4),cplcgWRpgZUHpm(4),cplcgZgWLmcVWLm,& 
& cplcgZgWLmcVWRm,cplcgZgWLmUHpm(4),cplcgZgWLpcUHpm(4),cplcgZgWLpVWLm,cplcgZgWRmcVWLm,   & 
& cplcgZgWRmcVWRm,cplcgZgWRmUHpm(4),cplcgZgWRpcUHpm(4),cplcgZgWRpVWLm,cplcgZgZpUhh(4),   & 
& cplcgZgZUhh(4),cplcgZpgWLmcVWLm,cplcgZpgWLmcVWRm,cplcgZpgWLmUHpm(4),cplcgZpgWLpcUHpm(4)

Complex(dp) :: cplcgZpgWLpVWLm,cplcgZpgWRmcVWLm,cplcgZpgWRmcVWRm,cplcgZpgWRmUHpm(4),cplcgZpgWRpcUHpm(4),& 
& cplcgZpgWRpVWLm,cplcgZpgZpUhh(4),cplcgZpgZUhh(4),cplcHpmcVWLmVP(4),cplcHpmcVWLmVZ(4),  & 
...
& cplcUFdFuVWRmL(3,3),cplcUFdFuVWRmR(3,3),cplcUFeFeAhL(3,3,4),cplcUFeFeAhR(3,3,4),       & 
...
& cplcUFeFvcHpmL(3,9,4),cplcUFeFvcHpmR(3,9,4),cplcUFeFvVWLmL(3,9),cplcUFeFvVWLmR(3,9),   & 
& cplcUFeFvVWRmL(3,9),cplcUFeFvVWRmR(3,9),cplcUFuFdcVWLmL(3,3),cplcUFuFdcVWLmR(3,3),     & 
& cplcUFuFdcVWRmL(3,3),cplcUFuFdcVWRmR(3,3),cplcUFuFdHpmL(3,3,4),cplcUFuFdHpmR(3,3,4),   & 
& cplcUFuFuAhL(3,3,4),cplcUFuFuAhR(3,3,4),cplcUFuFuhhL(3,3,4),cplcUFuFuhhR(3,3,4),       & 
...
& cplcUHpmcHpmcHpm(4,4,4),cplcUHpmcVWLmVP(4),cplcUHpmcVWLmVZ(4),cplcUHpmcVWLmVZR(4),     & 
...
& cplcVWLmVWRmVZ,cplcVWLmVWRmVZR,cplcVWRmcVWRmVWLmVWRm1,cplcVWRmcVWRmVWLmVWRm2,          & 
& cplcVWRmcVWRmVWLmVWRm3,cplcVWRmcVWRmVWRmVWRm1,cplcVWRmcVWRmVWRmVWRm2,cplcVWRmcVWRmVWRmVWRm3,& 
...
& cplcVWRmVPVWRmVZ2,cplcVWRmVPVWRmVZ3,cplcVWRmVPVWRmVZR1,cplcVWRmVPVWRmVZR2,             & 
...
Complex(dp) :: cplFvFvVZR(9,9),cplFvFvVZRL(9,9),cplFvFvVZRR(9,9),cplhhcHpmcVWLm(4,4),cplhhcHpmcVWRm(4,4),& 
& cplhhcUHpmcHpm(4,4,4),cplhhcUHpmcVWLm(4,4),cplhhcUHpmcVWRm(4,4),cplhhcVWLmVWLm(4),     & 
& cplhhcVWLmVWRm(4),cplhhcVWRmVWLm(4),cplhhcVWRmVWRm(4),cplhhhhcUHpm(4,4,4),             & 
& cplhhhhcVWLmVWLm(4,4),cplhhhhcVWRmVWLm(4,4),cplhhhhcVWRmVWRm(4,4),cplhhhhUHpmcUHpm(4,4,4,4),& 
& cplhhhhVPVP(4,4),cplhhhhVPVZ(4,4),cplhhhhVPVZR(4,4),cplhhhhVZRVZR(4,4),cplhhhhVZVZ(4,4),& 
& cplhhhhVZVZR(4,4),cplhhHpmcUHpm(4,4,4),cplhhHpmVWLm(4,4),cplhhVPVZ(4),cplhhVPVZR(4),   & 
& cplhhVZRVZR(4),cplhhVZVZ(4),cplhhVZVZR(4),cplHpmcHpmcVWLmVWLm(4,4),cplHpmcHpmcVWRmVWLm(4,4),& 
...
& cplHpmVWLmVZR(4),cplHpmVWRmVZ(4),cplHpmVWRmVZR(4),cplUAhAhAh(4,4,4),cplUAhAhcHpm(4,4,4),& 
& cplUAhAhhh(4,4,4),cplUAhcVWRmVWLm(4),cplUAhhhcHpm(4,4,4),cplUAhhhhh(4,4,4),            & 
& cplUAhhhVP(4,4),cplUAhhhVZ(4,4),cplUAhhhVZR(4,4),cplUAhHpmcHpm(4,4,4),cplUAhHpmHpm(4,4,4),& 
...
& cplUhhHpmHpm(4,4,4),cplUhhHpmVWLm(4,4),cplUhhHpmVWRm(4,4),cplUhhUhhcVWLmVWLm(4,4),     & 
& cplUhhUhhcVWRmVWRm(4,4),cplUhhUhhhhhh(4,4,4,4),cplUhhUhhHpmcHpm(4,4,4,4),              & 
& cplUhhUhhVPVP(4,4),cplUhhUhhVZRVZR(4,4),cplUhhUhhVZVZ(4,4),cplUhhVPVZ(4),              & 
& cplUhhVPVZR(4),cplUhhVZRVZR(4),cplUhhVZVZ(4),cplUhhVZVZR(4),cplUHpmcUHpmcVWLmVWLm(4,4),& 
...
Call CouplingsForLoopMasses(LAM2,LAM1,ALP1,RHO1,RHO2,ALP2,LAM3,LAM4,LAM6,             & 
& k1,k2,vR,vL,UP,ZH,ALP3,LAM5,UC,gBL,g2,ZZ,YQ1,YQ2,ZDL,ZDR,Y,Yt,ZEL,ZER,ZUL,             & 
& ZUR,ZM,PhiW,g3,cplAhAhUhh,cplAhUhhhh,cplAhUhhcHpm,cplAhUhhVP,cplAhUhhVZ,               & 
...
& cplUhhHpmcHpm,cplUhhHpmHpm,cplUhhHpmVWLm,cplUhhHpmVWRm,cplUhhVPVZ,cplUhhVPVZR,         & 
& cplUhhcVWLmVWLm,cplUhhcVWRmVWLm,cplUhhcVWRmVWRm,cplUhhVZVZ,cplUhhVZVZR,cplUhhVZRVZR,   & 
& cplAhAhUhhUhh,cplUhhUhhhhhh,cplUhhUhhHpmcHpm,cplUhhUhhVPVP,cplUhhUhhcVWLmVWLm,         & 
& cplUhhUhhcVWRmVWRm,cplUhhUhhVZVZ,cplUhhUhhVZRVZR,cplUAhAhAh,cplUAhAhhh,cplUAhAhcHpm,   & 
...
& cplUAhhhhh,cplUAhhhcHpm,cplUAhhhVP,cplUAhhhVZ,cplUAhhhVZR,cplUAhHpmcHpm,               & 
& cplUAhHpmHpm,cplUAhHpmVWLm,cplUAhHpmVWRm,cplUAhcVWRmVWLm,cplUAhUAhAhAh,cplUAhUAhhhhh,  & 
& cplUAhUAhHpmcHpm,cplUAhUAhVPVP,cplUAhUAhcVWLmVWLm,cplUAhUAhcVWRmVWRm,cplUAhUAhVZVZ,    & 
& cplUAhUAhVZRVZR,cplAhAhcUHpm,cplAhhhcUHpm,cplAhcUHpmcHpm,cplAhcUHpmcVWLm,              & 
& cplAhcUHpmcVWRm,cplAhHpmcUHpm,cplcFdFucUHpmL,cplcFdFucUHpmR,cplcFeFvcUHpmL,            & 
& cplcFeFvcUHpmR,cplcgZgWLpcUHpm,cplcgWLpgZUHpm,cplcgZpgWLpcUHpm,cplcgWLpgZpUHpm,        & 
& cplcgZgWRpcUHpm,cplcgWRpgZUHpm,cplcgZpgWRpcUHpm,cplcgWRpgZpUHpm,cplcgWLmgZcUHpm,       & 
& cplcgZgWLmUHpm,cplcgWRmgZcUHpm,cplcgZgWRmUHpm,cplcgWLmgZpcUHpm,cplcgZpgWLmUHpm,        & 
& cplcgWRmgZpcUHpm,cplcgZpgWRmUHpm,cplhhhhcUHpm,cplhhcUHpmcHpm,cplhhcUHpmcVWLm,          & 
...
& cplcUHpmcVWLmVZR,cplcUHpmcVWRmVZR,cplcUHpmcHpmcHpm,cplAhAhUHpmcUHpm,cplhhhhUHpmcUHpm,  & 
...
& cplhhVZVZ,cplhhVZVZR,cplHpmcHpmVZ,cplHpmVWLmVZ,cplHpmVWRmVZ,cplcVWLmVWLmVZ,            & 
...
& cplcVWRmVWRmVZVZ3,cplAhhhVZR,cplcFdFdVZRL,cplcFdFdVZRR,cplcFeFeVZRL,cplcFeFeVZRR,      & 
& cplcFuFuVZRL,cplcFuFuVZRR,cplFvFvVZRL,cplFvFvVZRR,cplcgWLmgWLmVZR,cplcgWRmgWLmVZR,     & 
& cplcgWLpgWLpVZR,cplcgWRpgWLpVZR,cplcgWRmgWRmVZR,cplcgWRpgWRpVZR,cplhhVZRVZR,           & 
...
& cplcVWRmVWRmVZRVZR3,cplAhcHpmcVWLm,cplAhcVWLmVWRm,cplcFuFdcVWLmL,cplcFuFdcVWLmR,       & 
...
& cplAhAhVPVZR,cplhhhhVPVZR,cplHpmcHpmVPVZR,cplcVWLmVPVWLmVZR1,cplcVWLmVPVWLmVZR2,       & 
...
& cplAhHpmVWLm,cplcFdFuVWLmL,cplcFdFuVWLmR,cplcFeFvVWLmL,cplcFeFvVWLmR,cplcgWLmgPVWLm,   & 
...
Call OneLoopTadpoleshh(k1,k2,vL,vR,MAh,MAh2,MFd,MFd2,MFe,MFe2,MFu,MFu2,               & 
...
If (NewGBC) Then 
Call CalculatePi2S(125._dp**2,k1,k2,vR,vL,gBL,g2,g3,LAM2,LAM1,ALP1,RHO1,              & 
& RHO2,ALP2,ALP3,LAM5,LAM3,LAM4,LAM6,Y,YQ1,YQ2,Yt,MU12,MU22,kont,ti_ep2L,Pi2S_EffPot,    & 
& PiP2S_EffPot)

Else 
Call CalculatePi2S(0._dp,k1,k2,vR,vL,gBL,g2,g3,LAM2,LAM1,ALP1,RHO1,RHO2,              & 
& ALP2,ALP3,LAM5,LAM3,LAM4,LAM6,Y,YQ1,YQ2,Yt,MU12,MU22,kont,ti_ep2L,Pi2S_EffPot,         & 
& PiP2S_EffPot)
...
End if 
Call SolveTadpoleEquations(gBL,g2,g3,LAM2,LAM1,ALP1,RHO1,RHO2,ALP2,ALP3,              & 
& LAM5,LAM3,LAM4,LAM6,Y,YQ1,YQ2,Yt,MU12,MU22,k1,k2,vR,vL,Tad1Loop)

Tad1Loop(1:4) = Tad1Loop(1:4) - ti_ep2L 
Call SolveTadpoleEquations(gBL,g2,g3,LAM2,LAM1,ALP1,RHO1,RHO2,ALP2,ALP3,              & 
& LAM5,LAM3,LAM4,LAM6,Y,YQ1,YQ2,Yt,MU12,MU22,k1,k2,vR,vL,Tad1Loop)

Call OneLoophh(MU12,MU22,LAM2,LAM1,ALP1,RHO1,RHO2,ALP2,LAM3,LAM6,k1,k2,               & 
& vR,vL,MAh,MAh2,Mhh,Mhh2,MHpm,MHpm2,MVZ,MVZ2,MVZR,MVZR2,MFd,MFd2,MFe,MFe2,              & 
& MFu,MFu2,MFv,MFv2,MVWLm,MVWLm2,MVWRm,MVWRm2,cplAhAhUhh,cplAhUhhhh,cplAhUhhcHpm,        & 
...
& cplUhhhhhh,cplUhhhhcHpm,cplUhhHpmcHpm,cplUhhHpmHpm,cplUhhHpmVWLm,cplUhhHpmVWRm,        & 
& cplUhhVPVZ,cplUhhVPVZR,cplUhhcVWLmVWLm,cplUhhcVWRmVWLm,cplUhhcVWRmVWRm,cplUhhVZVZ,     & 
& cplUhhVZVZR,cplUhhVZRVZR,cplAhAhUhhUhh,cplUhhUhhhhhh,cplUhhUhhHpmcHpm,cplUhhUhhVPVP,   & 
...
Call OneLoopAh(gBL,g2,MU12,MU22,LAM2,LAM1,ALP1,RHO1,RHO2,ALP2,LAM3,LAM4,              & 
& LAM6,k1,k2,vR,vL,ZZ,MAh,MAh2,Mhh,Mhh2,MHpm,MHpm2,MFd,MFd2,MFe,MFe2,MFu,MFu2,           & 
& MFv,MFv2,MVZ,MVZ2,MVZR,MVZR2,MVWLm,MVWLm2,MVWRm,MVWRm2,cplUAhAhAh,cplUAhAhhh,          & 
...
& cplUAhHpmHpm,cplUAhHpmVWLm,cplUAhHpmVWRm,cplUAhcVWRmVWLm,cplUAhUAhAhAh,cplUAhUAhhhhh,  & 
& cplUAhUAhHpmcHpm,cplUAhUAhVPVP,cplUAhUAhcVWLmVWLm,cplUAhUAhcVWRmVWRm,cplUAhUAhVZVZ,    & 
& cplUAhUAhVZRVZR,0.1_dp*delta_mass,MAh_1L,MAh2_1L,UP_1L,kont)
...
End if 
Call OneLoopHpm(g2,MU12,MU22,LAM2,LAM1,ALP1,RHO1,RHO2,ALP2,ALP3,LAM5,LAM3,            & 
& LAM4,LAM6,k1,k2,vR,vL,PhiW,MAh,MAh2,Mhh,Mhh2,MHpm,MHpm2,MVWLm,MVWLm2,MVWRm,            & 
& MVWRm2,MFd,MFd2,MFu,MFu2,MFe,MFe2,MFv,MFv2,MVZ,MVZ2,MVZR,MVZR2,cplAhAhcUHpm,           & 
& cplAhhhcUHpm,cplAhcUHpmcHpm,cplAhcUHpmcVWLm,cplAhcUHpmcVWRm,cplAhHpmcUHpm,             & 
& cplcFdFucUHpmL,cplcFdFucUHpmR,cplcFeFvcUHpmL,cplcFeFvcUHpmR,cplcgZgWLpcUHpm,           & 
& cplcgWLpgZUHpm,cplcgZpgWLpcUHpm,cplcgWLpgZpUHpm,cplcgZgWRpcUHpm,cplcgWRpgZUHpm,        & 
& cplcgZpgWRpcUHpm,cplcgWRpgZpUHpm,cplcgWLmgZcUHpm,cplcgZgWLmUHpm,cplcgWRmgZcUHpm,       & 
& cplcgZgWRmUHpm,cplcgWLmgZpcUHpm,cplcgZpgWLmUHpm,cplcgWRmgZpcUHpm,cplcgZpgWRmUHpm,      & 
& cplhhhhcUHpm,cplhhcUHpmcHpm,cplhhcUHpmcVWLm,cplhhcUHpmcVWRm,cplhhHpmcUHpm,             & 
& cplHpmcUHpmcHpm,cplHpmcUHpmVP,cplHpmcUHpmVZ,cplHpmcUHpmVZR,cplcUHpmcVWLmVP,            & 
& cplcUHpmcVWRmVP,cplcUHpmcVWLmVZ,cplcUHpmcVWRmVZ,cplcUHpmcVWLmVZR,cplcUHpmcVWRmVZR,     & 
& cplcUHpmcHpmcHpm,cplAhAhUHpmcUHpm,cplhhhhUHpmcUHpm,cplUHpmHpmcUHpmcHpm,cplUHpmcUHpmVPVP,& 
...
Call OneLoopFv(Y,Yt,k1,k2,MFv,MFv2,MAh,MAh2,MVWLm,MVWLm2,MFe,MFe2,MVWRm,              & 
...
Call OneLoopVZR(gBL,g2,k1,k2,vR,vL,ZZ,Mhh,Mhh2,MAh,MAh2,MFd,MFd2,MFe,MFe2,            & 
...
Call OneLoopVWRm(g2,k1,k2,vR,vL,PhiW,MHpm,MHpm2,MAh,MAh2,MVWLm,MVWLm2,MFu,            & 
...
Subroutine OneLoopTadpoleshh(k1,k2,vL,vR,MAh,MAh2,MFd,MFd2,MFe,MFe2,MFu,              & 
& MFu2,MFv,MFv2,Mhh,Mhh2,MHpm,MHpm2,MVWLm,MVWLm2,MVWRm,MVWRm2,MVZ,MVZ2,MVZR,             & 
& MVZR2,cplAhAhUhh,cplcFdFdUhhL,cplcFdFdUhhR,cplcFeFeUhhL,cplcFeFeUhhR,cplcFuFuUhhL,     & 
& cplcFuFuUhhR,cplFvFvUhhL,cplFvFvUhhR,cplcgWLmgWLmUhh,cplcgWLpgWLpUhh,cplcgWRmgWRmUhh,  & 
& cplcgWRpgWRpUhh,cplcgZgZUhh,cplcgZpgZpUhh,cplUhhhhhh,cplUhhHpmcHpm,cplUhhcVWLmVWLm,    & 
...
Subroutine OneLoophh(MU12,MU22,LAM2,LAM1,ALP1,RHO1,RHO2,ALP2,LAM3,LAM6,               & 
& k1,k2,vR,vL,MAh,MAh2,Mhh,Mhh2,MHpm,MHpm2,MVZ,MVZ2,MVZR,MVZR2,MFd,MFd2,MFe,             & 
& MFe2,MFu,MFu2,MFv,MFv2,MVWLm,MVWLm2,MVWRm,MVWRm2,cplAhAhUhh,cplAhUhhhh,cplAhUhhcHpm,   & 
& cplAhUhhVP,cplAhUhhVZ,cplAhUhhVZR,cplcFdFdUhhL,cplcFdFdUhhR,cplcFeFeUhhL,              & 
& cplcFeFeUhhR,cplcFuFuUhhL,cplcFuFuUhhR,cplFvFvUhhL,cplFvFvUhhR,cplcgWLmgWLmUhh,        & 
& cplcgWRmgWLmUhh,cplcgWLmgWRmUhh,cplcgWLpgWLpUhh,cplcgWRpgWLpUhh,cplcgWLpgWRpUhh,       & 
& cplcgWRmgWRmUhh,cplcgWRpgWRpUhh,cplcgZgZUhh,cplcgZpgZUhh,cplcgZgZpUhh,cplcgZpgZpUhh,   & 
...
Implicit None 
Real(dp), Intent(in) :: MAh(4),MAh2(4),Mhh(4),Mhh2(4),MHpm(4),MHpm2(4),MVZ,MVZ2,MVZR,MVZR2,MFd(3),            & 
& MFd2(3),MFe(3),MFe2(3),MFu(3),MFu2(3),MFv(9),MFv2(9),MVWLm,MVWLm2,MVWRm,MVWRm2

Real(dp), Intent(in) :: MU12,MU22,LAM2,LAM1,ALP1,RHO1,RHO2,ALP2,LAM3,LAM6,k1,k2,vR,vL

Complex(dp), Intent(in) :: cplAhAhUhh(4,4,4),cplAhUhhhh(4,4,4),cplAhUhhcHpm(4,4,4),cplAhUhhVP(4,4),              & 
& cplAhUhhVZ(4,4),cplAhUhhVZR(4,4),cplcFdFdUhhL(3,3,4),cplcFdFdUhhR(3,3,4),              & 
& cplcFeFeUhhL(3,3,4),cplcFeFeUhhR(3,3,4),cplcFuFuUhhL(3,3,4),cplcFuFuUhhR(3,3,4),       & 
& cplFvFvUhhL(9,9,4),cplFvFvUhhR(9,9,4),cplcgWLmgWLmUhh(4),cplcgWRmgWLmUhh(4),           & 
& cplcgWLmgWRmUhh(4),cplcgWLpgWLpUhh(4),cplcgWRpgWLpUhh(4),cplcgWLpgWRpUhh(4),           & 
& cplcgWRmgWRmUhh(4),cplcgWRpgWRpUhh(4),cplcgZgZUhh(4),cplcgZpgZUhh(4),cplcgZgZpUhh(4),  & 
& cplcgZpgZpUhh(4),cplUhhhhhh(4,4,4),cplUhhhhcHpm(4,4,4),cplUhhHpmcHpm(4,4,4),           & 
& cplUhhHpmHpm(4,4,4),cplUhhHpmVWLm(4,4),cplUhhHpmVWRm(4,4),cplUhhVPVZ(4),               & 
...
mat2a(1,1) = 0._dp 
mat2a(1,1) = mat2a(1,1)-3*k1**2*LAM1
mat2a(1,1) = mat2a(1,1)-(k2**2*LAM1)
mat2a(1,1) = mat2a(1,1)-3*k1**2*LAM2
mat2a(1,1) = mat2a(1,1)-4*k2**2*LAM3
mat2a(1,1) = mat2a(1,1)-2*k2**2*LAM6
mat2a(1,1) = mat2a(1,1)+MU12
mat2a(1,1) = mat2a(1,1)-1._dp/2._dp*(ALP1*vL**2)
mat2a(1,1) = mat2a(1,1)-1._dp/2._dp*(ALP1*vR**2)
mat2a(1,2) = 0._dp 
mat2a(1,2) = mat2a(1,2)-2*k1*k2*LAM1
mat2a(1,2) = mat2a(1,2)-8*k1*k2*LAM3
mat2a(1,2) = mat2a(1,2)-4*k1*k2*LAM6
mat2a(1,3) = 0._dp 
mat2a(1,3) = mat2a(1,3)-(ALP1*k1*vR)
mat2a(1,4) = 0._dp 
mat2a(1,4) = mat2a(1,4)-(ALP1*k1*vL)
mat2a(2,2) = 0._dp 
mat2a(2,2) = mat2a(2,2)-(k1**2*LAM1)
mat2a(2,2) = mat2a(2,2)-3*k2**2*LAM1
mat2a(2,2) = mat2a(2,2)-3*k2**2*LAM2
mat2a(2,2) = mat2a(2,2)-4*k1**2*LAM3
mat2a(2,2) = mat2a(2,2)-2*k1**2*LAM6
mat2a(2,2) = mat2a(2,2)+MU12
mat2a(2,2) = mat2a(2,2)-1._dp/2._dp*(ALP1*vL**2)
mat2a(2,2) = mat2a(2,2)-1._dp/2._dp*(ALP2*vL**2)
mat2a(2,2) = mat2a(2,2)-1._dp/2._dp*(ALP1*vR**2)
mat2a(2,2) = mat2a(2,2)-1._dp/2._dp*(ALP2*vR**2)
mat2a(2,3) = 0._dp 
mat2a(2,3) = mat2a(2,3)-(ALP1*k2*vR)
mat2a(2,3) = mat2a(2,3)-(ALP2*k2*vR)
mat2a(2,4) = 0._dp 
mat2a(2,4) = mat2a(2,4)-(ALP1*k2*vL)
mat2a(2,4) = mat2a(2,4)-(ALP2*k2*vL)
mat2a(3,3) = 0._dp 
mat2a(3,3) = mat2a(3,3)-1._dp/2._dp*(ALP1*k1**2)
mat2a(3,3) = mat2a(3,3)-1._dp/2._dp*(ALP1*k2**2)
mat2a(3,3) = mat2a(3,3)-1._dp/2._dp*(ALP2*k2**2)
mat2a(3,3) = mat2a(3,3)+MU22
mat2a(3,3) = mat2a(3,3)-1._dp/2._dp*(RHO2*vL**2)
mat2a(3,3) = mat2a(3,3)-3*RHO1*vR**2
mat2a(3,4) = 0._dp 
mat2a(3,4) = mat2a(3,4)-(RHO2*vL*vR)
mat2a(4,4) = 0._dp 
mat2a(4,4) = mat2a(4,4)-1._dp/2._dp*(ALP1*k1**2)
mat2a(4,4) = mat2a(4,4)-1._dp/2._dp*(ALP1*k2**2)
mat2a(4,4) = mat2a(4,4)-1._dp/2._dp*(ALP2*k2**2)
mat2a(4,4) = mat2a(4,4)+MU22
mat2a(4,4) = mat2a(4,4)-3*RHO1*vL**2
mat2a(4,4) = mat2a(4,4)-1._dp/2._dp*(RHO2*vR**2)
...
PiSf(1,:,:) = ZeroC 
p2 = 0._dp 
Call Pi1Loophh(p2,MAh,MAh2,Mhh,Mhh2,MHpm,MHpm2,MVZ,MVZ2,MVZR,MVZR2,MFd,               & 
& MFd2,MFe,MFe2,MFu,MFu2,MFv,MFv2,MVWLm,MVWLm2,MVWRm,MVWRm2,cplAhAhUhh,cplAhUhhhh,       & 
...
& cplcgZgZpUhh,cplcgZpgZpUhh,cplUhhhhhh,cplUhhhhcHpm,cplUhhHpmcHpm,cplUhhHpmHpm,         & 
& cplUhhHpmVWLm,cplUhhHpmVWRm,cplUhhVPVZ,cplUhhVPVZR,cplUhhcVWLmVWLm,cplUhhcVWRmVWLm,    & 
...
Subroutine Pi1Loophh(p2,MAh,MAh2,Mhh,Mhh2,MHpm,MHpm2,MVZ,MVZ2,MVZR,MVZR2,             & 
& MFd,MFd2,MFe,MFe2,MFu,MFu2,MFv,MFv2,MVWLm,MVWLm2,MVWRm,MVWRm2,cplAhAhUhh,              & 
& cplAhUhhhh,cplAhUhhcHpm,cplAhUhhVP,cplAhUhhVZ,cplAhUhhVZR,cplcFdFdUhhL,cplcFdFdUhhR,   & 
& cplcFeFeUhhL,cplcFeFeUhhR,cplcFuFuUhhL,cplcFuFuUhhR,cplFvFvUhhL,cplFvFvUhhR,           & 
& cplcgWLmgWLmUhh,cplcgWRmgWLmUhh,cplcgWLmgWRmUhh,cplcgWLpgWLpUhh,cplcgWRpgWLpUhh,       & 
& cplcgWLpgWRpUhh,cplcgWRmgWRmUhh,cplcgWRpgWRpUhh,cplcgZgZUhh,cplcgZpgZUhh,              & 
& cplcgZgZpUhh,cplcgZpgZpUhh,cplUhhhhhh,cplUhhhhcHpm,cplUhhHpmcHpm,cplUhhHpmHpm,         & 
...
Do gO1 = 1, 4
  Do gO2 = gO1, 4
coup1 = cplUhhHpmHpm(gO1,i1,i2)
coup2 = Conjg(cplUhhHpmHpm(gO2,i1,i2))
    SumI(gO1,gO2) = coup1*coup2*B0m2 
   End Do 
End Do 
res = res +1._dp* SumI  
...
Subroutine OneLoopAh(gBL,g2,MU12,MU22,LAM2,LAM1,ALP1,RHO1,RHO2,ALP2,LAM3,             & 
& LAM4,LAM6,k1,k2,vR,vL,ZZ,MAh,MAh2,Mhh,Mhh2,MHpm,MHpm2,MFd,MFd2,MFe,MFe2,               & 
& MFu,MFu2,MFv,MFv2,MVZ,MVZ2,MVZR,MVZR2,MVWLm,MVWLm2,MVWRm,MVWRm2,cplUAhAhAh,            & 
& cplUAhAhhh,cplUAhAhcHpm,cplcFdFdUAhL,cplcFdFdUAhR,cplcFeFeUAhL,cplcFeFeUAhR,           & 
...
& cplcgWRpgWRpUAh,cplUAhhhhh,cplUAhhhcHpm,cplUAhhhVP,cplUAhhhVZ,cplUAhhhVZR,             & 
& cplUAhHpmcHpm,cplUAhHpmHpm,cplUAhHpmVWLm,cplUAhHpmVWRm,cplUAhcVWRmVWLm,cplUAhUAhAhAh,  & 
...
Implicit None 
Real(dp), Intent(in) :: MAh(4),MAh2(4),Mhh(4),Mhh2(4),MHpm(4),MHpm2(4),MFd(3),MFd2(3),MFe(3),MFe2(3),         & 
...
Complex(dp), Intent(in) :: cplUAhAhAh(4,4,4),cplUAhAhhh(4,4,4),cplUAhAhcHpm(4,4,4),cplcFdFdUAhL(3,3,4),          & 
& cplcFdFdUAhR(3,3,4),cplcFeFeUAhL(3,3,4),cplcFeFeUAhR(3,3,4),cplcFuFuUAhL(3,3,4),       & 
& cplcFuFuUAhR(3,3,4),cplFvFvUAhL(9,9,4),cplFvFvUAhR(9,9,4),cplcgWLmgWLmUAh(4),          & 
& cplcgWRmgWLmUAh(4),cplcgWLmgWRmUAh(4),cplcgWLpgWLpUAh(4),cplcgWRpgWLpUAh(4),           & 
& cplcgWLpgWRpUAh(4),cplcgWRmgWRmUAh(4),cplcgWRpgWRpUAh(4),cplUAhhhhh(4,4,4),            & 
& cplUAhhhcHpm(4,4,4),cplUAhhhVP(4,4),cplUAhhhVZ(4,4),cplUAhhhVZR(4,4),cplUAhHpmcHpm(4,4,4),& 
& cplUAhHpmHpm(4,4,4),cplUAhHpmVWLm(4,4),cplUAhHpmVWRm(4,4),cplUAhcVWRmVWLm(4),          & 
& cplUAhUAhAhAh(4,4,4,4),cplUAhUAhhhhh(4,4,4,4),cplUAhUAhHpmcHpm(4,4,4,4),               & 
& cplUAhUAhVPVP(4,4),cplUAhUAhcVWLmVWLm(4,4),cplUAhUAhcVWRmVWRm(4,4),cplUAhUAhVZVZ(4,4), & 
& cplUAhUAhVZRVZR(4,4)
...
mat2a(1,1) = mat2a(1,1)+2*k2**2*LAM4
mat2a(1,1) = mat2a(1,1)+2*k2**2*LAM6
mat2a(1,1) = mat2a(1,1)+MU12
mat2a(1,1) = mat2a(1,1)-1._dp/2._dp*(ALP1*vL**2)
mat2a(1,1) = mat2a(1,1)-1._dp/2._dp*(ALP1*vR**2)
mat2a(1,1) = mat2a(1,1)+(g2**2*k1**2*Conjg(ZZ(2,2))*RXiZ*ZZ(2,2))/4._dp
mat2a(1,1) = mat2a(1,1)-1._dp/4._dp*(g2**2*k1**2*Conjg(ZZ(3,2))*RXiZ*ZZ(2,2))
mat2a(1,1) = mat2a(1,1)+(g2**2*k1**2*Conjg(ZZ(2,3))*RXiZR*ZZ(2,3))/4._dp
mat2a(1,1) = mat2a(1,1)-1._dp/4._dp*(g2**2*k1**2*Conjg(ZZ(3,3))*RXiZR*ZZ(2,3))
mat2a(1,1) = mat2a(1,1)-1._dp/4._dp*(g2**2*k1**2*Conjg(ZZ(2,2))*RXiZ*ZZ(3,2))
mat2a(1,1) = mat2a(1,1)+(g2**2*k1**2*Conjg(ZZ(3,2))*RXiZ*ZZ(3,2))/4._dp
mat2a(1,1) = mat2a(1,1)-1._dp/4._dp*(g2**2*k1**2*Conjg(ZZ(2,3))*RXiZR*ZZ(3,3))
mat2a(1,1) = mat2a(1,1)+(g2**2*k1**2*Conjg(ZZ(3,3))*RXiZR*ZZ(3,3))/4._dp
mat2a(1,2) = 0._dp 
mat2a(1,2) = mat2a(1,2)+4*k1*k2*LAM3
mat2a(1,2) = mat2a(1,2)+2*k1*k2*LAM4
mat2a(1,2) = mat2a(1,2)+4*k1*k2*LAM6
mat2a(1,2) = mat2a(1,2)-1._dp/4._dp*(g2**2*k1*k2*Conjg(ZZ(2,2))*RXiZ*ZZ(2,2))
mat2a(1,2) = mat2a(1,2)+(g2**2*k1*k2*Conjg(ZZ(3,2))*RXiZ*ZZ(2,2))/4._dp
mat2a(1,2) = mat2a(1,2)-1._dp/4._dp*(g2**2*k1*k2*Conjg(ZZ(2,3))*RXiZR*ZZ(2,3))
mat2a(1,2) = mat2a(1,2)+(g2**2*k1*k2*Conjg(ZZ(3,3))*RXiZR*ZZ(2,3))/4._dp
mat2a(1,2) = mat2a(1,2)+(g2**2*k1*k2*Conjg(ZZ(2,2))*RXiZ*ZZ(3,2))/4._dp
mat2a(1,2) = mat2a(1,2)-1._dp/4._dp*(g2**2*k1*k2*Conjg(ZZ(3,2))*RXiZ*ZZ(3,2))
mat2a(1,2) = mat2a(1,2)+(g2**2*k1*k2*Conjg(ZZ(2,3))*RXiZR*ZZ(3,3))/4._dp
mat2a(1,2) = mat2a(1,2)-1._dp/4._dp*(g2**2*k1*k2*Conjg(ZZ(3,3))*RXiZR*ZZ(3,3))
mat2a(1,3) = 0._dp 
mat2a(1,3) = mat2a(1,3)+(g2*gBL*k1*vR*Conjg(ZZ(2,2))*RXiZ*ZZ(1,2))/4._dp
mat2a(1,3) = mat2a(1,3)-1._dp/4._dp*(g2*gBL*k1*vR*Conjg(ZZ(3,2))*RXiZ*ZZ(1,2))
mat2a(1,3) = mat2a(1,3)+(g2*gBL*k1*vR*Conjg(ZZ(2,3))*RXiZR*ZZ(1,3))/4._dp
mat2a(1,3) = mat2a(1,3)-1._dp/4._dp*(g2*gBL*k1*vR*Conjg(ZZ(3,3))*RXiZR*ZZ(1,3))
mat2a(1,3) = mat2a(1,3)+(g2*gBL*k1*vR*Conjg(ZZ(1,2))*RXiZ*ZZ(2,2))/4._dp
mat2a(1,3) = mat2a(1,3)-1._dp/8._dp*(g2**2*k1*vR*Conjg(ZZ(3,2))*RXiZ*ZZ(2,2))
mat2a(1,3) = mat2a(1,3)+(g2*gBL*k1*vR*Conjg(ZZ(1,3))*RXiZR*ZZ(2,3))/4._dp
mat2a(1,3) = mat2a(1,3)-1._dp/8._dp*(g2**2*k1*vR*Conjg(ZZ(3,3))*RXiZR*ZZ(2,3))
mat2a(1,3) = mat2a(1,3)-1._dp/4._dp*(g2*gBL*k1*vR*Conjg(ZZ(1,2))*RXiZ*ZZ(3,2))
mat2a(1,3) = mat2a(1,3)-1._dp/8._dp*(g2**2*k1*vR*Conjg(ZZ(2,2))*RXiZ*ZZ(3,2))
mat2a(1,3) = mat2a(1,3)+(g2**2*k1*vR*Conjg(ZZ(3,2))*RXiZ*ZZ(3,2))/4._dp
mat2a(1,3) = mat2a(1,3)-1._dp/4._dp*(g2*gBL*k1*vR*Conjg(ZZ(1,3))*RXiZR*ZZ(3,3))
mat2a(1,3) = mat2a(1,3)-1._dp/8._dp*(g2**2*k1*vR*Conjg(ZZ(2,3))*RXiZR*ZZ(3,3))
mat2a(1,3) = mat2a(1,3)+(g2**2*k1*vR*Conjg(ZZ(3,3))*RXiZR*ZZ(3,3))/4._dp
mat2a(1,4) = 0._dp 
mat2a(1,4) = mat2a(1,4)+(g2*gBL*k1*vL*Conjg(ZZ(2,2))*RXiZ*ZZ(1,2))/4._dp
mat2a(1,4) = mat2a(1,4)-1._dp/4._dp*(g2*gBL*k1*vL*Conjg(ZZ(3,2))*RXiZ*ZZ(1,2))
mat2a(1,4) = mat2a(1,4)+(g2*gBL*k1*vL*Conjg(ZZ(2,3))*RXiZR*ZZ(1,3))/4._dp
mat2a(1,4) = mat2a(1,4)-1._dp/4._dp*(g2*gBL*k1*vL*Conjg(ZZ(3,3))*RXiZR*ZZ(1,3))
mat2a(1,4) = mat2a(1,4)+(g2*gBL*k1*vL*Conjg(ZZ(1,2))*RXiZ*ZZ(2,2))/4._dp
mat2a(1,4) = mat2a(1,4)-1._dp/4._dp*(g2**2*k1*vL*Conjg(ZZ(2,2))*RXiZ*ZZ(2,2))
mat2a(1,4) = mat2a(1,4)+(g2**2*k1*vL*Conjg(ZZ(3,2))*RXiZ*ZZ(2,2))/8._dp
mat2a(1,4) = mat2a(1,4)+(g2*gBL*k1*vL*Conjg(ZZ(1,3))*RXiZR*ZZ(2,3))/4._dp
mat2a(1,4) = mat2a(1,4)-1._dp/4._dp*(g2**2*k1*vL*Conjg(ZZ(2,3))*RXiZR*ZZ(2,3))
mat2a(1,4) = mat2a(1,4)+(g2**2*k1*vL*Conjg(ZZ(3,3))*RXiZR*ZZ(2,3))/8._dp
mat2a(1,4) = mat2a(1,4)-1._dp/4._dp*(g2*gBL*k1*vL*Conjg(ZZ(1,2))*RXiZ*ZZ(3,2))
mat2a(1,4) = mat2a(1,4)+(g2**2*k1*vL*Conjg(ZZ(2,2))*RXiZ*ZZ(3,2))/8._dp
mat2a(1,4) = mat2a(1,4)-1._dp/4._dp*(g2*gBL*k1*vL*Conjg(ZZ(1,3))*RXiZR*ZZ(3,3))
mat2a(1,4) = mat2a(1,4)+(g2**2*k1*vL*Conjg(ZZ(2,3))*RXiZR*ZZ(3,3))/8._dp
mat2a(2,2) = 0._dp 
mat2a(2,2) = mat2a(2,2)-(k1**2*LAM1)
mat2a(2,2) = mat2a(2,2)-(k2**2*LAM1)
mat2a(2,2) = mat2a(2,2)-(k2**2*LAM2)
mat2a(2,2) = mat2a(2,2)+2*k1**2*LAM4
mat2a(2,2) = mat2a(2,2)+2*k1**2*LAM6
mat2a(2,2) = mat2a(2,2)+MU12
mat2a(2,2) = mat2a(2,2)-1._dp/2._dp*(ALP1*vL**2)
mat2a(2,2) = mat2a(2,2)-1._dp/2._dp*(ALP2*vL**2)
mat2a(2,2) = mat2a(2,2)-1._dp/2._dp*(ALP1*vR**2)
mat2a(2,2) = mat2a(2,2)-1._dp/2._dp*(ALP2*vR**2)
mat2a(2,2) = mat2a(2,2)+(g2**2*k2**2*Conjg(ZZ(2,2))*RXiZ*ZZ(2,2))/4._dp
mat2a(2,2) = mat2a(2,2)-1._dp/4._dp*(g2**2*k2**2*Conjg(ZZ(3,2))*RXiZ*ZZ(2,2))
mat2a(2,2) = mat2a(2,2)+(g2**2*k2**2*Conjg(ZZ(2,3))*RXiZR*ZZ(2,3))/4._dp
mat2a(2,2) = mat2a(2,2)-1._dp/4._dp*(g2**2*k2**2*Conjg(ZZ(3,3))*RXiZR*ZZ(2,3))
mat2a(2,2) = mat2a(2,2)-1._dp/4._dp*(g2**2*k2**2*Conjg(ZZ(2,2))*RXiZ*ZZ(3,2))
mat2a(2,2) = mat2a(2,2)+(g2**2*k2**2*Conjg(ZZ(3,2))*RXiZ*ZZ(3,2))/4._dp
mat2a(2,2) = mat2a(2,2)-1._dp/4._dp*(g2**2*k2**2*Conjg(ZZ(2,3))*RXiZR*ZZ(3,3))
mat2a(2,2) = mat2a(2,2)+(g2**2*k2**2*Conjg(ZZ(3,3))*RXiZR*ZZ(3,3))/4._dp
mat2a(2,3) = 0._dp 
mat2a(2,3) = mat2a(2,3)-1._dp/4._dp*(g2*gBL*k2*vR*Conjg(ZZ(2,2))*RXiZ*ZZ(1,2))
mat2a(2,3) = mat2a(2,3)+(g2*gBL*k2*vR*Conjg(ZZ(3,2))*RXiZ*ZZ(1,2))/4._dp
mat2a(2,3) = mat2a(2,3)-1._dp/4._dp*(g2*gBL*k2*vR*Conjg(ZZ(2,3))*RXiZR*ZZ(1,3))
mat2a(2,3) = mat2a(2,3)+(g2*gBL*k2*vR*Conjg(ZZ(3,3))*RXiZR*ZZ(1,3))/4._dp
mat2a(2,3) = mat2a(2,3)-1._dp/4._dp*(g2*gBL*k2*vR*Conjg(ZZ(1,2))*RXiZ*ZZ(2,2))
mat2a(2,3) = mat2a(2,3)+(g2**2*k2*vR*Conjg(ZZ(3,2))*RXiZ*ZZ(2,2))/8._dp
mat2a(2,3) = mat2a(2,3)-1._dp/4._dp*(g2*gBL*k2*vR*Conjg(ZZ(1,3))*RXiZR*ZZ(2,3))
mat2a(2,3) = mat2a(2,3)+(g2**2*k2*vR*Conjg(ZZ(3,3))*RXiZR*ZZ(2,3))/8._dp
mat2a(2,3) = mat2a(2,3)+(g2*gBL*k2*vR*Conjg(ZZ(1,2))*RXiZ*ZZ(3,2))/4._dp
mat2a(2,3) = mat2a(2,3)+(g2**2*k2*vR*Conjg(ZZ(2,2))*RXiZ*ZZ(3,2))/8._dp
mat2a(2,3) = mat2a(2,3)-1._dp/4._dp*(g2**2*k2*vR*Conjg(ZZ(3,2))*RXiZ*ZZ(3,2))
mat2a(2,3) = mat2a(2,3)+(g2*gBL*k2*vR*Conjg(ZZ(1,3))*RXiZR*ZZ(3,3))/4._dp
mat2a(2,3) = mat2a(2,3)+(g2**2*k2*vR*Conjg(ZZ(2,3))*RXiZR*ZZ(3,3))/8._dp
mat2a(2,3) = mat2a(2,3)-1._dp/4._dp*(g2**2*k2*vR*Conjg(ZZ(3,3))*RXiZR*ZZ(3,3))
mat2a(2,4) = 0._dp 
mat2a(2,4) = mat2a(2,4)-1._dp/4._dp*(g2*gBL*k2*vL*Conjg(ZZ(2,2))*RXiZ*ZZ(1,2))
mat2a(2,4) = mat2a(2,4)+(g2*gBL*k2*vL*Conjg(ZZ(3,2))*RXiZ*ZZ(1,2))/4._dp
mat2a(2,4) = mat2a(2,4)-1._dp/4._dp*(g2*gBL*k2*vL*Conjg(ZZ(2,3))*RXiZR*ZZ(1,3))
mat2a(2,4) = mat2a(2,4)+(g2*gBL*k2*vL*Conjg(ZZ(3,3))*RXiZR*ZZ(1,3))/4._dp
mat2a(2,4) = mat2a(2,4)-1._dp/4._dp*(g2*gBL*k2*vL*Conjg(ZZ(1,2))*RXiZ*ZZ(2,2))
mat2a(2,4) = mat2a(2,4)+(g2**2*k2*vL*Conjg(ZZ(2,2))*RXiZ*ZZ(2,2))/4._dp
mat2a(2,4) = mat2a(2,4)-1._dp/8._dp*(g2**2*k2*vL*Conjg(ZZ(3,2))*RXiZ*ZZ(2,2))
mat2a(2,4) = mat2a(2,4)-1._dp/4._dp*(g2*gBL*k2*vL*Conjg(ZZ(1,3))*RXiZR*ZZ(2,3))
mat2a(2,4) = mat2a(2,4)+(g2**2*k2*vL*Conjg(ZZ(2,3))*RXiZR*ZZ(2,3))/4._dp
mat2a(2,4) = mat2a(2,4)-1._dp/8._dp*(g2**2*k2*vL*Conjg(ZZ(3,3))*RXiZR*ZZ(2,3))
mat2a(2,4) = mat2a(2,4)+(g2*gBL*k2*vL*Conjg(ZZ(1,2))*RXiZ*ZZ(3,2))/4._dp
mat2a(2,4) = mat2a(2,4)-1._dp/8._dp*(g2**2*k2*vL*Conjg(ZZ(2,2))*RXiZ*ZZ(3,2))
mat2a(2,4) = mat2a(2,4)+(g2*gBL*k2*vL*Conjg(ZZ(1,3))*RXiZR*ZZ(3,3))/4._dp
mat2a(2,4) = mat2a(2,4)-1._dp/8._dp*(g2**2*k2*vL*Conjg(ZZ(2,3))*RXiZR*ZZ(3,3))
mat2a(3,3) = 0._dp 
mat2a(3,3) = mat2a(3,3)-1._dp/2._dp*(ALP1*k1**2)
mat2a(3,3) = mat2a(3,3)-1._dp/2._dp*(ALP1*k2**2)
mat2a(3,3) = mat2a(3,3)-1._dp/2._dp*(ALP2*k2**2)
...
mat2a(3,3) = mat2a(3,3)-1._dp/2._dp*(g2*gBL*vR**2*Conjg(ZZ(3,2))*RXiZ*ZZ(1,2))
mat2a(3,3) = mat2a(3,3)+gBL**2*vR**2*Conjg(ZZ(1,3))*RXiZR*ZZ(1,3)
mat2a(3,3) = mat2a(3,3)-1._dp/2._dp*(g2*gBL*vR**2*Conjg(ZZ(3,3))*RXiZR*ZZ(1,3))
mat2a(3,3) = mat2a(3,3)-1._dp/2._dp*(g2*gBL*vR**2*Conjg(ZZ(1,2))*RXiZ*ZZ(3,2))
mat2a(3,3) = mat2a(3,3)+(g2**2*vR**2*Conjg(ZZ(3,2))*RXiZ*ZZ(3,2))/4._dp
mat2a(3,3) = mat2a(3,3)-1._dp/2._dp*(g2*gBL*vR**2*Conjg(ZZ(1,3))*RXiZR*ZZ(3,3))
mat2a(3,3) = mat2a(3,3)+(g2**2*vR**2*Conjg(ZZ(3,3))*RXiZR*ZZ(3,3))/4._dp
mat2a(3,4) = 0._dp 
mat2a(3,4) = mat2a(3,4)+gBL**2*vL*vR*Conjg(ZZ(1,2))*RXiZ*ZZ(1,2)
mat2a(3,4) = mat2a(3,4)-1._dp/4._dp*(g2*gBL*vL*vR*Conjg(ZZ(2,2))*RXiZ*ZZ(1,2))
mat2a(3,4) = mat2a(3,4)-1._dp/4._dp*(g2*gBL*vL*vR*Conjg(ZZ(3,2))*RXiZ*ZZ(1,2))
mat2a(3,4) = mat2a(3,4)+gBL**2*vL*vR*Conjg(ZZ(1,3))*RXiZR*ZZ(1,3)
mat2a(3,4) = mat2a(3,4)-1._dp/4._dp*(g2*gBL*vL*vR*Conjg(ZZ(2,3))*RXiZR*ZZ(1,3))
mat2a(3,4) = mat2a(3,4)-1._dp/4._dp*(g2*gBL*vL*vR*Conjg(ZZ(3,3))*RXiZR*ZZ(1,3))
mat2a(3,4) = mat2a(3,4)-1._dp/4._dp*(g2*gBL*vL*vR*Conjg(ZZ(1,2))*RXiZ*ZZ(2,2))
mat2a(3,4) = mat2a(3,4)+(g2**2*vL*vR*Conjg(ZZ(3,2))*RXiZ*ZZ(2,2))/8._dp
mat2a(3,4) = mat2a(3,4)-1._dp/4._dp*(g2*gBL*vL*vR*Conjg(ZZ(1,3))*RXiZR*ZZ(2,3))
mat2a(3,4) = mat2a(3,4)+(g2**2*vL*vR*Conjg(ZZ(3,3))*RXiZR*ZZ(2,3))/8._dp
mat2a(3,4) = mat2a(3,4)-1._dp/4._dp*(g2*gBL*vL*vR*Conjg(ZZ(1,2))*RXiZ*ZZ(3,2))
mat2a(3,4) = mat2a(3,4)+(g2**2*vL*vR*Conjg(ZZ(2,2))*RXiZ*ZZ(3,2))/8._dp
mat2a(3,4) = mat2a(3,4)-1._dp/4._dp*(g2*gBL*vL*vR*Conjg(ZZ(1,3))*RXiZR*ZZ(3,3))
mat2a(3,4) = mat2a(3,4)+(g2**2*vL*vR*Conjg(ZZ(2,3))*RXiZR*ZZ(3,3))/8._dp
mat2a(4,4) = 0._dp 
mat2a(4,4) = mat2a(4,4)-1._dp/2._dp*(ALP1*k1**2)
mat2a(4,4) = mat2a(4,4)-1._dp/2._dp*(ALP1*k2**2)
mat2a(4,4) = mat2a(4,4)-1._dp/2._dp*(ALP2*k2**2)
...
mat2a(4,4) = mat2a(4,4)-1._dp/2._dp*(g2*gBL*vL**2*Conjg(ZZ(2,2))*RXiZ*ZZ(1,2))
mat2a(4,4) = mat2a(4,4)+gBL**2*vL**2*Conjg(ZZ(1,3))*RXiZR*ZZ(1,3)
mat2a(4,4) = mat2a(4,4)-1._dp/2._dp*(g2*gBL*vL**2*Conjg(ZZ(2,3))*RXiZR*ZZ(1,3))
mat2a(4,4) = mat2a(4,4)-1._dp/2._dp*(g2*gBL*vL**2*Conjg(ZZ(1,2))*RXiZ*ZZ(2,2))
mat2a(4,4) = mat2a(4,4)+(g2**2*vL**2*Conjg(ZZ(2,2))*RXiZ*ZZ(2,2))/4._dp
mat2a(4,4) = mat2a(4,4)-1._dp/2._dp*(g2*gBL*vL**2*Conjg(ZZ(1,3))*RXiZR*ZZ(2,3))
mat2a(4,4) = mat2a(4,4)+(g2**2*vL**2*Conjg(ZZ(2,3))*RXiZR*ZZ(2,3))/4._dp
...
If (i1.eq.1) p2 = 0._dp 
If (i1.eq.2) p2 = 0._dp 
Call Pi1LoopAh(p2,MAh,MAh2,Mhh,Mhh2,MHpm,MHpm2,MFd,MFd2,MFe,MFe2,MFu,MFu2,            & 
& MFv,MFv2,MVZ,MVZ2,MVZR,MVZR2,MVWLm,MVWLm2,MVWRm,MVWRm2,cplUAhAhAh,cplUAhAhhh,          & 
& cplUAhAhcHpm,cplcFdFdUAhL,cplcFdFdUAhR,cplcFeFeUAhL,cplcFeFeUAhR,cplcFuFuUAhL,         & 
& cplcFuFuUAhR,cplFvFvUAhL,cplFvFvUAhR,cplcgWLmgWLmUAh,cplcgWRmgWLmUAh,cplcgWLmgWRmUAh,  & 
& cplcgWLpgWLpUAh,cplcgWRpgWLpUAh,cplcgWLpgWRpUAh,cplcgWRmgWRmUAh,cplcgWRpgWRpUAh,       & 
...
Subroutine Pi1LoopAh(p2,MAh,MAh2,Mhh,Mhh2,MHpm,MHpm2,MFd,MFd2,MFe,MFe2,               & 
& MFu,MFu2,MFv,MFv2,MVZ,MVZ2,MVZR,MVZR2,MVWLm,MVWLm2,MVWRm,MVWRm2,cplUAhAhAh,            & 
& cplUAhAhhh,cplUAhAhcHpm,cplcFdFdUAhL,cplcFdFdUAhR,cplcFeFeUAhL,cplcFeFeUAhR,           & 
& cplcFuFuUAhL,cplcFuFuUAhR,cplFvFvUAhL,cplFvFvUAhR,cplcgWLmgWLmUAh,cplcgWRmgWLmUAh,     & 
& cplcgWLmgWRmUAh,cplcgWLpgWLpUAh,cplcgWRpgWLpUAh,cplcgWLpgWRpUAh,cplcgWRmgWRmUAh,       & 
...
Do gO1 = 1, 4
  Do gO2 = gO1, 4
coup1 = cplUAhHpmHpm(gO1,i1,i2)
coup2 = Conjg(cplUAhHpmHpm(gO2,i1,i2))
    SumI(gO1,gO2) = coup1*coup2*B0m2 
   End Do 
End Do 
res = res +1._dp* SumI  
...
Subroutine OneLoopHpm(g2,MU12,MU22,LAM2,LAM1,ALP1,RHO1,RHO2,ALP2,ALP3,LAM5,           & 
& LAM3,LAM4,LAM6,k1,k2,vR,vL,PhiW,MAh,MAh2,Mhh,Mhh2,MHpm,MHpm2,MVWLm,MVWLm2,             & 
& MVWRm,MVWRm2,MFd,MFd2,MFu,MFu2,MFe,MFe2,MFv,MFv2,MVZ,MVZ2,MVZR,MVZR2,cplAhAhcUHpm,     & 
& cplAhhhcUHpm,cplAhcUHpmcHpm,cplAhcUHpmcVWLm,cplAhcUHpmcVWRm,cplAhHpmcUHpm,             & 
& cplcFdFucUHpmL,cplcFdFucUHpmR,cplcFeFvcUHpmL,cplcFeFvcUHpmR,cplcgZgWLpcUHpm,           & 
& cplcgWLpgZUHpm,cplcgZpgWLpcUHpm,cplcgWLpgZpUHpm,cplcgZgWRpcUHpm,cplcgWRpgZUHpm,        & 
& cplcgZpgWRpcUHpm,cplcgWRpgZpUHpm,cplcgWLmgZcUHpm,cplcgZgWLmUHpm,cplcgWRmgZcUHpm,       & 
...
Implicit None 
Real(dp), Intent(in) :: MAh(4),MAh2(4),Mhh(4),Mhh2(4),MHpm(4),MHpm2(4),MVWLm,MVWLm2,MVWRm,MVWRm2,             & 
...
Complex(dp), Intent(in) :: cplAhAhcUHpm(4,4,4),cplAhhhcUHpm(4,4,4),cplAhcUHpmcHpm(4,4,4),cplAhcUHpmcVWLm(4,4),   & 
& cplAhcUHpmcVWRm(4,4),cplAhHpmcUHpm(4,4,4),cplcFdFucUHpmL(3,3,4),cplcFdFucUHpmR(3,3,4), & 
& cplcFeFvcUHpmL(3,9,4),cplcFeFvcUHpmR(3,9,4),cplcgZgWLpcUHpm(4),cplcgWLpgZUHpm(4),      & 
& cplcgZpgWLpcUHpm(4),cplcgWLpgZpUHpm(4),cplcgZgWRpcUHpm(4),cplcgWRpgZUHpm(4),           & 
& cplcgZpgWRpcUHpm(4),cplcgWRpgZpUHpm(4),cplcgWLmgZcUHpm(4),cplcgZgWLmUHpm(4),           & 
& cplcgWRmgZcUHpm(4),cplcgZgWRmUHpm(4),cplcgWLmgZpcUHpm(4),cplcgZpgWLmUHpm(4),           & 
& cplcgWRmgZpcUHpm(4),cplcgZpgWRmUHpm(4),cplhhhhcUHpm(4,4,4),cplhhcUHpmcHpm(4,4,4),      & 
& cplhhcUHpmcVWLm(4,4),cplhhcUHpmcVWRm(4,4),cplhhHpmcUHpm(4,4,4),cplHpmcUHpmcHpm(4,4,4), & 
& cplHpmcUHpmVP(4,4),cplHpmcUHpmVZ(4,4),cplHpmcUHpmVZR(4,4),cplcUHpmcVWLmVP(4),          & 
& cplcUHpmcVWRmVP(4),cplcUHpmcVWLmVZ(4),cplcUHpmcVWRmVZ(4),cplcUHpmcVWLmVZR(4),          & 
& cplcUHpmcVWRmVZR(4),cplcUHpmcHpmcHpm(4,4,4),cplAhAhUHpmcUHpm(4,4,4,4),cplhhhhUHpmcUHpm(4,4,4,4),& 
...
mat2a(1,1) = mat2a(1,1)-(k2**2*LAM1)
mat2a(1,1) = mat2a(1,1)-(k1**2*LAM2)
mat2a(1,1) = mat2a(1,1)-(k2**2*LAM2)
mat2a(1,1) = mat2a(1,1)+(k1**2*LAM5)/2._dp
mat2a(1,1) = mat2a(1,1)+MU12
mat2a(1,1) = mat2a(1,1)-1._dp/2._dp*(ALP1*vL**2)
mat2a(1,1) = mat2a(1,1)-1._dp/2._dp*(ALP1*vR**2)
mat2a(1,1) = mat2a(1,1)-1._dp/2._dp*(ALP2*vR**2)
mat2a(1,1) = mat2a(1,1)+(g2**2*k2**2*Cos(PhiW)**2*RXiWLm)/4._dp
mat2a(1,1) = mat2a(1,1)+(g2**2*k1**2*Cos(PhiW)**2*RXiWRm)/4._dp
mat2a(1,1) = mat2a(1,1)-1._dp/2._dp*(g2**2*k1*k2*Cos(PhiW)*RXiWLm*Sin(PhiW))
mat2a(1,1) = mat2a(1,1)+(g2**2*k1*k2*Cos(PhiW)*RXiWRm*Sin(PhiW))/2._dp
mat2a(1,1) = mat2a(1,1)+(g2**2*k1**2*RXiWLm*Sin(PhiW)**2)/4._dp
mat2a(1,1) = mat2a(1,1)+(g2**2*k2**2*RXiWRm*Sin(PhiW)**2)/4._dp
mat2a(1,2) = 0._dp 
mat2a(1,2) = mat2a(1,2)-(k1*k2*LAM2)
mat2a(1,2) = mat2a(1,2)+4*k1*k2*LAM3
mat2a(1,2) = mat2a(1,2)-(k1*k2*LAM4)
mat2a(1,2) = mat2a(1,2)+2*k1*k2*LAM6
mat2a(1,2) = mat2a(1,2)-1._dp/4._dp*(g2**2*k1*k2*Cos(PhiW)**2*RXiWLm)
mat2a(1,2) = mat2a(1,2)-1._dp/4._dp*(g2**2*k1*k2*Cos(PhiW)**2*RXiWRm)
mat2a(1,2) = mat2a(1,2)+(g2**2*k1**2*Cos(PhiW)*RXiWLm*Sin(PhiW))/4._dp
mat2a(1,2) = mat2a(1,2)+(g2**2*k2**2*Cos(PhiW)*RXiWLm*Sin(PhiW))/4._dp
mat2a(1,2) = mat2a(1,2)-1._dp/4._dp*(g2**2*k1**2*Cos(PhiW)*RXiWRm*Sin(PhiW))
mat2a(1,2) = mat2a(1,2)-1._dp/4._dp*(g2**2*k2**2*Cos(PhiW)*RXiWRm*Sin(PhiW))
mat2a(1,2) = mat2a(1,2)-1._dp/4._dp*(g2**2*k1*k2*RXiWLm*Sin(PhiW)**2)
mat2a(1,2) = mat2a(1,2)-1._dp/4._dp*(g2**2*k1*k2*RXiWRm*Sin(PhiW)**2)
mat2a(1,3) = 0._dp 
mat2a(1,3) = mat2a(1,3)-1._dp/2._dp*(ALP2*k1*vR)
mat2a(1,3) = mat2a(1,3)+(ALP3*k1*vR)/2._dp
mat2a(1,3) = mat2a(1,3)-1._dp/4._dp*(g2**2*k1*vR*Cos(PhiW)**2*RXiWRm)
mat2a(1,3) = mat2a(1,3)+(g2**2*k2*vR*Cos(PhiW)*RXiWLm*Sin(PhiW))/4._dp
mat2a(1,3) = mat2a(1,3)-1._dp/4._dp*(g2**2*k2*vR*Cos(PhiW)*RXiWRm*Sin(PhiW))
mat2a(1,3) = mat2a(1,3)-1._dp/4._dp*(g2**2*k1*vR*RXiWLm*Sin(PhiW)**2)
mat2a(1,4) = 0._dp 
mat2a(1,4) = mat2a(1,4)-1._dp/2._dp*(ALP2*k2*vL)
mat2a(1,4) = mat2a(1,4)+(g2**2*k2*vL*Cos(PhiW)**2*RXiWLm)/4._dp
mat2a(1,4) = mat2a(1,4)-1._dp/4._dp*(g2**2*k1*vL*Cos(PhiW)*RXiWLm*Sin(PhiW))
mat2a(1,4) = mat2a(1,4)+(g2**2*k1*vL*Cos(PhiW)*RXiWRm*Sin(PhiW))/4._dp
mat2a(1,4) = mat2a(1,4)+(g2**2*k2*vL*RXiWRm*Sin(PhiW)**2)/4._dp
mat2a(2,2) = 0._dp 
mat2a(2,2) = mat2a(2,2)-(k1**2*LAM1)
mat2a(2,2) = mat2a(2,2)-(k2**2*LAM1)
mat2a(2,2) = mat2a(2,2)-(k1**2*LAM2)
mat2a(2,2) = mat2a(2,2)-(k2**2*LAM2)
mat2a(2,2) = mat2a(2,2)+(k2**2*LAM5)/2._dp
mat2a(2,2) = mat2a(2,2)+MU12
mat2a(2,2) = mat2a(2,2)-1._dp/2._dp*(ALP1*vL**2)
mat2a(2,2) = mat2a(2,2)-1._dp/2._dp*(ALP2*vL**2)
mat2a(2,2) = mat2a(2,2)-1._dp/2._dp*(ALP1*vR**2)
mat2a(2,2) = mat2a(2,2)-1._dp/2._dp*(ALP3*vR**2)
mat2a(2,2) = mat2a(2,2)-1._dp/2._dp*(ALP3*vL**2*epsTensor(1,rig1))
mat2a(2,2) = mat2a(2,2)+(g2**2*k1**2*Cos(PhiW)**2*RXiWLm)/4._dp
mat2a(2,2) = mat2a(2,2)+(g2**2*k2**2*Cos(PhiW)**2*RXiWRm)/4._dp
mat2a(2,2) = mat2a(2,2)-1._dp/2._dp*(g2**2*k1*k2*Cos(PhiW)*RXiWLm*Sin(PhiW))
mat2a(2,2) = mat2a(2,2)+(g2**2*k1*k2*Cos(PhiW)*RXiWRm*Sin(PhiW))/2._dp
mat2a(2,2) = mat2a(2,2)+(g2**2*k2**2*RXiWLm*Sin(PhiW)**2)/4._dp
mat2a(2,2) = mat2a(2,2)+(g2**2*k1**2*RXiWRm*Sin(PhiW)**2)/4._dp
mat2a(2,3) = 0._dp 
mat2a(2,3) = mat2a(2,3)-1._dp/2._dp*(ALP2*k2*vR)
mat2a(2,3) = mat2a(2,3)+(g2**2*k2*vR*Cos(PhiW)**2*RXiWRm)/4._dp
mat2a(2,3) = mat2a(2,3)-1._dp/4._dp*(g2**2*k1*vR*Cos(PhiW)*RXiWLm*Sin(PhiW))
mat2a(2,3) = mat2a(2,3)+(g2**2*k1*vR*Cos(PhiW)*RXiWRm*Sin(PhiW))/4._dp
mat2a(2,3) = mat2a(2,3)+(g2**2*k2*vR*RXiWLm*Sin(PhiW)**2)/4._dp
mat2a(2,4) = 0._dp 
mat2a(2,4) = mat2a(2,4)-1._dp/2._dp*(ALP2*k1*vL)
mat2a(2,4) = mat2a(2,4)-1._dp/2._dp*(ALP3*k1*vL*epsTensor(1,rig1))
mat2a(2,4) = mat2a(2,4)-1._dp/4._dp*(g2**2*k1*vL*Cos(PhiW)**2*RXiWLm)
mat2a(2,4) = mat2a(2,4)+(g2**2*k2*vL*Cos(PhiW)*RXiWLm*Sin(PhiW))/4._dp
mat2a(2,4) = mat2a(2,4)-1._dp/4._dp*(g2**2*k2*vL*Cos(PhiW)*RXiWRm*Sin(PhiW))
mat2a(2,4) = mat2a(2,4)-1._dp/4._dp*(g2**2*k1*vL*RXiWRm*Sin(PhiW)**2)
mat2a(3,3) = 0._dp 
mat2a(3,3) = mat2a(3,3)-1._dp/2._dp*(ALP1*k1**2)
mat2a(3,3) = mat2a(3,3)-1._dp/2._dp*(ALP2*k1**2)
mat2a(3,3) = mat2a(3,3)-1._dp/2._dp*(ALP1*k2**2)
mat2a(3,3) = mat2a(3,3)+MU22
mat2a(3,3) = mat2a(3,3)-1._dp/2._dp*(RHO2*vL**2)
mat2a(3,3) = mat2a(3,3)-(RHO1*vR**2)
mat2a(3,3) = mat2a(3,3)+(g2**2*vR**2*Cos(PhiW)**2*RXiWRm)/4._dp
mat2a(3,3) = mat2a(3,3)+(g2**2*vR**2*RXiWLm*Sin(PhiW)**2)/4._dp
mat2a(3,4) = 0._dp 
mat2a(3,4) = mat2a(3,4)+(g2**2*vL*vR*Cos(PhiW)*RXiWLm*Sin(PhiW))/4._dp
mat2a(3,4) = mat2a(3,4)-1._dp/4._dp*(g2**2*vL*vR*Cos(PhiW)*RXiWRm*Sin(PhiW))
mat2a(4,4) = 0._dp 
mat2a(4,4) = mat2a(4,4)-1._dp/2._dp*(ALP1*k1**2)
...
mat2a(4,4) = mat2a(4,4)-(RHO1*vL**2)
mat2a(4,4) = mat2a(4,4)-1._dp/2._dp*(RHO2*vR**2)
mat2a(4,4) = mat2a(4,4)+(g2**2*vL**2*Cos(PhiW)**2*RXiWLm)/4._dp
mat2a(4,4) = mat2a(4,4)+(g2**2*vL**2*RXiWRm*Sin(PhiW)**2)/4._dp
...
If (i1.eq.1) p2 = 0._dp 
If (i1.eq.2) p2 = 0._dp 
Call Pi1LoopHpm(p2,MAh,MAh2,Mhh,Mhh2,MHpm,MHpm2,MVWLm,MVWLm2,MVWRm,MVWRm2,            & 
& MFd,MFd2,MFu,MFu2,MFe,MFe2,MFv,MFv2,MVZ,MVZ2,MVZR,MVZR2,cplAhAhcUHpm,cplAhhhcUHpm,     & 
& cplAhcUHpmcHpm,cplAhcUHpmcVWLm,cplAhcUHpmcVWRm,cplAhHpmcUHpm,cplcFdFucUHpmL,           & 
...
& cplhhcUHpmcHpm,cplhhcUHpmcVWLm,cplhhcUHpmcVWRm,cplhhHpmcUHpm,cplHpmcUHpmcHpm,          & 
& cplHpmcUHpmVP,cplHpmcUHpmVZ,cplHpmcUHpmVZR,cplcUHpmcVWLmVP,cplcUHpmcVWRmVP,            & 
& cplcUHpmcVWLmVZ,cplcUHpmcVWRmVZ,cplcUHpmcVWLmVZR,cplcUHpmcVWRmVZR,cplcUHpmcHpmcHpm,    & 
& cplAhAhUHpmcUHpm,cplhhhhUHpmcUHpm,cplUHpmHpmcUHpmcHpm,cplUHpmcUHpmVPVP,cplUHpmcUHpmcVWLmVWLm,& 
& cplUHpmcUHpmcVWRmVWRm,cplUHpmcUHpmVZVZ,cplUHpmcUHpmVZRVZR,kont,PiSf(1,:,:))
...
& cplcUHpmcVWLmVZ,cplcUHpmcVWRmVZ,cplcUHpmcVWLmVZR,cplcUHpmcVWRmVZR,cplcUHpmcHpmcHpm,    & 
& cplAhAhUHpmcUHpm,cplhhhhUHpmcUHpm,cplUHpmHpmcUHpmcHpm,cplUHpmcUHpmVPVP,cplUHpmcUHpmcVWLmVWLm,& 
& cplUHpmcUHpmcVWRmVWRm,cplUHpmcUHpmVZVZ,cplUHpmcUHpmVZRVZR,kont,PiSf(i1,:,:))
...
Subroutine Pi1LoopHpm(p2,MAh,MAh2,Mhh,Mhh2,MHpm,MHpm2,MVWLm,MVWLm2,MVWRm,             & 
& MVWRm2,MFd,MFd2,MFu,MFu2,MFe,MFe2,MFv,MFv2,MVZ,MVZ2,MVZR,MVZR2,cplAhAhcUHpm,           & 
& cplAhhhcUHpm,cplAhcUHpmcHpm,cplAhcUHpmcVWLm,cplAhcUHpmcVWRm,cplAhHpmcUHpm,             & 
& cplcFdFucUHpmL,cplcFdFucUHpmR,cplcFeFvcUHpmL,cplcFeFvcUHpmR,cplcgZgWLpcUHpm,           & 
& cplcgWLpgZUHpm,cplcgZpgWLpcUHpm,cplcgWLpgZpUHpm,cplcgZgWRpcUHpm,cplcgWRpgZUHpm,        & 
...
Do gO1 = 1, 4
  Do gO2 = gO1, 4
coup1 = cplAhcUHpmcHpm(i2,gO1,i1)
coup2 = Conjg(cplAhcUHpmcHpm(i2,gO2,i1))
    SumI(gO1,gO2) = coup1*coup2*B0m2 
   End Do 
End Do 
res = res +1._dp* SumI  
...
Do gO1 = 1, 4
  Do gO2 = gO1, 4
coup1 = cplhhcUHpmcHpm(i2,gO1,i1)
coup2 = Conjg(cplhhcUHpmcHpm(i2,gO2,i1))
    SumI(gO1,gO2) = coup1*coup2*B0m2 
   End Do 
End Do 
res = res +1._dp* SumI  
...
Do gO1 = 1, 4
  Do gO2 = gO1, 4
coup1 = cplcUHpmcHpmcHpm(gO1,i1,i2)
coup2 = Conjg(cplcUHpmcHpmcHpm(gO2,i1,i2))
    SumI(gO1,gO2) = coup1*coup2*B0m2 
   End Do 
End Do 
res = res +1._dp/2._dp* SumI  
...
Subroutine OneLoopFd(YQ1,YQ2,k1,k2,MFd,MFd2,MAh,MAh2,Mhh,Mhh2,MVZ,MVZ2,               & 
...
mat1a(1,1) = 0._dp 
mat1a(1,1) = mat1a(1,1)+(k2*Conjg(YQ1(1,1)))/sqrt(2._dp)
mat1a(1,1) = mat1a(1,1)+(k1*Conjg(YQ2(1,1)))/sqrt(2._dp)
mat1a(1,2) = 0._dp 
mat1a(1,2) = mat1a(1,2)+(k2*Conjg(YQ1(1,2)))/sqrt(2._dp)
mat1a(1,2) = mat1a(1,2)+(k1*Conjg(YQ2(1,2)))/sqrt(2._dp)
mat1a(1,3) = 0._dp 
mat1a(1,3) = mat1a(1,3)+(k2*Conjg(YQ1(1,3)))/sqrt(2._dp)
mat1a(1,3) = mat1a(1,3)+(k1*Conjg(YQ2(1,3)))/sqrt(2._dp)
mat1a(2,1) = 0._dp 
mat1a(2,1) = mat1a(2,1)+(k2*Conjg(YQ1(2,1)))/sqrt(2._dp)
mat1a(2,1) = mat1a(2,1)+(k1*Conjg(YQ2(2,1)))/sqrt(2._dp)
mat1a(2,2) = 0._dp 
mat1a(2,2) = mat1a(2,2)+(k2*Conjg(YQ1(2,2)))/sqrt(2._dp)
mat1a(2,2) = mat1a(2,2)+(k1*Conjg(YQ2(2,2)))/sqrt(2._dp)
mat1a(2,3) = 0._dp 
mat1a(2,3) = mat1a(2,3)+(k2*Conjg(YQ1(2,3)))/sqrt(2._dp)
mat1a(2,3) = mat1a(2,3)+(k1*Conjg(YQ2(2,3)))/sqrt(2._dp)
mat1a(3,1) = 0._dp 
mat1a(3,1) = mat1a(3,1)+(k2*Conjg(YQ1(3,1)))/sqrt(2._dp)
mat1a(3,1) = mat1a(3,1)+(k1*Conjg(YQ2(3,1)))/sqrt(2._dp)
mat1a(3,2) = 0._dp 
mat1a(3,2) = mat1a(3,2)+(k2*Conjg(YQ1(3,2)))/sqrt(2._dp)
mat1a(3,2) = mat1a(3,2)+(k1*Conjg(YQ2(3,2)))/sqrt(2._dp)
mat1a(3,3) = 0._dp 
mat1a(3,3) = mat1a(3,3)+(k2*Conjg(YQ1(3,3)))/sqrt(2._dp)
...
Subroutine OneLoopFu(YQ1,YQ2,k1,k2,MFu,MFu2,MAh,MAh2,MVWLm,MVWLm2,MFd,MFd2,           & 
& MVWRm,MVWRm2,MHpm,MHpm2,Mhh,Mhh2,MVZ,MVZ2,MVZR,MVZR2,cplcUFuFuAhL,cplcUFuFuAhR,        & 
...
mat1a(1,1) = mat1a(1,1)+(k2*Conjg(YQ2(1,1)))/sqrt(2._dp)
mat1a(1,2) = 0._dp 
mat1a(1,2) = mat1a(1,2)+(k1*Conjg(YQ1(1,2)))/sqrt(2._dp)
mat1a(1,2) = mat1a(1,2)+(k2*Conjg(YQ2(1,2)))/sqrt(2._dp)
mat1a(1,3) = 0._dp 
mat1a(1,3) = mat1a(1,3)+(k1*Conjg(YQ1(1,3)))/sqrt(2._dp)
mat1a(1,3) = mat1a(1,3)+(k2*Conjg(YQ2(1,3)))/sqrt(2._dp)
mat1a(2,1) = 0._dp 
mat1a(2,1) = mat1a(2,1)+(k1*Conjg(YQ1(2,1)))/sqrt(2._dp)
mat1a(2,1) = mat1a(2,1)+(k2*Conjg(YQ2(2,1)))/sqrt(2._dp)
mat1a(2,2) = 0._dp 
mat1a(2,2) = mat1a(2,2)+(k1*Conjg(YQ1(2,2)))/sqrt(2._dp)
mat1a(2,2) = mat1a(2,2)+(k2*Conjg(YQ2(2,2)))/sqrt(2._dp)
mat1a(2,3) = 0._dp 
mat1a(2,3) = mat1a(2,3)+(k1*Conjg(YQ1(2,3)))/sqrt(2._dp)
mat1a(2,3) = mat1a(2,3)+(k2*Conjg(YQ2(2,3)))/sqrt(2._dp)
mat1a(3,1) = 0._dp 
mat1a(3,1) = mat1a(3,1)+(k1*Conjg(YQ1(3,1)))/sqrt(2._dp)
mat1a(3,1) = mat1a(3,1)+(k2*Conjg(YQ2(3,1)))/sqrt(2._dp)
mat1a(3,2) = 0._dp 
mat1a(3,2) = mat1a(3,2)+(k1*Conjg(YQ1(3,2)))/sqrt(2._dp)
mat1a(3,2) = mat1a(3,2)+(k2*Conjg(YQ2(3,2)))/sqrt(2._dp)
mat1a(3,3) = 0._dp 
mat1a(3,3) = mat1a(3,3)+(k1*Conjg(YQ1(3,3)))/sqrt(2._dp)
mat1a(3,3) = mat1a(3,3)+(k2*Conjg(YQ2(3,3)))/sqrt(2._dp)
...
Subroutine OneLoopFe(Y,Yt,k1,k2,MFe,MFe2,MAh,MAh2,Mhh,Mhh2,MVZ,MVZ2,MVZR,             & 
& MVZR2,MHpm,MHpm2,MFv,MFv2,MVWLm,MVWLm2,MVWRm,MVWRm2,cplcUFeFeAhL,cplcUFeFeAhR,         & 
& cplcUFeFehhL,cplcUFeFehhR,cplcUFeFeVPL,cplcUFeFeVPR,cplcUFeFeVZL,cplcUFeFeVZR,         & 
& cplcUFeFeVZRL,cplcUFeFeVZRR,cplcUFeFvcHpmL,cplcUFeFvcHpmR,cplcUFeFvVWLmL,              & 
...
mat1a(1,1) = 0._dp 
mat1a(1,1) = mat1a(1,1)+(k2*Conjg(Y(1,1)))/sqrt(2._dp)
mat1a(1,1) = mat1a(1,1)+(k1*Conjg(Yt(1,1)))/sqrt(2._dp)
mat1a(1,2) = 0._dp 
mat1a(1,2) = mat1a(1,2)+(k2*Conjg(Y(1,2)))/sqrt(2._dp)
mat1a(1,2) = mat1a(1,2)+(k1*Conjg(Yt(1,2)))/sqrt(2._dp)
mat1a(1,3) = 0._dp 
mat1a(1,3) = mat1a(1,3)+(k2*Conjg(Y(1,3)))/sqrt(2._dp)
mat1a(1,3) = mat1a(1,3)+(k1*Conjg(Yt(1,3)))/sqrt(2._dp)
mat1a(2,1) = 0._dp 
mat1a(2,1) = mat1a(2,1)+(k2*Conjg(Y(2,1)))/sqrt(2._dp)
mat1a(2,1) = mat1a(2,1)+(k1*Conjg(Yt(2,1)))/sqrt(2._dp)
mat1a(2,2) = 0._dp 
mat1a(2,2) = mat1a(2,2)+(k2*Conjg(Y(2,2)))/sqrt(2._dp)
mat1a(2,2) = mat1a(2,2)+(k1*Conjg(Yt(2,2)))/sqrt(2._dp)
mat1a(2,3) = 0._dp 
mat1a(2,3) = mat1a(2,3)+(k2*Conjg(Y(2,3)))/sqrt(2._dp)
mat1a(2,3) = mat1a(2,3)+(k1*Conjg(Yt(2,3)))/sqrt(2._dp)
mat1a(3,1) = 0._dp 
mat1a(3,1) = mat1a(3,1)+(k2*Conjg(Y(3,1)))/sqrt(2._dp)
mat1a(3,1) = mat1a(3,1)+(k1*Conjg(Yt(3,1)))/sqrt(2._dp)
mat1a(3,2) = 0._dp 
mat1a(3,2) = mat1a(3,2)+(k2*Conjg(Y(3,2)))/sqrt(2._dp)
mat1a(3,2) = mat1a(3,2)+(k1*Conjg(Yt(3,2)))/sqrt(2._dp)
mat1a(3,3) = 0._dp 
mat1a(3,3) = mat1a(3,3)+(k2*Conjg(Y(3,3)))/sqrt(2._dp)
...
Subroutine OneLoopFv(Y,Yt,k1,k2,MFv,MFv2,MAh,MAh2,MVWLm,MVWLm2,MFe,MFe2,              & 
& MVWRm,MVWRm2,MHpm,MHpm2,Mhh,Mhh2,MVZ,MVZ2,MVZR,MVZR2,cplUFvFvAhL,cplUFvFvAhR,          & 
...
mat1a(1,4) = mat1a(1,4)+(k2*Conjg(Yt(1,1)))/sqrt(2._dp)
mat1a(1,5) = 0._dp 
mat1a(1,5) = mat1a(1,5)+(k1*Conjg(Y(1,2)))/sqrt(2._dp)
mat1a(1,5) = mat1a(1,5)+(k2*Conjg(Yt(1,2)))/sqrt(2._dp)
mat1a(1,6) = 0._dp 
mat1a(1,6) = mat1a(1,6)+(k1*Conjg(Y(1,3)))/sqrt(2._dp)
mat1a(1,6) = mat1a(1,6)+(k2*Conjg(Yt(1,3)))/sqrt(2._dp)
mat1a(1,7) = 0._dp 
mat1a(1,8) = 0._dp 
mat1a(1,9) = 0._dp 
mat1a(2,1) = 0._dp 
...
mat1a(2,4) = mat1a(2,4)+(k2*Conjg(Yt(2,1)))/sqrt(2._dp)
mat1a(2,5) = 0._dp 
mat1a(2,5) = mat1a(2,5)+(k1*Conjg(Y(2,2)))/sqrt(2._dp)
mat1a(2,5) = mat1a(2,5)+(k2*Conjg(Yt(2,2)))/sqrt(2._dp)
mat1a(2,6) = 0._dp 
mat1a(2,6) = mat1a(2,6)+(k1*Conjg(Y(2,3)))/sqrt(2._dp)
mat1a(2,6) = mat1a(2,6)+(k2*Conjg(Yt(2,3)))/sqrt(2._dp)
mat1a(2,7) = 0._dp 
mat1a(2,8) = 0._dp 
mat1a(2,9) = 0._dp 
mat1a(3,1) = 0._dp 
...
mat1a(3,4) = mat1a(3,4)+(k2*Conjg(Yt(3,1)))/sqrt(2._dp)
mat1a(3,5) = 0._dp 
mat1a(3,5) = mat1a(3,5)+(k1*Conjg(Y(3,2)))/sqrt(2._dp)
mat1a(3,5) = mat1a(3,5)+(k2*Conjg(Yt(3,2)))/sqrt(2._dp)
mat1a(3,6) = 0._dp 
mat1a(3,6) = mat1a(3,6)+(k1*Conjg(Y(3,3)))/sqrt(2._dp)
mat1a(3,6) = mat1a(3,6)+(k2*Conjg(Yt(3,3)))/sqrt(2._dp)
mat1a(3,7) = 0._dp 
mat1a(3,8) = 0._dp 
mat1a(3,9) = 0._dp 
mat1a(4,1) = 0._dp 
mat1a(4,1) = mat1a(4,1)+(k1*Conjg(Y(1,1)))/sqrt(2._dp)
mat1a(4,1) = mat1a(4,1)+(k2*Conjg(Yt(1,1)))/sqrt(2._dp)
mat1a(4,2) = 0._dp 
mat1a(4,2) = mat1a(4,2)+(k1*Conjg(Y(2,1)))/sqrt(2._dp)
mat1a(4,2) = mat1a(4,2)+(k2*Conjg(Yt(2,1)))/sqrt(2._dp)
mat1a(4,3) = 0._dp 
mat1a(4,3) = mat1a(4,3)+(k1*Conjg(Y(3,1)))/sqrt(2._dp)
mat1a(4,3) = mat1a(4,3)+(k2*Conjg(Yt(3,1)))/sqrt(2._dp)
mat1a(4,4) = 0._dp 
mat1a(4,5) = 0._dp 
mat1a(4,6) = 0._dp 
mat1a(4,7) = 0._dp 
...
mat1a(5,1) = mat1a(5,1)+(k2*Conjg(Yt(1,2)))/sqrt(2._dp)
mat1a(5,2) = 0._dp 
mat1a(5,2) = mat1a(5,2)+(k1*Conjg(Y(2,2)))/sqrt(2._dp)
mat1a(5,2) = mat1a(5,2)+(k2*Conjg(Yt(2,2)))/sqrt(2._dp)
mat1a(5,3) = 0._dp 
mat1a(5,3) = mat1a(5,3)+(k1*Conjg(Y(3,2)))/sqrt(2._dp)
mat1a(5,3) = mat1a(5,3)+(k2*Conjg(Yt(3,2)))/sqrt(2._dp)
mat1a(5,4) = 0._dp 
mat1a(5,5) = 0._dp 
mat1a(5,6) = 0._dp 
mat1a(5,7) = 0._dp 
...
mat1a(6,1) = mat1a(6,1)+(k2*Conjg(Yt(1,3)))/sqrt(2._dp)
mat1a(6,2) = 0._dp 
mat1a(6,2) = mat1a(6,2)+(k1*Conjg(Y(2,3)))/sqrt(2._dp)
mat1a(6,2) = mat1a(6,2)+(k2*Conjg(Yt(2,3)))/sqrt(2._dp)
mat1a(6,3) = 0._dp 
mat1a(6,3) = mat1a(6,3)+(k1*Conjg(Y(3,3)))/sqrt(2._dp)
mat1a(6,3) = mat1a(6,3)+(k2*Conjg(Yt(3,3)))/sqrt(2._dp)
mat1a(6,4) = 0._dp 
mat1a(6,5) = 0._dp 
mat1a(6,6) = 0._dp 
mat1a(6,7) = 0._dp 
...
Subroutine OneLoopVZ(gBL,g2,k1,k2,vR,vL,ZZ,Mhh,Mhh2,MAh,MAh2,MFd,MFd2,MFe,            & 
& MFe2,MFu,MFu2,MFv,MFv2,MVZ,MVZ2,MVZR,MVZR2,MHpm,MHpm2,MVWLm,MVWLm2,MVWRm,              & 
& MVWRm2,cplAhhhVZ,cplcFdFdVZL,cplcFdFdVZR,cplcFeFeVZL,cplcFeFeVZR,cplcFuFuVZL,          & 
...
& cplHpmcHpmVZ,cplHpmVWLmVZ,cplHpmVWRmVZ,cplcVWLmVWLmVZ,cplcVWRmVWLmVZ,cplcVWRmVWRmVZ,   & 
...
Subroutine OneLoopVZR(gBL,g2,k1,k2,vR,vL,ZZ,Mhh,Mhh2,MAh,MAh2,MFd,MFd2,               & 
& MFe,MFe2,MFu,MFu2,MFv,MFv2,MVZ,MVZ2,MVZR,MVZR2,MHpm,MHpm2,MVWLm,MVWLm2,MVWRm,          & 
& MVWRm2,cplAhhhVZR,cplcFdFdVZRL,cplcFdFdVZRR,cplcFeFeVZRL,cplcFeFeVZRR,cplcFuFuVZRL,    & 
& cplcFuFuVZRR,cplFvFvVZRL,cplFvFvVZRR,cplcgWLmgWLmVZR,cplcgWRmgWLmVZR,cplcgWLpgWLpVZR,  & 
& cplcgWRpgWLpVZR,cplcgWRmgWRmVZR,cplcgWRpgWRpVZR,cplhhVPVZR,cplhhVZVZR,cplhhVZRVZR,     & 
& cplHpmcHpmVZR,cplHpmVWLmVZR,cplHpmVWRmVZR,cplcVWLmVWLmVZR,cplcVWRmVWLmVZR,             & 
& cplcVWRmVWRmVZR,cplAhAhVZRVZR,cplhhhhVZRVZR,cplHpmcHpmVZRVZR,cplcVWLmVWLmVZRVZR1,      & 
...
Subroutine OneLoopVWLm(g2,k1,k2,vR,vL,PhiW,MHpm,MHpm2,MAh,MAh2,MVWRm,MVWRm2,          & 
& MFu,MFu2,MFd,MFd2,MFv,MFv2,MFe,MFe2,Mhh,Mhh2,MVWLm,MVWLm2,MVZ,MVZ2,MVZR,               & 
& MVZR2,cplAhcHpmcVWLm,cplAhcVWLmVWRm,cplcFuFdcVWLmL,cplcFuFdcVWLmR,cplFvFecVWLmL,       & 
...
Real(dp), Intent(in) :: g2,k1,k2,vR,vL,PhiW
...
Subroutine OneLoopVWRm(g2,k1,k2,vR,vL,PhiW,MHpm,MHpm2,MAh,MAh2,MVWLm,MVWLm2,          & 
& MFu,MFu2,MFd,MFd2,MFv,MFv2,MFe,MFe2,Mhh,Mhh2,MVWRm,MVWRm2,MVZ,MVZ2,MVZR,               & 
& MVZR2,cplAhcHpmcVWRm,cplAhcVWRmVWLm,cplcFuFdcVWRmL,cplcFuFdcVWRmR,cplFvFecVWRmL,       & 
& cplFvFecVWRmR,cplcgWLpgPcVWRm,cplcgWRpgPcVWRm,cplcgPgWLmcVWRm,cplcgZgWLmcVWRm,         & 
& cplcgZpgWLmcVWRm,cplcgPgWRmcVWRm,cplcgZgWRmcVWRm,cplcgZpgWRmcVWRm,cplcgWLpgZcVWRm,     & 
& cplcgWRpgZcVWRm,cplcgWLpgZpcVWRm,cplcgWRpgZpcVWRm,cplhhcHpmcVWRm,cplhhcVWRmVWLm,       & 
& cplhhcVWRmVWRm,cplcHpmcVWRmVP,cplcVWRmVPVWLm,cplcVWRmVPVWRm,cplcVWRmVWLmVZ,            & 
...
sumI = 0._dp 
      ...
      Do i2 = 1, 4
 B0m2 = Real(VVSloop(p2,MVWLm2,MHpm2(i2)),dp) 
coup1 = cplcHpmcVWLmVP(i2)
coup2 = cplHpmVWLmVZ(i2)
    SumI = coup1*coup2*B0m2 
res = res +1._dp* SumI  
    End Do 
 !------------------------ 
...
sumI = 0._dp 
      ...
      Do i2 = 1, 4
 B0m2 = Real(VVSloop(p2,MVWRm2,MHpm2(i2)),dp) 
coup1 = cplcHpmcVWRmVP(i2)
coup2 = cplHpmVWRmVZ(i2)
    SumI = coup1*coup2*B0m2 
res = res +1._dp* SumI  
    End Do 
 !------------------------ 
...
& Mhh,Mhh2,MHpm,MHpm2,MVWLm,MVWLm2,MVWRm,MVWRm2,cplAhhhhh,cplAhhhVZ,cplcFdFdhhL,         & 
& cplcFdFdhhR,cplcFdFdVZL,cplcFdFdVZR,cplcFeFehhL,cplcFeFehhR,cplcFeFeVZL,               & 
& cplcFeFeVZR,cplcFuFuhhL,cplcFuFuhhR,cplcFuFuVZL,cplcFuFuVZR,cplcgWLmgWLmhh,            & 
& cplcgWLmgWLmVZ,cplcgWLmgWRmhh,cplcgWLmgWRmVZ,cplcgWLpgWLphh,cplcgWLpgWLpVZ,            & 
& cplcgWLpgWRphh,cplcgWLpgWRpVZ,cplcgWRmgWLmhh,cplcgWRmgWLmVZ,cplcgWRmgWRmhh,            & 
& cplcgWRmgWRmVZ,cplcgWRpgWLphh,cplcgWRpgWLpVZ,cplcgWRpgWRphh,cplcgWRpgWRpVZ,            & 
& cplcHpmcVWLmVZ,cplcHpmcVWRmVZ,cplcVWLmVWLmVZ,cplcVWLmVWRmVZ,cplcVWRmVWLmVZ,            & 
& cplcVWRmVWRmVZ,cplFvFvhhL,cplFvFvhhR,cplFvFvVZL,cplFvFvVZR,cplhhcHpmcVWLm,             & 
& cplhhcHpmcVWRm,cplhhcVWLmVWLm,cplhhcVWLmVWRm,cplhhcVWRmVWLm,cplhhcVWRmVWRm,            & 
& cplhhHpmcHpm,cplhhHpmVWLm,cplhhHpmVWRm,cplHpmcHpmVZ,cplHpmVWLmVZ,cplHpmVWRmVZ,kont,res)

Implicit None 
Real(dp), Intent(in) :: MAh(4),MAh2(4),MFd(3),MFd2(3),MFe(3),MFe2(3),MFu(3),MFu2(3),MFv(9),MFv2(9),           & 
& Mhh(4),Mhh2(4),MHpm(4),MHpm2(4),MVWLm,MVWLm2,MVWRm,MVWRm2

Complex(dp), Intent(in) :: cplAhhhhh(4,4,4),cplAhhhVZ(4,4),cplcFdFdhhL(3,3,4),cplcFdFdhhR(3,3,4),cplcFdFdVZL(3,3),& 
& cplcFdFdVZR(3,3),cplcFeFehhL(3,3,4),cplcFeFehhR(3,3,4),cplcFeFeVZL(3,3),               & 
& cplcFeFeVZR(3,3),cplcFuFuhhL(3,3,4),cplcFuFuhhR(3,3,4),cplcFuFuVZL(3,3),               & 
& cplcFuFuVZR(3,3),cplcgWLmgWLmhh(4),cplcgWLmgWLmVZ,cplcgWLmgWRmhh(4),cplcgWLmgWRmVZ,    & 
& cplcgWLpgWLphh(4),cplcgWLpgWLpVZ,cplcgWLpgWRphh(4),cplcgWLpgWRpVZ,cplcgWRmgWLmhh(4),   & 
& cplcgWRmgWLmVZ,cplcgWRmgWRmhh(4),cplcgWRmgWRmVZ,cplcgWRpgWLphh(4),cplcgWRpgWLpVZ,      & 
& cplcgWRpgWRphh(4),cplcgWRpgWRpVZ,cplcHpmcVWLmVZ(4),cplcHpmcVWRmVZ(4),cplcVWLmVWLmVZ,   & 
& cplcVWLmVWRmVZ,cplcVWRmVWLmVZ,cplcVWRmVWRmVZ,cplFvFvhhL(9,9,4),cplFvFvhhR(9,9,4),      & 
& cplFvFvVZL(9,9),cplFvFvVZR(9,9),cplhhcHpmcVWLm(4,4),cplhhcHpmcVWRm(4,4),               & 
...
Subroutine Pi1LoopVZRhh(p2,MAh,MAh2,MFd,MFd2,MFe,MFe2,MFu,MFu2,MFv,MFv2,              & 
& Mhh,Mhh2,MHpm,MHpm2,MVWLm,MVWLm2,MVWRm,MVWRm2,cplAhhhhh,cplAhhhVZR,cplcFdFdhhL,        & 
& cplcFdFdhhR,cplcFdFdVZRL,cplcFdFdVZRR,cplcFeFehhL,cplcFeFehhR,cplcFeFeVZRL,            & 
& cplcFeFeVZRR,cplcFuFuhhL,cplcFuFuhhR,cplcFuFuVZRL,cplcFuFuVZRR,cplcgWLmgWLmhh,         & 
& cplcgWLmgWLmVZR,cplcgWLmgWRmhh,cplcgWLmgWRmVZR,cplcgWLpgWLphh,cplcgWLpgWLpVZR,         & 
& cplcgWLpgWRphh,cplcgWLpgWRpVZR,cplcgWRmgWLmhh,cplcgWRmgWLmVZR,cplcgWRmgWRmhh,          & 
& cplcgWRmgWRmVZR,cplcgWRpgWLphh,cplcgWRpgWLpVZR,cplcgWRpgWRphh,cplcgWRpgWRpVZR,         & 
& cplcHpmcVWLmVZR,cplcHpmcVWRmVZR,cplcVWLmVWLmVZR,cplcVWLmVWRmVZR,cplcVWRmVWLmVZR,       & 
& cplcVWRmVWRmVZR,cplFvFvhhL,cplFvFvhhR,cplFvFvVZRL,cplFvFvVZRR,cplhhcHpmcVWLm,          & 
& cplhhcHpmcVWRm,cplhhcVWLmVWLm,cplhhcVWLmVWRm,cplhhcVWRmVWLm,cplhhcVWRmVWRm,            & 
& cplhhHpmcHpm,cplhhHpmVWLm,cplhhHpmVWRm,cplHpmcHpmVZR,cplHpmVWLmVZR,cplHpmVWRmVZR,kont,res)

Implicit None 
Real(dp), Intent(in) :: MAh(4),MAh2(4),MFd(3),MFd2(3),MFe(3),MFe2(3),MFu(3),MFu2(3),MFv(9),MFv2(9),           & 
& Mhh(4),Mhh2(4),MHpm(4),MHpm2(4),MVWLm,MVWLm2,MVWRm,MVWRm2

Complex(dp), Intent(in) :: cplAhhhhh(4,4,4),cplAhhhVZR(4,4),cplcFdFdhhL(3,3,4),cplcFdFdhhR(3,3,4),               & 
& cplcFdFdVZRL(3,3),cplcFdFdVZRR(3,3),cplcFeFehhL(3,3,4),cplcFeFehhR(3,3,4),             & 
& cplcFeFeVZRL(3,3),cplcFeFeVZRR(3,3),cplcFuFuhhL(3,3,4),cplcFuFuhhR(3,3,4),             & 
& cplcFuFuVZRL(3,3),cplcFuFuVZRR(3,3),cplcgWLmgWLmhh(4),cplcgWLmgWLmVZR,cplcgWLmgWRmhh(4),& 
& cplcgWLmgWRmVZR,cplcgWLpgWLphh(4),cplcgWLpgWLpVZR,cplcgWLpgWRphh(4),cplcgWLpgWRpVZR,   & 
& cplcgWRmgWLmhh(4),cplcgWRmgWLmVZR,cplcgWRmgWRmhh(4),cplcgWRmgWRmVZR,cplcgWRpgWLphh(4), & 
& cplcgWRpgWLpVZR,cplcgWRpgWRphh(4),cplcgWRpgWRpVZR,cplcHpmcVWLmVZR(4),cplcHpmcVWRmVZR(4),& 
& cplcVWLmVWLmVZR,cplcVWLmVWRmVZR,cplcVWRmVWLmVZR,cplcVWRmVWRmVZR,cplFvFvhhL(9,9,4),     & 
& cplFvFvhhR(9,9,4),cplFvFvVZRL(9,9),cplFvFvVZRR(9,9),cplhhcHpmcVWLm(4,4),               & 
& cplhhcHpmcVWRm(4,4),cplhhcVWLmVWLm(4),cplhhcVWLmVWRm(4),cplhhcVWRmVWLm(4),             & 
& cplhhcVWRmVWRm(4),cplhhHpmcHpm(4,4,4),cplhhHpmVWLm(4,4),cplhhHpmVWRm(4,4),             & 
& cplHpmcHpmVZR(4,4),cplHpmVWLmVZR(4),cplHpmVWRmVZR(4)
...
Subroutine DerPi1LoopVZRhh(p2,MAh,MAh2,MFd,MFd2,MFe,MFe2,MFu,MFu2,MFv,MFv2,           & 
& Mhh,Mhh2,MHpm,MHpm2,MVWLm,MVWLm2,MVWRm,MVWRm2,cplAhhhhh,cplAhhhVZR,cplcFdFdhhL,        & 
& cplcFdFdhhR,cplcFdFdVZRL,cplcFdFdVZRR,cplcFeFehhL,cplcFeFehhR,cplcFeFeVZRL,            & 
& cplcFeFeVZRR,cplcFuFuhhL,cplcFuFuhhR,cplcFuFuVZRL,cplcFuFuVZRR,cplcgWLmgWLmhh,         & 
& cplcgWLmgWLmVZR,cplcgWLmgWRmhh,cplcgWLmgWRmVZR,cplcgWLpgWLphh,cplcgWLpgWLpVZR,         & 
...
Subroutine Pi1LoopVWLmHpm(p2,MAh,MAh2,Mhh,Mhh2,MHpm,MHpm2,cplAhcHpmcHpm,              & 
& cplAhHpmVWLm,cplhhcHpmcHpm,cplhhHpmVWLm,kont,res)

Implicit None 
Real(dp), Intent(in) :: MAh(4),MAh2(4),Mhh(4),Mhh2(4),MHpm(4),MHpm2(4)

Complex(dp), Intent(in) :: cplAhcHpmcHpm(4,4,4),cplAhHpmVWLm(4,4),cplhhcHpmcHpm(4,4,4),cplhhHpmVWLm(4,4)
...
Subroutine DerPi1LoopVWLmHpm(p2,MAh,MAh2,Mhh,Mhh2,MHpm,MHpm2,cplAhcHpmcHpm,           & 
& cplAhHpmVWLm,cplhhcHpmcHpm,cplhhHpmVWLm,kont,res)
...
Subroutine Pi1LoopVWRmHpm(p2,MAh,MAh2,Mhh,Mhh2,MHpm,MHpm2,cplAhcHpmcHpm,              & 
& cplAhHpmVWRm,cplhhcHpmcHpm,cplhhHpmVWRm,kont,res)

Implicit None 
Real(dp), Intent(in) :: MAh(4),MAh2(4),Mhh(4),Mhh2(4),MHpm(4),MHpm2(4)

Complex(dp), Intent(in) :: cplAhcHpmcHpm(4,4,4),cplAhHpmVWRm(4,4),cplhhcHpmcHpm(4,4,4),cplhhHpmVWRm(4,4)
...
Subroutine DerPi1LoopVWRmHpm(p2,MAh,MAh2,Mhh,Mhh2,MHpm,MHpm2,cplAhcHpmcHpm,           & 
& cplAhHpmVWRm,cplhhcHpmcHpm,cplhhHpmVWRm,kont,res)
