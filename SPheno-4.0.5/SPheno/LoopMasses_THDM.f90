...
& betaH,vd,vu,g1,g2,g3,Lam5,Lam1,Lam4,Lam3,Lam2,Yu,Yd,Ye,M12,M112,M222,kont)
...
& cplcgWmgWmVZ,cplcgWmgZUHm(2),cplcgWpCgAcVWm,cplcgWpCgWpCUAh(2),cplcgWpCgWpCUhh(2),     & 
& cplcgWpCgWpCVZ,cplcgWpCgZcUHm(2),cplcgWpCgZcVWm,cplcgZgWmcUHm(2),cplcgZgWmcVWm,        & 
& cplcgZgWpCUHm(2),cplcgZgZUhh(2),cplcUFdFdAhL(3,3,2),cplcUFdFdAhR(3,3,2),               & 
...
& cplhhcUHmVWm(2,2),cplhhcVWmVWm(2),cplhhhhcVWmVWm(2,2),cplhhhhUHmcUHm(2,2,2,2),         & 
...
& cplHmcVWmVZ(2),cplUAhAhAh(2,2,2),cplUAhAhhh(2,2,2),cplUAhhhhh(2,2,2),cplUAhhhVZ(2,2),  & 
& cplUAhHmcHm(2,2,2),cplUAhHmcVWm(2,2),cplUAhUAhAhAh(2,2,2,2),cplUAhUAhcVWmVWm(2,2),     & 
& cplUAhUAhhhhh(2,2,2,2),cplUAhUAhHmcHm(2,2,2,2),cplUAhUAhVZVZ(2,2),cplUhhcVWmVWm(2),    & 
& cplUhhhhhh(2,2,2),cplUhhHmcHm(2,2,2),cplUhhHmcVWm(2,2),cplUhhUhhcVWmVWm(2,2),          & 
& cplUhhUhhhhhh(2,2,2,2),cplUhhUhhHmcHm(2,2,2,2),cplUhhUhhVZVZ(2,2),cplUhhVZVZ(2),       & 
& cplUHmcUHmcVWmVWm(2,2),cplUHmcUHmVPVP(2,2),cplUHmcUHmVZVZ(2,2),cplUHmHmcUHmcHm(2,2,2,2)
...
& vd,vu,g1,g2,g3,Lam5,Lam1,Lam4,Lam3,Lam2,Yu,Yd,Ye,M12,M112,M222,GenerationMixing,kont)
...
Call CouplingsForVectorBosons(g1,g2,ZH,ZA,TW,vd,vu,ZP,ZDL,ZUL,ZEL,cplAhhhVZ,          & 
...
vu=tanbQ*vd
Call SolveTadpoleEquations(g1,g2,g3,Lam5,Lam1,Lam4,Lam3,Lam2,Yu,Yd,Ye,M12,            & 
& M112,M222,vd,vu,(/ ZeroC, ZeroC /))

Call TreeMasses(MAh,MAh2,MFd,MFd2,MFe,MFe2,MFu,MFu2,Mhh,Mhh2,MHm,MHm2,MVWm,           & 
& MVWm2,MVZ,MVZ2,TW,ZDR,ZER,ZUR,v,ZDL,ZEL,ZUL,ZA,ZH,ZP,ZW,ZZ,alphaH,betaH,               & 
& vd,vu,g1,g2,g3,Lam5,Lam1,Lam4,Lam3,Lam2,Yu,Yd,Ye,M12,M112,M222,GenerationMixing,kont)

Call CouplingsForLoopMasses(Lam5,Lam1,Lam4,Lam3,Lam2,vd,vu,ZA,ZH,g1,g2,               & 
& TW,Yd,ZDL,ZDR,Ye,ZEL,ZER,Yu,ZUL,ZUR,ZP,g3,cplAhAhUhh,cplAhUhhhh,cplAhUhhVZ,            & 
...
M222Tree  = M222
Call SolveTadpoleEquations(g1,g2,g3,Lam5,Lam1,Lam4,Lam3,Lam2,Yu,Yd,Ye,M12,            & 
& M112,M222,vd,vu,Tad1Loop)

M1121L = M112
M2221L = M222
Call OneLoophh(M12,Lam5,M1122L,M2222L,Lam1,Lam4,Lam3,Lam2,vd,vu,MAh,MAh2,             & 
& Mhh,Mhh2,MVZ,MVZ2,MFd,MFd2,MFe,MFe2,MFu,MFu2,MHm,MHm2,MVWm,MVWm2,cplAhAhUhh,           & 
& cplAhUhhhh,cplAhUhhVZ,cplcFdFdUhhL,cplcFdFdUhhR,cplcFeFeUhhL,cplcFeFeUhhR,             & 
& cplcFuFuUhhL,cplcFuFuUhhR,cplcgWmgWmUhh,cplcgWpCgWpCUhh,cplcgZgZUhh,cplUhhhhhh,        & 
& cplUhhHmcHm,cplUhhHmcVWm,cplUhhcVWmVWm,cplUhhVZVZ,cplAhAhUhhUhh,cplUhhUhhhhhh,         & 
& cplUhhUhhHmcHm,cplUhhUhhcVWmVWm,cplUhhUhhVZVZ,0.1_dp*delta_mass,Mhh_1L,Mhh2_1L,        & 
& ZH_1L,kont)

Call OneLoopAh(g1,g2,M12,Lam5,M1121L,M2221L,Lam1,Lam4,Lam3,Lam2,vd,vu,TW,             & 
& MAh,MAh2,Mhh,Mhh2,MFd,MFd2,MFe,MFe2,MFu,MFu2,MVZ,MVZ2,MHm,MHm2,MVWm,MVWm2,             & 
...
& cplUAhHmcHm,cplUAhHmcVWm,cplUAhUAhAhAh,cplUAhUAhhhhh,cplUAhUAhHmcHm,cplUAhUAhcVWmVWm,  & 
& cplUAhUAhVZVZ,0.1_dp*delta_mass,MAh_1L,MAh2_1L,ZA_1L,kont)

Call OneLoopHm(g2,M12,Lam5,M1121L,M2221L,Lam1,Lam4,Lam3,Lam2,vd,vu,MHm,               & 
...
Subroutine OneLoophh(M12,Lam5,M112,M222,Lam1,Lam4,Lam3,Lam2,vd,vu,MAh,MAh2,           & 
& Mhh,Mhh2,MVZ,MVZ2,MFd,MFd2,MFe,MFe2,MFu,MFu2,MHm,MHm2,MVWm,MVWm2,cplAhAhUhh,           & 
& cplAhUhhhh,cplAhUhhVZ,cplcFdFdUhhL,cplcFdFdUhhR,cplcFeFeUhhL,cplcFeFeUhhR,             & 
& cplcFuFuUhhL,cplcFuFuUhhR,cplcgWmgWmUhh,cplcgWpCgWpCUhh,cplcgZgZUhh,cplUhhhhhh,        & 
& cplUhhHmcHm,cplUhhHmcVWm,cplUhhcVWmVWm,cplUhhVZVZ,cplAhAhUhhUhh,cplUhhUhhhhhh,         & 
...
Complex(dp), Intent(in) :: M12,Lam5,M112,M222,Lam1,Lam4,Lam3,Lam2
...
Subroutine OneLoopAh(g1,g2,M12,Lam5,M112,M222,Lam1,Lam4,Lam3,Lam2,vd,vu,              & 
& TW,MAh,MAh2,Mhh,Mhh2,MFd,MFd2,MFe,MFe2,MFu,MFu2,MVZ,MVZ2,MHm,MHm2,MVWm,MVWm2,          & 
& cplUAhAhAh,cplUAhAhhh,cplcFdFdUAhL,cplcFdFdUAhR,cplcFeFeUAhL,cplcFeFeUAhR,             & 
& cplcFuFuUAhL,cplcFuFuUAhR,cplcgWmgWmUAh,cplcgWpCgWpCUAh,cplUAhhhhh,cplUAhhhVZ,         & 
& cplUAhHmcHm,cplUAhHmcVWm,cplUAhUAhAhAh,cplUAhUAhhhhh,cplUAhUAhHmcHm,cplUAhUAhcVWmVWm,  & 
...
Subroutine OneLoopHm(g2,M12,Lam5,M112,M222,Lam1,Lam4,Lam3,Lam2,vd,vu,MHm,             & 
& MHm2,MAh,MAh2,MVWm,MVWm2,MFu,MFu2,MFd,MFd2,MFe,MFe2,Mhh,Mhh2,MVZ,MVZ2,cplAhHmcUHm,     & 
& cplAhcUHmVWm,cplcFuFdcUHmL,cplcFuFdcUHmR,cplcFvFecUHmL,cplcFvFecUHmR,cplcgZgWmcUHm,    & 
& cplcgWmgZUHm,cplcgWpCgZcUHm,cplcgZgWpCUHm,cplhhHmcUHm,cplhhcUHmVWm,cplHmcUHmVP,        & 
& cplHmcUHmVZ,cplcUHmVPVWm,cplcUHmVWmVZ,cplAhAhUHmcUHm,cplhhhhUHmcUHm,cplUHmHmcUHmcHm,   & 
& cplUHmcUHmVPVP,cplUHmcUHmcVWmVWm,cplUHmcUHmVZVZ,delta,mass,mass2,RS,kont)
...
Subroutine OneLoopFd(Yd,vu,MFd,MFd2,MAh,MAh2,Mhh,Mhh2,MVZ,MVZ2,MHm,MHm2,              & 
...
mat1a(1,1) = 0._dp 
mat1a(1,1) = mat1a(1,1)+(vu*Yd(1,1))/sqrt(2._dp)
mat1a(1,2) = 0._dp 
mat1a(1,2) = mat1a(1,2)+(vu*Yd(2,1))/sqrt(2._dp)
mat1a(1,3) = 0._dp 
mat1a(1,3) = mat1a(1,3)+(vu*Yd(3,1))/sqrt(2._dp)
mat1a(2,1) = 0._dp 
mat1a(2,1) = mat1a(2,1)+(vu*Yd(1,2))/sqrt(2._dp)
mat1a(2,2) = 0._dp 
mat1a(2,2) = mat1a(2,2)+(vu*Yd(2,2))/sqrt(2._dp)
mat1a(2,3) = 0._dp 
mat1a(2,3) = mat1a(2,3)+(vu*Yd(3,2))/sqrt(2._dp)
mat1a(3,1) = 0._dp 
mat1a(3,1) = mat1a(3,1)+(vu*Yd(1,3))/sqrt(2._dp)
mat1a(3,2) = 0._dp 
mat1a(3,2) = mat1a(3,2)+(vu*Yd(2,3))/sqrt(2._dp)
mat1a(3,3) = 0._dp 
mat1a(3,3) = mat1a(3,3)+(vu*Yd(3,3))/sqrt(2._dp)
...
& cplcUFdFdVGR,cplcUFdFdVPL,cplcUFdFdVPR,cplcUFdFdVZL,cplcUFdFdVZR,cplcUFdFuHmL,         & 
& cplcUFdFuHmR,cplcUFdFuVWmL,cplcUFdFuVWmR,sigL,sigR,sigS)
...
& MFu,MFu2,MVWm,MVWm2,cplcUFdFdAhL,cplcUFdFdAhR,cplcUFdFdhhL,cplcUFdFdhhR,               & 
& cplcUFdFdVGL,cplcUFdFdVGR,cplcUFdFdVPL,cplcUFdFdVPR,cplcUFdFdVZL,cplcUFdFdVZR,         & 
& cplcUFdFuHmL,cplcUFdFuHmR,cplcUFdFuVWmL,cplcUFdFuVWmR,sigL,sigR,sigS)
...
Subroutine OneLoopFu(Yu,vu,MFu,MFu2,MAh,MAh2,MHm,MHm2,MFd,MFd2,MVWm,MVWm2,            & 
...
Subroutine OneLoopFe(Ye,vu,MFe,MFe2,MAh,MAh2,Mhh,Mhh2,MVZ,MVZ2,MHm,MHm2,              & 
...
mat1a(1,1) = 0._dp 
mat1a(1,1) = mat1a(1,1)+(vu*Ye(1,1))/sqrt(2._dp)
mat1a(1,2) = 0._dp 
mat1a(1,2) = mat1a(1,2)+(vu*Ye(2,1))/sqrt(2._dp)
mat1a(1,3) = 0._dp 
mat1a(1,3) = mat1a(1,3)+(vu*Ye(3,1))/sqrt(2._dp)
mat1a(2,1) = 0._dp 
mat1a(2,1) = mat1a(2,1)+(vu*Ye(1,2))/sqrt(2._dp)
mat1a(2,2) = 0._dp 
mat1a(2,2) = mat1a(2,2)+(vu*Ye(2,2))/sqrt(2._dp)
mat1a(2,3) = 0._dp 
mat1a(2,3) = mat1a(2,3)+(vu*Ye(3,2))/sqrt(2._dp)
mat1a(3,1) = 0._dp 
mat1a(3,1) = mat1a(3,1)+(vu*Ye(1,3))/sqrt(2._dp)
mat1a(3,2) = 0._dp 
mat1a(3,2) = mat1a(3,2)+(vu*Ye(2,3))/sqrt(2._dp)
mat1a(3,3) = 0._dp 
mat1a(3,3) = mat1a(3,3)+(vu*Ye(3,3))/sqrt(2._dp)
...
Do gO1 = 1, 3
  Do gO2 = 1, 3
B1m2 = -0.5_dp*Real(B1(p2,0._dp,MHm2(i1)),dp) 
B0m2 = 0.*Real(B0(p2,0._dp,MHm2(i1)),dp) 
