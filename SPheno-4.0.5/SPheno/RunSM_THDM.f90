...
Contains 
 ...
 Subroutine RunSM_and_SUSY_RGEs(Qout,g1input,g2input,g3input,Lam5input,Lam1input,      & 
...
& M112,M222,vd,vu,CKMout,sinW2_out,Alpha_out,AlphaS_out,realCKM)
...
Real(dp) :: scale_save, Qin, tz, dt, g1D(75), g62_SM(62) 
 
 
! Run SUSY RGEs from M_SUSY to Qin 
Qin=sqrt(getRenormalizationScale()) 
scale_save = Qin 
Call ParametersToG75(g1input,g2input,g3input,Lam5input,Lam1input,Lam4input,           & 
& Lam3input,Lam2input,Yuinput,Ydinput,Yeinput,M12input,M112input,M222input,              & 
& vdinput,vuinput,g1D)

Call GToParameters75(g1D,g1,g2,g3,Lam5,Lam1,Lam4,Lam3,Lam2,Yu,Yd,Ye,M12,              & 
& M112,M222,vd,vu)
