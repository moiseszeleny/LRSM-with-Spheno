...
& ZW,ZZ,alphaH,betaH,g1,g2,g3,Lam5,Lam1,Lam4,Lam3,Lam2,Yu,Yd,Ye,M12,M112,M222,           & 
& vd,vu,gTAh,gThh,gTHm,gTVWm,gTVZ,gFdFdcFdFd,gFdFdcFeFe,gFdFdcFuFu,gFdFdcFvFv,           & 
& gFdFucFvFe,epsI,deltaM,CheckRealStates,gT,gPartial,BR)
...
& ZUL,ZA,ZH,ZP,ZW,ZZ,alphaH,betaH,g1,g2,g3,Lam5,Lam1,Lam4,Lam3,Lam2,Yu,Yd,               & 
& Ye,M12,M112,M222,vd,vu,cplcFdFdAhL,cplcFdFdAhR,cplcFdFdhhL,cplcFdFdhhR,cplcFdFdVZL,    & 
...
coup2(1) = cplcFdFdVZL(iIN,gt1) 
coup2(2) = cplcFdFdVZR(iIN,gt1) 
coup2(3) = Conjg(cplcFdFuHmL(iIN,gt3,i2)) 
coup2(4) = Conjg(cplcFdFuHmR(iIN,gt3,i2))  
coup2(5) = cplcFuFuVZL(gt2,gt3) 
coup2(6) = cplcFuFuVZR(gt2,gt3) 
coup2(7) = Conjg(cplcFuFdcHmL(gt2,gt1,i2)) 
coup2(8) = Conjg(cplcFuFdcHmR(gt2,gt1,i2)) 
coupT = coup2(7) 
coup2(7) = coup2(8) 
coup2(8) = coupT 
Call IntegrateGaugeSscalarT(Boson4, mass, coup2, deltaM, epsI,IntegralVSst,NVSst, resC, check) 
...
coup2(3) = Conjg(cplcFdFuHmL(iIN,gt1,i2)) 
coup2(4) = Conjg(cplcFdFuHmR(iIN,gt1,i2))  
coup2(5) = cplcFvFecVWmL(gt2,gt3) 
coup2(6) = cplcFvFecVWmR(gt2,gt3) 
coup2(7) = Conjg(cplcFvFecHmL(gt2,gt3,i2)) 
coup2(8) = Conjg(cplcFvFecHmR(gt2,gt3,i2)) 
Call IntegrateGaugeSscalarS(Boson4, mass, coup2, deltaM, epsI,IntegralVSss,NVSss, resC, check) 
If (resC.ne.resC) resC = 0._dp
resC = 2._dp*resC 
resC= 1*resC ! color factor 
