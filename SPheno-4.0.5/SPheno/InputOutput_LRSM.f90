...
! ------------------------------------------------------------------------------  
! File created at 22:13 on 4.9.2024   
! ----------------------------------------------------------------------  
 
 
Module InputOutput_LRSM 
...
Complex(dp) :: PDGAh(4),PDGFd(3),PDGFe(3),PDGFu(3),PDGFv(6),PDGgG,PDGgP,PDGgWLm,PDGgWLmC,            & 
& PDGgWRm,PDGgWRmC,PDGgZ,PDGgZR,PDGhh(4),PDGHpm(4),PDGHppmm(2),PDGVG,PDGVP,              & 
& PDGVWLm,PDGVWRm,PDGVZ,PDGVZR
...
Character(len=30),Dimension(2):: NameParticleHppmm
...
PDGHppmm(1)=-9000055
NameParticleHppmm(1)="Hppmm_1"
PDGHppmm(2)=-9000065
NameParticleHppmm(2)="Hppmm_2"
PDGVG=21
NameParticleVG="VG"
PDGVP=22
NameParticleVP="VP"
...
Write(io_L,100) "# SUSY Les Houches Accord 2 - LRSM Spectrum + Decays + Flavour Observables"
...
Write(io_L,104) 12,Real(RHO4,dp), "# RHO4" 
Write(io_L,104) 7,Real(RHO1,dp), "# RHO1" 
Write(io_L,104) 11,Real(RHO3,dp), "# RHO3" 
Write(io_L,104) 22,Real(BETA1,dp), "# BETA1" 
...
Write(io_L,104) 24,Real(BETA2,dp), "# BETA2" 
Write(io_L,104) 26,Real(BETA3,dp), "# BETA3" 
Write(io_L,104) 5,Real(LAM4,dp), "# LAM4" 
Write(io_L,104) 2,Real(LAM2,dp), "# LAM2" 
Write(io_L,104) 4,Real(LAM3,dp), "# LAM3" 
Write(io_L,104) 104,Real(muLR2,dp), "# muLR2" 
...
Write(io_L,104) 102,Real(vHd,dp), "# vHd" 
Write(io_L,104) 103,Real(vHu,dp), "# vHu" 
WriteNextBlock = .false. 
If (OutputForMG) WriteNextBlock = .True. 
...
Write(io_L,104) 24,Real(BETA2Tree,dp), "# BETA2" 
Write(io_L,104) 104,Real(muLR2Tree,dp), "# muLR2" 
...
Write(io_L,104) 24,Real(BETA21L,dp), "# BETA2" 
Write(io_L,104) 104,Real(muLR21L,dp), "# muLR2" 
...
If ((MaxVal(Abs(AImag(YL1))).gt.0._dp).OR.(OutputForMG)) Then 
...
If ((MaxVal(Abs(AImag(YL2))).gt.0._dp).OR.(OutputForMG)) Then 
...
Write(io_L,104) 12,Real(RHO4GUT,dp), "# RHO4" 
Write(io_L,104) 7,Real(RHO1GUT,dp), "# RHO1" 
Write(io_L,104) 11,Real(RHO3GUT,dp), "# RHO3" 
Write(io_L,104) 22,Real(BETA1GUT,dp), "# BETA1" 
...
Write(io_L,104) 24,Real(BETA2GUT,dp), "# BETA2" 
Write(io_L,104) 26,Real(BETA3GUT,dp), "# BETA3" 
Write(io_L,104) 5,Real(LAM4GUT,dp), "# LAM4" 
Write(io_L,104) 2,Real(LAM2GUT,dp), "# LAM2" 
Write(io_L,104) 4,Real(LAM3GUT,dp), "# LAM3" 
Write(io_L,104) 104,Real(muLR2GUT,dp), "# muLR2" 
...
If ((MaxVal(Abs(AImag(YL1GUT))).gt.0._dp).OR.(OutputForMG)) Then 
...
If ((MaxVal(Abs(AImag(YL2GUT))).gt.0._dp).OR.(OutputForMG)) Then 
...
Write(io_L,106) "Block CKMR Q=",Q,"# (  )" 
Write(io_L,107)1,1,Real(CKMR(1,1),dp), "# Real(CKMR(1,1),dp)" 
Write(io_L,107)1,2,Real(CKMR(1,2),dp), "# Real(CKMR(1,2),dp)" 
Write(io_L,107)1,3,Real(CKMR(1,3),dp), "# Real(CKMR(1,3),dp)" 
Write(io_L,107)2,1,Real(CKMR(2,1),dp), "# Real(CKMR(2,1),dp)" 
Write(io_L,107)2,2,Real(CKMR(2,2),dp), "# Real(CKMR(2,2),dp)" 
Write(io_L,107)2,3,Real(CKMR(2,3),dp), "# Real(CKMR(2,3),dp)" 
Write(io_L,107)3,1,Real(CKMR(3,1),dp), "# Real(CKMR(3,1),dp)" 
Write(io_L,107)3,2,Real(CKMR(3,2),dp), "# Real(CKMR(3,2),dp)" 
Write(io_L,107)3,3,Real(CKMR(3,3),dp), "# Real(CKMR(3,3),dp)" 
If ((MaxVal(Abs(AImag(CKMR))).gt.0._dp).OR.(OutputForMG)) Then 
Write(io_L,106) "Block IMCKMR Q=",Q,"# (  )" 
Write(io_L,107)1,1,Aimag(CKMR(1,1)), "# Aimag(CKMR(1,1))" 
Write(io_L,107)1,2,Aimag(CKMR(1,2)), "# Aimag(CKMR(1,2))" 
Write(io_L,107)1,3,Aimag(CKMR(1,3)), "# Aimag(CKMR(1,3))" 
Write(io_L,107)2,1,Aimag(CKMR(2,1)), "# Aimag(CKMR(2,1))" 
Write(io_L,107)2,2,Aimag(CKMR(2,2)), "# Aimag(CKMR(2,2))" 
Write(io_L,107)2,3,Aimag(CKMR(2,3)), "# Aimag(CKMR(2,3))" 
Write(io_L,107)3,1,Aimag(CKMR(3,1)), "# Aimag(CKMR(3,1))" 
Write(io_L,107)3,2,Aimag(CKMR(3,2)), "# Aimag(CKMR(3,2))" 
Write(io_L,107)3,3,Aimag(CKMR(3,3)), "# Aimag(CKMR(3,3))" 
End If 
...
Write(io_L,100) "#   PDG code      mass          particle" 
 ...
 Write(io_L,102) INT(Abs(PDGHppmm(1))),MHppmm(1),"# "//Trim(NameParticleHppmm(1))// "" 
 Write(io_L,102) INT(Abs(PDGHppmm(2))),MHppmm(2),"# "//Trim(NameParticleHppmm(2))// "" 
...
Write(io_L,100) "Block DMASS  # Overall uncertainty"
 ...
 Write(io_L,102) INT(Abs(-9000055)), Sqrt(mass_uncertainty_Q(13)**2+mass_uncertainty_Yt(13)**2),"# MHppmm(1) " 
 Write(io_L,102) INT(Abs(-9000065)), Sqrt(mass_uncertainty_Q(14)**2+mass_uncertainty_Yt(14)**2),"# MHppmm(2) " 
Write(io_L,100) "Block DMASSQ  # Scale uncertainty"
 ...
 Write(io_L,102) INT(Abs(-9000055)), mass_uncertainty_Q(13),"# MHppmm(1) " 
 Write(io_L,102) INT(Abs(-9000065)), mass_uncertainty_Q(14),"# MHppmm(2) " 
Write(io_L,100) "Block DMASST  # Top Matching uncertainty"
 ...
 Write(io_L,102) INT(Abs(-9000055)), mass_uncertainty_Yt(13),"# MHppmm(1) " 
 Write(io_L,102) INT(Abs(-9000065)), mass_uncertainty_Yt(14),"# MHppmm(2) " 
End if
...
Write(io_L,106) "Block CHCHMIX Q=",Q,"# ()" 
Write(io_L,107)1,1,UCC(1,1), "# UCC(1,1)" 
Write(io_L,107)1,2,UCC(1,2), "# UCC(1,2)" 
Write(io_L,107)2,1,UCC(2,1), "# UCC(2,1)" 
Write(io_L,107)2,2,UCC(2,2), "# UCC(2,2)" 
...
End do 
Do i2=1,2
CurrentPDG2(2) = Abs(PDGHppmm(i2)) 
Write(io_L,122) CurrentPDG2(1), CurrentPDG2(2), HPPloopHppmm(i2,i1), " # h(",i1,")-Hppmm(",i2,")-loop " 
End do 
Do i2=1,3
...
icount = icount +1 
  End Do 
If (Maxval(BRFu(1,37:279)).Gt.BRmin) Then 
...
icount = icount +1 
  End Do 
If (Maxval(BRFu(2,37:279)).Gt.BRmin) Then 
Write(io_L,100) "#    BR                NDA      ID1      ID2       ID3" 
End If 
Do gt1=1,3
  Do gt2=1,3
...
icount = icount +1 
  End Do 
If (Maxval(BRFu(3,37:279)).Gt.BRmin) Then 
Write(io_L,100) "#    BR                NDA      ID1      ID2       ID3" 
End If 
Do gt1=1,3
  Do gt2=1,3
...
If (BRFe(1,icount).Gt.BrMin) Then 
CurrentPDG2(1) = -PDGFe(gt1) 
CurrentPDG2(2) = PDGHppmm(gt2) 
Write(io_L,201) BRFe(1,icount),2,CurrentPDG2, & 
 & Trim(NameParticleFe(1))//" -> "//Trim(NameParticleFe(gt1))//"^* "//Trim(NameParticleHppmm(gt2))//" "//")"
End if 
icount = icount +1 
  End Do 
End Do 
 
If (Maxval(BRFe(1,55:297)).Gt.BRmin) Then 
Write(io_L,100) "#    BR                NDA      ID1      ID2       ID3" 
End If 
Do gt1=1,3
  Do gt2=1,3
...
CurrentPDG2(2) = PDGHppmm(gt2) 
Write(io_L,201) BRFe(2,icount),2,CurrentPDG2, & 
 & Trim(NameParticleFe(2))//" -> "//Trim(NameParticleFe(gt1))//"^* "//Trim(NameParticleHppmm(gt2))//" "//")"
End if 
icount = icount +1 
  End Do 
End Do 
 
If (Maxval(BRFe(2,55:297)).Gt.BRmin) Then 
Write(io_L,100) "#    BR                NDA      ID1      ID2       ID3" 
End If 
Do gt1=1,3
  Do gt2=1,3
...
CurrentPDG2(2) = PDGHppmm(gt2) 
Write(io_L,201) BRFe(3,icount),2,CurrentPDG2, & 
 & Trim(NameParticleFe(3))//" -> "//Trim(NameParticleFe(gt1))//"^* "//Trim(NameParticleHppmm(gt2))//" "//")"
End if 
icount = icount +1 
  End Do 
End Do 
 
If (Maxval(BRFe(3,55:297)).Gt.BRmin) Then 
Write(io_L,100) "#    BR                NDA      ID1      ID2       ID3" 
End If 
Do gt1=1,3
  Do gt2=1,3
...
icount = icount +1 
  End Do 
If (Maxval(BRFd(1,37:279)).Gt.BRmin) Then 
Write(io_L,100) "#    BR                NDA      ID1      ID2       ID3" 
End If 
Do gt1=1,3
  Do gt2=1,3
...
icount = icount +1 
  End Do 
If (Maxval(BRFd(2,37:279)).Gt.BRmin) Then 
Write(io_L,100) "#    BR                NDA      ID1      ID2       ID3" 
End If 
Do gt1=1,3
  Do gt2=1,3
...
icount = icount +1 
  End Do 
If (Maxval(BRFd(3,37:279)).Gt.BRmin) Then 
Write(io_L,100) "#    BR                NDA      ID1      ID2       ID3" 
End If 
Do gt1=1,3
  Do gt2=1,3
...
Do gt1= 1, 2
  Do gt2=1, 2
If (BRhh(1,icount).Gt.BrMin) Then 
CurrentPDG2(1) = -PDGHppmm(gt1) 
CurrentPDG2(2) = PDGHppmm(gt2) 
Write(io_L,201) BRhh(1,icount),2,CurrentPDG2, & 
 & Trim(NameParticlehh(1))//" -> "//Trim(NameParticleHppmm(gt1))//"^* "//Trim(NameParticleHppmm(gt2))//" "//")"
End if 
icount = icount +1 
  End Do 
End Do 
...
CurrentPDG2(2) = PDGHppmm(gt2) 
Write(io_L,201) BRhh(2,icount),2,CurrentPDG2, & 
 & Trim(NameParticlehh(2))//" -> "//Trim(NameParticleHppmm(gt1))//"^* "//Trim(NameParticleHppmm(gt2))//" "//")"
End if 
icount = icount +1 
  End Do 
End Do 
...
CurrentPDG2(2) = PDGHppmm(gt2) 
Write(io_L,201) BRhh(3,icount),2,CurrentPDG2, & 
 & Trim(NameParticlehh(3))//" -> "//Trim(NameParticleHppmm(gt1))//"^* "//Trim(NameParticleHppmm(gt2))//" "//")"
End if 
icount = icount +1 
  End Do 
End Do 
...
CurrentPDG2(2) = PDGHppmm(gt2) 
Write(io_L,201) BRhh(4,icount),2,CurrentPDG2, & 
 & Trim(NameParticlehh(4))//" -> "//Trim(NameParticleHppmm(gt1))//"^* "//Trim(NameParticleHppmm(gt2))//" "//")"
End if 
icount = icount +1 
  End Do 
End Do 
...
icount = icount +1 
  End Do 
If (Maxval(BRFv(1,61:465)).Gt.BRmin) Then 
Write(io_L,100) "#    BR                NDA      ID1      ID2       ID3" 
End If 
Do gt1=1,6
  Do gt2=1,3
...
icount = icount +1 
  End Do 
If (Maxval(BRFv(2,61:465)).Gt.BRmin) Then 
Write(io_L,100) "#    BR                NDA      ID1      ID2       ID3" 
End If 
Do gt1=1,6
  Do gt2=1,3
...
icount = icount +1 
  End Do 
If (Maxval(BRFv(3,61:465)).Gt.BRmin) Then 
Write(io_L,100) "#    BR                NDA      ID1      ID2       ID3" 
End If 
Do gt1=1,6
  Do gt2=1,3
...
icount = icount +1 
  End Do 
If (Maxval(BRFv(4,61:465)).Gt.BRmin) Then 
Write(io_L,100) "#    BR                NDA      ID1      ID2       ID3" 
End If 
Do gt1=1,6
  Do gt2=1,3
...
icount = icount +1 
  End Do 
If (Maxval(BRFv(5,61:465)).Gt.BRmin) Then 
Write(io_L,100) "#    BR                NDA      ID1      ID2       ID3" 
End If 
Do gt1=1,6
  Do gt2=1,3
...
icount = icount +1 
  End Do 
If (Maxval(BRFv(6,61:465)).Gt.BRmin) Then 
Write(io_L,100) "#    BR                NDA      ID1      ID2       ID3" 
End If 
Do gt1=1,6
  Do gt2=1,3
...
CurrentPDG2(2) = PDGHppmm(gt2) 
Write(io_L,201) BRVZ(1,icount),2,CurrentPDG2, & 
 & Trim(NameParticleVZ)//" -> "//Trim(NameParticleHppmm(gt1))//"^* "//Trim(NameParticleHppmm(gt2))//" "//")"
End if 
icount = icount +1 
  End Do 
End Do 
...
CurrentPDG2(2) = PDGHppmm(gt2) 
Write(io_L,201) BRVZR(1,icount),2,CurrentPDG2, & 
 & Trim(NameParticleVZR)//" -> "//Trim(NameParticleHppmm(gt1))//"^* "//Trim(NameParticleHppmm(gt2))//" "//")"
End if 
icount = icount +1 
  End Do 
End Do 
...
If ((gTHppmm(1).gt.MinWidth).or.(OutputForMG)) Then 
Write(io_L,200) -INT(PDGHppmm(1)),gTHppmm(1),Trim(NameParticleHppmm(1)) 
Write(io_L,100) "#    BR                NDA      ID1      ID2" 
icount = 1 
Do gt1= 1, 2
  Do gt2=3, 4
If (BRHppmm(1,icount).Gt.BrMin) Then 
CurrentPDG2(1) = -PDGHppmm(gt1) 
CurrentPDG2(2) = PDGAh(gt2) 
Write(io_L,201) BRHppmm(1,icount),2,CurrentPDG2, & 
 & Trim(NameParticleHppmm(1))//"^* -> "//Trim(NameParticleHppmm(gt1))//"^* "//Trim(NameParticleAh(gt2))//" "//")"
End if 
icount = icount +1 
  End Do 
End Do 
...
CurrentPDG2(2) = -PDGFe(gt2) 
Write(io_L,201) BRHppmm(1,icount),2,CurrentPDG2, & 
 & Trim(NameParticleHppmm(1))//"^* -> "//Trim(NameParticleFe(gt1))//"^* "//Trim(NameParticleFe(gt2))//"^* "//")"
End if 
icount = icount +1 
  End Do 
End Do 
...
CurrentPDG2(2) = PDGhh(gt2) 
Write(io_L,201) BRHppmm(1,icount),2,CurrentPDG2, & 
 & Trim(NameParticleHppmm(1))//"^* -> "//Trim(NameParticleHppmm(gt1))//"^* "//Trim(NameParticlehh(gt2))//" "//")"
End if 
icount = icount +1 
  End Do 
End Do 
...
CurrentPDG2(2) = -PDGHpm(gt2) 
Write(io_L,201) BRHppmm(1,icount),2,CurrentPDG2, & 
 & Trim(NameParticleHppmm(1))//"^* -> "//Trim(NameParticleHpm(gt1))//"^* "//Trim(NameParticleHpm(gt2))//"^* "//")"
End if 
icount = icount +1 
  End Do 
End Do 
...
CurrentPDG2(2) = -PDGVWLm 
Write(io_L,201) BRHppmm(1,icount),2,CurrentPDG2, & 
 & Trim(NameParticleHppmm(1))//"^* -> "//Trim(NameParticleHpm(gt1))//"^* "//Trim(NameParticleVWLm)//"^* "//")"
End if 
icount = icount +1 
  End Do 
Do gt1= 3, 4
...
CurrentPDG2(2) = -PDGVWRm 
Write(io_L,201) BRHppmm(1,icount),2,CurrentPDG2, & 
 & Trim(NameParticleHppmm(1))//"^* -> "//Trim(NameParticleHpm(gt1))//"^* "//Trim(NameParticleVWRm)//"^* "//")"
End if 
icount = icount +1 
  End Do 
Do gt1= 1, 2
...
CurrentPDG2(2) = PDGVZ 
Write(io_L,201) BRHppmm(1,icount),2,CurrentPDG2, & 
 & Trim(NameParticleHppmm(1))//"^* -> "//Trim(NameParticleHppmm(gt1))//"^* "//Trim(NameParticleVZ)//" "//")"
End if 
icount = icount +1 
  End Do 
Do gt1= 1, 2
...
CurrentPDG2(2) = PDGVZR 
Write(io_L,201) BRHppmm(1,icount),2,CurrentPDG2, & 
 & Trim(NameParticleHppmm(1))//"^* -> "//Trim(NameParticleHppmm(gt1))//"^* "//Trim(NameParticleVZR)//" "//")"
End if 
icount = icount +1 
  End Do 
If (BRHppmm(1,icount).Gt.BrMin) Then 
...
CurrentPDG2(2) = -PDGVWLm 
Write(io_L,201) BRHppmm(1,icount),2,CurrentPDG2, & 
 & Trim(NameParticleHppmm(1))//"^* -> "//Trim(NameParticleVWLm)//"^* "//Trim(NameParticleVWLm)//"^* "//")"
End if 
icount = icount +1 
If (BRHppmm(1,icount).Gt.BrMin) Then 
CurrentPDG2(1) = -PDGVWLm 
CurrentPDG2(2) = -PDGVWRm 
Write(io_L,201) BRHppmm(1,icount),2,CurrentPDG2, & 
 & Trim(NameParticleHppmm(1))//"^* -> "//Trim(NameParticleVWLm)//"^* "//Trim(NameParticleVWRm)//"^* "//")"
End if 
icount = icount +1 
If (BRHppmm(1,icount).Gt.BrMin) Then 
CurrentPDG2(1) = -PDGVWRm 
CurrentPDG2(2) = -PDGVWRm 
Write(io_L,201) BRHppmm(1,icount),2,CurrentPDG2, & 
 & Trim(NameParticleHppmm(1))//"^* -> "//Trim(NameParticleVWRm)//"^* "//Trim(NameParticleVWRm)//"^* "//")"
End if 
icount = icount +1 
End if 
If ((gTHppmm(2).gt.MinWidth).or.(OutputForMG)) Then 
Write(io_L,200) -INT(PDGHppmm(2)),gTHppmm(2),Trim(NameParticleHppmm(2)) 
Write(io_L,100) "#    BR                NDA      ID1      ID2" 
icount = 1 
Do gt1= 1, 2
  Do gt2=3, 4
If (BRHppmm(2,icount).Gt.BrMin) Then 
CurrentPDG2(1) = -PDGHppmm(gt1) 
CurrentPDG2(2) = PDGAh(gt2) 
Write(io_L,201) BRHppmm(2,icount),2,CurrentPDG2, & 
 & Trim(NameParticleHppmm(2))//"^* -> "//Trim(NameParticleHppmm(gt1))//"^* "//Trim(NameParticleAh(gt2))//" "//")"
End if 
icount = icount +1 
  End Do 
End Do 
...
CurrentPDG2(2) = -PDGFe(gt2) 
Write(io_L,201) BRHppmm(2,icount),2,CurrentPDG2, & 
 & Trim(NameParticleHppmm(2))//"^* -> "//Trim(NameParticleFe(gt1))//"^* "//Trim(NameParticleFe(gt2))//"^* "//")"
End if 
icount = icount +1 
  End Do 
End Do 
...
CurrentPDG2(2) = PDGhh(gt2) 
Write(io_L,201) BRHppmm(2,icount),2,CurrentPDG2, & 
 & Trim(NameParticleHppmm(2))//"^* -> "//Trim(NameParticleHppmm(gt1))//"^* "//Trim(NameParticlehh(gt2))//" "//")"
End if 
icount = icount +1 
  End Do 
End Do 
...
CurrentPDG2(2) = -PDGHpm(gt2) 
Write(io_L,201) BRHppmm(2,icount),2,CurrentPDG2, & 
 & Trim(NameParticleHppmm(2))//"^* -> "//Trim(NameParticleHpm(gt1))//"^* "//Trim(NameParticleHpm(gt2))//"^* "//")"
End if 
icount = icount +1 
  End Do 
End Do 
...
CurrentPDG2(2) = -PDGVWLm 
Write(io_L,201) BRHppmm(2,icount),2,CurrentPDG2, & 
 & Trim(NameParticleHppmm(2))//"^* -> "//Trim(NameParticleHpm(gt1))//"^* "//Trim(NameParticleVWLm)//"^* "//")"
End if 
icount = icount +1 
  End Do 
Do gt1= 3, 4
...
CurrentPDG2(2) = -PDGVWRm 
Write(io_L,201) BRHppmm(2,icount),2,CurrentPDG2, & 
 & Trim(NameParticleHppmm(2))//"^* -> "//Trim(NameParticleHpm(gt1))//"^* "//Trim(NameParticleVWRm)//"^* "//")"
End if 
icount = icount +1 
  End Do 
Do gt1= 1, 2
...
CurrentPDG2(2) = PDGVZ 
Write(io_L,201) BRHppmm(2,icount),2,CurrentPDG2, & 
 & Trim(NameParticleHppmm(2))//"^* -> "//Trim(NameParticleHppmm(gt1))//"^* "//Trim(NameParticleVZ)//" "//")"
End if 
icount = icount +1 
  End Do 
Do gt1= 1, 2
...
CurrentPDG2(2) = PDGVZR 
Write(io_L,201) BRHppmm(2,icount),2,CurrentPDG2, & 
 & Trim(NameParticleHppmm(2))//"^* -> "//Trim(NameParticleHppmm(gt1))//"^* "//Trim(NameParticleVZR)//" "//")"
End if 
icount = icount +1 
  End Do 
If (BRHppmm(2,icount).Gt.BrMin) Then 
...
CurrentPDG2(2) = -PDGVWLm 
Write(io_L,201) BRHppmm(2,icount),2,CurrentPDG2, & 
 & Trim(NameParticleHppmm(2))//"^* -> "//Trim(NameParticleVWLm)//"^* "//Trim(NameParticleVWLm)//"^* "//")"
End if 
icount = icount +1 
If (BRHppmm(2,icount).Gt.BrMin) Then 
CurrentPDG2(1) = -PDGVWLm 
CurrentPDG2(2) = -PDGVWRm 
Write(io_L,201) BRHppmm(2,icount),2,CurrentPDG2, & 
 & Trim(NameParticleHppmm(2))//"^* -> "//Trim(NameParticleVWLm)//"^* "//Trim(NameParticleVWRm)//"^* "//")"
End if 
icount = icount +1 
If (BRHppmm(2,icount).Gt.BrMin) Then 
CurrentPDG2(1) = -PDGVWRm 
CurrentPDG2(2) = -PDGVWRm 
Write(io_L,201) BRHppmm(2,icount),2,CurrentPDG2, & 
 & Trim(NameParticleHppmm(2))//"^* -> "//Trim(NameParticleVWRm)//"^* "//Trim(NameParticleVWRm)//"^* "//")"
End if 
icount = icount +1 
End if 
...
CurrentPDG2(2) = -PDGHppmm(gt2) 
Write(io_L,201) BRHpm(3,icount),2,CurrentPDG2, & 
 & Trim(NameParticleHpm(3))//"^* -> "//Trim(NameParticleHpm(gt1))//" "//Trim(NameParticleHppmm(gt2))//"^* "//")"
End if 
icount = icount +1 
  End Do 
End Do 
...
CurrentPDG2(2) = PDGVWLm 
Write(io_L,201) BRHpm(3,icount),2,CurrentPDG2, & 
 & Trim(NameParticleHpm(3))//"^* -> "//Trim(NameParticleHppmm(gt1))//"^* "//Trim(NameParticleVWLm)//" "//")"
End if 
icount = icount +1 
  End Do 
Do gt1= 1, 2
...
CurrentPDG2(2) = PDGVWRm 
Write(io_L,201) BRHpm(3,icount),2,CurrentPDG2, & 
 & Trim(NameParticleHpm(3))//"^* -> "//Trim(NameParticleHppmm(gt1))//"^* "//Trim(NameParticleVWRm)//" "//")"
End if 
icount = icount +1 
  End Do 
If (BRHpm(3,icount).Gt.BrMin) Then 
...
CurrentPDG2(2) = -PDGHppmm(gt2) 
Write(io_L,201) BRHpm(4,icount),2,CurrentPDG2, & 
 & Trim(NameParticleHpm(4))//"^* -> "//Trim(NameParticleHpm(gt1))//" "//Trim(NameParticleHppmm(gt2))//"^* "//")"
End if 
icount = icount +1 
  End Do 
End Do 
...
CurrentPDG2(2) = PDGVWLm 
Write(io_L,201) BRHpm(4,icount),2,CurrentPDG2, & 
 & Trim(NameParticleHpm(4))//"^* -> "//Trim(NameParticleHppmm(gt1))//"^* "//Trim(NameParticleVWLm)//" "//")"
End if 
icount = icount +1 
  End Do 
Do gt1= 1, 2
...
CurrentPDG2(2) = PDGVWRm 
Write(io_L,201) BRHpm(4,icount),2,CurrentPDG2, & 
 & Trim(NameParticleHpm(4))//"^* -> "//Trim(NameParticleHppmm(gt1))//"^* "//Trim(NameParticleVWRm)//" "//")"
End if 
icount = icount +1 
  End Do 
If (BRHpm(4,icount).Gt.BrMin) Then 
...
CurrentPDG2(2) = PDGHppmm(gt2) 
Write(io_L,201) BRAh(3,icount),2,CurrentPDG2, & 
 & Trim(NameParticleAh(3))//" -> "//Trim(NameParticleHppmm(gt1))//"^* "//Trim(NameParticleHppmm(gt2))//" "//")"
End if 
icount = icount +1 
  End Do 
End Do 
...
CurrentPDG2(2) = PDGHppmm(gt2) 
Write(io_L,201) BRAh(4,icount),2,CurrentPDG2, & 
 & Trim(NameParticleAh(4))//" -> "//Trim(NameParticleHppmm(gt1))//"^* "//Trim(NameParticleHppmm(gt2))//" "//")"
End if 
icount = icount +1 
  End Do 
End Do 
...
CurrentPDG2(2) = -PDGHppmm(gt2) 
Write(io_L,201) BRVWLm(1,icount),2,CurrentPDG2, & 
 & Trim(NameParticleVWLm)//"^* -> "//Trim(NameParticleHpm(gt1))//" "//Trim(NameParticleHppmm(gt2))//"^* "//")"
End if 
icount = icount +1 
  End Do 
End Do 
...
CurrentPDG2(2) = PDGVWLm 
Write(io_L,201) BRVWLm(1,icount),2,CurrentPDG2, & 
 & Trim(NameParticleVWLm)//"^* -> "//Trim(NameParticleHppmm(gt1))//"^* "//Trim(NameParticleVWLm)//" "//")"
End if 
icount = icount +1 
  End Do 
Do gt1= 1, 2
...
CurrentPDG2(2) = PDGVWRm 
Write(io_L,201) BRVWLm(1,icount),2,CurrentPDG2, & 
 & Trim(NameParticleVWLm)//"^* -> "//Trim(NameParticleHppmm(gt1))//"^* "//Trim(NameParticleVWRm)//" "//")"
End if 
icount = icount +1 
  End Do 
If (BRVWLm(1,icount).Gt.BrMin) Then 
...
CurrentPDG2(2) = PDGHppmm(gt2) 
Write(io_L,201) BRVWRm(1,icount),2,CurrentPDG2, & 
 & Trim(NameParticleVWRm)//" -> "//Trim(NameParticleHpm(gt1))//"^* "//Trim(NameParticleHppmm(gt2))//" "//")"
End if 
icount = icount +1 
  End Do 
End Do 
...
CurrentPDG2(2) = -PDGVWLm 
Write(io_L,201) BRVWRm(1,icount),2,CurrentPDG2, & 
 & Trim(NameParticleVWRm)//" -> "//Trim(NameParticleHppmm(gt1))//" "//Trim(NameParticleVWLm)//"^* "//")"
End if 
icount = icount +1 
  End Do 
Do gt1= 1, 2
...
CurrentPDG2(2) = -PDGVWRm 
Write(io_L,201) BRVWRm(1,icount),2,CurrentPDG2, & 
 & Trim(NameParticleVWRm)//" -> "//Trim(NameParticleHppmm(gt1))//" "//Trim(NameParticleVWRm)//"^* "//")"
End if 
icount = icount +1 
  End Do 
If (BRVWRm(1,icount).Gt.BrMin) Then 
...
Subroutine WriteWHIZARD 
   Open(123,file="WHIZARD.par.LRSM",status="unknown")
...
Write(123,*) "RHO1= ",RHO1
Write(123,*) "RHO3= ",RHO3
Write(123,*) "BETA1= ",BETA1
Write(123,*) "ALP3= ",ALP3
Write(123,*) "ALP1= ",ALP1
Write(123,*) "LAM1= ",LAM1
Write(123,*) "ALP2= ",ALP2
Write(123,*) "BETA2= ",BETA2
Write(123,*) "BETA3= ",BETA3
Write(123,*) "LAM4= ",LAM4
Write(123,*) "LAM2= ",LAM2
Write(123,*) "LAM3= ",LAM3
...
Write(123,*) "MHmm1= ", Abs(MHppmm(1)) 
Write(123,*) "MHmm2= ", Abs(MHppmm(2)) 
...
Write(123,*) "WZ = ",gTVZ
Write(123,*) "WZp = ",gTVZR
Write(123,*) "WHmm1 = ",gTHppmm(1)
Write(123,*) "WHmm2 = ",gTHppmm(2)
...
Write(123,*) "UCC11= ",UCC(1,1)
Write(123,*) "UCC12= ",UCC(1,2)
Write(123,*) "UCC21= ",UCC(2,1)
Write(123,*) "UCC22= ",UCC(2,2)
...
Subroutine WriteWCXF 
   Open(123,file="WC.LRSM_1.json",status="unknown")
Write(123,*) "{"
Write(123,*) '  "eft": "WET",'
...
Write(123,*) "}"
    Close(123) 
   Open(123,file="WC.LRSM_2.json",status="unknown")
Write(123,*) "{"
Write(123,*) '  "eft": "WET",'
Write(123,*) '  "basis": "FlavorKit",'
Write(123,*) '  "scale": "91.",'
...
BETA2IN= wert 
InputValueforBETA2= .True. 
Else If (i_par.Eq.26) Then 
BETA3IN= wert 
InputValueforBETA3= .True. 
Else If (i_par.Eq.5) Then 
LAM4IN= wert 
