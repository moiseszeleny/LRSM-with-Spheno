...
Module CouplingsForDecays_THDM
...
& ZZinput,alphaHinput,betaHinput,g1input,g2input,g3input,Lam5input,Lam1input,            & 
& Lam4input,Lam3input,Lam2input,Yuinput,Ydinput,Yeinput,M12input,M112input,              & 
& M222input,vdinput,vuinput,cplcFuFuAhL,cplcFuFuAhR,cplcFuFdcHmL,cplcFuFdcHmR,           & 
...
& ZZinput,alphaHinput,betaHinput,g1input,g2input,g3input,Lam5input,Lam1input,            & 
& Lam4input,Lam3input,Lam2input,Yuinput,Ydinput,Yeinput,M12input,M112input,              & 
& M222input,vdinput,vuinput,cplcFeFeAhL,cplcFeFeAhR,cplcFeFehhL,cplcFeFehhR,             & 
& cplcFeFeVZL,cplcFeFeVZR,cplcFeFvHmL,cplcFeFvHmR,deltaM)
...
& ZZinput,alphaHinput,betaHinput,g1input,g2input,g3input,Lam5input,Lam1input,            & 
& Lam4input,Lam3input,Lam2input,Yuinput,Ydinput,Yeinput,M12input,M112input,              & 
& M222input,vdinput,vuinput,cplcFdFdAhL,cplcFdFdAhR,cplcFdFdhhL,cplcFdFdhhR,             & 
...
& ZZinput,alphaHinput,betaHinput,g1input,g2input,g3input,Lam5input,Lam1input,            & 
& Lam4input,Lam3input,Lam2input,Yuinput,Ydinput,Yeinput,M12input,M112input,              & 
& M222input,vdinput,vuinput,cplHiggsPP,cplHiggsGG,cplHiggsZZvirt,cplHiggsWWvirt,         & 
...
& MHm,MVWm,rq,rsq,coup)

cplHiggsPP(i1) = coup*Alpha 
CoupHPP(i1) = coup 
Call CoupHiggsToPhotonSM(m_in,MFd,MFe,MFu,MHm,MVWm,rq,coup)

ratioPP(i1) = Abs(cplHiggsPP(i1)/(coup*Alpha))**2 
rq = rsq 
Call CoupHiggsToGluon(m_in,i1,ratFd,ratFu,MFd,MFu,rq,rsq,coup)

cplHiggsGG(i1) = coup*AlphaS_MZ 
CoupHGG(i1) = coup 
Call CoupHiggsToGluonSM(m_in,MFd,MFu,rq,coup)
...
& ZZinput,alphaHinput,betaHinput,g1input,g2input,g3input,Lam5input,Lam1input,            & 
& Lam4input,Lam3input,Lam2input,Yuinput,Ydinput,Yeinput,M12input,M112input,              & 
& M222input,vdinput,vuinput,cplPseudoHiggsPP,cplPseudoHiggsGG,cplAhAhAh,cplAhAhhh,       & 
...
Call CoupPseudoHiggsToPhotonSM(m_in,MFd,MFe,MFu,MHm,MVWm,coup)

ratioPPP(i1) = Abs(cplPseudoHiggsPP(i1)/(2._dp*coup*oo4pi*(1._dp-mW2/mZ2)*g2**2))**2 
Call CoupPseudoHiggsToGluon(Mhh(i1),i1,ratPFd,ratPFu,MFd,MFu,coup)

cplPseudoHiggsGG(i1) = 2._dp*coup*AlphaS_MZ 
CoupAGG(i1) = 2._dp*coup 
Call CoupPseudoHiggsToGluonSM(m_in,MFd,MFu,coup)
...
& ZZinput,alphaHinput,betaHinput,g1input,g2input,g3input,Lam5input,Lam1input,            & 
& Lam4input,Lam3input,Lam2input,Yuinput,Ydinput,Yeinput,M12input,M112input,              & 
& M222input,vdinput,vuinput,cplAhHmcHm,cplAhcHmVWm,cplcFuFdcHmL,cplcFuFdcHmR,            & 
& cplcFvFecHmL,cplcFvFecHmR,cplhhHmcHm,cplhhcHmVWm,cplHmcHmVZ,cplcHmVWmVZ,deltaM)
...
& cplcFuFuhhL,cplcFuFuhhR,cplcFuFuVZL,cplcFuFuVZR,cplcFvFecHmL,cplcFvFecHmR,             & 
& cplcFvFecVWmL,cplcFvFecVWmR,cplcFvFvVZL,cplcFvFvVZR,deltaM)
...
End Module CouplingsForDecays_THDM
