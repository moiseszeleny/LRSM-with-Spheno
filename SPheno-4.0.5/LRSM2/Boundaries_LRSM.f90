...
CosW2SinW2=(1._dp-sinW2_Q)*sinW2_Q
If (IncludeDeltaVB) Then 
Call DeltaVB(sinW2_Q,sinW2_Q,rho,MAh,MFe,MFv,Mhh,MHpm,MHppmm,MVWLm,MVWRm,             & 
...
delta_emmatch= DeltaAlphaEW_T(g1sm**2*g2sm**2*oo4pi/(g1sm**2+g2sm**2),mudim,Abs(MVWLm),Abs(MVWRm),Abs(MHpm),Abs(MHppmm),Abs(MFd),Abs(MFu),Abs(MFe)) 
