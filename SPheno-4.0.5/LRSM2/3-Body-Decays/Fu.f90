...
& gTVWLm,gTVWRm,gTVZ,gTVZR,gFuFucFdFd,gFuFucFeFe,gFuFucFuFu,gFuFuFvFv,gFuFdcFeFv,        & 
...
Real(dp),Intent(in) :: MFu(3),MFv(6),MVZ,MVZR,MAh(4),Mhh(4)
...
Real(dp),Intent(in) :: MFd(3),MFe(3),MFv(6),MVWLm,MVWRm,MHpm(4),MFu(3)
