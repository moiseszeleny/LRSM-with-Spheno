...
Character(len=8),Save,Private::versionSARAH="4.6.0"
...
l_open= .False.
End If
Write(io_L,100) "# SUSY Les Houches Accord 2 - THDM Spectrum + Decays + Flavor Observables"
...
icount = icount +1 
  End Do 
If (Maxval(BRFu(1,19:153)).Gt.BRmin) Then 
...
icount = icount +1 
  End Do 
If (Maxval(BRFu(2,19:153)).Gt.BRmin) Then 
Write(io_L,100) "#    BR                NDA      ID1      ID2       ID3" 
End If 
Do gt1=1,3
  Do gt2=1,3
...
icount = icount +1 
  End Do 
If (Maxval(BRFu(3,19:153)).Gt.BRmin) Then 
Write(io_L,100) "#    BR                NDA      ID1      ID2       ID3" 
End If 
Do gt1=1,3
  Do gt2=1,3
...
If (Maxval(BRFe(1,16:150)).Gt.BRmin) Then 
Write(io_L,100) "#    BR                NDA      ID1      ID2       ID3" 
End If 
Do gt1=1,3
  Do gt2=1,3
...
If (Maxval(BRFe(2,16:150)).Gt.BRmin) Then 
Write(io_L,100) "#    BR                NDA      ID1      ID2       ID3" 
End If 
Do gt1=1,3
  Do gt2=1,3
...
If (Maxval(BRFe(3,16:150)).Gt.BRmin) Then 
Write(io_L,100) "#    BR                NDA      ID1      ID2       ID3" 
End If 
Do gt1=1,3
  Do gt2=1,3
...
icount = icount +1 
  End Do 
If (Maxval(BRFd(1,19:153)).Gt.BRmin) Then 
Write(io_L,100) "#    BR                NDA      ID1      ID2       ID3" 
End If 
Do gt1=1,3
  Do gt2=1,3
...
icount = icount +1 
  End Do 
If (Maxval(BRFd(2,19:153)).Gt.BRmin) Then 
Write(io_L,100) "#    BR                NDA      ID1      ID2       ID3" 
End If 
Do gt1=1,3
  Do gt2=1,3
...
icount = icount +1 
  End Do 
If (Maxval(BRFd(3,19:153)).Gt.BRmin) Then 
Write(io_L,100) "#    BR                NDA      ID1      ID2       ID3" 
End If 
Do gt1=1,3
  Do gt2=1,3
...
Subroutine WriteWHIZARD 
   Open(123,file="WHIZARD.par.THDM",status="unknown")
