...
& betaH,vd,vu,g1,g2,g3,Lam5,Lam1,Lam4,Lam3,Lam2,Yu,Yd,Ye,M12,M112,M222,GenerationMixing,kont)
...
Iname = Iname + 1 
NameOfUnit(Iname) = 'TreeMassesTHDM'
...
Call CalculateMhh(M12,Lam5,M112,M222,Lam1,Lam4,Lam3,Lam2,vd,vu,ZH,Mhh,Mhh2,kont)

kontSave = kont 
Call CalculateMAh(g1,g2,M12,Lam5,M112,M222,Lam1,Lam4,Lam3,Lam2,vd,vu,TW,              & 
& ZA,MAh,MAh2,kont)

kont = kontSave 
kontSave = kont 
Call CalculateMHm(g2,M12,Lam5,M112,M222,Lam1,Lam4,Lam3,Lam2,vd,vu,ZP,MHm,             & 
& MHm2,kont)

kont = kontSave 
Call CalculateMFd(Yd,vu,ZDL,ZDR,MFd,kont)

MFd2 = MFd**2 
Call CalculateMFu(Yu,vu,ZUL,ZUR,MFu,kont)

MFu2 = MFu**2 
Call CalculateMFe(Ye,vu,ZEL,ZER,MFe,kont)
...
& alphaH,betaH,vd,vu,g1,g2,g3,Lam5,Lam1,Lam4,Lam3,Lam2,Yu,Yd,Ye,M12,M112,M222,           & 
...
Call CalculateMhhEffPot(M12,Lam5,M112,M222,Lam1,Lam4,Lam3,Lam2,vd,vu,ZH,              & 
& Mhh,Mhh2,kont)

kontSave = kont 
Call CalculateMAhEffPot(g1,g2,M12,Lam5,M112,M222,Lam1,Lam4,Lam3,Lam2,vd,              & 
& vu,TW,ZA,MAh,MAh2,kont)

kont = kontSave 
kontSave = kont 
Call CalculateMHmEffPot(g2,M12,Lam5,M112,M222,Lam1,Lam4,Lam3,Lam2,vd,vu,              & 
& ZP,MHm,MHm2,kont)

kont = kontSave 
Call CalculateMFdEffPot(Yd,vu,ZDL,ZDR,MFd,kont)

MFd2 = MFd**2 
Call CalculateMFuEffPot(Yu,vu,ZUL,ZUR,MFu,kont)

MFu2 = MFu**2 
Call CalculateMFeEffPot(Ye,vu,ZEL,ZER,MFe,kont)
...
Subroutine CalculateMhh(M12,Lam5,M112,M222,Lam1,Lam4,Lam3,Lam2,vd,vu,ZH,              & 
& Mhh,Mhh2,kont)
...
Subroutine CalculateMAh(g1,g2,M12,Lam5,M112,M222,Lam1,Lam4,Lam3,Lam2,vd,              & 
& vu,TW,ZA,MAh,MAh2,kont)
...
Subroutine CalculateMHm(g2,M12,Lam5,M112,M222,Lam1,Lam4,Lam3,Lam2,vd,vu,              & 
& ZP,MHm,MHm2,kont)
...
Subroutine CalculateMFd(Yd,vu,ZDL,ZDR,MFd,kont)
...
ZDR = 0._dp 
mat(1,1) = 0._dp 
mat(1,1) = mat(1,1)+(vu*Yd(1,1))/sqrt(2._dp)
mat(1,2) = 0._dp 
mat(1,2) = mat(1,2)+(vu*Yd(2,1))/sqrt(2._dp)
mat(1,3) = 0._dp 
mat(1,3) = mat(1,3)+(vu*Yd(3,1))/sqrt(2._dp)
mat(2,1) = 0._dp 
mat(2,1) = mat(2,1)+(vu*Yd(1,2))/sqrt(2._dp)
mat(2,2) = 0._dp 
mat(2,2) = mat(2,2)+(vu*Yd(2,2))/sqrt(2._dp)
mat(2,3) = 0._dp 
mat(2,3) = mat(2,3)+(vu*Yd(3,2))/sqrt(2._dp)
mat(3,1) = 0._dp 
mat(3,1) = mat(3,1)+(vu*Yd(1,3))/sqrt(2._dp)
mat(3,2) = 0._dp 
mat(3,2) = mat(3,2)+(vu*Yd(2,3))/sqrt(2._dp)
mat(3,3) = 0._dp 
mat(3,3) = mat(3,3)+(vu*Yd(3,3))/sqrt(2._dp)
...
Subroutine CalculateMFe(Ye,vu,ZEL,ZER,MFe,kont)
...
ZER = 0._dp 
mat(1,1) = 0._dp 
mat(1,1) = mat(1,1)+(vu*Ye(1,1))/sqrt(2._dp)
mat(1,2) = 0._dp 
mat(1,2) = mat(1,2)+(vu*Ye(2,1))/sqrt(2._dp)
mat(1,3) = 0._dp 
mat(1,3) = mat(1,3)+(vu*Ye(3,1))/sqrt(2._dp)
mat(2,1) = 0._dp 
mat(2,1) = mat(2,1)+(vu*Ye(1,2))/sqrt(2._dp)
mat(2,2) = 0._dp 
mat(2,2) = mat(2,2)+(vu*Ye(2,2))/sqrt(2._dp)
mat(2,3) = 0._dp 
mat(2,3) = mat(2,3)+(vu*Ye(3,2))/sqrt(2._dp)
mat(3,1) = 0._dp 
mat(3,1) = mat(3,1)+(vu*Ye(1,3))/sqrt(2._dp)
mat(3,2) = 0._dp 
mat(3,2) = mat(3,2)+(vu*Ye(2,3))/sqrt(2._dp)
mat(3,3) = 0._dp 
mat(3,3) = mat(3,3)+(vu*Ye(3,3))/sqrt(2._dp)
...
Subroutine CalculateMhhEffPot(M12,Lam5,M112,M222,Lam1,Lam4,Lam3,Lam2,vd,              & 
& vu,ZH,Mhh,Mhh2,kont)
...
Subroutine CalculateMAhEffPot(g1,g2,M12,Lam5,M112,M222,Lam1,Lam4,Lam3,Lam2,           & 
...
Subroutine CalculateMHmEffPot(g2,M12,Lam5,M112,M222,Lam1,Lam4,Lam3,Lam2,              & 
& vd,vu,ZP,MHm,MHm2,kont)
...
Subroutine CalculateMFdEffPot(Yd,vu,ZDL,ZDR,MFd,kont)
...
Subroutine CalculateMFeEffPot(Ye,vu,ZEL,ZER,MFe,kont)
...
& TW,ZDR,ZER,ZUR,ZDL,ZEL,ZUL,ZW,ZZ,vd,vu,g1,g2,g3,Lam5,Lam1,Lam4,Lam3,Lam2,              & 
& Yu,Yd,Ye,M12,M112,M222,GenerationMixing,kont)
