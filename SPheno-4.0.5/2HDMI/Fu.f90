...
& vd,vu,gTAh,gThh,gTHm,gTVWm,gTVZ,gFuFucFdFd,gFuFucFeFe,gFuFucFuFu,gFuFdcFeFv,           & 
...
coup2(1) = cplcFuFuVZL(iIN,gt1) 
coup2(2) = cplcFuFuVZR(iIN,gt1) 
coup2(3) = Conjg(cplcFuFdcHmL(iIN,gt3,i2)) 
coup2(4) = Conjg(cplcFuFdcHmR(iIN,gt3,i2))  
coup2(5) = cplcFdFdVZL(gt2,gt3) 
coup2(6) = cplcFdFdVZR(gt2,gt3) 
coup2(7) = Conjg(cplcFdFuHmL(gt2,gt1,i2)) 
coup2(8) = Conjg(cplcFdFuHmR(gt2,gt1,i2)) 
coupT = coup2(7) 
coup2(7) = coup2(8) 
coup2(8) = coupT 
...
coup2(3) = Conjg(cplcFuFdcHmL(iIN,gt1,i2)) 
coup2(4) = Conjg(cplcFuFdcHmR(iIN,gt1,i2))  
coup2(5) = cplcFeFvVWmL(gt2,gt3) 
coup2(6) = cplcFeFvVWmR(gt2,gt3) 
coup2(7) = Conjg(cplcFeFvHmL(gt2,gt3,i2)) 
coup2(8) = Conjg(cplcFeFvHmR(gt2,gt3,i2)) 
Call IntegrateGaugeSscalarS(Boson4, mass, coup2, deltaM, epsI,IntegralVSss,NVSss, resC, check) 
If (resC.ne.resC) resC = 0._dp
resC = 2._dp*resC 
resC= 1*resC ! color factor 
