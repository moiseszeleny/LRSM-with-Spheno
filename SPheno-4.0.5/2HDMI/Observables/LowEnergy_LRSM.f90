...
! ------------------------------------------------------------------------------  
! File created at 22:08 on 4.9.2024   
! ----------------------------------------------------------------------  
 
 
Module LowEnergy_LRSM 
Use Control 
Use Settings 
Use Couplings_LRSM 
Use LoopCouplings_LRSM 
Use LoopMasses_SM_HC 
Use LoopFunctions 
Use LoopMasses_LRSM 
Use StandardModel 
Use RunSM_LRSM
Use FlavorKit_LFV_LRSM
Use FlavorKit_QFV_LRSM
Use FlavorKit_Observables_LRSM
...
& MHppmm,MHppmm2,MVWLm,MVWLm2,MVWRm,MVWRm2,MVZR,MVZR2,cplcFeFeAhL,cplcFeFeAhR,           & 
& cplAhhhVP,cplFeFecHppmmL,cplFeFecHppmmR,cplFvFecHpmL,cplFvFecHpmR,cplFvFecVWLmL,       & 
& cplFvFecVWLmR,cplFvFecVWRmL,cplFvFecVWRmR,cplcFeFehhL,cplcFeFehhR,cplcFeFeVPL,         & 
& cplcFeFeVPR,cplcFeFeVZRL,cplcFeFeVZRR,cplFvFvVPL,cplFvFvVPR,cplcFeFvHpmL,              & 
& cplcFeFvHpmR,cplcFeFvVWRmL,cplcFeFvVWRmR,cplHpmcHpmVP,cplHppmmcHppmmVP,cplcFecFeHppmmL,& 
& cplcFecFeHppmmR,cplcVWRmVPVWLm,cplcVWRmVPVWRm,a_mu)

Real(dp),Intent(in)  :: MAh(4),MAh2(4),MFe(3),MFe2(3),MFv(6),MFv2(6),Mhh(4),Mhh2(4),MHpm(4),MHpm2(4),         & 
& MHppmm(2),MHppmm2(2),MVWLm,MVWLm2,MVWRm,MVWRm2,MVZR,MVZR2

Complex(dp),Intent(in)  :: cplcFeFeAhL(3,3,4),cplcFeFeAhR(3,3,4),cplAhhhVP(4,4),cplFeFecHppmmL(3,3,2),           & 
& cplFeFecHppmmR(3,3,2),cplFvFecHpmL(6,3,4),cplFvFecHpmR(6,3,4),cplFvFecVWLmL(6,3),      & 
& cplFvFecVWLmR(6,3),cplFvFecVWRmL(6,3),cplFvFecVWRmR(6,3),cplcFeFehhL(3,3,4),           & 
& cplcFeFehhR(3,3,4),cplcFeFeVPL(3,3),cplcFeFeVPR(3,3),cplcFeFeVZRL(3,3),cplcFeFeVZRR(3,3),& 
& cplFvFvVPL(6,6),cplFvFvVPR(6,6),cplcFeFvHpmL(3,6,4),cplcFeFvHpmR(3,6,4),               & 
& cplcFeFvVWRmL(3,6),cplcFeFvVWRmR(3,6),cplHpmcHpmVP(4,4),cplHppmmcHppmmVP(2,2),         & 
& cplcFecFeHppmmL(3,3,2),cplcFecFeHppmmR(3,3,2),cplcVWRmVPVWLm,cplcVWRmVPVWRm
...
coup1L = cplcFeFvHpmL(gt1,i2,i1)
coup1R = cplcFeFvHpmR(gt1,i2,i1)
...
coup1L = cplcFeFvVWRmL(gt1,i2)
coup1R = cplcFeFvVWRmR(gt1,i2)
coup2L = cplFvFecVWRmL(i3,gt2)
coup2R = cplFvFecVWRmR(i3,gt2)
ratio = MVWRm2/MFv2(i2)
 ratio = 1._dp/ratio ! conventions in 1402.7065 are different 
 chargefactor = chargefactor*(0._dp)
 If ((ratio.eq.ratio).and.(ratio.lt.1.0E+30_dp).and.(ratio.gt.1.0E-30_dp)) Then 
a_mu = a_mu - 8._dp*chargefactor*ratio*(Real(coup1L*Conjg(coup1R),dp)*gFFV(ratio)/MFv(i2)& 
      & + 2._dp*MFe(Ifermion)*(Abs(coup1L)**2 + Abs(coup1R)**2)*fFFV(ratio)/MFv2(i2)) 
End if 
...
ratio = MHppmm2(i2)/MFe2(i1)
 chargefactor = chargefactor*(2._dp)
 If ((ratio.eq.ratio).and.(ratio.lt.1.0E+30_dp).and.(ratio.gt.1.0E-30_dp)) Then 
a_mu = a_mu - chargefactor*(2._dp*Real(coup1L*Conjg(coup1R),dp)*F4(ratio)/MFe(i1)& 
      & +2._dp*MFe(Ifermion)*(Abs(coup1L)**2 + Abs(coup1R)**2)*F1(ratio)/MFe2(i1)) 
End if 
...
& MHpm2,MHppmm,MHppmm2,MVWLm,MVWLm2,MVWRm,MVWRm2,MVZ,MVZ2,MVZR,MVZR2,cplcFeFeAhL,        & 
& cplcFeFeAhR,cplAhhhVP,cplFeFecHppmmL,cplFeFecHppmmR,cplFvFecHpmL,cplFvFecHpmR,         & 
...
& cplFvFvVPL,cplFvFvVPR,cplcFeFvHpmL,cplcFeFvHpmR,cplcFeFvVWLmL,cplcFeFvVWLmR,           & 
& cplcFeFvVWRmL,cplcFeFvVWRmR,cplHpmcHpmVP,cplHppmmcHppmmVP,cplcFecFeHppmmL,             & 
& cplcFecFeHppmmR,cplcVWLmVPVWLm,cplcVWRmVPVWLm,cplcVWLmVPVWRm,cplcVWRmVPVWRm,EDM)

Implicit None
Real(dp),Intent(in)  :: MAh(4),MAh2(4),MFe(3),MFe2(3),MFv(6),MFv2(6),Mhh(4),Mhh2(4),MHpm(4),MHpm2(4),         & 
& MHppmm(2),MHppmm2(2),MVWLm,MVWLm2,MVWRm,MVWRm2,MVZ,MVZ2,MVZR,MVZR2

Complex(dp),Intent(in)  :: cplcFeFeAhL(3,3,4),cplcFeFeAhR(3,3,4),cplAhhhVP(4,4),cplFeFecHppmmL(3,3,2),           & 
& cplFeFecHppmmR(3,3,2),cplFvFecHpmL(6,3,4),cplFvFecHpmR(6,3,4),cplFvFecVWLmL(6,3),      & 
& cplFvFecVWLmR(6,3),cplFvFecVWRmL(6,3),cplFvFecVWRmR(6,3),cplcFeFehhL(3,3,4),           & 
& cplcFeFehhR(3,3,4),cplcFeFeVPL(3,3),cplcFeFeVPR(3,3),cplcFeFeVZL(3,3),cplcFeFeVZR(3,3),& 
& cplcFeFeVZRL(3,3),cplcFeFeVZRR(3,3),cplFvFvVPL(6,6),cplFvFvVPR(6,6),cplcFeFvHpmL(3,6,4),& 
& cplcFeFvHpmR(3,6,4),cplcFeFvVWLmL(3,6),cplcFeFvVWLmR(3,6),cplcFeFvVWRmL(3,6),          & 
& cplcFeFvVWRmR(3,6),cplHpmcHpmVP(4,4),cplHppmmcHppmmVP(2,2),cplcFecFeHppmmL(3,3,2),     & 
& cplcFecFeHppmmR(3,3,2),cplcVWLmVPVWLm,cplcVWRmVPVWLm,cplcVWLmVPVWRm,cplcVWRmVPVWRm
...
!ratio = MFv2(i2)/MHpm2(i1)
 !If ((ratio.eq.ratio).and.(ratio.lt.1.0E+30_dp).and.(ratio.gt.1.0E-30_dp)) Then 
!EDM = EDM -(0)* chargefactor*Aimag(coup1R*Conjg(coup1L))*FeynFunctionA(ratio)*MFv(i2)/MHpm2(i1) 
!End if 
...
!ratio = MFe2(i2)/MHppmm2(i1)
 !If ((ratio.eq.ratio).and.(ratio.lt.1.0E+30_dp).and.(ratio.gt.1.0E-30_dp)) Then 
!EDM = EDM -(-1)* chargefactor*Aimag(coup1R*Conjg(coup1L))*FeynFunctionA(ratio)*MFe(i2)/MHppmm2(i1) 
!End if 
...
coup1L = cplcFeFvVWLmL(gt1,i2)
coup1R = cplcFeFvVWLmR(gt1,i2)
coup2L = cplFvFecVWLmL(i3,gt2)
coup2R = cplFvFecVWLmR(i3,gt2)
ratio = MVWLm2/MFv2(i2)
 ratio = 1._dp/ratio ! conventions in 1402.7065 are different 
 chargefactor = chargefactor*(0._dp)
 If ((ratio.eq.ratio).and.(ratio.lt.1.0E+30_dp).and.(ratio.gt.1.0E-30_dp)) Then 
...
!ratio = MFe2(i1)/MHppmm2(i2)
 !If ((ratio.eq.ratio).and.(ratio.lt.1.0E+30_dp).and.(ratio.gt.1.0E-30_dp)) Then 
!EDM = EDM +(-2)* chargefactor*Aimag(coup1L*Conjg(coup1R))*FeynFunctionB(ratio)*MFe(i1)/MHppmm2(i2) 
!End if 
...
& cplAhAhcVWLmVWLm,cplAhAhVZVZ,cplAhcVWLmVWRm,cplAhhhVZ,cplAhHpmcVWLm,cplcFdFdVZL,       & 
...
& cplcVWLmVWLmVZRVZR2,cplcVWLmVWLmVZRVZR3,cplcVWLmVWLmVZVZ1,cplcVWLmVWLmVZVZ2,           & 
& cplcVWLmVWLmVZVZ3,cplcVWLmVWRmVZ,cplcVWLmVWRmVZR,cplcVWRmVWLmVZ,cplcVWRmVWRmVZ,        & 
& cplcVWRmVWRmVZVZ1,cplcVWRmVWRmVZVZ2,cplcVWRmVWRmVZVZ3,cplFvFecVWLmL(6,3),              & 
& cplFvFecVWLmR(6,3),cplFvFvVZL(6,6),cplFvFvVZR(6,6),cplhhcVWLmVWLm(4),cplhhcVWLmVWRm(4),& 
...
& MVWLm2,MVWRm,MVWRm2,MVZ,MVZ2,MVZR,MVZR2,cplAhhhVP,cplcFdFdVPL,cplcFdFdVPR,             & 
& cplcFeFeVPL,cplcFeFeVPR,cplcFuFuVPL,cplcFuFuVPR,cplFvFvVPL,cplFvFvVPR,cplcgWLmgWLmVP,  & 
...
Complex(dp),Intent(in)  :: cplcgWRmgZVWLm,cplcgWLmgZpVWLm,cplcgWRmgZpVWLm,cplhhcHpmVWLm(4,4),cplHpmcHppmmVWLm(4,2),& 
...
& cplAhAhVPVZ,cplAhhhVP,cplAhhhVZ,cplcFdFdVPL,cplcFdFdVPR,cplcFdFdVZL,cplcFdFdVZR,       & 
& cplcFeFeVPL,cplcFeFeVPR,cplcFeFeVZL,cplcFeFeVZR,cplcFuFuVPL,cplcFuFuVPR,               & 
& cplcFuFuVZL,cplcFuFuVZR,cplcgWLmgWLmVP,cplcgWLmgWLmVZ,cplcgWLmgWRmVP,cplcgWLmgWRmVZ,   & 
...
& cplcgWRpgWRpVP,cplcgWRpgWRpVZ,cplcHpmVPVWLm,cplcHpmVPVWRm,cplcHpmVWLmVZ,               & 
& cplcHpmVWRmVZ,cplcVWLmVPVWLm,cplcVWLmVPVWLmVZ1,cplcVWLmVPVWLmVZ2,cplcVWLmVPVWLmVZ3,    & 
...
& cplhhVZVZ,cplhhVZVZR,cplHpmcHpmVP,cplHpmcHpmVPVZ,cplHpmcHpmVZ,cplHpmcVWLmVP,           & 
& cplHpmcVWLmVZ,cplHpmcVWRmVP,cplHpmcVWRmVZ,cplHppmmcHppmmVP,cplHppmmcHppmmVPVZ,         & 
& cplHppmmcHppmmVZ,kont,PiZg_mz2)
...
& cplcVWRmVPVPVWRm2,kont,Pigg_mz2)
...
Subroutine CalculateLowEnergyConstraints(gBLinput,g2input,gRinput,g3input,            & 
& RHO2input,RHO4input,RHO1input,RHO3input,BETA1input,ALP3input,ALP1input,LAM1input,      & 
& ALP2input,BETA2input,BETA3input,LAM4input,LAM2input,LAM3input,YDRinput,YL1input,       & 
& YQ1input,YQ2input,YDLinput,YL2input,muLR2input,MU22input,MU12input,vHdinput,           & 
& vHuinput,vRinput,vLinput,Tpar,Spar,Upar,ae,amu,atau,EDMe,EDMmu,EDMtau,dRho,            & 
...
Real(dp),Intent(inout) :: gBLinput,g2input,gRinput,g3input,RHO2input,RHO4input,RHO1input,RHO3input,             & 
...
Complex(dp),Intent(inout) :: YDRinput(3,3),YL1input(3,3),YQ1input(3,3),YQ2input(3,3),YDLinput(3,3),YL2input(3,3)
...
Complex(dp) :: cplAhAhcVWLmVWLm(4,4),cplAhAhcVWRmVWLm(4,4),cplAhAhhh(4,4,4),cplAhAhVPVP(4,4),        & 
& cplAhAhVPVZ(4,4),cplAhAhVPVZR(4,4),cplAhAhVZVZ(4,4),cplAhAhVZVZR(4,4),cplAhcHpmVWLm(4,4),& 
& cplAhcHpmVWRm(4,4),cplAhcVWLmVWRm(4),cplAhcVWRmVWLm(4),cplAhhhVP(4,4),cplAhhhVZ(4,4),  & 
& cplAhhhVZR(4,4),cplAhHpmcHpm(4,4,4),cplAhHpmcVWLm(4,4),cplAhHpmcVWRm(4,4),             & 
& cplAhHppmmcHppmm(4,2,2),cplcFdFdAhL(3,3,4),cplcFdFdAhR(3,3,4),cplcFdFdhhL(3,3,4),      & 
...
& cplcFdFuVWRmR(3,3),cplcFecFeHppmmL(3,3,2),cplcFecFeHppmmR(3,3,2),cplcFeFeAhL(3,3,4),   & 
...
& cplcFeFvVWRmL(3,6),cplcFeFvVWRmR(3,6),cplcFuFdcHpmL(3,3,4),cplcFuFdcHpmR(3,3,4),       & 
...
& cplcFuFuVZR(3,3),cplcFuFuVZRL(3,3),cplcFuFuVZRR(3,3),cplcgPgWLmcVWLm,cplcgPgWLpVWLm,   & 
& cplcgPgWRmcVWLm,cplcgPgWRpVWLm,cplcgWLmgPVWLm,cplcgWLmgWLmVP,cplcgWLmgWLmVZ,           & 
& cplcgWLmgWRmVP,cplcgWLmgWRmVZ,cplcgWLmgZpVWLm,cplcgWLmgZVWLm,cplcgWLpgPcVWLm,          & 
& cplcgWLpgWLpVP,cplcgWLpgWLpVZ,cplcgWLpgWRpVP,cplcgWLpgWRpVZ,cplcgWLpgZcVWLm,           & 
& cplcgWLpgZpcVWLm,cplcgWRmgPVWLm,cplcgWRmgWLmVP,cplcgWRmgWLmVZ,cplcgWRmgWRmVP,          & 
& cplcgWRmgWRmVZ,cplcgWRmgZpVWLm,cplcgWRmgZVWLm,cplcgWRpgPcVWLm,cplcgWRpgWLpVP,          & 
& cplcgWRpgWLpVZ,cplcgWRpgWRpVP,cplcgWRpgWRpVZ,cplcgWRpgZcVWLm,cplcgWRpgZpcVWLm,         & 
& cplcgZgWLmcVWLm,cplcgZgWLpVWLm,cplcgZgWRmcVWLm,cplcgZgWRpVWLm,cplcgZpgWLmcVWLm,        & 
& cplcgZpgWLpVWLm,cplcgZpgWRmcVWLm,cplcgZpgWRpVWLm,cplcHpmVPVWLm(4),cplcHpmVPVWRm(4),    & 
& cplcHpmVWLmVZ(4),cplcHpmVWLmVZR(4),cplcHpmVWRmVZ(4),cplcHpmVWRmVZR(4),cplcHppmmVWLmVWLm(2),& 
& cplcHppmmVWLmVWRm(2),cplcHppmmVWRmVWRm(2),cplcVWLmcVWLmVWLmVWLm1,cplcVWLmcVWLmVWLmVWLm2,& 
...
& cplcVWRmVWRmVZVZR1,cplcVWRmVWRmVZVZR2,cplcVWRmVWRmVZVZR3,cplFeFecHppmmL(3,3,2),        & 
& cplFeFecHppmmR(3,3,2),cplFvFecHpmL(6,3,4),cplFvFecHpmR(6,3,4),cplFvFecVWLmL(6,3),      & 
...
& cplFvFvVZL(6,6),cplFvFvVZR(6,6),cplFvFvVZRL(6,6),cplFvFvVZRR(6,6),cplhhcHpmVWLm(4,4),  & 
...
& cplhhhhVPVP(4,4),cplhhhhVPVZ(4,4),cplhhhhVPVZR(4,4),cplhhhhVZVZ(4,4),cplhhhhVZVZR(4,4),& 
& cplhhHpmcHpm(4,4,4),cplhhHpmcVWLm(4,4),cplhhHpmcVWRm(4,4),cplhhHppmmcHppmm(4,2,2),     & 
...
& cplHpmcHpmVZVZR(4,4),cplHpmcHppmmVWLm(4,2),cplHpmcHppmmVWRm(4,2),cplHpmcVWLmVP(4),     & 
& cplHpmcVWLmVZ(4),cplHpmcVWLmVZR(4),cplHpmcVWRmVP(4),cplHpmcVWRmVZ(4),cplHpmcVWRmVZR(4),& 
& cplHpmHpmcHppmm(4,4,2),cplHppmmcHpmcHpm(2,4,4),cplHppmmcHpmcVWLm(2,4),cplHppmmcHpmcVWRm(2,4),& 
& cplHppmmcHppmmcVWLmVWLm(2,2),cplHppmmcHppmmcVWRmVWLm(2,2),cplHppmmcHppmmVP(2,2),       & 
& cplHppmmcHppmmVPVP(2,2),cplHppmmcHppmmVPVZ(2,2),cplHppmmcHppmmVPVZR(2,2),              & 
& cplHppmmcHppmmVZ(2,2),cplHppmmcHppmmVZR(2,2),cplHppmmcHppmmVZVZ(2,2),cplHppmmcHppmmVZVZR(2,2),& 
& cplHppmmcVWLmcVWLm(2),cplHppmmcVWLmcVWRm(2),cplHppmmcVWRmcVWRm(2),cplVGVGVG
...
scale_save = Qin 
Call RunSM_and_SUSY_RGEs(160._dp,gBLinput,g2input,gRinput,g3input,RHO2input,          & 
...
& vR,vL,CKM_160,sinW2_160,Alpha_160,AlphaS_160,.false.)
...
MHpm(2)=MVWRm
MHpm2(2)=MVWRm2
Call AllCouplings(RHO1,RHO3,BETA1,ALP3,ALP1,LAM1,ALP2,BETA2,BETA3,LAM4,               & 
& LAM2,LAM3,vHd,vHu,vR,vL,ZH,UP,UC,RHO4,UCC,RHO2,gBL,g2,gR,ZZ,PhiW,g3,YQ1,               & 
& YQ2,ZDL,ZDR,YL1,YL2,ZEL,ZER,ZUL,ZUR,YDR,YDL,UV,cplAhAhhh,cplAhHpmcHpm,cplAhHppmmcHppmm,& 
& cplhhhhhh,cplhhHpmcHpm,cplhhHppmmcHppmm,cplHpmHpmcHppmm,cplHppmmcHpmcHpm,              & 
& cplAhhhVP,cplAhhhVZ,cplAhhhVZR,cplAhHpmcVWLm,cplAhHpmcVWRm,cplAhcHpmVWLm,              & 
& cplAhcHpmVWRm,cplhhHpmcVWLm,cplhhHpmcVWRm,cplhhcHpmVWLm,cplhhcHpmVWRm,cplHpmcHpmVP,    & 
& cplHpmcHppmmVWLm,cplHpmcHppmmVWRm,cplHpmcHpmVZ,cplHpmcHpmVZR,cplHppmmcHppmmVP,         & 
& cplHppmmcHppmmVZ,cplHppmmcHppmmVZR,cplHppmmcHpmcVWLm,cplHppmmcHpmcVWRm,cplAhcVWRmVWLm, & 
& cplAhcVWLmVWRm,cplhhVPVZ,cplhhVPVZR,cplhhcVWLmVWLm,cplhhcVWRmVWLm,cplhhcVWLmVWRm,      & 
& cplhhcVWRmVWRm,cplhhVZVZ,cplhhVZVZR,cplhhVZRVZR,cplHpmcVWLmVP,cplHpmcVWRmVP,           & 
& cplHpmcVWLmVZ,cplHpmcVWRmVZ,cplHpmcVWLmVZR,cplHpmcVWRmVZR,cplHppmmcVWLmcVWLm,          & 
& cplHppmmcVWLmcVWRm,cplHppmmcVWRmcVWRm,cplcHpmVPVWLm,cplcHpmVPVWRm,cplcHppmmVWLmVWLm,   & 
& cplcHppmmVWLmVWRm,cplcHpmVWLmVZ,cplcHpmVWLmVZR,cplcHppmmVWRmVWRm,cplcHpmVWRmVZ,        & 
& cplcHpmVWRmVZR,cplVGVGVG,cplcVWLmVPVWLm,cplcVWRmVPVWLm,cplcVWLmVPVWRm,cplcVWRmVPVWRm,  & 
...
& cplcFuFdcHpmL,cplcFuFdcHpmR,cplFeFecHppmmL,cplFeFecHppmmR,cplFvFecHpmL,cplFvFecHpmR,   & 
& cplcFeFehhL,cplcFeFehhR,cplcFuFuhhL,cplcFuFuhhR,cplcFdFuHpmL,cplcFdFuHpmR,             & 
& cplFvFvhhL,cplFvFvhhR,cplcFeFvHpmL,cplcFeFvHpmR,cplcFecFeHppmmL,cplcFecFeHppmmR,       & 
& cplcFdFdVGL,cplcFdFdVGR,cplcFdFdVPL,cplcFdFdVPR,cplcFdFdVZL,cplcFdFdVZR,               & 
& cplcFdFdVZRL,cplcFdFdVZRR,cplcFuFdcVWLmL,cplcFuFdcVWLmR,cplcFuFdcVWRmL,cplcFuFdcVWRmR, & 
& cplFvFecVWLmL,cplFvFecVWLmR,cplFvFecVWRmL,cplFvFecVWRmR,cplcFeFeVPL,cplcFeFeVPR,       & 
& cplcFeFeVZL,cplcFeFeVZR,cplcFeFeVZRL,cplcFeFeVZRR,cplcFuFuVGL,cplcFuFuVGR,             & 
& cplcFuFuVPL,cplcFuFuVPR,cplcFdFuVWLmL,cplcFdFuVWLmR,cplcFdFuVWRmL,cplcFdFuVWRmR,       & 
& cplcFuFuVZL,cplcFuFuVZR,cplcFuFuVZRL,cplcFuFuVZRR,cplFvFvVPL,cplFvFvVPR,               & 
...
& MVWRm2,MVZ,MVZ2,MVZR,MVZR2,cplAhAhhh,cplAhcHpmVWLm,cplAhcHpmVWRm,cplAhcVWLmVWRm,       & 
& cplAhcVWRmVWLm,cplAhhhVP,cplAhhhVZ,cplAhhhVZR,cplAhHpmcHpm,cplAhHpmcVWLm,              & 
& cplAhHpmcVWRm,cplAhHppmmcHppmm,cplcFdFdAhL,cplcFdFdAhR,cplcFdFdhhL,cplcFdFdhhR,        & 
...
& cplcFuFdcVWRmR,cplcFuFuAhL,cplcFuFuAhR,cplcFuFuhhL,cplcFuFuhhR,cplcFuFuVPL,            & 
& cplcFuFuVPR,cplcFuFuVZL,cplcFuFuVZR,cplcFuFuVZRL,cplcFuFuVZRR,cplcHpmVPVWLm,           & 
...
& cplcVWRmVWRmVZ,cplcVWRmVWRmVZR,cplFeFecHppmmL,cplFeFecHppmmR,cplFvFecHpmL,             & 
& cplFvFecHpmR,cplFvFecVWLmL,cplFvFecVWLmR,cplFvFecVWRmL,cplFvFecVWRmR,cplFvFvAhL,       & 
& cplFvFvAhR,cplFvFvhhL,cplFvFvhhR,cplFvFvVPL,cplFvFvVPR,cplFvFvVZL,cplFvFvVZR,          & 
...
& cplhhHppmmcHppmm,cplhhVPVZ,cplhhVPVZR,cplhhVZRVZR,cplhhVZVZ,cplhhVZVZR,cplHpmcHpmVP,   & 
& cplHpmcHpmVZ,cplHpmcHpmVZR,cplHpmcVWLmVP,cplHpmcVWLmVZ,cplHpmcVWLmVZR,cplHpmcVWRmVP,   & 
& cplHpmcVWRmVZ,cplHpmcVWRmVZR,cplHppmmcHppmmVP,cplHppmmcHppmmVZ,cplHppmmcHppmmVZR,      & 
...
& cplcFeFvVWRmL,cplcFeFvVWRmR,cplcFuFdcHpmL,cplcFuFdcHpmR,cplcFuFdcVWLmL,cplcFuFdcVWLmR, & 
...
& cplcVWLmVPVWLm,cplcVWLmVPVWRm,cplcVWLmVWLmVZ,cplcVWLmVWLmVZR,cplcVWLmVWRmVZ,           & 
& cplcVWLmVWRmVZR,cplcVWRmVPVWLm,cplcVWRmVPVWRm,cplcVWRmVWLmVZ,cplcVWRmVWLmVZR,          & 
& cplcVWRmVWRmVZ,cplcVWRmVWRmVZR,cplFvFecHpmL,cplFvFecHpmR,cplFvFecVWLmL,cplFvFecVWLmR,  & 
& cplFvFecVWRmL,cplFvFecVWRmR,cplFvFvAhL,cplFvFvAhR,cplFvFvhhL,cplFvFvhhR,               & 
& cplFvFvVPL,cplFvFvVPR,cplFvFvVZL,cplFvFvVZR,cplFvFvVZRL,cplFvFvVZRR,cplhhcHpmVWLm,     & 
& cplhhcHpmVWRm,cplhhcVWLmVWLm,cplhhcVWLmVWRm,cplhhcVWRmVWLm,cplhhcVWRmVWRm,             & 
& cplhhhhhh,cplhhHpmcHpm,cplhhHpmcVWLm,cplhhHpmcVWRm,cplhhVPVZ,cplhhVPVZR,               & 
...
& cplAhcHpmVWLm,cplAhcHpmVWRm,cplAhcVWLmVWRm,cplAhcVWRmVWLm,cplAhhhVP,cplAhhhVZ,         & 
& cplAhhhVZR,cplAhHpmcHpm,cplAhHpmcVWLm,cplAhHpmcVWRm,cplcFdFdAhL,cplcFdFdAhR,           & 
...
& cplcVWLmVPVWLm,cplcVWLmVPVWRm,cplcVWLmVWLmVZ,cplcVWLmVWLmVZR,cplcVWLmVWRmVZ,           & 
& cplcVWLmVWRmVZR,cplcVWRmVPVWLm,cplcVWRmVPVWRm,cplcVWRmVWLmVZ,cplcVWRmVWLmVZR,          & 
& cplcVWRmVWRmVZ,cplcVWRmVWRmVZR,cplhhcHpmVWLm,cplhhcHpmVWRm,cplhhcVWLmVWLm,             & 
& cplhhcVWLmVWRm,cplhhcVWRmVWLm,cplhhcVWRmVWRm,cplhhhhhh,cplhhHpmcHpm,cplhhHpmcVWLm,     & 
& cplhhHpmcVWRm,cplhhVPVZ,cplhhVPVZR,cplhhVZRVZR,cplhhVZVZ,cplhhVZVZR,cplHpmcHpmVP,      & 
& cplHpmcHpmVZ,cplHpmcHpmVZR,cplHpmcVWLmVP,cplHpmcVWLmVZ,cplHpmcVWLmVZR,cplHpmcVWRmVP,   & 
...
& MFu,MFu2,MFv,MFv2,Mhh,Mhh2,MHpm,MHpm2,MHppmm,MHppmm2,MVWLm,MVWLm2,MVWRm,               & 
& MVWRm2,MVZ,MVZ2,MVZR,MVZR2,cplAhcHpmVWLm,cplAhcHpmVWRm,cplAhcVWLmVWRm,cplAhcVWRmVWLm,  & 
...
& cplcFdFuHpmR,cplcFdFuVWLmL,cplcFdFuVWLmR,cplcFdFuVWRmL,cplcFdFuVWRmR,cplcFecFeHppmmL,  & 
...
& cplcHpmVWLmVZR,cplcHpmVWRmVZ,cplcHpmVWRmVZR,cplcHppmmVWLmVWLm,cplcHppmmVWLmVWRm,       & 
& cplcHppmmVWRmVWRm,cplcVWLmVWLmVZ,cplcVWLmVWLmVZR,cplcVWLmVWRmVZ,cplcVWLmVWRmVZR,       & 
& cplcVWRmVWLmVZ,cplcVWRmVWLmVZR,cplcVWRmVWRmVZ,cplcVWRmVWRmVZR,cplFeFecHppmmL,          & 
& cplFeFecHppmmR,cplFvFecHpmL,cplFvFecHpmR,cplFvFecVWLmL,cplFvFecVWLmR,cplFvFecVWRmL,    & 
& cplFvFecVWRmR,cplFvFvAhL,cplFvFvAhR,cplFvFvhhL,cplFvFvhhR,cplFvFvVZL,cplFvFvVZR,       & 
& cplFvFvVZRL,cplFvFvVZRR,cplhhcHpmVWLm,cplhhcHpmVWRm,cplhhcVWLmVWLm,cplhhcVWLmVWRm,     & 
& cplhhcVWRmVWLm,cplhhcVWRmVWRm,cplhhHpmcHpm,cplhhHpmcVWLm,cplhhHpmcVWRm,cplHpmcHpmVZ,   & 
& cplHpmcHpmVZR,cplHpmcHppmmVWLm,cplHpmcHppmmVWRm,cplHpmcVWLmVZ,cplHpmcVWLmVZR,          & 
& cplHpmcVWRmVZ,cplHpmcVWRmVZR,cplHpmHpmcHppmm,TSOdulvSLL(gt1,gt2,gt3,gt4)               & 
...
& cplhhcVWRmVWLm,cplhhcVWRmVWRm,cplhhHpmcHpm,cplhhHpmcVWLm,cplhhHpmcVWRm,cplHpmcHpmVZ,   & 
& cplHpmcHpmVZR,cplHpmcHppmmVWLm,cplHpmcHppmmVWRm,cplHpmcVWLmVZ,cplHpmcVWLmVZR,          & 
& cplHpmcVWRmVZ,cplHpmcVWRmVZR,cplHpmHpmcHppmm,TVOdulvSLL(gt1,gt2,gt3,gt4)               & 
...
& cplcFdFdVZL,cplcFdFdVZR,cplcFdFdVZRL,cplcFdFdVZRR,cplcFdFuHpmL,cplcFdFuHpmR,           & 
& cplcFdFuVWLmL,cplcFdFuVWLmR,cplcFdFuVWRmL,cplcFdFuVWRmR,cplcFuFdcHpmL,cplcFuFdcHpmR,   & 
& cplcFuFdcVWLmL,cplcFuFdcVWLmR,cplcFuFdcVWRmL,cplcFuFdcVWRmR,cplcFuFuVPL,               & 
& cplcFuFuVPR,cplcHpmVPVWLm,cplcHpmVPVWRm,cplcVWLmVPVWLm,cplcVWLmVPVWRm,cplcVWRmVPVWLm,  & 
& cplcVWRmVPVWRm,cplhhVPVZ,cplhhVPVZR,cplHpmcHpmVP,cplHpmcVWLmVP,cplHpmcVWRmVP,          & 
...
& cplhhcVWRmVWLm,cplhhcVWRmVWRm,cplhhHpmcHpm,cplhhHpmcVWLm,cplhhHpmcVWRm,cplHpmcHpmVZ,   & 
& cplHpmcHpmVZR,cplHpmcHppmmVWLm,cplHpmcHppmmVWRm,cplHpmcVWLmVZ,cplHpmcVWLmVZR,          & 
& cplHpmcVWRmVZ,cplHpmcVWRmVZR,cplHpmHpmcHppmm,TSOdulvSLLSM(gt1,gt2,gt3,gt4)             & 
...
& cplhhcVWRmVWLm,cplhhcVWRmVWRm,cplhhHpmcHpm,cplhhHpmcVWLm,cplhhHpmcVWRm,cplHpmcHpmVZ,   & 
& cplHpmcHpmVZR,cplHpmcHppmmVWLm,cplHpmcHppmmVWRm,cplHpmcVWLmVZ,cplHpmcVWLmVZR,          & 
& cplHpmcVWRmVZ,cplHpmcVWRmVZR,cplHpmHpmcHppmm,TVOdulvSLLSM(gt1,gt2,gt3,gt4)             & 
...
If (MatchingOrder.gt.-1) Then 
Call RunSM_and_SUSY_RGEs(mz,gBLinput,g2input,gRinput,g3input,RHO2input,               & 
& RHO4input,RHO1input,RHO3input,BETA1input,ALP3input,ALP1input,LAM1input,ALP2input,      & 
& BETA2input,BETA3input,LAM4input,LAM2input,LAM3input,YDRinput,YL1input,YQ1input,        & 
& YQ2input,YDLinput,YL2input,muLR2input,MU22input,MU12input,vHdinput,vHuinput,           & 
& vRinput,vLinput,gBL,g2,gR,g3,RHO2,RHO4,RHO1,RHO3,BETA1,ALP3,ALP1,LAM1,ALP2,            & 
& BETA2,BETA3,LAM4,LAM2,LAM3,YDR,YL1,YQ1,YQ2,YDL,YL2,muLR2,MU22,MU12,vHd,vHu,            & 
& vR,vL,CKM_MZ,sinW2_MZ,Alpha_MZ,AlphaS_MZ,.true.)
...
& cplAhhhVP,cplAhhhVZ,cplAhhhVZR,cplAhHpmcHpm,cplAhHpmcVWLm,cplAhHpmcVWRm,               & 
& cplAhHppmmcHppmm,cplcFecFeHppmmL,cplcFecFeHppmmR,cplcFeFeAhL,cplcFeFeAhR,              & 
& cplcFeFehhL,cplcFeFehhR,cplcFeFeVPL,cplcFeFeVPR,cplcFeFeVZL,cplcFeFeVZR,               & 
& cplcFeFeVZRL,cplcFeFeVZRR,cplcFeFvHpmL,cplcFeFvHpmR,cplcFeFvVWLmL,cplcFeFvVWLmR,       & 
& cplcFeFvVWRmL,cplcFeFvVWRmR,cplcHpmVPVWLm,cplcHpmVPVWRm,cplcHpmVWLmVZ,cplcHpmVWLmVZR,  & 
& cplcHpmVWRmVZ,cplcHpmVWRmVZR,cplcHppmmVWLmVWLm,cplcHppmmVWLmVWRm,cplcHppmmVWRmVWRm,    & 
& cplcVWLmVPVWLm,cplcVWLmVPVWRm,cplcVWLmVWLmVZ,cplcVWLmVWLmVZR,cplcVWLmVWRmVZ,           & 
& cplcVWLmVWRmVZR,cplcVWRmVPVWLm,cplcVWRmVPVWRm,cplcVWRmVWLmVZ,cplcVWRmVWLmVZR,          & 
& cplcVWRmVWRmVZ,cplcVWRmVWRmVZR,cplFeFecHppmmL,cplFeFecHppmmR,cplFvFecHpmL,             & 
& cplFvFecHpmR,cplFvFecVWLmL,cplFvFecVWLmR,cplFvFecVWRmL,cplFvFecVWRmR,cplFvFvAhL,       & 
...
& cplhhcVWRmVWLm,cplhhcVWRmVWRm,cplhhhhhh,cplhhHpmcHpm,cplhhHpmcVWLm,cplhhHpmcVWRm,      & 
& cplhhHppmmcHppmm,cplhhVPVZ,cplhhVPVZR,cplhhVZRVZR,cplhhVZVZ,cplhhVZVZR,cplHpmcHpmVP,   & 
& cplHpmcHpmVZ,cplHpmcHpmVZR,cplHpmcHppmmVWLm,cplHpmcHppmmVWRm,cplHpmcVWLmVP,            & 
& cplHpmcVWLmVZ,cplHpmcVWLmVZR,cplHpmcVWRmVP,cplHpmcVWRmVZ,cplHpmcVWRmVZR,               & 
& cplHpmHpmcHppmm,cplHppmmcHpmcHpm,cplHppmmcHpmcVWLm,cplHppmmcHpmcVWRm,cplHppmmcHppmmVP, & 
& cplHppmmcHppmmVZ,cplHppmmcHppmmVZR,cplHppmmcVWLmcVWLm,cplHppmmcVWLmcVWRm,              & 
& cplHppmmcVWRmcVWRm,TSO4lSLL(gt1,gt2,gt3,gt4),TSO4lSRR(gt1,gt2,gt3,gt4),TSO4lSRL(gt1,gt2,gt3,gt4)& 
...
& cplHpmHpmcHppmm,cplHppmmcHpmcHpm,cplHppmmcHpmcVWLm,cplHppmmcHpmcVWRm,cplHppmmcHppmmVP, & 
& cplHppmmcHppmmVZ,cplHppmmcHppmmVZR,cplHppmmcVWLmcVWLm,cplHppmmcVWLmcVWRm,              & 
& cplHppmmcVWRmcVWRm,TSO4lSLLSM(gt1,gt2,gt3,gt4),TSO4lSRRSM(gt1,gt2,gt3,gt4)             & 
...
& cplHpmHpmcHppmm,cplHppmmcHpmcHpm,cplHppmmcHpmcVWLm,cplHppmmcHpmcVWRm,cplHppmmcHppmmVP, & 
& cplHppmmcHppmmVZ,cplHppmmcHppmmVZR,cplHppmmcVWLmcVWLm,cplHppmmcVWLmcVWRm,              & 
& cplHppmmcVWRmcVWRm,TVO4lSLL(gt1,gt2,gt3,gt4),TVO4lSRR(gt1,gt2,gt3,gt4),TVO4lSRL(gt1,gt2,gt3,gt4)& 
...
& cplHpmHpmcHppmm,cplHppmmcHpmcHpm,cplHppmmcHpmcVWLm,cplHppmmcHpmcVWRm,cplHppmmcHppmmVP, & 
& cplHppmmcHppmmVZ,cplHppmmcHppmmVZR,cplHppmmcVWLmcVWLm,cplHppmmcVWLmcVWRm,              & 
& cplHppmmcVWRmcVWRm,TVO4lSLLSM(gt1,gt2,gt3,gt4),TVO4lSRRSM(gt1,gt2,gt3,gt4)             & 
...
& cplHpmHpmcHppmm,cplHppmmcHpmcHpm,cplHppmmcHpmcVWLm,cplHppmmcHpmcVWRm,cplHppmmcHppmmVP, & 
& cplHppmmcHppmmVZ,cplHppmmcHppmmVZR,cplHppmmcVWLmcVWLm,cplHppmmcVWLmcVWRm,              & 
& cplHppmmcVWRmcVWRm,TSO4lSLLcross(gt1,gt2,gt3,gt4),TSO4lSRRcross(gt1,gt2,gt3,gt4)       & 
...
& cplHpmHpmcHppmm,cplHppmmcHpmcHpm,cplHppmmcHpmcVWLm,cplHppmmcHpmcVWRm,cplHppmmcHppmmVP, & 
& cplHppmmcHppmmVZ,cplHppmmcHppmmVZR,cplHppmmcVWLmcVWLm,cplHppmmcVWLmcVWRm,              & 
& cplHppmmcVWRmcVWRm,TSO4lSLLcrossSM(gt1,gt2,gt3,gt4),TSO4lSRRcrossSM(gt1,gt2,gt3,gt4)   & 
...
& cplHpmHpmcHppmm,cplHppmmcHpmcHpm,cplHppmmcHpmcVWLm,cplHppmmcHpmcVWRm,cplHppmmcHppmmVP, & 
& cplHppmmcHppmmVZ,cplHppmmcHppmmVZR,cplHppmmcVWLmcVWLm,cplHppmmcVWLmcVWRm,              & 
& cplHppmmcVWRmcVWRm,TVO4lSLLcross(gt1,gt2,gt3,gt4),TVO4lSRRcross(gt1,gt2,gt3,gt4)       & 
...
& cplHpmHpmcHppmm,cplHppmmcHpmcHpm,cplHppmmcHpmcVWLm,cplHppmmcHpmcVWRm,cplHppmmcHppmmVP, & 
& cplHppmmcHppmmVZ,cplHppmmcHppmmVZR,cplHppmmcVWLmcVWLm,cplHppmmcVWLmcVWRm,              & 
& cplHppmmcVWRmcVWRm,TVO4lSLLcrossSM(gt1,gt2,gt3,gt4),TVO4lSRRcrossSM(gt1,gt2,gt3,gt4)   & 
...
& cplHpmHpmcHppmm,cplHppmmcHpmcHpm,cplHppmmcHpmcVWLm,cplHppmmcHpmcVWRm,cplHppmmcHppmmVP, & 
& cplHppmmcHppmmVZ,cplHppmmcHppmmVZR,cplHppmmcVWLmcVWLm,cplHppmmcVWLmcVWRm,              & 
& cplHppmmcVWRmcVWRm,BO4lSLL(gt1,gt2,gt3,gt4),BO4lSRR(gt1,gt2,gt3,gt4),BO4lSRL(gt1,gt2,gt3,gt4)& 
...
& Mhh2,MHpm,MHpm2,MHppmm,MHppmm2,MVWLm,MVWLm2,MVWRm,MVWRm2,MVZ,MVZ2,MVZR,MVZR2,          & 
& cplAhAhhh,cplAhcHpmVWLm,cplAhcHpmVWRm,cplAhcVWLmVWRm,cplAhcVWRmVWLm,cplAhhhVP,         & 
& cplAhhhVZ,cplAhhhVZR,cplAhHpmcHpm,cplAhHpmcVWLm,cplAhHpmcVWRm,cplAhHppmmcHppmm,        & 
& cplcFecFeHppmmL,cplcFecFeHppmmR,cplcFeFeAhL,cplcFeFeAhR,cplcFeFehhL,cplcFeFehhR,       & 
& cplcFeFeVPL,cplcFeFeVPR,cplcFeFeVZL,cplcFeFeVZR,cplcFeFeVZRL,cplcFeFeVZRR,             & 
& cplcFeFvHpmL,cplcFeFvHpmR,cplcFeFvVWLmL,cplcFeFvVWLmR,cplcFeFvVWRmL,cplcFeFvVWRmR,     & 
& cplcHpmVPVWLm,cplcHpmVPVWRm,cplcHpmVWLmVZ,cplcHpmVWLmVZR,cplcHpmVWRmVZ,cplcHpmVWRmVZR, & 
& cplcHppmmVWLmVWLm,cplcHppmmVWLmVWRm,cplcHppmmVWRmVWRm,cplcVWLmVPVWLm,cplcVWLmVPVWRm,   & 
...
& cplFeFecHppmmL,cplFeFecHppmmR,cplFvFecHpmL,cplFvFecHpmR,cplFvFecVWLmL,cplFvFecVWLmR,   & 
& cplFvFecVWRmL,cplFvFecVWRmR,cplFvFvAhL,cplFvFvAhR,cplFvFvhhL,cplFvFvhhR,               & 
& cplFvFvVPL,cplFvFvVPR,cplFvFvVZL,cplFvFvVZR,cplFvFvVZRL,cplFvFvVZRR,cplhhcHpmVWLm,     & 
& cplhhcHpmVWRm,cplhhcVWLmVWLm,cplhhcVWLmVWRm,cplhhcVWRmVWLm,cplhhcVWRmVWRm,             & 
& cplhhhhhh,cplhhHpmcHpm,cplhhHpmcVWLm,cplhhHpmcVWRm,cplhhHppmmcHppmm,cplhhVPVZ,         & 
& cplhhVPVZR,cplhhVZRVZR,cplhhVZVZ,cplhhVZVZR,cplHpmcHpmVP,cplHpmcHpmVZ,cplHpmcHpmVZR,   & 
& cplHpmcHppmmVWLm,cplHpmcHppmmVWRm,cplHpmcVWLmVP,cplHpmcVWLmVZ,cplHpmcVWLmVZR,          & 
& cplHpmcVWRmVP,cplHpmcVWRmVZ,cplHpmcVWRmVZR,cplHpmHpmcHppmm,cplHppmmcHpmcHpm,           & 
& cplHppmmcHpmcVWLm,cplHppmmcHpmcVWRm,cplHppmmcHppmmVP,cplHppmmcHppmmVZ,cplHppmmcHppmmVZR,& 
& cplHppmmcVWLmcVWLm,cplHppmmcVWLmcVWRm,cplHppmmcVWRmcVWRm,BO4lSLLSM(gt1,gt2,gt3,gt4)    & 
...
& cplHpmHpmcHppmm,cplHppmmcHpmcHpm,cplHppmmcHpmcVWLm,cplHppmmcHpmcVWRm,cplHppmmcHppmmVP, & 
& cplHppmmcHppmmVZ,cplHppmmcHppmmVZR,cplHppmmcVWLmcVWLm,cplHppmmcVWLmcVWRm,              & 
& cplHppmmcVWRmcVWRm,PSO4lSLL(gt1,gt2,gt3,gt4),PSO4lSRR(gt1,gt2,gt3,gt4),PSO4lSRL(gt1,gt2,gt3,gt4)& 
...
& cplHpmHpmcHppmm,cplHppmmcHpmcHpm,cplHppmmcHpmcVWLm,cplHppmmcHpmcVWRm,cplHppmmcHppmmVP, & 
& cplHppmmcHppmmVZ,cplHppmmcHppmmVZR,cplHppmmcVWLmcVWLm,cplHppmmcVWLmcVWRm,              & 
& cplHppmmcVWRmcVWRm,PSO4lSLLSM(gt1,gt2,gt3,gt4),PSO4lSRRSM(gt1,gt2,gt3,gt4)             & 
...
& cplHpmHpmcHppmm,cplHppmmcHpmcHpm,cplHppmmcHpmcVWLm,cplHppmmcHpmcVWRm,cplHppmmcHppmmVP, & 
& cplHppmmcHppmmVZ,cplHppmmcHppmmVZR,cplHppmmcVWLmcVWLm,cplHppmmcVWLmcVWRm,              & 
& cplHppmmcVWRmcVWRm,PVO4lSLL(gt1,gt2,gt3,gt4),PVO4lSRR(gt1,gt2,gt3,gt4),PVO4lSRL(gt1,gt2,gt3,gt4)& 
...
& cplHpmHpmcHppmm,cplHppmmcHpmcHpm,cplHppmmcHpmcVWLm,cplHppmmcHpmcVWRm,cplHppmmcHppmmVP, & 
& cplHppmmcHppmmVZ,cplHppmmcHppmmVZR,cplHppmmcVWLmcVWLm,cplHppmmcVWLmcVWRm,              & 
& cplHppmmcVWRmcVWRm,PVO4lSLLSM(gt1,gt2,gt3,gt4),PVO4lSRRSM(gt1,gt2,gt3,gt4)             & 
...
& cplHpmHpmcHppmm,cplHppmmcHpmcHpm,cplHppmmcHpmcVWLm,cplHppmmcHpmcVWRm,cplHppmmcHppmmVP, & 
& cplHppmmcHppmmVZ,cplHppmmcHppmmVZR,cplHppmmcVWLmcVWLm,cplHppmmcVWLmcVWRm,              & 
& cplHppmmcVWRmcVWRm,BO4lSLLcross(gt1,gt2,gt3,gt4),BO4lSRRcross(gt1,gt2,gt3,gt4)         & 
...
& cplHpmHpmcHppmm,cplHppmmcHpmcHpm,cplHppmmcHpmcVWLm,cplHppmmcHpmcVWRm,cplHppmmcHppmmVP, & 
& cplHppmmcHppmmVZ,cplHppmmcHppmmVZR,cplHppmmcVWLmcVWLm,cplHppmmcVWLmcVWRm,              & 
& cplHppmmcVWRmcVWRm,BO4lSLLcrossSM(gt1,gt2,gt3,gt4),BO4lSRRcrossSM(gt1,gt2,gt3,gt4)     & 
...
& cplHpmHpmcHppmm,cplHppmmcHpmcHpm,cplHppmmcHpmcVWLm,cplHppmmcHpmcVWRm,cplHppmmcHppmmVP, & 
& cplHppmmcHppmmVZ,cplHppmmcHppmmVZR,cplHppmmcVWLmcVWLm,cplHppmmcVWLmcVWRm,              & 
& cplHppmmcVWRmcVWRm,PSO4lSLLcross(gt1,gt2,gt3,gt4),PSO4lSRRcross(gt1,gt2,gt3,gt4)       & 
...
& cplHpmHpmcHppmm,cplHppmmcHpmcHpm,cplHppmmcHpmcVWLm,cplHppmmcHpmcVWRm,cplHppmmcHppmmVP, & 
& cplHppmmcHppmmVZ,cplHppmmcHppmmVZR,cplHppmmcVWLmcVWLm,cplHppmmcVWLmcVWRm,              & 
& cplHppmmcVWRmcVWRm,PSO4lSLLcrossSM(gt1,gt2,gt3,gt4),PSO4lSRRcrossSM(gt1,gt2,gt3,gt4)   & 
...
& cplHpmHpmcHppmm,cplHppmmcHpmcHpm,cplHppmmcHpmcVWLm,cplHppmmcHpmcVWRm,cplHppmmcHppmmVP, & 
& cplHppmmcHppmmVZ,cplHppmmcHppmmVZR,cplHppmmcVWLmcVWLm,cplHppmmcVWLmcVWRm,              & 
& cplHppmmcVWRmcVWRm,PVO4lSLLcross(gt1,gt2,gt3,gt4),PVO4lSRRcross(gt1,gt2,gt3,gt4)       & 
...
& cplHpmHpmcHppmm,cplHppmmcHpmcHpm,cplHppmmcHpmcVWLm,cplHppmmcHpmcVWRm,cplHppmmcHppmmVP, & 
& cplHppmmcHppmmVZ,cplHppmmcHppmmVZR,cplHppmmcVWLmcVWLm,cplHppmmcVWLmcVWRm,              & 
& cplHppmmcVWRmcVWRm,PVO4lSLLcrossSM(gt1,gt2,gt3,gt4),PVO4lSRRcrossSM(gt1,gt2,gt3,gt4)   & 
...
& Mhh2,MHpm,MHpm2,MHppmm,MHppmm2,MVWLm,MVWLm2,MVWRm,MVWRm2,MVZ,MVZ2,MVZR,MVZR2,          & 
& cplAhhhVP,cplcFecFeHppmmL,cplcFecFeHppmmR,cplcFeFeAhL,cplcFeFeAhR,cplcFeFehhL,         & 
...
& cplcFeFvVWRmR,cplcHpmVPVWLm,cplcHpmVPVWRm,cplcVWLmVPVWLm,cplcVWLmVPVWRm,               & 
& cplcVWRmVPVWLm,cplcVWRmVPVWRm,cplFeFecHppmmL,cplFeFecHppmmR,cplFvFecHpmL,              & 
& cplFvFecHpmR,cplFvFecVWLmL,cplFvFecVWLmR,cplFvFecVWRmL,cplFvFecVWRmR,cplFvFvVPL,       & 
& cplFvFvVPR,cplhhVPVZ,cplhhVPVZR,cplHpmcHpmVP,cplHpmcVWLmVP,cplHpmcVWRmVP,              & 
& cplHppmmcHppmmVP,OA2lSL(gt1,gt2),OA2lSR(gt1,gt2),OA1L(gt1,gt2),OA1R(gt1,gt2))
...
& cplFvFecHpmR,cplFvFecVWLmL,cplFvFecVWLmR,cplFvFecVWRmL,cplFvFecVWRmR,cplFvFvVPL,       & 
& cplFvFvVPR,cplhhVPVZ,cplhhVPVZR,cplHpmcHpmVP,cplHpmcVWLmVP,cplHpmcVWRmVP,              & 
& cplHppmmcHppmmVP,OA2lSLSM(gt1,gt2),OA2lSRSM(gt1,gt2),OA1LSM(gt1,gt2),OA1RSM(gt1,gt2))
...
& MHpm,MHpm2,MHppmm,MHppmm2,MVWLm,MVWLm2,MVWRm,MVWRm2,MVZ,MVZ2,MVZR,MVZR2,               & 
& cplAhAhhh,cplAhhhVZ,cplAhhhVZR,cplcFecFeHppmmL,cplcFecFeHppmmR,cplcFeFeAhL,            & 
& cplcFeFeAhR,cplcFeFehhL,cplcFeFehhR,cplcFeFeVZL,cplcFeFeVZR,cplcFeFeVZRL,              & 
& cplcFeFeVZRR,cplcFeFvHpmL,cplcFeFvHpmR,cplcFeFvVWLmL,cplcFeFvVWLmR,cplcFeFvVWRmL,      & 
& cplcFeFvVWRmR,cplFeFecHppmmL,cplFeFecHppmmR,cplFvFecHpmL,cplFvFecHpmR,cplFvFecVWLmL,   & 
& cplFvFecVWLmR,cplFvFecVWRmL,cplFvFecVWRmR,cplFvFvhhL,cplFvFvhhR,cplhhcHpmVWLm,         & 
& cplhhcHpmVWRm,cplhhcVWLmVWLm,cplhhcVWLmVWRm,cplhhcVWRmVWLm,cplhhcVWRmVWRm,             & 
& cplhhhhhh,cplhhHpmcHpm,cplhhHpmcVWLm,cplhhHpmcVWRm,cplhhHppmmcHppmm,cplhhVZRVZR,       & 
& cplhhVZVZ,cplhhVZVZR,OH2lSL(gt1,gt2,gt3),OH2lSR(gt1,gt2,gt3))
...
& cplhhcHpmVWRm,cplhhcVWLmVWLm,cplhhcVWLmVWRm,cplhhcVWRmVWLm,cplhhcVWRmVWRm,             & 
& cplhhhhhh,cplhhHpmcHpm,cplhhHpmcVWLm,cplhhHpmcVWRm,cplhhHppmmcHppmm,cplhhVZRVZR,       & 
& cplhhVZVZ,cplhhVZVZR,OH2lSLSM(gt1,gt2,gt3),OH2lSRSM(gt1,gt2,gt3))
...
& MFv2,Mhh,Mhh2,MHpm,MHpm2,MHppmm,MHppmm2,MVWLm,MVWLm2,MVWRm,MVWRm2,MVZ,MVZ2,            & 
& MVZR,MVZR2,cplAhhhVP,cplcFecFeHppmmL,cplcFecFeHppmmR,cplcFeFeAhL,cplcFeFeAhR,          & 
& cplcFeFehhL,cplcFeFehhR,cplcFeFeVPL,cplcFeFeVPR,cplcFeFeVZL,cplcFeFeVZR,               & 
& cplcFeFeVZRL,cplcFeFeVZRR,cplcFeFvHpmL,cplcFeFvHpmR,cplcFeFvVWLmL,cplcFeFvVWLmR,       & 
& cplcFeFvVWRmL,cplcFeFvVWRmR,cplcHpmVPVWLm,cplcHpmVPVWRm,cplcVWLmVPVWLm,cplcVWLmVPVWRm, & 
& cplcVWRmVPVWLm,cplcVWRmVPVWRm,cplFeFecHppmmL,cplFeFecHppmmR,cplFvFecHpmL,              & 
& cplFvFecHpmR,cplFvFecVWLmL,cplFvFecVWLmR,cplFvFecVWRmL,cplFvFecVWRmR,cplFvFvVPL,       & 
& cplFvFvVPR,cplhhVPVZ,cplhhVPVZR,cplHpmcHpmVP,cplHpmcVWLmVP,cplHpmcVWRmVP,              & 
& cplHppmmcHppmmVP,DP2lSL(gt1,gt2),DP2lSR(gt1,gt2))
...
& cplFvFecHpmR,cplFvFecVWLmL,cplFvFecVWLmR,cplFvFecVWRmL,cplFvFecVWRmR,cplFvFvVPL,       & 
& cplFvFvVPR,cplhhVPVZ,cplhhVPVZR,cplHpmcHpmVP,cplHpmcVWLmVP,cplHpmcVWRmVP,              & 
& cplHppmmcHppmmVP,DP2lSLSM(gt1,gt2),DP2lSRSM(gt1,gt2))
...
& MHpm,MHpm2,MHppmm,MHppmm2,MVWLm,MVWLm2,MVWRm,MVWRm2,MVZ,MVZ2,MVZR,MVZR2,               & 
& cplAhhhVZ,cplcFecFeHppmmL,cplcFecFeHppmmR,cplcFeFeAhL,cplcFeFeAhR,cplcFeFehhL,         & 
& cplcFeFehhR,cplcFeFeVZL,cplcFeFeVZR,cplcFeFeVZRL,cplcFeFeVZRR,cplcFeFvHpmL,            & 
& cplcFeFvHpmR,cplcFeFvVWLmL,cplcFeFvVWLmR,cplcFeFvVWRmL,cplcFeFvVWRmR,cplcHpmVWLmVZ,    & 
& cplcHpmVWRmVZ,cplcVWLmVWLmVZ,cplcVWLmVWRmVZ,cplcVWRmVWLmVZ,cplcVWRmVWRmVZ,             & 
& cplFeFecHppmmL,cplFeFecHppmmR,cplFvFecHpmL,cplFvFecHpmR,cplFvFecVWLmL,cplFvFecVWLmR,   & 
& cplFvFecVWRmL,cplFvFecVWRmR,cplFvFvVZL,cplFvFvVZR,cplhhVZVZ,cplhhVZVZR,cplHpmcHpmVZ,   & 
& cplHpmcVWLmVZ,cplHpmcVWRmVZ,cplHppmmcHppmmVZ,OZ2lSL(gt1,gt2),OZ2lSR(gt1,gt2)           & 
& ,OZ2lVL(gt1,gt2),OZ2lVR(gt1,gt2))
...
& cplFeFecHppmmL,cplFeFecHppmmR,cplFvFecHpmL,cplFvFecHpmR,cplFvFecVWLmL,cplFvFecVWLmR,   & 
& cplFvFecVWRmL,cplFvFecVWRmR,cplFvFvVZL,cplFvFvVZR,cplhhVZVZ,cplhhVZVZR,cplHpmcHpmVZ,   & 
& cplHpmcVWLmVZ,cplHpmcVWRmVZ,cplHppmmcHppmmVZ,OZ2lSLSM(gt1,gt2),OZ2lSRSM(gt1,gt2)       & 
...
& MHpm2,MHppmm,MHppmm2,MVWLm,MVWLm2,MVWRm,MVWRm2,MVZ,MVZ2,MVZR,MVZR2,cplAhAhcVWLmVWLm,   & 
...
& cplHpmcHpmVZVZ,cplHpmcVWLmVP,cplHpmcVWLmVZ,cplHpmcVWLmVZR,cplHpmcVWRmVZ,               & 
& cplHppmmcHpmcVWLm,cplHppmmcHppmmcVWLmVWLm,cplHppmmcHppmmVZ,cplHppmmcHppmmVZVZ,         & 
& cplHppmmcVWLmcVWLm,cplHppmmcVWLmcVWRm,dRho)
...
& MVWRm2,MVZ,MVZ2,MVZR,MVZR2,cplAhhhVP,cplcFdFdVPL,cplcFdFdVPR,cplcFeFeVPL,              & 
& cplcFeFeVPR,cplcFuFuVPL,cplcFuFuVPR,cplFvFvVPL,cplFvFvVPR,cplcgWLmgWLmVP,              & 
& cplcgWRmgWLmVP,cplcgWLpgWLpVP,cplcgWRpgWLpVP,cplcgWRmgWRmVP,cplcgWRpgWRpVP,            & 
& cplhhVPVZ,cplhhVPVZR,cplHpmcHpmVP,cplHpmcVWLmVP,cplHpmcVWRmVP,cplHppmmcHppmmVP,        & 
& cplcVWLmVPVWLm,cplcVWRmVPVWLm,cplcVWRmVPVWRm,cplAhAhVPVP,cplhhhhVPVP,cplHpmcHpmVPVP,   & 
