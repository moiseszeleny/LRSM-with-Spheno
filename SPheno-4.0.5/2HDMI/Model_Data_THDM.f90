...
Complex(dp) :: Lam5IN,Lam1IN,Lam4IN,Lam3IN,Lam2IN,YuIN(3,3),YdIN(3,3),YeIN(3,3),M12IN,               & 
& M112IN,M222IN

Real(dp) :: g1MZ,g2MZ,g3MZ

Complex(dp) :: Lam5MZ,Lam1MZ,Lam4MZ,Lam3MZ,Lam2MZ,YuMZ(3,3),YdMZ(3,3),YeMZ(3,3),M12MZ,               & 
& M112MZ,M222MZ

Real(dp) :: g1GUT,g2GUT,g3GUT

Complex(dp) :: Lam5GUT,Lam1GUT,Lam4GUT,Lam3GUT,Lam2GUT,YuGUT(3,3),YdGUT(3,3),YeGUT(3,3),             & 
& M12GUT,M112GUT,M222GUT
