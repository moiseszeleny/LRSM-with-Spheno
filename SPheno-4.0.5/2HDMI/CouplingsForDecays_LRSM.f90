...
Module CouplingsForDecays_LRSM
...
& vHuinput,vRinput,vLinput,cplcFuFuAhL,cplcFuFuAhR,cplcFuFdcHpmL,cplcFuFdcHpmR,          & 
...
& YDR,YL1,YQ1,YQ2,YDL,YL2,muLR2,MU22,MU12,.True.,kont)
...
& ALP2input,BETA2input,BETA3input,LAM4input,LAM2input,LAM3input,YDRinput,YL1input,       & 
& YQ1input,YQ2input,YDLinput,YL2input,muLR2input,MU22input,MU12input,vHdinput,           & 
& vHuinput,vRinput,vLinput,cplcFeFeAhL,cplcFeFeAhR,cplcFeFehhL,cplcFeFehhR,              & 
& cplcFeFeVZL,cplcFeFeVZR,cplcFeFeVZRL,cplcFeFeVZRR,cplcFeFvHpmL,cplcFeFvHpmR,           & 
& cplcFeFvVWLmL,cplcFeFvVWLmR,cplcFeFvVWRmL,cplcFeFvVWRmR,cplcFecFeHppmmL,               & 
...
& cplcFeFvVWRmR(3,6),cplcFecFeHppmmL(3,3,2),cplcFecFeHppmmR(3,3,2)
...
& ALP2input,BETA2input,BETA3input,LAM4input,LAM2input,LAM3input,YDRinput,YL1input,       & 
& YQ1input,YQ2input,YDLinput,YL2input,muLR2input,MU22input,MU12input,vHdinput,           & 
& vHuinput,vRinput,vLinput,cplcFdFdAhL,cplcFdFdAhR,cplcFdFdhhL,cplcFdFdhhR,              & 
...
& ALP2input,BETA2input,BETA3input,LAM4input,LAM2input,LAM3input,YDRinput,YL1input,       & 
& YQ1input,YQ2input,YDLinput,YL2input,muLR2input,MU22input,MU12input,vHdinput,           & 
& vHuinput,vRinput,vLinput,cplHiggsPP,cplHiggsGG,cplHiggsZZvirt,cplHiggsWWvirt,          & 
...
Do gt1 = 1, 4
 Do gt2 = 1, 4
  Do gt3 = 1, 4
Call CouplingAhAhhhT(gt1,gt2,gt3,RHO1,RHO3,BETA1,ALP3,ALP1,LAM1,ALP2,BETA2,           & 
& BETA3,LAM4,LAM2,LAM3,vHd,vHu,vR,vL,ZH,UP,cplAhAhhh(gt1,gt2,gt3))
...
Do gt1 = 1, 4
 Do gt2 = 1, 4
  Do gt3 = 1, 4
Call CouplinghhhhhhT(gt1,gt2,gt3,RHO1,RHO3,BETA1,ALP3,ALP1,LAM1,ALP2,BETA2,           & 
& BETA3,LAM4,LAM2,LAM3,vHd,vHu,vR,vL,ZH,cplhhhhhh(gt1,gt2,gt3))
...
Do gt1 = 1, 4
 Do gt2 = 1, 4
  Do gt3 = 1, 4
Call CouplinghhHpmcHpmT(gt1,gt2,gt3,RHO1,RHO3,BETA1,ALP3,ALP1,LAM1,ALP2,              & 
& BETA2,BETA3,LAM4,LAM2,LAM3,vHd,vHu,vR,vL,ZH,UC,cplhhHpmcHpm(gt1,gt2,gt3))
...
Do gt1 = 1, 4
 Do gt2 = 1, 2
  Do gt3 = 1, 2
Call CouplinghhHppmmcHppmmT(gt1,gt2,gt3,RHO2,RHO4,RHO1,RHO3,BETA1,ALP3,               & 
& ALP1,ALP2,BETA2,BETA3,vHd,vHu,vR,vL,ZH,UCC,cplhhHppmmcHppmm(gt1,gt2,gt3))
...
Do gt1 = 1, 4
Call CouplinghhcVWRmVWRmT(gt1,g2,gR,vHd,vHu,vR,vL,ZH,PhiW,cplhhcVWRmVWRm(gt1))
...
cplhhVZVZ = 0._dp 
Do gt1 = 1, 4
Call CouplinghhVZVZT(gt1,gBL,g2,gR,vHd,vHu,vR,vL,ZZ,ZH,cplhhVZVZ(gt1))
...
cplhhVZVZR = 0._dp 
Do gt1 = 1, 4
Call CouplinghhVZVZRT(gt1,gBL,g2,gR,vHd,vHu,vR,vL,ZZ,ZH,cplhhVZVZR(gt1))
...
cplhhVZRVZR = 0._dp 
Do gt1 = 1, 4
Call CouplinghhVZRVZRT(gt1,gBL,g2,gR,vHd,vHu,vR,vL,ZZ,ZH,cplhhVZRVZR(gt1))
...
& ratVWRm,MFd,MFe,MFu,MHpm,MHppmm,MVWLm,MVWRm,gNLO,coup)

cplHiggsPP(i1) = coup*Alpha 
CoupHPP(i1) = coup 
Call CoupHiggsToPhotonSM(m_in,MFd,MFe,MFu,MHpm,MHppmm,MVWLm,MVWRm,gNLO,coup)
...
& ALP2input,BETA2input,BETA3input,LAM4input,LAM2input,LAM3input,YDRinput,YL1input,       & 
& YQ1input,YQ2input,YDLinput,YL2input,muLR2input,MU22input,MU12input,vHdinput,           & 
& vHuinput,vRinput,vLinput,cplFvFvAhL,cplFvFvAhR,cplFvFecHpmL,cplFvFecHpmR,              & 
& cplFvFecVWLmL,cplFvFecVWLmR,cplFvFecVWRmL,cplFvFecVWRmR,cplFvFvhhL,cplFvFvhhR,         & 
...
Complex(dp),Intent(out) :: cplFvFvAhL(6,6,4),cplFvFvAhR(6,6,4),cplFvFecHpmL(6,3,4),cplFvFecHpmR(6,3,4),          & 
...
& ALP2input,BETA2input,BETA3input,LAM4input,LAM2input,LAM3input,YDRinput,YL1input,       & 
& YQ1input,YQ2input,YDLinput,YL2input,muLR2input,MU22input,MU12input,vHdinput,           & 
& vHuinput,vRinput,vLinput,cplAhhhVZ,cplcFdFdVZL,cplcFdFdVZR,cplcFeFeVZL,cplcFeFeVZR,    & 
...
cplHpmcVWLmVZ = 0._dp 
Do gt1 = 1, 4
Call CouplingHpmcVWLmVZT(gt1,gBL,g2,gR,vHd,vHu,vR,vL,ZZ,UC,PhiW,cplHpmcVWLmVZ(gt1))
...
cplHpmcVWRmVZ = 0._dp 
Do gt1 = 1, 4
Call CouplingHpmcVWRmVZT(gt1,gBL,g2,gR,vHd,vHu,vR,vL,ZZ,UC,PhiW,cplHpmcVWRmVZ(gt1))
...
& ALP2input,BETA2input,BETA3input,LAM4input,LAM2input,LAM3input,YDRinput,YL1input,       & 
& YQ1input,YQ2input,YDLinput,YL2input,muLR2input,MU22input,MU12input,vHdinput,           & 
& vHuinput,vRinput,vLinput,cplAhhhVZR,cplcFdFdVZRL,cplcFdFdVZRR,cplcFeFeVZRL,            & 
...
Do gt1 = 1, 4
Call CouplingHpmcVWLmVZRT(gt1,gBL,g2,gR,vHd,vHu,vR,vL,ZZ,UC,PhiW,cplHpmcVWLmVZR(gt1))
...
Do gt1 = 1, 4
Call CouplingHpmcVWRmVZRT(gt1,gBL,g2,gR,vHd,vHu,vR,vL,ZZ,UC,PhiW,cplHpmcVWRmVZR(gt1))
...
& ALP2input,BETA2input,BETA3input,LAM4input,LAM2input,LAM3input,YDRinput,YL1input,       & 
& YQ1input,YQ2input,YDLinput,YL2input,muLR2input,MU22input,MU12input,vHdinput,           & 
& vHuinput,vRinput,vLinput,cplAhHppmmcHppmm,cplFeFecHppmmL,cplFeFecHppmmR,               & 
...
Do gt1 = 1, 4
 Do gt2 = 1, 2
  Do gt3 = 1, 2
Call CouplingAhHppmmcHppmmT(gt1,gt2,gt3,RHO4,BETA1,BETA2,BETA3,vHd,vHu,               & 
& vR,vL,UP,UCC,cplAhHppmmcHppmm(gt1,gt2,gt3))
...
Do gt1 = 1, 4
 Do gt2 = 1, 4
  Do gt3 = 1, 2
Call CouplingHpmHpmcHppmmT(gt1,gt2,gt3,RHO2,RHO4,BETA1,ALP3,BETA2,BETA3,              & 
& vHd,vHu,vR,vL,UC,UCC,cplHpmHpmcHppmm(gt1,gt2,gt3))
...
Do gt1 = 1, 2
Call CouplingcHppmmVWRmVWRmT(gt1,g2,gR,vR,vL,UCC,PhiW,cplcHppmmVWRmVWRm(gt1))
...
& ALP2input,BETA2input,BETA3input,LAM4input,LAM2input,LAM3input,YDRinput,YL1input,       & 
& YQ1input,YQ2input,YDLinput,YL2input,muLR2input,MU22input,MU12input,vHdinput,           & 
& vHuinput,vRinput,vLinput,cplAhHpmcHpm,cplAhcHpmVWLm,cplAhcHpmVWRm,cplcFuFdcHpmL,       & 
& cplcFuFdcHpmR,cplFvFecHpmL,cplFvFecHpmR,cplhhHpmcHpm,cplhhcHpmVWLm,cplhhcHpmVWRm,      & 
...
& cplcFuFdcHpmR(3,3,4),cplFvFecHpmL(6,3,4),cplFvFecHpmR(6,3,4),cplhhHpmcHpm(4,4,4),      & 
& cplhhcHpmVWLm(4,4),cplhhcHpmVWRm(4,4),cplHpmcHpmVZ(4,4),cplHpmcHpmVZR(4,4),            & 
& cplHppmmcHpmcHpm(2,4,4),cplHppmmcHpmcVWLm(2,4),cplHppmmcHpmcVWRm(2,4),cplcHpmVWLmVZ(4),& 
& cplcHpmVWLmVZR(4),cplcHpmVWRmVZ(4),cplcHpmVWRmVZR(4)
...
Do gt1 = 1, 4
 Do gt2 = 1, 4
  Do gt3 = 1, 4
Call CouplingAhHpmcHpmT(gt1,gt2,gt3,BETA1,ALP3,BETA2,BETA3,LAM2,LAM3,vHd,             & 
& vHu,vR,vL,UP,UC,cplAhHpmcHpm(gt1,gt2,gt3))
...
Do gt1 = 1, 2
 Do gt2 = 1, 4
  Do gt3 = 1, 4
Call CouplingHppmmcHpmcHpmT(gt1,gt2,gt3,RHO2,RHO4,BETA1,ALP3,BETA2,BETA3,             & 
& vHd,vHu,vR,vL,UC,UCC,cplHppmmcHpmcHpm(gt1,gt2,gt3))
...
cplcHpmVWLmVZ = 0._dp 
Do gt1 = 1, 4
Call CouplingcHpmVWLmVZT(gt1,gBL,g2,gR,vHd,vHu,vR,vL,ZZ,UC,PhiW,cplcHpmVWLmVZ(gt1))
...
cplcHpmVWRmVZ = 0._dp 
Do gt1 = 1, 4
Call CouplingcHpmVWRmVZT(gt1,gBL,g2,gR,vHd,vHu,vR,vL,ZZ,UC,PhiW,cplcHpmVWRmVZ(gt1))
...
Do gt1 = 1, 4
Call CouplingcHpmVWRmVZRT(gt1,gBL,g2,gR,vHd,vHu,vR,vL,ZZ,UC,PhiW,cplcHpmVWRmVZR(gt1))
...
& ALP2input,BETA2input,BETA3input,LAM4input,LAM2input,LAM3input,YDRinput,YL1input,       & 
& YQ1input,YQ2input,YDLinput,YL2input,muLR2input,MU22input,MU12input,vHdinput,           & 
& vHuinput,vRinput,vLinput,cplPseudoHiggsPP,cplPseudoHiggsGG,cplAhAhhh,cplcFdFdAhL,      & 
...
& ratPVWLm,ratPVWRm,MFd,MFe,MFu,MHpm,MHppmm,MVWLm,MVWRm,gNLO,coup)
...
& ALP2input,BETA2input,BETA3input,LAM4input,LAM2input,LAM3input,YDRinput,YL1input,       & 
& YQ1input,YQ2input,YDLinput,YL2input,muLR2input,MU22input,MU12input,vHdinput,           & 
& vHuinput,vRinput,vLinput,cplAhHpmcVWLm,cplAhcVWLmVWRm,cplcFuFdcVWLmL,cplcFuFdcVWLmR,   & 
& cplFvFecVWLmL,cplFvFecVWLmR,cplhhHpmcVWLm,cplhhcVWLmVWLm,cplhhcVWLmVWRm,               & 
...
& cplFvFecVWLmL(6,3),cplFvFecVWLmR(6,3),cplhhHpmcVWLm(4,4),cplhhcVWLmVWLm(4),            & 
& cplhhcVWLmVWRm(4),cplHpmcVWLmVZ(4),cplHpmcVWLmVZR(4),cplHppmmcHpmcVWLm(2,4),           & 
& cplHppmmcVWLmcVWLm(2),cplHppmmcVWLmcVWRm(2),cplcVWLmVWLmVZ,cplcVWLmVWLmVZR,            & 
...
Do gt1 = 1, 4
Call CouplingAhcVWLmVWRmT(gt1,g2,gR,vHd,vHu,UP,cplAhcVWLmVWRm(gt1))
...
Do gt1 = 1, 4
Call CouplinghhcVWLmVWRmT(gt1,g2,gR,vHd,vHu,vR,vL,ZH,PhiW,cplhhcVWLmVWRm(gt1))
...
Do gt1 = 1, 2
Call CouplingHppmmcVWLmcVWLmT(gt1,g2,gR,vR,vL,UCC,PhiW,cplHppmmcVWLmcVWLm(gt1))
...
Do gt1 = 1, 2
Call CouplingHppmmcVWLmcVWRmT(gt1,g2,gR,vR,vL,UCC,PhiW,cplHppmmcVWLmcVWRm(gt1))
...
& ALP2input,BETA2input,BETA3input,LAM4input,LAM2input,LAM3input,YDRinput,YL1input,       & 
& YQ1input,YQ2input,YDLinput,YL2input,muLR2input,MU22input,MU12input,vHdinput,           & 
& vHuinput,vRinput,vLinput,cplAhHpmcVWRm,cplAhcVWRmVWLm,cplcFuFdcVWRmL,cplcFuFdcVWRmR,   & 
& cplFvFecVWRmL,cplFvFecVWRmR,cplhhHpmcVWRm,cplhhcVWRmVWLm,cplhhcVWRmVWRm,               & 
...
& cplFvFecVWRmL(6,3),cplFvFecVWRmR(6,3),cplhhHpmcVWRm(4,4),cplhhcVWRmVWLm(4),            & 
& cplhhcVWRmVWRm(4),cplHpmcVWRmVZ(4),cplHpmcVWRmVZR(4),cplHppmmcHpmcVWRm(2,4),           & 
& cplHppmmcVWLmcVWRm(2),cplHppmmcVWRmcVWRm(2),cplcVWRmVWLmVZ,cplcVWRmVWLmVZR,            & 
...
Do gt1 = 1, 2
Call CouplingHppmmcVWRmcVWRmT(gt1,g2,gR,vR,vL,UCC,PhiW,cplHppmmcVWRmcVWRm(gt1))
...
& cplcFuFdcHpmL,cplcFuFdcHpmR,cplcFuFdcVWLmL,cplcFuFdcVWLmR,cplcFuFdcVWRmL,              & 
& cplcFuFdcVWRmR,cplcFuFuAhL,cplcFuFuAhR,cplcFuFuhhL,cplcFuFuhhR,cplcFuFuVZL,            & 
& cplcFuFuVZR,cplcFuFuVZRL,cplcFuFuVZRR,cplFvFecHpmL,cplFvFecHpmR,cplFvFecVWLmL,         & 
& cplFvFecVWLmR,cplFvFecVWRmL,cplFvFecVWRmR,cplFvFvAhL,cplFvFvAhR,cplFvFvhhL,            & 
...
End Module CouplingsForDecays_LRSM
