...
! ------------------------------------------------------------------------------  
! File created at 22:06 on 4.9.2024   
! ----------------------------------------------------------------------  
 
 
Module LoopMasses_LRSM 
...
mat2a(3,4) = 0._dp 
mat2a(3,4) = mat2a(3,4)-1._dp/2._dp*(BETA2*vHd**2)
mat2a(3,4) = mat2a(3,4)+(BETA1*vHd*vHu)/2._dp
mat2a(3,4) = mat2a(3,4)-1._dp/2._dp*(BETA3*vHu**2)
...
mat2a(1,1) = mat2a(1,1)-1._dp/4._dp*(g2*gR*vHd**2*Conjg(ZZ(3,2))*RXiZ*ZZ(2,2))
mat2a(1,1) = mat2a(1,1)+(g2**2*vHd**2*Conjg(ZZ(2,3))*RXiZR*ZZ(2,3))/4._dp
mat2a(1,1) = mat2a(1,1)-1._dp/4._dp*(g2*gR*vHd**2*Conjg(ZZ(3,3))*RXiZR*ZZ(2,3))
mat2a(1,1) = mat2a(1,1)-1._dp/4._dp*(g2*gR*vHd**2*Conjg(ZZ(2,2))*RXiZ*ZZ(3,2))
mat2a(1,1) = mat2a(1,1)+(gR**2*vHd**2*Conjg(ZZ(3,2))*RXiZ*ZZ(3,2))/4._dp
mat2a(1,1) = mat2a(1,1)-1._dp/4._dp*(g2*gR*vHd**2*Conjg(ZZ(2,3))*RXiZR*ZZ(3,3))
...
mat2a(1,2) = mat2a(1,2)+(BETA1*vL*vR)/2._dp
mat2a(1,2) = mat2a(1,2)+ALP2*vR**2
mat2a(1,2) = mat2a(1,2)-1._dp/4._dp*(g2**2*vHd*vHu*Conjg(ZZ(2,2))*RXiZ*ZZ(2,2))
mat2a(1,2) = mat2a(1,2)+(g2*gR*vHd*vHu*Conjg(ZZ(3,2))*RXiZ*ZZ(2,2))/4._dp
mat2a(1,2) = mat2a(1,2)-1._dp/4._dp*(g2**2*vHd*vHu*Conjg(ZZ(2,3))*RXiZR*ZZ(2,3))
...
mat2a(1,2) = mat2a(1,2)-1._dp/4._dp*(gR**2*vHd*vHu*Conjg(ZZ(3,2))*RXiZ*ZZ(3,2))
mat2a(1,2) = mat2a(1,2)+(g2*gR*vHd*vHu*Conjg(ZZ(2,3))*RXiZR*ZZ(3,3))/4._dp
mat2a(1,2) = mat2a(1,2)-1._dp/4._dp*(gR**2*vHd*vHu*Conjg(ZZ(3,3))*RXiZR*ZZ(3,3))
mat2a(1,3) = 0._dp 
mat2a(1,3) = mat2a(1,3)-(BETA2*vHd*vL)
mat2a(1,3) = mat2a(1,3)+(BETA1*vHu*vL)/2._dp
mat2a(1,3) = mat2a(1,3)+(g2*gBL*vHd*vR*Conjg(ZZ(2,2))*RXiZ*ZZ(1,2))/4._dp
mat2a(1,3) = mat2a(1,3)-1._dp/4._dp*(gBL*gR*vHd*vR*Conjg(ZZ(3,2))*RXiZ*ZZ(1,2))
mat2a(1,3) = mat2a(1,3)+(g2*gBL*vHd*vR*Conjg(ZZ(2,3))*RXiZR*ZZ(1,3))/4._dp
mat2a(1,3) = mat2a(1,3)-1._dp/4._dp*(gBL*gR*vHd*vR*Conjg(ZZ(3,3))*RXiZR*ZZ(1,3))
mat2a(1,3) = mat2a(1,3)+(g2*gBL*vHd*vR*Conjg(ZZ(1,2))*RXiZ*ZZ(2,2))/4._dp
mat2a(1,3) = mat2a(1,3)-1._dp/4._dp*(g2*gR*vHd*vR*Conjg(ZZ(3,2))*RXiZ*ZZ(2,2))
mat2a(1,3) = mat2a(1,3)+(g2*gBL*vHd*vR*Conjg(ZZ(1,3))*RXiZR*ZZ(2,3))/4._dp
mat2a(1,3) = mat2a(1,3)-1._dp/4._dp*(g2*gR*vHd*vR*Conjg(ZZ(3,3))*RXiZR*ZZ(2,3))
mat2a(1,3) = mat2a(1,3)-1._dp/4._dp*(gBL*gR*vHd*vR*Conjg(ZZ(1,2))*RXiZ*ZZ(3,2))
mat2a(1,3) = mat2a(1,3)-1._dp/4._dp*(g2*gR*vHd*vR*Conjg(ZZ(2,2))*RXiZ*ZZ(3,2))
mat2a(1,3) = mat2a(1,3)+(gR**2*vHd*vR*Conjg(ZZ(3,2))*RXiZ*ZZ(3,2))/2._dp
mat2a(1,3) = mat2a(1,3)-1._dp/4._dp*(gBL*gR*vHd*vR*Conjg(ZZ(1,3))*RXiZR*ZZ(3,3))
mat2a(1,3) = mat2a(1,3)-1._dp/4._dp*(g2*gR*vHd*vR*Conjg(ZZ(2,3))*RXiZR*ZZ(3,3))
mat2a(1,3) = mat2a(1,3)+(gR**2*vHd*vR*Conjg(ZZ(3,3))*RXiZR*ZZ(3,3))/2._dp
mat2a(1,4) = 0._dp 
mat2a(1,4) = mat2a(1,4)+BETA2*vHd*vR
mat2a(1,4) = mat2a(1,4)-1._dp/2._dp*(BETA1*vHu*vR)
mat2a(1,4) = mat2a(1,4)+(g2*gBL*vHd*vL*Conjg(ZZ(2,2))*RXiZ*ZZ(1,2))/4._dp
mat2a(1,4) = mat2a(1,4)-1._dp/4._dp*(gBL*gR*vHd*vL*Conjg(ZZ(3,2))*RXiZ*ZZ(1,2))
mat2a(1,4) = mat2a(1,4)+(g2*gBL*vHd*vL*Conjg(ZZ(2,3))*RXiZR*ZZ(1,3))/4._dp
mat2a(1,4) = mat2a(1,4)-1._dp/4._dp*(gBL*gR*vHd*vL*Conjg(ZZ(3,3))*RXiZR*ZZ(1,3))
mat2a(1,4) = mat2a(1,4)+(g2*gBL*vHd*vL*Conjg(ZZ(1,2))*RXiZ*ZZ(2,2))/4._dp
mat2a(1,4) = mat2a(1,4)-1._dp/2._dp*(g2**2*vHd*vL*Conjg(ZZ(2,2))*RXiZ*ZZ(2,2))
...
mat2a(1,4) = mat2a(1,4)-1._dp/2._dp*(g2**2*vHd*vL*Conjg(ZZ(2,3))*RXiZR*ZZ(2,3))
mat2a(1,4) = mat2a(1,4)+(g2*gR*vHd*vL*Conjg(ZZ(3,3))*RXiZR*ZZ(2,3))/4._dp
mat2a(1,4) = mat2a(1,4)-1._dp/4._dp*(gBL*gR*vHd*vL*Conjg(ZZ(1,2))*RXiZ*ZZ(3,2))
mat2a(1,4) = mat2a(1,4)+(g2*gR*vHd*vL*Conjg(ZZ(2,2))*RXiZ*ZZ(3,2))/4._dp
mat2a(1,4) = mat2a(1,4)-1._dp/4._dp*(gBL*gR*vHd*vL*Conjg(ZZ(1,3))*RXiZR*ZZ(3,3))
...
mat2a(2,2) = mat2a(2,2)-1._dp/4._dp*(g2*gR*vHu**2*Conjg(ZZ(3,2))*RXiZ*ZZ(2,2))
mat2a(2,2) = mat2a(2,2)+(g2**2*vHu**2*Conjg(ZZ(2,3))*RXiZR*ZZ(2,3))/4._dp
mat2a(2,2) = mat2a(2,2)-1._dp/4._dp*(g2*gR*vHu**2*Conjg(ZZ(3,3))*RXiZR*ZZ(2,3))
mat2a(2,2) = mat2a(2,2)-1._dp/4._dp*(g2*gR*vHu**2*Conjg(ZZ(2,2))*RXiZ*ZZ(3,2))
mat2a(2,2) = mat2a(2,2)+(gR**2*vHu**2*Conjg(ZZ(3,2))*RXiZ*ZZ(3,2))/4._dp
mat2a(2,2) = mat2a(2,2)-1._dp/4._dp*(g2*gR*vHu**2*Conjg(ZZ(2,3))*RXiZR*ZZ(3,3))
mat2a(2,2) = mat2a(2,2)+(gR**2*vHu**2*Conjg(ZZ(3,3))*RXiZR*ZZ(3,3))/4._dp
mat2a(2,3) = 0._dp 
mat2a(2,3) = mat2a(2,3)-1._dp/2._dp*(BETA1*vHd*vL)
mat2a(2,3) = mat2a(2,3)+BETA3*vHu*vL
mat2a(2,3) = mat2a(2,3)-1._dp/4._dp*(g2*gBL*vHu*vR*Conjg(ZZ(2,2))*RXiZ*ZZ(1,2))
mat2a(2,3) = mat2a(2,3)+(gBL*gR*vHu*vR*Conjg(ZZ(3,2))*RXiZ*ZZ(1,2))/4._dp
mat2a(2,3) = mat2a(2,3)-1._dp/4._dp*(g2*gBL*vHu*vR*Conjg(ZZ(2,3))*RXiZR*ZZ(1,3))
mat2a(2,3) = mat2a(2,3)+(gBL*gR*vHu*vR*Conjg(ZZ(3,3))*RXiZR*ZZ(1,3))/4._dp
mat2a(2,3) = mat2a(2,3)-1._dp/4._dp*(g2*gBL*vHu*vR*Conjg(ZZ(1,2))*RXiZ*ZZ(2,2))
mat2a(2,3) = mat2a(2,3)+(g2*gR*vHu*vR*Conjg(ZZ(3,2))*RXiZ*ZZ(2,2))/4._dp
mat2a(2,3) = mat2a(2,3)-1._dp/4._dp*(g2*gBL*vHu*vR*Conjg(ZZ(1,3))*RXiZR*ZZ(2,3))
...
mat2a(2,3) = mat2a(2,3)-1._dp/2._dp*(gR**2*vHu*vR*Conjg(ZZ(3,2))*RXiZ*ZZ(3,2))
...
mat2a(2,3) = mat2a(2,3)-1._dp/2._dp*(gR**2*vHu*vR*Conjg(ZZ(3,3))*RXiZR*ZZ(3,3))
mat2a(2,4) = 0._dp 
mat2a(2,4) = mat2a(2,4)+(BETA1*vHd*vR)/2._dp
mat2a(2,4) = mat2a(2,4)-(BETA3*vHu*vR)
mat2a(2,4) = mat2a(2,4)-1._dp/4._dp*(g2*gBL*vHu*vL*Conjg(ZZ(2,2))*RXiZ*ZZ(1,2))
mat2a(2,4) = mat2a(2,4)+(gBL*gR*vHu*vL*Conjg(ZZ(3,2))*RXiZ*ZZ(1,2))/4._dp
mat2a(2,4) = mat2a(2,4)-1._dp/4._dp*(g2*gBL*vHu*vL*Conjg(ZZ(2,3))*RXiZR*ZZ(1,3))
mat2a(2,4) = mat2a(2,4)+(gBL*gR*vHu*vL*Conjg(ZZ(3,3))*RXiZR*ZZ(1,3))/4._dp
mat2a(2,4) = mat2a(2,4)-1._dp/4._dp*(g2*gBL*vHu*vL*Conjg(ZZ(1,2))*RXiZ*ZZ(2,2))
mat2a(2,4) = mat2a(2,4)+(g2**2*vHu*vL*Conjg(ZZ(2,2))*RXiZ*ZZ(2,2))/2._dp
mat2a(2,4) = mat2a(2,4)-1._dp/4._dp*(g2*gR*vHu*vL*Conjg(ZZ(3,2))*RXiZ*ZZ(2,2))
mat2a(2,4) = mat2a(2,4)-1._dp/4._dp*(g2*gBL*vHu*vL*Conjg(ZZ(1,3))*RXiZR*ZZ(2,3))
mat2a(2,4) = mat2a(2,4)+(g2**2*vHu*vL*Conjg(ZZ(2,3))*RXiZR*ZZ(2,3))/2._dp
mat2a(2,4) = mat2a(2,4)-1._dp/4._dp*(g2*gR*vHu*vL*Conjg(ZZ(3,3))*RXiZR*ZZ(2,3))
mat2a(2,4) = mat2a(2,4)+(gBL*gR*vHu*vL*Conjg(ZZ(1,2))*RXiZ*ZZ(3,2))/4._dp
mat2a(2,4) = mat2a(2,4)-1._dp/4._dp*(g2*gR*vHu*vL*Conjg(ZZ(2,2))*RXiZ*ZZ(3,2))
mat2a(2,4) = mat2a(2,4)+(gBL*gR*vHu*vL*Conjg(ZZ(1,3))*RXiZR*ZZ(3,3))/4._dp
mat2a(2,4) = mat2a(2,4)-1._dp/4._dp*(g2*gR*vHu*vL*Conjg(ZZ(2,3))*RXiZR*ZZ(3,3))
mat2a(3,3) = 0._dp 
mat2a(3,3) = mat2a(3,3)-1._dp*(muLR2)
mat2a(3,3) = mat2a(3,3)+(ALP1*vHd**2)/2._dp
mat2a(3,3) = mat2a(3,3)-2*ALP2*vHd*vHu
...
mat2a(3,4) = mat2a(3,4)-1._dp/2._dp*(g2*gBL*vL*vR*Conjg(ZZ(2,2))*RXiZ*ZZ(1,2))
mat2a(3,4) = mat2a(3,4)-1._dp/2._dp*(gBL*gR*vL*vR*Conjg(ZZ(3,2))*RXiZ*ZZ(1,2))
mat2a(3,4) = mat2a(3,4)+gBL**2*vL*vR*Conjg(ZZ(1,3))*RXiZR*ZZ(1,3)
mat2a(3,4) = mat2a(3,4)-1._dp/2._dp*(g2*gBL*vL*vR*Conjg(ZZ(2,3))*RXiZR*ZZ(1,3))
mat2a(3,4) = mat2a(3,4)-1._dp/2._dp*(gBL*gR*vL*vR*Conjg(ZZ(3,3))*RXiZR*ZZ(1,3))
mat2a(3,4) = mat2a(3,4)-1._dp/2._dp*(g2*gBL*vL*vR*Conjg(ZZ(1,2))*RXiZ*ZZ(2,2))
mat2a(3,4) = mat2a(3,4)+(g2*gR*vL*vR*Conjg(ZZ(3,2))*RXiZ*ZZ(2,2))/2._dp
mat2a(3,4) = mat2a(3,4)-1._dp/2._dp*(g2*gBL*vL*vR*Conjg(ZZ(1,3))*RXiZR*ZZ(2,3))
mat2a(3,4) = mat2a(3,4)+(g2*gR*vL*vR*Conjg(ZZ(3,3))*RXiZR*ZZ(2,3))/2._dp
mat2a(3,4) = mat2a(3,4)-1._dp/2._dp*(gBL*gR*vL*vR*Conjg(ZZ(1,2))*RXiZ*ZZ(3,2))
mat2a(3,4) = mat2a(3,4)+(g2*gR*vL*vR*Conjg(ZZ(2,2))*RXiZ*ZZ(3,2))/2._dp
mat2a(3,4) = mat2a(3,4)-1._dp/2._dp*(gBL*gR*vL*vR*Conjg(ZZ(1,3))*RXiZR*ZZ(3,3))
...
mat2a(1,1) = mat2a(1,1)-1._dp/2._dp*(g2*gR*vHd*vHu*Cos(PhiW)*RXiWLm*Sin(PhiW))
...
mat2a(1,2) = mat2a(1,2)+ALP2*vL**2
mat2a(1,2) = mat2a(1,2)+ALP2*vR**2
mat2a(1,2) = mat2a(1,2)-1._dp/4._dp*(g2**2*vHd*vHu*Cos(PhiW)**2*RXiWLm)
mat2a(1,2) = mat2a(1,2)-1._dp/4._dp*(gR**2*vHd*vHu*Cos(PhiW)**2*RXiWRm)
...
mat2a(1,2) = mat2a(1,2)-1._dp/4._dp*(g2*gR*vHd**2*Cos(PhiW)*RXiWRm*Sin(PhiW))
mat2a(1,2) = mat2a(1,2)-1._dp/4._dp*(g2*gR*vHu**2*Cos(PhiW)*RXiWRm*Sin(PhiW))
mat2a(1,2) = mat2a(1,2)-1._dp/4._dp*(gR**2*vHd*vHu*RXiWLm*Sin(PhiW)**2)
mat2a(1,2) = mat2a(1,2)-1._dp/4._dp*(g2**2*vHd*vHu*RXiWRm*Sin(PhiW)**2)
mat2a(1,3) = 0._dp 
...
mat2a(1,3) = mat2a(1,3)-1._dp/2._dp*(g2*gR*vHd*vR*Cos(PhiW)*RXiWLm*Sin(PhiW))/sqrt(2._dp)
...
mat2a(1,4) = mat2a(1,4)-1._dp/2._dp*(BETA1*vHu*vR)/sqrt(2._dp)
mat2a(1,4) = mat2a(1,4)-1._dp/2._dp*(g2**2*vHd*vL*Cos(PhiW)**2*RXiWLm)/sqrt(2._dp)
mat2a(1,4) = mat2a(1,4)+(g2*gR*vHu*vL*Cos(PhiW)*RXiWLm*Sin(PhiW))/(2._dp*sqrt(2._dp))
mat2a(1,4) = mat2a(1,4)-1._dp/2._dp*(g2*gR*vHu*vL*Cos(PhiW)*RXiWRm*Sin(PhiW))/sqrt(2._dp)
mat2a(1,4) = mat2a(1,4)-1._dp/2._dp*(g2**2*vHd*vL*RXiWRm*Sin(PhiW)**2)/sqrt(2._dp)
mat2a(2,2) = 0._dp 
mat2a(2,2) = mat2a(2,2)-1._dp*(MU12)
mat2a(2,2) = mat2a(2,2)+LAM1*vHd**2
mat2a(2,2) = mat2a(2,2)-2*LAM4*vHd*vHu
...
mat2a(2,2) = mat2a(2,2)-1._dp/2._dp*(g2*gR*vHd*vHu*Cos(PhiW)*RXiWLm*Sin(PhiW))
...
mat2a(2,3) = mat2a(2,3)-1._dp/2._dp*(BETA1*vHu*vL)/sqrt(2._dp)
mat2a(2,3) = mat2a(2,3)+(ALP3*vHd*vR)/(2._dp*sqrt(2._dp))
mat2a(2,3) = mat2a(2,3)-1._dp/2._dp*(gR**2*vHd*vR*Cos(PhiW)**2*RXiWRm)/sqrt(2._dp)
mat2a(2,3) = mat2a(2,3)+(g2*gR*vHu*vR*Cos(PhiW)*RXiWLm*Sin(PhiW))/(2._dp*sqrt(2._dp))
mat2a(2,3) = mat2a(2,3)-1._dp/2._dp*(g2*gR*vHu*vR*Cos(PhiW)*RXiWRm*Sin(PhiW))/sqrt(2._dp)
mat2a(2,3) = mat2a(2,3)-1._dp/2._dp*(gR**2*vHd*vR*RXiWLm*Sin(PhiW)**2)/sqrt(2._dp)
mat2a(2,4) = 0._dp 
...
mat2a(2,4) = mat2a(2,4)-1._dp/2._dp*(g2*gR*vHd*vL*Cos(PhiW)*RXiWLm*Sin(PhiW))/sqrt(2._dp)
...
mat2a(3,4) = mat2a(3,4)-1._dp/2._dp*(BETA2*vHd*vHu)
mat2a(3,4) = mat2a(3,4)-1._dp/2._dp*(BETA3*vHd*vHu)
mat2a(3,4) = mat2a(3,4)+(BETA1*vHu**2)/4._dp
mat2a(3,4) = mat2a(3,4)+(g2*gR*vL*vR*Cos(PhiW)*RXiWLm*Sin(PhiW))/2._dp
mat2a(3,4) = mat2a(3,4)-1._dp/2._dp*(g2*gR*vL*vR*Cos(PhiW)*RXiWRm*Sin(PhiW))
mat2a(4,4) = 0._dp 
mat2a(4,4) = mat2a(4,4)-1._dp*(muLR2)
mat2a(4,4) = mat2a(4,4)+(ALP1*vHd**2)/2._dp
...
mat2a(1,2) = 0._dp 
mat2a(1,2) = mat2a(1,2)-1._dp/2._dp*(BETA3*vHd**2)
mat2a(1,2) = mat2a(1,2)+(BETA1*vHd*vHu)/2._dp
mat2a(1,2) = mat2a(1,2)-1._dp/2._dp*(BETA2*vHu**2)
