...
Module FlavorKit_Observables_LRSM 
Use Control 
Use Settings 
Use Couplings_LRSM 
...
Subroutine Calculate_K0toEmu(OddllSLL,OddllSLR,OddllSRR,OddllSRL,OddllVRR,            & 
& OddllVLR,OddllVRL,OddllVLL,OddllSLLSM,OddllSLRSM,OddllSRRSM,OddllSRLSM,OddllVRRSM,     & 
& OddllVLRSM,OddllVRLSM,OddllVLLSM,BrK0eMu,ratioK0eMu)

Implicit None 
Complex(dp) :: OddllSLL(3,3,3,3),OddllSLR(3,3,3,3),OddllSRR(3,3,3,3),OddllSRL(3,3,3,3),              & 
& OddllVRR(3,3,3,3),OddllVLR(3,3,3,3),OddllVRL(3,3,3,3),OddllVLL(3,3,3,3),               & 
& OddllSLLSM(3,3,3,3),OddllSLRSM(3,3,3,3),OddllSRRSM(3,3,3,3),OddllSRLSM(3,3,3,3),       & 
& OddllVRRSM(3,3,3,3),OddllVLRSM(3,3,3,3),OddllVRLSM(3,3,3,3),OddllVLLSM(3,3,3,3)

Real(dp), Intent(out) :: BrK0eMu 
Real(dp), Intent(out) :: ratioK0eMu 
...
ratioK0eMu = width / width_SM
 ...
 ! ###### End user defined body 
End Subroutine Calculate_K0toEmu
...
End Function C1C2 
End Module FlavorKit_Observables_LRSM 
